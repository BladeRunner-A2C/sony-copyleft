...
#   
#
# Copyright 2017, 2020-2022 by QUALCOMM Technologies, Incorporated.
# All Rights Reserved.
...
# --------   ---------------       ------------------------------------------------------
# 09/14/22   rama                  Add RAW_FOLDER
# 05/18/22   rama                  Latest version of commons.py
# 07/30/21   yps                   Remove V2_SIGN_MODE
# 12/01/20   ck                    Added UNSIGNED_FOLDER and SIGNED_FOLDER from SBL 4.1
# 06/30/20   yps                   Support python3.8.3
# 02/27/20   yps                   Make scripts compatible with python2 and python3
# 10/11/17   vk                    Update xml
