...
@REM
@REM Copyright (c) 2022 Qualcomm Technologies Inc. All rights reserved.<BR>
...
@REM QCOM_EDK2_PATCH start
if not defined PYTHON_HOME (
  set PYTHON_HOME=c:\python27
@REM  echo %PYTHON_HOME%
)

if not defined PYTHON_COMMAND (
  set PYTHON_COMMAND=Python
@REM  echo PYTHON_COMMAND=%PYTHON_COMMAND%
)
@REM QCOM_EDK2_PATCH end
