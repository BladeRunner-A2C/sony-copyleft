  ...
  )
{
  ...
  //NULL added to set TestKeyUsed = TRUE always.
...
#if defined (QCOM_EDK2_PATCH)
  // TODO: Will use internal implementation. TBD
#else //QCOM_EDK2_PATCH
  //
...
#if defined (QCOM_EDK2_PATCH)
    // TODO: will use internal implementation.
#else //QCOM_EDK2_PATCH
