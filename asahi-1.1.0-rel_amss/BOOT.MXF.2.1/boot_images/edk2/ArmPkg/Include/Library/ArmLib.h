/** @file
  ...
  Copyright (c) 2015, 2016, 2020, 2022 Qualcomm Technologies, Inc. All Rights Reserved.
...
/*Adding a mask of memory protection attributes*/
#define EFI_MEMORY_PROTECTION_MASK (EFI_MEMORY_RO | EFI_MEMORY_RP | \
                                    EFI_MEMORY_WP | EFI_MEMORY_XP)
#endif
/**
...
typedef enum {
...
#if defined (QCOM_EDK2_PATCH)
  ,
  ARM_MEMORY_REGION_ATTRIBUTE_WRITE_THROUGH_XN=32,
  ...
  ARM_MEMORY_REGION_ATTRIBUTE_DEVICE_RO,
