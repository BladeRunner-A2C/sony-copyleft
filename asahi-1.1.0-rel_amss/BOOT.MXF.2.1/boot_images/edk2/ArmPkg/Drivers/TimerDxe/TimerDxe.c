/** @file
  ...
  Copyright (c) 2014, 2016 - 2018, 2020, 2022 Qualcomm Technologies, Inc. All rights reserved
  ...
  )
{
  ...
  if (gBS->LocateProtocol ((EFI_GUID *)&gEfiTimerArchProtocolGuid, NULL, &Intf) == EFI_SUCCESS)
    return EFI_SUCCESS;  
#endif
