/** @file
*
*  Copyright (c) 2020, 2021, 2022 Qualcomm Technologies, Inc. All rights reserved
  ...
  )
{
  ...
  /* EFI_MEMORY_RP should ideally not be used
  Heapguard is passing EFI_MEMORY_RP, considering that as RO to be safe */
  if (EfiAttributes == EFI_MEMORY_RP)
    EfiAttributes = EFI_MEMORY_RO;
#endif
...
#endif	   //ENABLE_XN && ENABLE_EXEC_CODE_READY_TO_BOOT && (ENABLE_DEP_64 || ENABLE_DEP_32)
      return EFI_SUCCESS;
    }
#endif     //ENABLE_XN
