...
#define MAX_VAL(arg1,arg2) (((arg1)>(arg2))?(arg1):(arg2))
// Qualcomm: Reduced FAT and Data cache sizes to reduce memory usage
#undef FAT_DATACACHE_GROUP_COUNT
#define FAT_DATACACHE_GROUP_COUNT         4

#undef FAT_FATCACHE_GROUP_MAX_COUNT
#define FAT_FATCACHE_GROUP_MAX_COUNT      4
#endif
...
typedef struct {
  ...
  UINTN     GroupMask;
#if defined (QCOM_EDK2_PATCH)
  CACHE_TAG CacheTag[MAX_VAL(FAT_DATACACHE_GROUP_COUNT,FAT_FATCACHE_GROUP_MAX_COUNT)];
#else
