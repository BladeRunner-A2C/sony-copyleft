...
# QCOM_EDK2_PATCH Start
# Explicitly remove file to enable rebuilding. Else IOError seen.
                UNIDestFile = os.path.join(self.OutputDir, MDefs['MODULE_UNI_FILE'])
                if os.path.isfile(UNIDestFile):
                  os.chmod( UNIDestFile, stat.S_IWRITE )                
                  os.remove(UNIDestFile)
# QCOM_EDK2_PATCH End
...
# QCOM_EDK2_PATCH Start
# Explicitly remove file to enable rebuilding. Else IOError seen.
                UNIDestFile = os.path.join(self.OutputDir, TianoCore[1])
                if os.path.isfile(UNIDestFile):
                  os.chmod( UNIDestFile, stat.S_IWRITE )                
                  os.remove(UNIDestFile)
# QCOM_EDK2_PATCH End
