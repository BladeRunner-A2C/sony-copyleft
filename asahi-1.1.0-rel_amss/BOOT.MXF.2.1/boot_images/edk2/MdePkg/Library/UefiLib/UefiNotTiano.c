...
#ifdef QCOM_EDK2_PATCH  
    /* Refer to MdeModulePkg\Universal\Acpi\FirmwarePerformanceDataTableDxe\FirmwarePerformanceDxe.c line no 546.
       FPDT is installed only when below Status code is reported */
