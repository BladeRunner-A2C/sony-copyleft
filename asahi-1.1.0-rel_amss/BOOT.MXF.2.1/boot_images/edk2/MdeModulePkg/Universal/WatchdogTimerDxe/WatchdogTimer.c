...
// CR2335501
// When the S/W wdog timer expires, it eventually calls Reset which continues executing at the same TPL (TPL_NOTIFY).
// However, the QC reset sequence requires certain services (like variables) which execute at TPL_CALLBACK.
                  TPL_CALLBACK,
#else
                  TPL_NOTIFY,
#endif
