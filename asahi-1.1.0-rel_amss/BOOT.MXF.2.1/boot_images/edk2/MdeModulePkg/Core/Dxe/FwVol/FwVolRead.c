...
Copyright (c) 2013-2014, 2016, 2019, 2020, 2022 Qualcomm Technologies, Inc.  All Rights Reserved.
...
#if defined (QCOM_EDK2_PATCH)
  // This should be done for the exactly opposite condition, where the
  // device is block device and is not a directly addressable memory.
  // FfsHeader already has the cached file data, just skip over this to 
  // use the previous cached buffer, otherwise it double caches the FV files
#else
