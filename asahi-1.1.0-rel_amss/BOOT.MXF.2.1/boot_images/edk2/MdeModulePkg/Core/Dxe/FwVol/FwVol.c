...
Copyright (c) 2020, 2022 Qualcomm Technologies Inc. All rights reserved.<BR>
  ...
  )
{
  ...
  DxeLock ();
  Status = FvReadFileSection (This, NameGuid, SectionType, SectionInstance, 
  ...
  )
{
  ...
  Status = FvReadFile (This, NameGuid, Buffer, BufferSize, FoundType, FileAttributes, AuthenticationStatus);
  ...
  )
{
  ...
  Status = FvGetNextFile (This, Key, FileType, NameGuid, Attributes, Size);
