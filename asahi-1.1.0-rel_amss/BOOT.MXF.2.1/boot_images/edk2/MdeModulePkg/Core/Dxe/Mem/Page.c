...
Copyright (c) 2013-2017, 2020, 2021, 2022 Qualcomm Technologies Inc. All rights reserved.
...
#if defined (QCOM_EDK2_PATCH)
          DEBUG ((DEBUG_WARN | DEBUG_PAGE, "the pages to free have been freed\n"));
#else
          DEBUG ((DEBUG_ERROR | DEBUG_PAGE, "the pages to free have been freed\n"));
#endif
        } else {
#if defined (QCOM_EDK2_PATCH)
          DEBUG ((DEBUG_WARN | DEBUG_PAGE, "the pages to allocate have been allocated\n"));
#else
  ...
  )
{
  ...
  //
#if defined (QCOM_EDK2_PATCH)
  Target = (UINTN) Target - (UINTN)(NumberOfBytes - 1);
#else
