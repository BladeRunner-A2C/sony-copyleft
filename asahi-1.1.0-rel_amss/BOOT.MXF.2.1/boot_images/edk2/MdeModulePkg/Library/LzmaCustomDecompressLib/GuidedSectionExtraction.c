...
/*
 * CR 3375068: LZMA decompress library headers are now moved to allow
 * external access. Use library header located at
 * "MdeModulePkg/Include/Library/LzmaDecompressLib.h"
 */
