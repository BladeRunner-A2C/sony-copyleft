...
/** @defgroup EFI_USBFN_IO_PROTOCOL  EFI_USBFN_IO_PROTOCOL 
 *  @ingroup INTERFACES 
 */
 /** @defgroup  EFI_USBFN_IO_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_USBFN_IO_PROTOCOL 
 */ 
 /** @defgroup  EFI_USBFN_IO_PROTOCOL_apis APIs
 *  @ingroup EFI_USBFN_IO_PROTOCOL 
 */ 

/** @defgroup  EFI_USBFN_IO_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_USBFN_IO_PROTOCOL 
 */

/*  Protocol GUID definition */
/** @ingroup EFI_USBFN_IO_PROTOCOL_data */
...
// Related Definitions
//
/** @addtogroup EFI_USBFN_IO_PROTOCOL_data
@{ */
/** Port type. */
...
/** @} */ /* end_addtogroup EFI_USBFN_IO_PROTOCOL_data */
...
/** @ingroup EFI_USBFN_IO_PROTOCOL_apis
  @par Summary
...
@{ */
/** Protocol version. */
#define EFI_USBFN_IO_PROTOCOL_REVISION   EFI_USBFN_IO_PROTOCOL_REVISION_3
#define EFI_USBFN_IO_PROTOCOL_REVISION_3 0x00010003
/** @} */ /* end_addtogroup efi_usbfn_constants */

/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_USBFN_IO_PROTOCOL_prot
  @par Summary
...
struct _EFI_USBFN_IO_PROTOCOL {
  ...
  /// descriptors. Enable the device by setting the run/stop bit.
  ///
  EFI_USBFN_IO_CONFIGURE_ENABLE_ENDPOINTS_EX  ConfigureEnableEndpointsEx;  //* Added in EFI_USBFN_IO_PROTOCOL_REVISION_3 */ 
  ///
  /// Update the Super speed descriptor of the device
  /// 
  ///
  EFI_USBFN_IO_Update_SS_Descriptor  UpdateSSDescriptor;                  //* Added in EFI_USBFN_IO_PROTOCOL_REVISION_3 */ 
};
