...
/** @defgroup efi_platform_info_protocol EFI_PLATFORM_INFO_PROTOCOL
 *  @ingroup SOCINFRA 
 */
 /** @defgroup  efi_platform_info_protocol_prot PROTOCOL
 *  @ingroup efi_platform_info_protocol 
 */ 
 /** @defgroup  efi_platform_info_protocol_apis APIs
 *  @ingroup efi_platform_info_protocol 
 */ 

/** @defgroup  efi_platform_info_protocol_data DATA_STRUCTURES
 *  @ingroup efi_platform_info_protocol 
 */
