...
/** @defgroup EFI_QCOM_PMIC_VERSION_PROTOCOL 
 *  @ingroup PMIC 
 */
 /** @defgroup  EFI_QCOM_PMIC_VERSION_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_QCOM_PMIC_VERSION_PROTOCOL 
 */ 
 /** @defgroup  EFI_QCOM_PMIC_VERSION_PROTOCOL_apis APIs
 *  @ingroup EFI_QCOM_PMIC_VERSION_PROTOCOL 
 */ 

/** @defgroup  EFI_QCOM_PMIC_VERSION_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_QCOM_PMIC_VERSION_PROTOCOL 
 */ 
...
/** @ingroup efi_pmicVersion_constants
  Protocol version.
*/
#define PMIC_VERSION_REVISION EFI_PMIC_VERSION_REVISION_1
#define EFI_PMIC_VERSION_REVISION_1 0x0000000000010006
...
typedef enum
{
   ...
   EFI_PMIC_IS_PM7325B   = 0x3C,               /**< PM7325B */
   EFI_PMIC_IS_PM1010H   = 0x3E,               /**< PM1010H */
   EFI_PMIC_IS_PM7325    = 0x3F,               /**< PM7325  */
   /* Following PMIC models are available only from 0x0000000000010005 */
   EFI_PMIC_IS_PM8010    = 0x41,               /**< PM8010  */
   EFI_PMIC_IS_PMG1110   = 0x43,               /**< PMG1110 */  
   EFI_PMIC_IS_VOODOO6   = 0x45,               /**< VOODOO6 */
   EFI_PMIC_IS_VOODOO8   = 0x46,               /**< VOODOO8 */  
   EFI_PMIC_IS_KOHALA    = 0x47,               /**< KOHALA  */
   EFI_PMIC_IS_NALOJR    = 0x48,               /**< NALOJR  */  
   EFI_PMIC_IS_HUMU      = 0x49,               /**< HUMU    */
   EFI_PMIC_IS_AZURA     = 0x4A,               /**< AZURA   */
   EFI_PMIC_IS_SCULPIN   = 0x4C,               /**< SCULPIN */
   EFI_PMIC_IS_BONEFISH  = 0x50,               /**< BONEFISH*/
   EFI_PMIC_IS_MORRO     = 0x51,               /**< MORRO   */
   EFI_PMIC_IS_COSWORTH  = 0x52,               /**< COSWORTHC8   */
   EFI_PMIC_IS_DONINGTON = 0x53,               /**< DONINGTON   */
   EFI_PMIC_IS_ETNA      = 0x55,               /**< ETNA    */
...
/** @} */ /* end_addtogroup EFI_QCOM_PMIC_VERSION_PROTOCOL_data */
...
/** @ingroup EFI_QCOM_PMIC_VERSION_PROTOCOL_apis
  @par Summary
