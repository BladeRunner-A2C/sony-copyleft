...
/*=============================================================================
 ...
 11/06/17   gk       Updated new Pmic API for UsbPwrCtrlDxe for UEFI
...
/*===========================================================================
  INCLUDE FILES
===========================================================================*/
/** @defgroup QCOM_USB_CONFIG_PROTOCOL  QCOM_USB_CONFIG_PROTOCOL 
 *  @ingroup INTERFACES 
 */
 /** @defgroup  QCOM_USB_CONFIG_PROTOCOL_prot PROTOCOL
 *  @ingroup QCOM_USB_CONFIG_PROTOCOL 
 */ 
 /** @defgroup  QCOM_USB_CONFIG_PROTOCOL_apis APIs
 *  @ingroup QCOM_USB_CONFIG_PROTOCOL 
 */ 

/** @defgroup  QCOM_USB_CONFIG_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup QCOM_USB_CONFIG_PROTOCOL 
 */
/**
...
/*  this is redefined below just before the protocol interface. 
  Protocol version.
*/
#define EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION   EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3
#define EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_1 0x0000000000010006
#define EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 0x0000000000020001
#define EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3 0x0000000000030001
...
/** @cond */
#define USB_CONFIG_INTERFACE_REVISION        EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION
#define USB_CONFIG_INTERFACE_REVISION_2      EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2
#define USB_CONFIG_INTERFACE_REVISION_3      EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3
...
/** @ingroup QCOM_USB_CONFIG_PROTOCOL_data */
...
/** @addtogroup QCOM_USB_CONFIG_PROTOCOL_data 
@{ */
/**
  USB core id. 
*/
typedef enum {
  ...
  USB_CORE_2,          /**< Core2. */
  USB_CORE_3,          /**< Core3. */  
  USB_CORE_4,          /**< Core4. */  /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
  USB_CORE_5,          /**< Core5. */  /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
...
typedef enum {
  ...
  USB_CONFIG_SSUSB3, /**< Super-speed USB 3. */

  USB_CONFIG_SSUSB4, /**< Super-speed USB 4. */  /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
  USB_CONFIG_SSUSB5, /**< Super-speed USB 5. */  /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
  USB_CONFIG_HSUSB5, /**< High-speed USB 5. */   /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
  USB_CONFIG_HSUSB6, /**< High-speed USB 6. */   /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
/** @cond */
  USB_CONFIG_CORE_MAX
/** @endcond */
} QCOM_USB_CONFIG_CORE_TYPE;

/* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
/**@ingroup QCOM_USB_CONFIG_PROTOCOL_data
  USB core and mode.
*/
typedef enum {
  USB_CONFIG_WOL_DISABLED,          /**< Wake on LAN Feature is disabled.                               */
                                    /**< Enable state is only entered in Offmode Charging state         */
  USB_CONFIG_WOL_EN_ETH_INIT,       /**< Wake on LAN Feature is enabled, and no USB ETH is enumerated.  */
  USB_CONFIG_WOL_EN_ETH_ENUM,       /**< Wake on LAN Feature is enabled, and USB ETH is enumerated.     */
  USB_CONFIG_WOL_EN_ETH_ARMED,      /**< Wake on LAN Feathre is enabled, and WoL is armed.              */
  USB_CONFIG_WOL_EN_ETH_TRIGGERED,  /**< Wake on LAN Feature is enabled, and WoL is triggered.          */
/** @cond */
  USB_CONFIG_WOL_MAX
/** @endcond */
} QCOM_USB_CONFIG_WOL_STATE_TYPE;
...
===========================================================================*/
/** @ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
 * 
**/
typedef
EFI_STATUS
...
/* QCOM_USB_CONFIG_PROTOCOL_POLL_SS_PHY_TRAINING */ 
/** @ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
 Polls SS PHY for target specific handling during training sequence. 

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[in]   CoreNum       CoreNumber (port) specified for which USB needs to be polled
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCOL_POLL_SS_PHY_TRAINING)(
  IN  QCOM_USB_CONFIG_PROTOCOL  *This,
  IN  QCOM_USB_CONFIG_CORE_TYPE  CoreType
  );

/* QCOM_USB_CONFIG_PROTOCOL_ADVANCE_SS_CMPL_PATTERN */ 
/** @ingroup QCOM_USB_CONFIG_PROTOCOL_apis  
  Advances USB SS compliance pattern (CP0, CP1 etc.) using target specific hardware register. 
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCOL_ADVANCE_SS_CMPL_PATTERN)(
  IN  QCOM_USB_CONFIG_PROTOCOL  *This,
  IN  QCOM_USB_CORE_NUM  CoreNum
  );


/* QCOM_USB_CONFIG_PROTOCOL_GET_WOL_STATE */ 
/** @ingroup QCOM_USB_CONFIG_PROTOCOL_apis  
  Gets Wake on LAN state from USB Config. 

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[out]  pWoLSatate    Pointer to the supported Wake On LAN state
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCOL_GET_WOL_STATE)(
  IN  QCOM_USB_CONFIG_PROTOCOL        *This,
  OUT QCOM_USB_CONFIG_WOL_STATE_TYPE  *pWoLState
  );

/* QCOM_USB_CONFIG_PROTOCOL_SET_WOL_STATE */ 
/**@ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
  Gets Wake on LAN state from USB Config. 

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[in]   WoLSatate     Wake On LAN state
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCOL_SET_WOL_STATE)(
  IN  QCOM_USB_CONFIG_PROTOCOL        *This,
  IN  QCOM_USB_CONFIG_WOL_STATE_TYPE   WoLState
  );

/* QCOM_USB_CONFIG_PROTOCOL_GET_VARIABLE */ 
/**@ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
  Get UEFI Variable from USB Config

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[in]   VariableEnum  UEFI Variable enum
  @param[out]  Data          Uefi Variable Value
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCOL_GET_VARIABLE)(
  IN      QCOM_USB_CONFIG_PROTOCOL        *This,
  IN      UINT32                          VariableEnum,
  OUT     INT32                           *Data
);

/* QCOM_USB_CONFIG_PROTOCOL_SET_VARIABLE */ 
/**@ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
  Set UEFI Variable from USB Config

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[in]   VariableEnum  UEFI Variable enum
  @param[out]  Data          Uefi Variable Value to write
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCOL_SET_VARIABLE)(
  IN      QCOM_USB_CONFIG_PROTOCOL        *This,
  IN      UINT32       VariableEnum,
  IN     INT32                      *Data
);
...
/* QCOM_USB_CONFIG_PROTOCOL_GET_EUD_ENABLE */ 
/**@ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
  Get EUD enable from USB Config

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[out]  IsEudEnable   EUD is enable
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCAL_GET_EUD_ENABLE)(
  IN    QCOM_USB_CONFIG_PROTOCOL        *This,
  OUT   UINT32                         *IsEudEnable
);

/* QCOM_USB_CONFIG_PROTOCAL_SET_USB_LOOPBACK */ 
/**@ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
  Set Usb Loopback before trigger the test

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[in]   DeviceIndex   Device Index
  @param[in]   HostIndex     Host Index
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCAL_SET_USB_LOOPBACK)(
  IN    QCOM_USB_CONFIG_PROTOCOL       *This,
  IN    UINT32                         DeviceIndex,
  IN    UINT32                         HostIndex
);

/* QCOM_USB_CONFIG_PROTOCAL_GET_USB_CORE_INFO */ 
/**@ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
  Set Usb Loopback before trigger the test

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[in]   CoreIndex     Core Index
  @param[Out]  UsbCoreInfo   Pointer to Usb Core info
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCAL_GET_USB_CORE_INFO)(
  IN    QCOM_USB_CONFIG_PROTOCOL       *This,
  IN    UINT32                         CoreIndex,
  IN    UINT32                         InfoEnum,
  OUT   UINT64                         *InfoData
...
/* QCOM_USB_CONFIG_PROTOCAL_SET_USB_CORE_MODE */ 
/**@ingroup QCOM_USB_CONFIG_PROTOCOL_apis 
  Set Usb core mode 

  @param[in]   This          Pointer to the QCOM_USB_CONFIG_PROTOCOL instance.
  @param[in]   CoreIndex     Core Index
  @param[Out]  newMode       New usb core mode (DISABLE, DEVICE_MODE, HOST_MODE, DUAL_MODE)
...
typedef
EFI_STATUS
(EFIAPI *QCOM_USB_CONFIG_PROTOCAL_SET_USB_CORE_MODE)(
IN    QCOM_USB_CONFIG_PROTOCOL       *This,
IN    UINT32             CoreIdx,
IN    UINT32             newMode
);
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup QCOM_USB_CONFIG_PROTOCOL_prot
  @par Summary
...
struct _QCOM_USB_CONFIG_PROTOCOL {
  ...
  QCOM_USB_CONFIG_PROTOCOL_POLL_SS_PHY_TRAINING         PollSSPhyTraining;
  QCOM_USB_CONFIG_PROTOCOL_ADVANCE_SS_CMPL_PATTERN      AdvanceSSCmplPattern;
  QCOM_USB_CONFIG_PROTOCOL_GET_WOL_STATE                GetWoLState;    /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
  QCOM_USB_CONFIG_PROTOCOL_SET_WOL_STATE                SetWoLState;    /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_2 */
  QCOM_USB_CONFIG_PROTOCOL_GET_VARIABLE                 GetVariable;    /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3 */
  QCOM_USB_CONFIG_PROTOCOL_SET_VARIABLE                 SetVariable;    /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3 */
  QCOM_USB_CONFIG_PROTOCAL_GET_EUD_ENABLE               IsEudEnable;    /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3 */
  QCOM_USB_CONFIG_PROTOCAL_SET_USB_LOOPBACK             SetUsbLoopback; /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3 */
  QCOM_USB_CONFIG_PROTOCAL_GET_USB_CORE_INFO            GetUsbCoreInfo; /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3 */
  QCOM_USB_CONFIG_PROTOCAL_SET_USB_CORE_MODE            SetUsbCoreMode; /* Added in EFI_QCOM_USB_CONFIG_PROTOCOL_REVISION_3 */
