...
/*==============================================================================
  Copyright (c) 2011-2017,2019-2021, 2023 Qualcomm Technologies, Inc.
           All Rights Reserved.
...
$Header: //components/rel/core.boot_sdk/1.3/QcomSdkPkg/Include/Protocol/prot_inc/smem_type.h#2 $
...
/** @addtogroup EFI_SMEM_PROTOCOL_data
@{ */
...
typedef enum 
{
  ...
  SMEM_NPU          =  10,                    /**< NPU processor */
  SMEM_SPSS_SP      =  11,                    /**< SPSS Host that shares partition with TZ*/
  SMEM_NSP1         =  12,                    /**< NSP1 processor */
  SMEM_WPSS         =  13,                    /**< WPSS processor */
  SMEM_TME          =  14,                    /**< TME processor */
  SMEM_APPS_VM_LA   =  15,                    /**< VM LA Host of Apps processor> */
  SMEM_EXT_PM       =  16,                    /**< External PM > */
  SMEM_GPDSP0       =  17,                    /**< General Purpose DSP 0 > */
  SMEM_GPDSP1       =  18,                    /**< General Purpose DSP 1 > */
  SMEM_SOCCP        =  19,                    /**< SOCCP processor */
  SMEM_NUM_HOSTS    =  20,                    /**< Max number of host in target */
...
/** @} */ /* end_addtogroup EFI_SMEM_PROTOCOL_data */
