...
===========================================================================
Copyright (c) 2017,2021-22 QUALCOMM Technologies Incorporated.
All Rights Reserved.
...
$Header: //components/rel/core.boot_sdk/1.3/QcomSdkPkg/Include/Protocol/prot_inc/GPIOTypes.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/06/22   ara     Added strong pull support
...
==========================================================================*/
/** @defgroup efi_gpio_protocol EFI_GPIO_PROTOCOL
 *  @ingroup SOCINFRA 
 */
 /** @defgroup  efi_gpio_protocol_prot PROTOCOL
 *  @ingroup efi_gpio_protocol 
 */ 
 /** @defgroup  efi_gpio_protocol_apis APIs
 *  @ingroup efi_gpio_protocol 
 */ 

/** @defgroup  efi_gpio_protocol_data DATA_STRUCTURES
 *  @ingroup efi_gpio_protocol 
 */ 
...
/** @} */ /* end_ingroup efi_gpio_protocol_data */
...
typedef enum
{
  ...
  GPIO_DEVICE_DT       = 2,     /*<-- Device tree GPIO instance        > */
...
typedef struct GPIOConfigType
{
  ...
  uint32 strongpull   :  1;   /**<-- GPIO strong pull support             >*/
  uint32 unused       : 12;   /**<-- Unused bits                          >*/
}GPIOConfigType;
