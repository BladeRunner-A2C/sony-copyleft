...
#if !defined(FEATURE_XBOOT) /* this definition move to EFIPmicPwrOn.h */
typedef enum
{
...
typedef enum
{
    ...
    EFI_PM_READ_SPMI,
    EFI_PM_WRITE_SPMI,
    EFI_PM_DISABLE_DEBUG_SPMI,
} EFI_PM_TEST_DRIVER_ENABLE_DEBUG_SPMI_TYPE_FUNCTION;


typedef struct _EFI_PM_TEST_SPMI_DEBUG_PARAM
{
   UINT32  BusId;
   UINT32  DeviceIndex;
   UINT32  Addr;
...
{
   EFI_PM_TEST_SPMI_DEBUG_PARAM      SpmiParams;
}EFI_PM_TEST_ENABLE_DEBUG_SPMI_FUNCTION_TYPE;

/** @} */ /* end_ingroup EFI_QCOM_PMIC_TEST_PROTOCOL_data */
