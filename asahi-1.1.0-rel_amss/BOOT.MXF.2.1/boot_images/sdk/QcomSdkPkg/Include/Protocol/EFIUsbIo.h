...
/** @defgroup EFI_USB_IO_PROTOCOL  EFI_USB_IO_PROTOCOL 
 *  @ingroup INTERFACES 
 */
 /** @defgroup  EFI_USB_IO_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_USB_IO_PROTOCOL 
 */ 
 /** @defgroup  EFI_USB_IO_PROTOCOL_apis APIs
 *  @ingroup EFI_USB_IO_PROTOCOL 
 */ 

/** @defgroup  EFI_USB_IO_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_USB_IO_PROTOCOL 
 */
...
#define EFI_USB_IO_PROTOCOL_REVISION   EFI_USB_IO_PROTOCOL_REVISION_1
#define EFI_USB_IO_PROTOCOL_REVISION_1 0x0000000000010001

/* Global ID for the USB I/O Protocol */
/** @ingroup EFI_USB_IO_PROTOCOL_data */
...
/** @addtogroup EFI_USB_IO_PROTOCOL_data 
@{ */
...
/** @} */ /* end_addtogroup EFI_USB_IO_PROTOCOL_data */
...
/** @ingroup EFI_USB_IO_PROTOCOL_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_USB_IO_PROTOCOL_prot
  @par Summary
...
struct _EFI_USB_IO_PROTOCOL {
  ...
  UINT64                                Revision;                /* EFI_USB_IO_PROTOCOL_REVISION_1 */
  EFI_USB_IO_ASYNC_BULK_TRANSFER        UsbAsyncBulkTransfer;    /* EFI_USB_IO_PROTOCOL_REVISION_1 */
  EFI_USB_IO_ASYNC_CONTROL_TRANSFER     UsbAsyncControlTransfer; /* EFI_USB_IO_PROTOCOL_REVISION_1 */
};
