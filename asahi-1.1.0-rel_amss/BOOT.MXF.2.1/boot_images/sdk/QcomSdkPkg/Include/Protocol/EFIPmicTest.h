...
/** @defgroup EFI_QCOM_PMIC_TEST_PROTOCOL 
 *  @ingroup PMIC 
 */
 /** @defgroup  EFI_QCOM_PMIC_TEST_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_QCOM_PMIC_TEST_PROTOCOL 
 */ 
 /** @defgroup  EFI_QCOM_PMIC_TEST_PROTOCOL_apis APIs
 *  @ingroup EFI_QCOM_PMIC_TEST_PROTOCOL 
 */ 

/** @defgroup  EFI_QCOM_PMIC_TEST_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_QCOM_PMIC_TEST_PROTOCOL 
 */ 
...
/** @ingroup EFI_QCOM_PMIC_TEST_PROTOCOL_data
  Protocol version.
*/
...
typedef union _EFI_PM_TEST_DRIVER_TYPE_FUNCTION
{
  //  EFI_PM_TEST_DRIVER_GPIO_TYPE_FUNCTION GpioTypeFunction;
    ...
    EFI_PM_TEST_DRIVER_BOB_TYPE_FUNCTION  BOBTypeFunction;
	 EFI_PM_TEST_DRIVER_ENABLE_DEBUG_SPMI_TYPE_FUNCTION  SPMIDebugTypeFunction;
    ...
    union
    {
     //   EFI_PM_TEST_GPIO_FUNCTION_TYPE       GpioFuntionType;
      ...
      EFI_PM_TEST_BOB_FUNCTION_TYPE        BOBFunctionType;
	   EFI_PM_TEST_ENABLE_DEBUG_SPMI_FUNCTION_TYPE        SPMIDebugFunctionType;
    } u;    
...
/**
 @ingroup EFI_QCOM_PMIC_TEST_PROTOCOL_prot
...
/** @ingroup EFI_QCOM_PMIC_TEST_PROTOCOL_apis
**/
typedef
...
typedef
void (EFIAPI *EFI_PM_PRM_OS_AUX_DEV_INIT)(
);
...
/** @ingroup EFI_QCOM_PMIC_TEST_PROTOCOL_prot
  @par Summary
  EFI_QCOM_PMIC_TEST_PROTOCOL Protocol interface.
...
struct _EFI_QCOM_PMIC_TEST_PROTOCOL {
    ...
    EFI_PM_PRM_OS_AUX_DEV_INIT            PmicPrmOsAuxDevInit;
};
