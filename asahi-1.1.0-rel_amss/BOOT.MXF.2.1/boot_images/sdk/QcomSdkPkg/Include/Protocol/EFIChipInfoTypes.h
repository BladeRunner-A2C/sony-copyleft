...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
12/1/24    adokhle    Chipinfo name update for Palawan7 as Lamma
12/28/23   adokhle    Added chipinfo IDs for Palawan target
01/11/23   myendamu   Added Purwa ChipID
06/28/23   schaubey   Added chipid for Matrix
03/28/23   vbingi     Added chipinfo part id for Kailua target
03/23/23   adokhle    Added chipinfo ID for Lemans new variant
03/06/23   adokhle    Added chipinfo IDs for Palawan target
12/21/22   vbingi	  Added Chipinfo IDs for Monaco target
09/08/22   ara        Added SKU definitions.
01/28/16   pbitra     Created.
=============================================================================*/

#ifndef __EFICHIPINFOTYPES_H__
#define __EFICHIPINFOTYPES_H__
/** @defgroup efi_chipInfo_protocol EFI_CHIPINFO_PROTOCOL
 *  @ingroup SOCINFRA
 */

 /** @defgroup  efi_chipInfo_protocol_prot PROTOCOL
 *  @ingroup efi_chipInfo_protocol
 */
 /** @defgroup  efi_chipInfo_protocol_apis APIs
 *  @ingroup efi_chipInfo_protocol
 */

/** @defgroup  efi_chipInfo_protocol_data DATA_STRUCTURES
 *  @ingroup efi_chipInfo_protocol
 */

/** @ingroup efi_chipInfo_protocol_data
@{ */
 ...
 */
  #define EFICHIPINFO_MODEM_UNKNOWN    0x0000
  #define EFICHIPINFO_MODEM_1X         0x0001
  #define EFICHIPINFO_MODEM_EVDO       0x0002
  #define EFICHIPINFO_MODEM_GSM        0x0004
  #define EFICHIPINFO_MODEM_UMTS       0x0008
  #define EFICHIPINFO_MODEM_CGPS       0x0010
  #define EFICHIPINFO_MODEM_EVDO_REVA  0x0020
  #define EFICHIPINFO_MODEM_EVDO_REVB  0x0040
  #define EFICHIPINFO_MODEM_LTE        0x0080
  #define EFICHIPINFO_MODEM_GNSS       0x0100
  #define EFICHIPINFO_MODEM_EHRPD      0x0200
  #define EFICHIPINFO_MODEM_SUPPORTED  0xFFFFFFFF

/** @} */ /* end_ingroup efi_chipInfo_protocol_data */
...
typedef enum
{
  ...
  EFICHIPINFO_ID_SMP_RENNELL        = 424,
  ...
  EFICHIPINFO_ID_SM_LAHAINA_MODULE  = 456,
  EFICHIPINFO_ID_SM_WAIPIO          = 457,
  EFICHIPINFO_ID_SDX_OLYMPIC        = 458,
  EFICHIPINFO_ID_SM_BITRA_H         = 459,
  EFICHIPINFO_ID_SA_MAKENA_IVI      = 460,
  EFICHIPINFO_ID_SA_MAKENA_ADAS     = 461,
  EFICHIPINFO_ID_FSM10000           = 462,
  EFICHIPINFO_ID_FSM10005           = 463,
  EFICHIPINFO_ID_FSM10010           = 464,
  EFICHIPINFO_ID_FSM10051           = 465,
  EFICHIPINFO_ID_FSM10056           = 466,
  EFICHIPINFO_ID_QCM_NICOBAR        = 467,
  EFICHIPINFO_ID_QCS_NICOBAR        = 468,
  EFICHIPINFO_ID_QCM_KAMORTA        = 469,
  EFICHIPINFO_ID_QCS_KAMORTA        = 470,
  EFICHIPINFO_ID_QMP_AGATTI         = 471,
  EFICHIPINFO_ID_SM_AGATTI          = EFICHIPINFO_ID_QM_AGATTI,
  EFICHIPINFO_ID_SMP_AGATTI         = EFICHIPINFO_ID_QMP_AGATTI,
  EFICHIPINFO_ID_SM_MANNAR_H        = 472,
  EFICHIPINFO_ID_SCP_MAKENA         = EFICHIPINFO_ID_SC_MAKENA,
  EFICHIPINFO_ID_QCM_AGATTI         = 473,
  EFICHIPINFO_ID_QCS_AGATTI         = 474,
  EFICHIPINFO_ID_SM_KODIAK          = 475,
  EFICHIPINFO_ID_SM_FRASER          = 476,
  EFICHIPINFO_ID_QCN9100            = 477,
  EFICHIPINFO_ID_QCN9101            = 478,
  EFICHIPINFO_ID_QCN9102            = 479,
  EFICHIPINFO_ID_QCN9110            = 480,
  EFICHIPINFO_ID_QCS8250            = 481,
  EFICHIPINFO_ID_SMP_WAIPIO         = 482,
  EFICHIPINFO_ID_SDX_OLYMPIC_HYBRID = EFICHIPINFO_ID_SDX_OLYMPIC,
  EFICHIPINFO_ID_SDX_OLYMPIC_SINGLEDIE = 483,
  EFICHIPINFO_ID_SDX12              = 484,
  EFICHIPINFO_ID_WCN7850            = 485,
  EFICHIPINFO_ID_SDW_ATHERTON       = 486,
  EFICHIPINFO_ID_SC_KODIAK_CHROME   = 487,
  EFICHIPINFO_ID_SC_KODIAK_WINDOWS  = 488,
  EFICHIPINFO_ID_QCN9022            = 489,
  EFICHIPINFO_ID_QCN9024            = 490,
  EFICHIPINFO_ID_QCN9070            = 491,
  EFICHIPINFO_ID_QCN9072            = 492,
  EFICHIPINFO_ID_QCN9074            = 493,
  EFICHIPINFO_ID_QTANG2             = 494,
  EFICHIPINFO_ID_SC7180P            = 495,
  EFICHIPINFO_ID_QRB5165N           = 496,
  EFICHIPINFO_ID_QCM_KODIAK         = 497,
  EFICHIPINFO_ID_QCS_KODIAK         = 498,
  EFICHIPINFO_ID_SMP_KODIAK         = 499,
  EFICHIPINFO_ID_SDX57              = 500,
  EFICHIPINFO_ID_SM_LAHAINA_LTE_ONLY = 501,
  EFICHIPINFO_ID_SMP_LAHAINA_OEM_SPECIFIC = 502,
  EFICHIPINFO_ID_IPQ5000            = 503,
  EFICHIPINFO_ID_IPQ0509            = 504,
  EFICHIPINFO_ID_IPQ0518            = 505,
  EFICHIPINFO_ID_SM_FILLMORE        = 506,
  EFICHIPINFO_ID_SM_STRAIT          = 507,
  EFICHIPINFO_ID_WCN7851            = 508,
  EFICHIPINFO_ID_SDX_OLYMPIC_LITE   = 509,
  EFICHIPINFO_ID_IPQ9008            = 510,
  EFICHIPINFO_ID_IPQ9028            = 511,
  EFICHIPINFO_ID_IPQ9038            = 512,
  EFICHIPINFO_ID_IPQ9047            = 513,
  EFICHIPINFO_ID_IPQ9048            = 514,
  EFICHIPINFO_ID_SM_KODIAK_LTE_ONLY = 515,
  EFICHIPINFO_ID_QCX315             = 516,
  EFICHIPINFO_ID_SWP_ATHERTON       = 517,
  EFICHIPINFO_ID_SM_DIVAR           = 518,
  EFICHIPINFO_ID_SM_KAILUA          = 519,
  EFICHIPINFO_ID_IPQ5016            = 520,
  EFICHIPINFO_ID_IPQ9510            = 521,
  EFICHIPINFO_ID_QCS8155            = 522,
  EFICHIPINFO_ID_QRB_KAMORTA        = 523,
  EFICHIPINFO_ID_QRB_AGATTI         = 524,
  EFICHIPINFO_ID_SXR_AURORA         = 525,
  EFICHIPINFO_ID_QCN9274            = 526,
  EFICHIPINFO_ID_QCN6224            = 527,
  EFICHIPINFO_ID_QCN9222            = 528,
  EFICHIPINFO_ID_QCN9272            = 529,
  EFICHIPINFO_ID_SM_PALIMA          = 530,
  EFICHIPINFO_ID_SMP_PALIMA         = 531,
  EFICHIPINFO_ID_SA_LEMANSAU_IVI    = 532,
  EFICHIPINFO_ID_SA_LEMANSAU_ADAS_H = 533,
  EFICHIPINFO_ID_SA_LEMANSAU_IVI_ADAS = 534,
  EFICHIPINFO_ID_SA_LEMANSAU_ADAS   = 535,
  EFICHIPINFO_ID_SMP_KAILUA         = 536,
  EFICHIPINFO_ID_SM_NETRANI         = 537,
  EFICHIPINFO_ID_HELIOS             = 538,
  EFICHIPINFO_ID_QRU_LASSEN         = 539,
  EFICHIPINFO_ID_SM_PALIMA_LTE_ONLY = 540,
  EFICHIPINFO_ID_FSM20000           = 541,
  EFICHIPINFO_ID_FSM20051           = 542,
  EFICHIPINFO_ID_FSM20055           = 543,
  EFICHIPINFO_ID_FSM20056           = 544,
  EFICHIPINFO_ID_QDU_LASSEN         = 545,
  EFICHIPINFO_ID_SCP_KODIAK         = 546,
  EFICHIPINFO_ID_SMP_FILLMORE       = 547,
  EFICHIPINFO_ID_QDRU_LASSEN        = EFICHIPINFO_ID_QRU_LASSEN,
  EFICHIPINFO_ID_QCS7230            = 548,
  EFICHIPINFO_ID_SXR_HALLIDAY       = 549,
  EFICHIPINFO_ID_FSM10016           = 550,
  EFICHIPINFO_ID_SDX_OLYMPIC_HYBRID_PRO = 551,
  EFICHIPINFO_ID_SM_WAIPIO_LTE_ONLY = 552,
  EFICHIPINFO_ID_SC_8CGEN3          = 553,
  EFICHIPINFO_ID_SSG_AURORA         = 554,
  EFICHIPINFO_ID_SCP_HAMOA           = 555,
  EFICHIPINFO_ID_SDX_PINNACLES       = 556,
  EFICHIPINFO_ID_SM_LANAI            = 557,
  EFICHIPINFO_ID_SA_PINNACLES        = 558,
  EFICHIPINFO_ID_SA_PINNACLES_L      = 559,
  EFICHIPINFO_ID_SA_AMINI            = 560,
  EFICHIPINFO_ID_STP_DIVAR           = 561,
  EFICHIPINFO_ID_STP_DIVAR_L         = 562,
  EFICHIPINFO_ID_SCP_8CGEN3          = 563,
  EFICHIPINFO_ID_SM_FILLMORE_LTE_ONLY= 564,
  EFICHIPINFO_ID_SMP_STRAIT          = 565,
  EFICHIPINFO_ID_SM_KAPITI           = 566,
  EFICHIPINFO_ID_KODIAK_SCP_7CGEN3   = 567,
  EFICHIPINFO_ID_SM_CLARENCE         = 568,
  EFICHIPINFO_ID_IPQ5019             = 569,
  EFICHIPINFO_ID_SDX_KUNO_SINGLEDIE  = 570,
  EFICHIPINFO_ID_SDX_KUNO_HYBRID     = 571,
  EFICHIPINFO_ID_MDM9628AQ           = 572,
  EFICHIPINFO_ID_QFW6114             = 573,
  EFICHIPINFO_ID_QFW6124             = 574,
  EFICHIPINFO_ID_QCS_KODIAK_LITE     = 575,
  EFICHIPINFO_ID_QCM_KODIAK_LITE     = 576,
  EFICHIPINFO_ID_SMP_LANAI           = 577,
  EFICHIPINFO_ID_SM_STRAIT_LITE      = 578,
  EFICHIPINFO_ID_SSG2_AURORA         = 579,
  EFICHIPINFO_ID_SDX_PINNACLES_M     = 580,
  EFICHIPINFO_ID_QCM_CLARENCE        = 581,
  EFICHIPINFO_ID_QCS_CLARENCE        = 582,
  EFICHIPINFO_ID_SMP_NETRANI         = 583,
  EFICHIPINFO_ID_DIVAR_XR            = 584,
  EFICHIPINFO_ID_DIVAR_GAMING        = 585,
  EFICHIPINFO_ID_DIVARQ_IOT          = 586,
  EFICHIPINFO_ID_QDU1010_LASSEN      = 587,
  EFICHIPINFO_ID_QRU1032_LASSEN      = 588,
  EFICHIPINFO_ID_QRU1052_LASSEN      = 589,
  EFICHIPINFO_ID_QRU1062_LASSEN      = 590,
  EFICHIPINFO_ID_SM_TOFINO           = 591,
  EFICHIPINFO_ID_IPQ5332             = 592,
  EFICHIPINFO_ID_IPQ5322             = 593,
  EFICHIPINFO_ID_IPQ5312             = 594,
  EFICHIPINFO_ID_IPQ5302             = 595,
  EFICHIPINFO_ID_WCN7855             = 596,
  EFICHIPINFO_ID_WCN7856             = 597,
  EFICHIPINFO_ID_QRB3165             = 598,
  EFICHIPINFO_ID_QRB3165N            = 599,
  EFICHIPINFO_ID_SG_KAILUA           = 600,
  EFICHIPINFO_ID_SGP_KAILUA          = 601,
  EFICHIPINFO_ID_SMP_CLARENCE        = 602,
  EFICHIPINFO_ID_QCS_KAILUA          = 603,
  EFICHIPINFO_ID_QCM_KAILUA          = 604,
  EFICHIPINFO_ID_SA_MONACOAU_ADAS    = 605,
  EFICHIPINFO_ID_SA_MONACOAU_IVI     = 606,
  EFICHIPINFO_ID_SA_MONACOAU_SRV1L   = 607,
  EFICHIPINFO_ID_SM_CAMANO           = 608,
  EFICHIPINFO_ID_SDX_PINNACLES_L     = 609,
  EFICHIPINFO_ID_SDX_PINNACLES_UL    = 610,
  EFICHIPINFO_ID_WCN7880             = 611,
  EFICHIPINFO_ID_WCN7881             = 612,
  EFICHIPINFO_ID_SM_NETRANI7         = 613,
  EFICHIPINFO_ID_SM_PALAWAN          = 614,
  EFICHIPINFO_ID_SCP_HAMOA_10CORE    = 615,
  EFICHIPINFO_ID_SCP_HAMOA_8CORE     = 616,
  EFICHIPINFO_ID_QCN9160             = 617,
  EFICHIPINFO_ID_SM_PAKALA           = 618,
  EFICHIPINFO_ID_SA_LEMANSAU_IVI_ADAS_L = 619,
  EFICHIPINFO_ID_SA_MONACOAU_SRV1L_FFC  = 620,
  EFICHIPINFO_ID_QWM_AGATTI          = 621,
  EFICHIPINFO_ID_QWS_AGATTI          = 622,
  EFICHIPINFO_ID_SM_KALPENI          = 623,
  EFICHIPINFO_ID_IPQ5300             = 624,
  EFICHIPINFO_ID_QCN6432             = 625,
  EFICHIPINFO_ID_MDM9205S            = 626,
  EFICHIPINFO_ID_QCN6422             = 627,
  EFICHIPINFO_ID_SXR_STRAIT          = 628,
  EFICHIPINFO_ID_SXR_MATRIX          = 629,
  EFICHIPINFO_ID_QCN6412             = 630,
  EFICHIPINFO_ID_SCQ_NETRANI         = 631,
  EFICHIPINFO_ID_SM_LAMMA            = 632,
  EFICHIPINFO_ID_SG_NETRANI          = 633,
  EFICHIPINFO_ID_SGP_NETRANI         = 634,
  EFICHIPINFO_ID_SCP_PURWA           = 635,
  EFICHIPINFO_ID_SM_KIMOLOS          = 636,  
  EFICHIPINFO_ID_SDX_OLYMPIC_HYBRID_PRO_PLUS = 637,
  EFICHIPINFO_ID_SCP_NETRANI7        = 638,
  EFICHIPINFO_ID_SMP_PAKALA          = 639,
  EFICHIPINFO_ID_SM_MILOS            = 640,
  EFICHIPINFO_ID_SMP_MILOS           = 641,
  EFICHIPINFO_ID_SMP_PALAWAN         = 642,
  EFICHIPINFO_ID_SMP_LAMMA           = 643,
  EFICHIPINFO_ID_SM_SHAW             = 644,
  EFICHIPINFO_ID_QCM_LANAI           = 645,
  EFICHIPINFO_ID_QCS_LANAI           = 646,
  EFICHIPINFO_ID_SM_ARAN             = 647,
  EFICHIPINFO_ID_SMP_NORDAU          = 648,
  EFICHIPINFO_ID_SXR_HALLIDAY5       = 649,
  EFICHIPINFO_ID_IPQ5321             = 650,
  EFICHIPINFO_ID_IPQ5424             = 651,
  EFICHIPINFO_ID_SXR_MATRIX5         = 652,
  EFICHIPINFO_ID_SG_CLARENCE         = 653,
  EFICHIPINFO_ID_SGP_CLARENCE        = 654,
  EFICHIPINFO_ID_SM_BONITO           = 655,
  EFICHIPINFO_ID_QRB_LEMANS          = 656,
...
/** @cond */
  ...
  EFICHIPINFO_FAMILY_KODIAK     = 118,
  EFICHIPINFO_FAMILY_QCN91xx    = 119,
  EFICHIPINFO_FAMILY_WCN7850    = 120,
  EFICHIPINFO_FAMILY_ATHERTON   = 121,
  EFICHIPINFO_FAMILY_QTANG2     = 122,
  EFICHIPINFO_FAMILY_FILLMORE   = 123,
  EFICHIPINFO_FAMILY_STRAIT     = 124,
  EFICHIPINFO_FAMILY_IPQ90xx    = 125,
  EFICHIPINFO_FAMILY_DIVAR      = 126,
  EFICHIPINFO_FAMILY_KAILUA     = 127,
  EFICHIPINFO_FAMILY_AURORA     = 128,
  EFICHIPINFO_FAMILY_QCN92xx    = 129,
  EFICHIPINFO_FAMILY_PALIMA     = 130,
  EFICHIPINFO_FAMILY_LEMANSAU   = 131,
  EFICHIPINFO_FAMILY_NETRANI    = 132,
  EFICHIPINFO_FAMILY_HELIOS     = 133,
  EFICHIPINFO_FAMILY_LASSEN     = 134,
  EFICHIPINFO_FAMILY_HALLIDAY   = 135,
  EFICHIPINFO_FAMILY_HAMOA      = 136,
  EFICHIPINFO_FAMILY_PINNACLES  = 137,
  EFICHIPINFO_FAMILY_LANAI      = 138,
  EFICHIPINFO_FAMILY_AMINI      = 139,
  EFICHIPINFO_FAMILY_KAPITI     = 140,
  EFICHIPINFO_FAMILY_CLARENCE   = 141,
  EFICHIPINFO_FAMILY_KUNO       = 142,
  EFICHIPINFO_FAMILY_IPQ53xx    = 143,
  EFICHIPINFO_FAMILY_WCN7855    = 144,
  EFICHIPINFO_FAMILY_MONACOAU   = 145,
  EFICHIPINFO_FAMILY_CAMANO     = 146,
  EFICHIPINFO_FAMILY_WCN7880    = 147,
  EFICHIPINFO_FAMILY_PALAWAN    = 148,
  EFICHIPINFO_FAMILY_QCN9160    = 149,
  EFICHIPINFO_FAMILY_PAKALA     = 150,
  EFICHIPINFO_FAMILY_KALPENI    = 151,
  EFICHIPINFO_FAMILY_QCN6432    = 152,
  EFICHIPINFO_FAMILY_MATRIX     = 153,
  EFICHIPINFO_FAMILY_PURWA      = 154,
  EFICHIPINFO_FAMILY_MILOS      = 155,
  EFICHIPINFO_FAMILY_NORDAU     = 156,
  EFICHIPINFO_FAMILY_IPQ54xx    = 157,
  EFICHIPINFO_FAMILY_BONITO     = 158,
/** @cond */
 ...
 * e.g. EFICHIPINFO_PART_DISPLAY is for MDSS_0 on Makena.
 */
...
typedef enum
{
  ...
  EFICHIPINFO_PART_COMP      = 8,  // For both CDSP and NSP
 ...
 * Use EFIChipInfo_GetSKU to get the current chip's Feature Code.
 *
 * See EFIChipInfo_GetSKU for more details.
 */
typedef enum
{
 ...
 * Use EFIChipInfo_GetSKU to get the current chip's P-Code.
 *
 * See EFIChipInfo_GetSKU for more details.
 */
typedef enum
