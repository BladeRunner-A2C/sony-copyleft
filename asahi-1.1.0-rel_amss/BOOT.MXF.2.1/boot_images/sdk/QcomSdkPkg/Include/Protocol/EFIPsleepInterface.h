...
#define EFI_PSLEEP_PROTOCOL_REVISION_3 0x0000000000030000
#define EFI_PSLEEP_PROTOCOL_REVISION_4 0x0000000000040000

#define EFI_PSLEEP_PROTOCOL_REVISION EFI_PSLEEP_PROTOCOL_REVISION_4
...
/** @ingroup EFI_PSLEEP_PROTOCOL_apis
*/
typedef void (*PsleepVetoLpm)(
  UINT32 coreMask, UINT16 mode_id
);

/** @ingroup EFI_PSLEEP_PROTOCOL_apis 
*/
typedef void (*PsleepPcieCxpcBlocker)(void);
...
typedef struct 
{
  ...
  PsleepVetoLpm         VetoLpm;         //Added in EFI_PSLEEP_PROTOCOL_REVISION_3
  PsleepPcieCxpcBlocker PcieCxpcBlocker; //Added in EFI_PSLEEP_PROTOCOL_REVISION_4
}EFI_PSLEEP_PROTOCOL;
