...
/** @defgroup EFI_USB2_HC_PROTOCOL  EFI_USB2_HC_PROTOCOL 
 *  @ingroup INTERFACES 
 */
 /** @defgroup  EFI_USB2_HC_PROTOCOL_prot PROTOCOL
 *  @ingroup EFI_USB2_HC_PROTOCOL 
 */ 
 /** @defgroup  EFI_USB2_HC_PROTOCOL_apis APIs
 *  @ingroup EFI_USB2_HC_PROTOCOL 
 */ 

/** @defgroup  EFI_USB2_HC_PROTOCOL_data DATA_STRUCTURES
 *  @ingroup EFI_USB2_HC_PROTOCOL 
 */
...
/*  
  Protocol version.
*/
#define EFI_USB2_HC_PROTOCOL_REVISION    EFI_USB2_HC_PROTOCOL_REVISION_3
#define EFI_USB2_HC_PROTOCOL_REVISION_3  0x0000000000030001
/** @endcond */

/* Added in EFI_USB2_HC_PROTOCOL_REVISION_3 */ 
/* EFI_ASYNC_USB_TRANSFER_CALLBACK_INT_BULK */
/** @ingroup EFI_USB2_HC_PROTOCOL_data
  @par Summary
...
/** @addtogroup EFI_USB2_HC_PROTOCOL_data 
@{ */
...
/** Port status bit definition for enhanced super speed. */
...
/** @} */ /* end_addtogroup EFI_USB2_HC_PROTOCOL_data */
...
#define EFI_USB_SPEED_SUPER_PLUS    0x0004  /* Added in EFI_USB2_HC_PROTOCOL_REVISION_3 */ 
...
/** @ingroup EFI_USB2_HC_PROTOCOL_apis
  @par Summary
...
/*===========================================================================
  PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup EFI_USB2_HC_PROTOCOL_prot
  @par Summary
...
struct _EFI_USB2_HC_PROTOCOL {
  ...
  UINT64                                           Revision;                /* Added in EFI_USB2_HC_PROTOCOL_REVISION_3 */ 
  
  EFI_USB2_HC_PROTOCOL_ASYNC_BULK_TRANSFER         AsyncBulkTransfer;       /* Added in EFI_USB2_HC_PROTOCOL_REVISION_3 */ 
                                                                            // need to address the change
                                                                            // to move out and create new version
                                                                            // of the protocol structure
  EFI_USB2_HC_PROTOCOL_ASYNC_CONTROL_TRANSFER      AsyncControlTransfer;    /* Added in EFI_USB2_HC_PROTOCOL_REVISION_3 */ 
                                                                            // need to address the change
};
