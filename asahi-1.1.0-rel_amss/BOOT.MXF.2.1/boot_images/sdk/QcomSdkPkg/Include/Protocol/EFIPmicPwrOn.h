...
/** @ingroup efi_pmic_pon_protocol_data 
  Protocol version. 
*/
#define PMIC_PWRON_REVISION 0x000000000001000B
...
/*! \enum pm_pon_irq_trigger_type
   \brief Type definition for different IRQ triggers
 */
typedef enum {
  EFI_PM_PON_IRQ_TRIGGER_ACTIVE_LOW,
  EFI_PM_PON_IRQ_TRIGGER_ACTIVIE_HIGH,
  EFI_PM_PON_IRQ_TRIGGER_RISING_EDGE,
  EFI_PM_PON_IRQ_TRIGGER_FALLING_EDGE,
  EFI_PM_PON_IRQ_TRIGGER_DUAL_EDGE,
  EFI_PM_PON_IRQ_TRIGGER_INVALID,
} EFI_PM_PON_IRQ_TRIGGER_TYPE;

/*! \enum pm_irq_status_type
 *  \brief Type definition for different IRQ STATUS type
 */
typedef enum {
  EFI_PM_PON_IRQ_STATUS_RT,
  EFI_PM_PON_IRQ_STATUS_LATCHED,
  EFI_PM_PON_IRQ_STATUS_PENDING,
  EFI_PM_PON_IRQ_STATUS_ENABLE,
  EFI_PM_PON_IRQ_STATUS_INVALID
} EFI_PM_PON_IRQ_STATUS_TYPE;
...
/** @} */
/* end_ingroup efi_pmic_pon_protocol_data */
 ...
 * @ingroup efi_pmic_pon_protocol_apis
  @par Summary
...
*/
typedef
EFI_STATUS (EFIAPI *EFI_PM_PWRON_IRQ_ENABLE)(
  IN UINT32              PmicDeviceIndex, 
...
*/
typedef
EFI_STATUS (EFIAPI *EFI_PM_PWRON_IRQ_CLEAR)(
  IN UINT32              PmicDeviceIndex, 
  IN EFI_PM_PON_IRQ_TYPE PonIrqType
);
...
*/
typedef
EFI_STATUS (EFIAPI *EFI_PM_PWRON_IRQ_SET_TRIGGER)(
  IN UINT32              PmicDeviceIndex, 
  IN EFI_PM_PON_IRQ_TYPE PonIrqType,
...
*/
typedef
EFI_STATUS (EFIAPI *EFI_PM_PWRON_IRQ_GET_PON_IRQ_STATUS)(
  IN UINT32              PmicDeviceIndex, 
  IN EFI_PM_PON_IRQ_TYPE PonIrqType,
...
/** @ingroup efi_pmic_pon_protocol_apis
 * @brief Returns all fault reasons
 *
 * @param[in]  PmicDeviceIndex. Primary PMIC: 0 Secondary PMIC: 1
 * @param[out] PonReasons:
 *             Bit <0:7>    FAULT_REASON1
 *             BIT <8:15>  FAULT_REASON2
 *             BIT <16:23> S3_REASON
 *             BIT <24:31>  SOFT_REASON
 *
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG__INVALID_POINTER = Null pointer passed
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_PON_GET_ALL_FAULT_REASONS)(
   IN  UINT32      PmicDeviceIndex,
...
#ifdef FEATURE_XBOOT
typedef
EFI_STATUS(EFIAPI *EFI_PM_PON_RESET_SOURCE_CFG)
(
IN UINT32                       PmicDeviceIndex,
...
typedef
EFI_STATUS(EFIAPI *EFI_PM_PON_ENABLE_RESET_SOURCE)
(
  IN UINT32                       PmicDeviceIndex,
  IN EFI_PM_PON_RESET_SOURCE_TYPE ResetSource,
  IN BOOLEAN                      enable
...
typedef
EFI_STATUS(EFIAPI *EFI_PM_PON_GET_DECIDE_RESET_DISABLE)
(
  IN UINT32                       PmicDeviceIndex,
  IN BOOLEAN                      *enable
);
 ...
 * @ingroup efi_pmic_pon_protocol_prot
  @par Summary
...
struct _EFI_QCOM_PMIC_PWRON_PROTOCOL {
  ...
  EFI_PM_PWRON_IRQ_ENABLE                      EnableIrq;
  EFI_PM_PWRON_IRQ_CLEAR                       ClearIrq;
  EFI_PM_PWRON_IRQ_SET_TRIGGER                 SetIrqTriggerType;
  EFI_PM_PWRON_IRQ_GET_PON_IRQ_STATUS          GetPonIrqStatus;
  EFI_PM_PON_GET_ALL_FAULT_REASONS			   GetAllFaultReasons;
#ifdef FEATURE_XBOOT
  EFI_PM_PON_RESET_SOURCE_CFG                  ResetSourceCfg;
  EFI_PM_PON_ENABLE_RESET_SOURCE               EnableResetSource;
  EFI_PM_PON_GET_DECIDE_RESET_DISABLE          GetDecideResetDisable;
#endif /* FEATURE_XBOOT */
};
