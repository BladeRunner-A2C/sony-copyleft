...
/** @ingroup efi_pmic_gpio_protocol_data
  Protocol version.
*/
#define PMIC_GPIO_REVISION EFI_PMIC_GPIO_REVISION_3
#define EFI_PMIC_GPIO_REVISION_2 0x0000000000020000
#define EFI_PMIC_GPIO_REVISION_3 0x0000000000030000
...
typedef enum
{
    ...
    EFI_PM_GPIO_VIN2,  /**< Voltage input 2. */
 ...
 * @ingroup efi_pmic_gpio_protocol_apis
  @par Summary
...
/* EFI_PM_GPIO_SET_PULL_SEL */ 
/** @ingroup efi_pm_gpio_ext_pin_config
  @par Summary
  Select GPIO current source pulls type.

  @param[in]  PmicDeviceIndex      Primary: 0. Secondary: 1.
  @param[in]  Gpio                 Which GPIO; see # EFI_PM_GPIO_PERIPH_INDEX 
                                   for details.
  @param[in]  Gpio_Pull            Select the Gpio Pull . Refer #EFI_PM_GPIO_I_SRC_PULL_TYPE for more info
...
*/
typedef
EFI_STATUS (EFIAPI *EFI_PM_GPIO_SET_PULL_SEL)
(
 IN  UINT32                             PmicDeviceIndex,
 IN  EFI_PM_GPIO_PERIPH_INDEX           Gpio,
 IN  EFI_PM_GPIO_I_SRC_PULL_TYPE        Gpio_Pull
);
...
===========================================================================*/
/** @ingroup efi_pmicGpio_protocol
 * @ingroup efi_pmic_gpio_protocol_prot
  @par Summary
...
struct _EFI_QCOM_PMIC_GPIO_PROTOCOL {
  ...
  EFI_PM_GPIO_SET_PULL_SEL              PullSel;            /*Added in EFI_PMIC_GPIO_REVISION_3*/
};
