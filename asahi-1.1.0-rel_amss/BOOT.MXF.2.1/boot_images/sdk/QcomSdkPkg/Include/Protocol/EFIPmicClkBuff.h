...
MACRO DECLARATIONS
===========================================================================*/
/** @defgroup efi_pmic_clk_buff_protocol EFI_PMIC_CLK_BUFF_PROTOCOL
 *  @ingroup PMIC 
 */
 /** @defgroup  efi_pmic_clk_buff_protocol_prot PROTOCOL
 *  @ingroup efi_pmic_clk_buff_protocol 
 */ 
 /** @defgroup  efi_pmic_clk_buff_protocol_apis APIs
 *  @ingroup efi_pmic_clk_buff_protocol 
 */ 

/** @defgroup  efi_pmic_clk_buff_protocol_data DATA_STRUCTURES
 *  @ingroup efi_pmic_clk_buff_protocol 
 */
/** efi_pmic_clk_buff_protocol_data
Protocol version.
*/

#define PMIC_CLKBUFF_REVISION EFI_PMIC_CLKBUFF_REVISION_5
#define EFI_PMIC_CLKBUFF_REVISION_5 0x0000000000050000
/** @} */ /* end_addtogroup efi_pmicClkBuff_constants */

/*  Protocol GUID definition */
/** @ingroup efi_pmic_clk_buff_protocol_data */
#define EFI_PMIC_CLKBUFF_PROTOCOL_GUID \
    { 0xD7BE2FB1, 0x4027, 0xB47A, { 0xBE, 0xB5, 0xD4, 0x92, 0x38, 0x56, 0xFA, 0x04 } }
...
typedef enum{
    ...
    EFI_PM_CLK_13,
    EFI_PM_CLK_DIST,
    EFI_PM_CLK_MAX_INDEX,
    EFI_PM_CLK_TYPE_INVALID = EFI_PM_CLK_MAX_INDEX,  /**< Invalid clock. */
    
    /* Legacy PMIC Clock Buffer numbers */
    EFI_PM_CLK_RF_1 = EFI_PM_CLK_1,
    EFI_PM_CLK_RF_2,
    EFI_PM_CLK_RF_3,
    EFI_PM_CLK_RF_4,
    EFI_PM_CLK_RF_5,
    EFI_PM_CLK_LN_BB = EFI_PM_CLK_6,
    EFI_PM_CLK_BB_1 = EFI_PM_CLK_LN_BB,
    EFI_PM_CLK_BB_2,
    EFI_PM_CLK_BB_3,
    EFI_PM_CLK_BB_4,
    EFI_PM_CLK_BB_5,
    EFI_PM_CLK_DIV_1 = EFI_PM_CLK_11,
    EFI_PM_CLK_DIV_2,
    EFI_PM_CLK_DIV_3,
    EFI_PM_ALL_CLKS = EFI_PM_CLK_MAX_INDEX,
...
*/
typedef UINT32 EFI_PM_CLK_BUFF_OUTPUT_DRIVE_STRENGTH_TYPE;
 ...
 * @ingroup efi_pmic_clk_buff_protocol_apis
  @par Summary
 ...
 * @ingroup efi_pmic_clk_buff_protocol_prot
  @par Summary
