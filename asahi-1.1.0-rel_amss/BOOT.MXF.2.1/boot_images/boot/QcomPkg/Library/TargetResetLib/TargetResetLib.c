/**
  ...
  Copyright (c) 2013,2018,2021,2022 by Qualcomm Technologies, Inc. All Rights Reserved.
...
SaveSysRegInInfoBlk (VOID)
{
  ...
  CpuNum = (Mpidr & ((1 << SocConfig->MpidrToCoreNumBits) - 1)) >> SocConfig->MpidrToCoreNumShift;
