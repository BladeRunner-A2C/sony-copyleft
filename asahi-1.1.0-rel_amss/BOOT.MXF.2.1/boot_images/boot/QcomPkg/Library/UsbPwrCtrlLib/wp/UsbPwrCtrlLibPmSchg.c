...
/**
  ...
  @param[IN]    HwInfo          Specify which port the request is for
  @param[IN]    PortEnType      Enable/Dsiable Type-C Port/PD functionality
  ...
  EFI_USB_PWR_CTRL_TYPEC_PORT_EN_TYPE PortEnType)
{
  ...
  Status = PmicSchgProtocol->SetPortEn(PortIndex, (EFI_PM_SCHG_TYPEC_PORT_EN_TYPE)PortEnType);
...
/**
  Read Enable/Disable Type-C Port
  @param[IN]    HwInfo          Specify which port the request is for
  @param[OUT]   PortEnType      Enable/Dsiable Type-C Port/PD functionality
  ...
  EFI_USB_PWR_CTRL_TYPEC_PORT_EN_TYPE *PortEnType)
{
  ...
  Status = PmicSchgProtocol->GetPortEn(PortIndex, (EFI_PM_SCHG_TYPEC_PORT_EN_TYPE*)PortEnType);
