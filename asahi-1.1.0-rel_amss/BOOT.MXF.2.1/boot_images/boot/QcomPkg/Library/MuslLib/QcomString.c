 ...
 *
 * Copyright (C) 2014,2020,2023 by Qualcomm Technologies Inc. All Rights Reserved.
 *
 *********************************************************************/
/*=======================================================================
                        Edit History
...
--------   ----    ---------------------------------------------------
02/23/23   ck      Reordered includes
...
size_t wstrlcpy(CHAR16 * dst,
                ...
                size_t size)
{
  /* StrnCpyS is natively uses 2 byte characters (I.E. wchar) */
  if (StrnCpyS(dst, size + 1,
              src,
              size) != RETURN_SUCCESS)
  {
    /* An error occured if return value from strncpyS does not match dst */
  }
