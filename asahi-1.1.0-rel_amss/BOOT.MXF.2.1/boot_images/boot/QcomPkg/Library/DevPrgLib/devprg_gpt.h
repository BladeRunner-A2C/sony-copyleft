...
#define PROTECTIVE_MBR_TYPE                          0xEE
#define PROTECTIVE_MBR_PARTITION_SIZE_IN_BYTES       4 
#define PROTECTIVE_MBR_PARTITION_ENTRY_BYTE_OFFSET   (0x01BE + 0xC)
