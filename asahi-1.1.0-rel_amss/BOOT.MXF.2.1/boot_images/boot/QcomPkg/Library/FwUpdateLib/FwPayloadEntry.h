/** @file FwPayloadEntry.h
  ...
  Copyright (c) 2012, 2013, 2016-2019, 2021, 2023 Qualcomm Technologies, Inc.  All Rights Reserved.
...
/*=============================================================================
 ...
 2021/06/08     dmohan      Changes to support A/B Recovery feature
 2019/02/01     rajb        Changed structure members to align progree bar changes
...
#define SYSFW_VERSION_PARTITION_NAME    L"SYSFW_VERSION"
...
typedef enum
{
  ...
  FWENTRY_UPDATE_TYPE_CUSTOM_FIRMWARE1= 0x00000006,
  FWENTRY_UPDATE_TYPE_MAX             = 0x00000007
...
typedef enum
{
  ...
  FWENTRY_BACKUP_TYPE_CUSTOM_FIRMWARE1= 0x00000002,
  FWENTRY_BACKUP_TYPE_MAX             = 0x00000003
...
{
   VOID                       *FwEntryBuffer;                            /* Pointer to the buffer with the FV entry*/
   UINTN                      FwEntrySize;                               /* Size of the FV entry*/
   BOOLEAN                    IsEncrypted;                               /* Flag to track if this entry was encrypted in the payload */
   BOOLEAN                    BackupAlreadyDone;                         /* Flag to indicate that backup of this entry is already available */
