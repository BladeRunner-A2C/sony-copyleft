...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ICBLib/icbcfgi.h#1 $

when         who     what, where, why
----------   ---     ------------------------------------------------------
2022/06/29   sds     Support more than 6 regions
2019/04/03   sds     Nested prop data tables
...
===========================================================================
    Copyright (c) 2013-2022 Qualcomm Technologies Incorporated.
                         All Rights Reserved.
...
{
  uint32 len;                      /**< Length of the config  data array */
  icbcfg_prop_seg_type **segs;     /**< Pointer to data segment arrays */
} icbcfg_prop_type;
...
typedef struct
{
  ...
  /* Chip version information, extended. */
  uint8 *              reg_addr; /**< Register or fuse. */
  uint32               reg_mask; /**< Register mask. */
  uint32               reg_val;  /**< Register value. */
 
  /* Device specific information. */ 
  uint32               num_llccs_per_channel; /**< Number of LLCCs per Channel. */
  ChipInfoIdType       chipid;

  /* Early prop list */
  icbcfg_prop_type *      early_prop_data;

  /* Additional trans bases for regions 6+
   * Make sure this points to the bottom most CFG2 of the addl region */
  uint8 **                addl_trans_bases;
