...
/*
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ICBLib/icbcfg_hwio.h#1 $
...
#define HWIO_LLCC_BEAC_ADDR_TRANSLATOR_CFG_RMSK                                             0x3ff1
...
#define HWIO_LLCC_BEAC_ADDR_TRANSLATOR_CFG_ERROR_BMSK                                       0x3ff0
...
#define HWIO_LLCC_BEAC_ADDR_REGIONn_CFG1_RMSK                                                  0xff
...
#define HWIO_LLCC_BEAC_ADDR_REGIONn_CFG1_OFFSET_HIGH_BMSK                                      0xff
...
#define HWIO_LLCC_BEAC_ADDR_REGIONn_CFG3_RMSK                                                  0xff
...
#define HWIO_LLCC_BEAC_ADDR_REGIONn_CFG3_BASE_HIGH_BMSK                                        0xff
#define HWIO_LLCC_BEAC_ADDR_REGIONn_CFG3_BASE_HIGH_SHFT                                        0x0

/*----------------------------------------------------------------------------
 * Additional region 6+ offsets
 *--------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------
 * ADDL_REGIONn_CFG2[6...] - ADDR LOW
 *--------------------------------------------------------------------------*/
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_ADDRI(x,n)                                        ((x) + (((n)-6) * 0x10) + 0x00000000)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_RMSK                                           0xffffffff
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_INI(x,n)      \
        in_dword_masked(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_ADDRI(x,n), HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_RMSK)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_INMI(x,n,m)      \
        in_dword_masked(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_ADDRI(x,n), m)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_OUTI(x,n,v)      \
        out_dword(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_ADDRI(x,n),v)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_OUTMI(x,n,m,v) \
        out_dword_masked_ns(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_ADDRI(x,n),m,v,HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_INI(x,n))
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_BASE_LOW_BMSK                                  0xffffffff
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG2_BASE_LOW_SHFT                                         0x0

/*----------------------------------------------------------------------------
 * ADDL_REGIONn_CFG3[6...] - ADDR LOW
 *--------------------------------------------------------------------------*/
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_ADDRI(x,n)                                        ((x) + (((n)-6) * 0x10) + 0x00000004)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_RMSK                                                  0xff
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_INI(x,n)      \
        in_dword_masked(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_ADDRI(x,n), HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_RMSK)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_INMI(x,n,m)      \
        in_dword_masked(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_ADDRI(x,n), m)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_OUTI(x,n,v)      \
        out_dword(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_ADDRI(x,n),v)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_OUTMI(x,n,m,v) \
        out_dword_masked_ns(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_ADDRI(x,n),m,v,HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_INI(x,n))
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_BASE_HIGH_BMSK                                        0xff
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG3_BASE_HIGH_SHFT                                        0x0

/*----------------------------------------------------------------------------
 * ADDL_REGIONn_CFG0[6...] - OFFSET LOW
 *--------------------------------------------------------------------------*/
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_ADDRI(x,n)                                        ((x) + (((n)-6) * 0x10) + 0x00000008)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_RMSK                                           0xffffffff
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_INI(x,n)      \
        in_dword_masked(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_ADDRI(x,n), HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_RMSK)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_INMI(x,n,m)      \
        in_dword_masked(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_ADDRI(x,n), m)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_OUTI(x,n,v)      \
        out_dword(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_ADDRI(x,n),v)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_OUTMI(x,n,m,v) \
        out_dword_masked_ns(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_ADDRI(x,n),m,v,HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_INI(x,n))
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_OFFSET_LOW_BMSK                                0xffffffff
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG0_OFFSET_LOW_SHFT                                       0x0

/*----------------------------------------------------------------------------
 * ADDL_REGIONn_CFG1[6...] - OFFSET HIGH
 *--------------------------------------------------------------------------*/
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_ADDRI(x,n)                                        ((x) + (((n)-6) * 0x10) + 0x0000000c)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_RMSK                                                  0xff
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_INI(x,n)      \
        in_dword_masked(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_ADDRI(x,n), HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_RMSK)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_INMI(x,n,m)      \
        in_dword_masked(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_ADDRI(x,n), m)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_OUTI(x,n,v)      \
        out_dword(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_ADDRI(x,n),v)
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_OUTMI(x,n,m,v) \
        out_dword_masked_ns(HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_ADDRI(x,n),m,v,HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_INI(x,n))
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_OFFSET_HIGH_BMSK                                      0xff
#define HWIO_LLCC_BEAC_ADDR_ADDL_REGIONn_CFG1_OFFSET_HIGH_SHFT                                      0x0


/*----------------------------------------------------------------------------
 * MODULE: MC0_MC_COMMON_ISU
 *--------------------------------------------------------------------------*/
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ADDR(x)                                                                ((x) + 0x000)
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_RMSK                                                                        0x3f1
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_IN(x)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ADDR(x), HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_RMSK)
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_INM(x, m)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ADDR(x), m)
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_OUT(x, v)            \
                out_dword(HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ADDR(x),v)
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ADDR(x),m,v,HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_IN(x))
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ERROR_BMSK                                                                  0x3f0
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ERROR_SHFT                                                                      4
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ENABLE_BMSK                                                                   0x1
#define HWIO_MC_ISU_ADDR_TRANSLATOR_CFG_ENABLE_SHFT                                                                     0

/*************************************************************************************
   Macros Exclusivley for Region 0
**************************************************************************************/

#define HWIO_MC_ISU_ADDR_REGION_n_CFG0_ADDRI(x,n)                                                                  ((x) + ((n) * 0x10) + 0x04)
#define HWIO_MC_ISU_ADDR_REGION_n_CFG0_RMSK                                                                     0xffffffff
#define HWIO_MC_ISU_ADDR_REGION_n_CFG0_INI(x,n)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGION_n_CFG0_ADDRI(x,n), HWIO_MC_ISU_ADDR_REGION_n_CFG0_RMSK)
#define HWIO_MC_ISU_ADDR_REGION_n_CFG0_INMI(x,n, m)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGION_n_CFG0_ADDRI(x,n), m)
#define HWIO_MC_ISU_ADDR_REGION_n_CFG0_OUTI(x,n, v)            \
                out_dword(HWIO_MC_ISU_ADDR_REGION_n_CFG0_ADDRI(x,n),v)
#define HWIO_MC_ISU_ADDR_REGION_n_CFG0_OUTMI(x,n,m,v) \
                out_dword_masked_ns(HWIO_MC_ISU_ADDR_REGION_n_CFG0_ADDRI(x,n),m,v,HWIO_MC_ISU_ADDR_REGION_n_CFG0_INI(x,n))
#define HWIO_MC_ISU_ADDR_REGION_n_CFG0_OFFSET_LOW_BMSK                                                          0xffffffff
#define HWIO_MC_ISU_ADDR_REGION_n_CFG0_OFFSET_LOW_SHFT                                                                   0

#define HWIO_MC_ISU_ADDR_REGION_n_CFG1_ADDRI(x,n)                                                                  ((x) + ((n) * 0x10) + 0x08)
#define HWIO_MC_ISU_ADDR_REGION_n_CFG1_RMSK                                                                            0xf
#define HWIO_MC_ISU_ADDR_REGION_n_CFG1_INI(x,n)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGION_n_CFG1_ADDRI(x,n), HWIO_MC_ISU_ADDR_REGION_n_CFG1_RMSK)
#define HWIO_MC_ISU_ADDR_REGION_n_CFG1_INMI(x,n, m)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGION_n_CFG1_ADDRI(x,n), m)
#define HWIO_MC_ISU_ADDR_REGION_n_CFG1_OUTI(x,n, v)            \
                out_dword(HWIO_MC_ISU_ADDR_REGION_n_CFG1_ADDRI(x,n),v)
#define HWIO_MC_ISU_ADDR_REGION_n_CFG1_OUTMI(x,n,m,v) \
                out_dword_masked_ns(HWIO_MC_ISU_ADDR_REGION_n_CFG1_ADDRI(x,n),m,v,HWIO_MC_ISU_ADDR_REGION_n_CFG1_INI(x,n))
#define HWIO_MC_ISU_ADDR_REGION_n_CFG1_OFFSET_HIGH_BMSK                                                                0xf
#define HWIO_MC_ISU_ADDR_REGION_n_CFG1_OFFSET_HIGH_SHFT                                                                  0

/*************************************************************************************
   Macros Exclusivley for Region 1 to n
**************************************************************************************/

#define HWIO_MC_ISU_ADDR_REGIONn_CFG0_ADDRI(x,n)                                                                  ((x) + (((n)-1) * 0x10) + 0x0c)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG0_RMSK                                                                     0xffffffff
#define HWIO_MC_ISU_ADDR_REGIONn_CFG0_INI(x,n)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGIONn_CFG0_ADDRI(x,n), HWIO_MC_ISU_ADDR_REGIONn_CFG0_RMSK)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG0_INMI(x,n, m)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGIONn_CFG0_ADDRI(x,n), m)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG0_OUTI(x,n, v)            \
                out_dword(HWIO_MC_ISU_ADDR_REGIONn_CFG0_ADDRI(x,n),v)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG0_OUTMI(x,n,m,v) \
                out_dword_masked_ns(HWIO_MC_ISU_ADDR_REGIONn_CFG0_ADDRI(x,n),m,v,HWIO_MC_ISU_ADDR_REGIONn_CFG0_INI(x,n))
#define HWIO_MC_ISU_ADDR_REGIONn_CFG0_OFFSET_LOW_BMSK                                                          0xffffffff
#define HWIO_MC_ISU_ADDR_REGIONn_CFG0_OFFSET_LOW_SHFT                                                                   0

#define HWIO_MC_ISU_ADDR_REGIONn_CFG1_ADDRI(x,n)                                                                  ((x) + (((n)-1) * 0x10) + 0x10)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG1_RMSK                                                                            0xf
#define HWIO_MC_ISU_ADDR_REGIONn_CFG1_INI(x,n)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGIONn_CFG1_ADDRI(x,n), HWIO_MC_ISU_ADDR_REGIONn_CFG1_RMSK)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG1_INMI(x,n, m)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGIONn_CFG1_ADDRI(x,n), m)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG1_OUTI(x,n, v)            \
                out_dword(HWIO_MC_ISU_ADDR_REGIONn_CFG1_ADDRI(x,n),v)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG1_OUTMI(x,n,m,v) \
                out_dword_masked_ns(HWIO_MC_ISU_ADDR_REGIONn_CFG1_ADDRI(x,n),m,v,HWIO_MC_ISU_ADDR_REGIONn_CFG1_INI(x,n))
#define HWIO_MC_ISU_ADDR_REGIONn_CFG1_OFFSET_HIGH_BMSK                                                                0xf
#define HWIO_MC_ISU_ADDR_REGIONn_CFG1_OFFSET_HIGH_SHFT                                                                  0

#define HWIO_MC_ISU_ADDR_REGIONn_CFG2_ADDRI(x,n)                                                                  ((x) + (((n)-1) * 0x10) + 0x14)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG2_RMSK                                                                     0xffffffff
#define HWIO_MC_ISU_ADDR_REGIONn_CFG2_INI(x,n)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGIONn_CFG2_ADDRI(x,n), HWIO_MC_ISU_ADDR_REGIONn_CFG2_RMSK)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG2_INMI(x,n, m)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGIONn_CFG2_ADDRI(x,n), m)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG2_OUTI(x,n, v)            \
                out_dword(HWIO_MC_ISU_ADDR_REGIONn_CFG2_ADDRI(x,n),v)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG2_OUTMI(x,n,m,v) \
                out_dword_masked_ns(HWIO_MC_ISU_ADDR_REGIONn_CFG2_ADDRI(x,n),m,v,HWIO_MC_ISU_ADDR_REGIONn_CFG2_INI(x,n))
#define HWIO_MC_ISU_ADDR_REGIONn_CFG2_BASE_LOW_BMSK                                                            0xffffffff
#define HWIO_MC_ISU_ADDR_REGIONn_CFG2_BASE_LOW_SHFT                                                                     0

#define HWIO_MC_ISU_ADDR_REGIONn_CFG3_ADDRI(x,n)                                                                  ((x) + (((n)-1) * 0x10) + 0x18)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG3_RMSK                                                                            0xf
#define HWIO_MC_ISU_ADDR_REGIONn_CFG3_INI(x,n)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGIONn_CFG3_ADDRI(x,n), HWIO_MC_ISU_ADDR_REGIONn_CFG3_RMSK)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG3_INMI(x,n, m)            \
                in_dword_masked(HWIO_MC_ISU_ADDR_REGIONn_CFG3_ADDRI(x,n), m)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG3_OUTI(x,n, v)            \
                out_dword(HWIO_MC_ISU_ADDR_REGIONn_CFG3_ADDRI(x,n),v)
#define HWIO_MC_ISU_ADDR_REGIONn_CFG3_OUTMI(x,n,m,v) \
                out_dword_masked_ns(HWIO_MC_ISU_ADDR_REGIONn_CFG3_ADDRI(x,n),m,v,HWIO_MC_ISU_ADDR_REGIONn_CFG3_INI(x,n))
#define HWIO_MC_ISU_ADDR_REGIONn_CFG3_BASE_HIGH_BMSK                                                                  0xf
#define HWIO_MC_ISU_ADDR_REGIONn_CFG3_BASE_HIGH_SHFT                                                                    0
