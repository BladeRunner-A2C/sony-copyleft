 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/CPRLib/common/inc/cpr_smem.h#1 $
 * $Change: 53083464 $
 */
#ifndef CPR_SMEM_H
#define CPR_SMEM_H
...
typedef struct __attribute__ ((__packed__))
{
    uint8 vpid;
    uint8 railsCount;
    boolean agingData;//cpr_smem_aging_data
} cpr_smem_misc_data;
