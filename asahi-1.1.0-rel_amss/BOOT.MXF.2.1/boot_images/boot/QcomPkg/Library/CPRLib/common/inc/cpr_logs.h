 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/CPRLib/common/inc/cpr_logs.h#1 $
 * $Change: 53083464 $
 */
#ifndef CPR_LOGS_H
#define CPR_LOGS_H
...
#define CPR_LOG_UART(format_str, args...) CPR_IMAGE_LOG_UART(format_str, ##args)
