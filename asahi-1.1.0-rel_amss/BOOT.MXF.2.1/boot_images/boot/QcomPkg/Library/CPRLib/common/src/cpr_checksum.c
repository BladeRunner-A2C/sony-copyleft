 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/CPRLib/common/src/cpr_checksum.c#1 $
 * $Change: 53083464 $
 */
#include "cpr_data.h"
#include "cpr_utils.h"
...
{
    #if defined(LASSEN) || defined(PINNACLES)
      cpr_domain_id rail_ids[] = {CPR_RAIL_MX, CPR_RAIL_CX, CPR_RAIL_VDDA};
    #elif defined(KUNO)
      cpr_domain_id rail_ids[] = {CPR_RAIL_MX, CPR_RAIL_CX};
    #else
      cpr_domain_id rail_ids[] = {CPR_RAIL_MX, CPR_RAIL_CX, CPR_RAIL_VDDA, CPR_RAIL_GFX};
    #endif
