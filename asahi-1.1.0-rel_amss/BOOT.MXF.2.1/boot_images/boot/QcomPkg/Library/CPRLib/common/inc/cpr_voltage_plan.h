 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/CPRLib/common/inc/cpr_voltage_plan.h#1 $
 * $Change: 53083464 $
 */
...
typedef struct
{
    cpr_domain_id rail;
    uint8 modeCount;
    cpr_vbump_mode_cfg *modeCfg;
} cpr_vbump_rail_cfg;

typedef struct
{
    uint8 railCount;
    cpr_vbump_rail_cfg **railCfg;
    uint8 skuCount;
    cpr_vbump_sku_map *sku_map;
} cpr_vbump_cfg;
