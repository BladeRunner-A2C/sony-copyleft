 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/CPRLib/image/core/src/cpr_image.c#1 $
 * $Change: 53083464 $
 */
#include <stdlib.h>
#include "cpr_image.h"
...
const char * cpr_image_get_vrm_map(const char *name)
{
    ...
    else if (strncmp(name, "MXG", strlen("MXG")) == 0)
    {
        return "vrm.mxg";
    }
