 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/CPRLib/image/core/src/cpr_image_logs.c#1 $
 * $Change: 53083464 $
 */
...
void cpr_image_log_message(const char * restrict msg, ...)
{
    ...
    va_start(ap, msg);
    vsnprintf(buf, CPR_LOG_BUF_SIZE-1, msg, ap);
    va_end(ap);
