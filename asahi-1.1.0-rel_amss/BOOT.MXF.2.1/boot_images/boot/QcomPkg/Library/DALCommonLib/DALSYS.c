/** @file DALSYS.c
  ...
  Copyright (c) 2010-2011,2014,2016,2018,2022,2023 Qualcomm Technologies, Inc. All rights reserved.
...
/*=============================================================================
 ...
 01/21/22   ak      Changed prototype for DALSYS_Memscpy, added CONST to psrc
...
UINTN DALSYS_memscpy(VOID * Destination, UINTN DestLength, CONST VOID * Source, UINTN SrcLength)
{
