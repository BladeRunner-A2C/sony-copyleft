 ...
 *
 * Copyright (c) 2008-2010, 2012, 2014, 2017, 2020-2021, 2022 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
 ...
 * ----------   ---     ----------------------------------------------
 * 09/20/22     sh      mibib_pg_buf size increased for raw reads
...
extern unsigned char mibib_pg_buf[TOTAL_PAGE_SIZE];
...
uint32 flash_prog_dump_parti_new()
{
  ...
  memset((void *)mibib_pg_buf, 0, TOTAL_PAGE_SIZE);
