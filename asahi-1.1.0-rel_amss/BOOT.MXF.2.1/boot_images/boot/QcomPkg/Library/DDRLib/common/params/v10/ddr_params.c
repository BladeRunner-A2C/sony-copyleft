...
--------   ---     --------------------------------------------------------
11/10/21   yps     fix clang16 compilation issue
...
===========================================================================
                   Copyright 2018-2021 Qualcomm Technologies Incorporated
                              All Rights Reserved
...
{   
...
#endif
    fptr_HAL_EXT_CORE_SW_Get_Fuse_Value = ddr_get_fuse_value;
	...
	fptr_HAL_DDR_FW_MC_MR_Read = DDR_FW_MC_MR_Read;
	...
	fptr_HAL_DDR_FW_eCDT_Get_Voltage_Override_Values = DDR_FW_eCDT_Get_Voltage_Override_Values;
