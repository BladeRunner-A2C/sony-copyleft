                              ...
                              HAL_MDP_VbifId eVbifId)
{
    ...
    out_dword(HWIO_VBIF_VBIF_OUT_AXI_AMEMTYPE_CONF1_ADDR + uRegOffset, 0x33333333);
    out_dword(HWIO_VBIF_VBIF_OUT_AXI_ASHARED_ADDR        + uRegOffset, 0);
    out_dword(HWIO_VBIF_VBIF_OUT_AXI_AINNERSHARED_ADDR   + uRegOffset, 0);
                                         ...
                                         uint32         uFlags)
{
   ...
   if (HAL_MDP_VBIF_0 == eVbifId)
   {
      ...
      HAL_MDP_VBif_QOSRemapper(eVbifId, HAL_MDP_VBIF_CLIENT_DMA4);
      HAL_MDP_VBif_QOSRemapper(eVbifId, HAL_MDP_VBIF_CLIENT_DMA5);
      HAL_MDP_VBif_QOSRemapper(eVbifId, HAL_MDP_VBIF_CLIENT_DSIDMA);
      HAL_MDP_VBif_QOSRemapper(eVbifId, HAL_MDP_VBIF_CLIENT_WB2);
   }
                                                   ...
                                                   HAL_MDP_VBIF_ClientIDType eClientId)
{
  uintPtr                       uRegOffset       = 0;
  HAL_MDSS_ErrorType            eStatus          = HAL_MDSS_STATUS_SUCCESS;
  HAL_MDP_VBIFQOSRemappersType *pVBIFQOSRemapper = &pgsMdpHwInfo->pVBIFQOSRemappers[eClientId];
