...
#define HAL_MDP_ARRAY_LENGTH(_array_)  (sizeof(_array_)/sizeof((_array_)[0]))
...
//#TODO#IMPLEMENT - PING_PONG_RD_PTRS are moved to TEAR block
...
/*!
* \enum HAL_MDP_UBWC_HighestbankBitType
*
* The HAL_MDP_UBWC_HighestbankBitType lists all the possible values of highest bank bit
*
*/
typedef enum _HAL_MDP_UBWC_HighestbankBitType
{
  HAL_MDP_UBWC_HIGHEST_BANK_BIT_13        = 0x0,          /* Highest bank bit 13 */
  HAL_MDP_UBWC_HIGHEST_BANK_BIT_14        = 0x1,          /* Highest bank bit 14 */
  HAL_MDP_UBWC_HIGHEST_BANK_BIT_15        = 0x2,          /* Highest bank bit 15 */
  HAL_MDP_UBWC_HIGHEST_BANK_BIT_16        = 0x3,          /* Highest bank bit 16 */
  HAL_MDP_UBWC_HIGHEST_BANK_BIT_17        = 0x4,          /* Highest bank bit 17 */
} HAL_MDP_UBWC_HighestbankBitType;

/*!
* \enum HAL_MDP_UBWC_MALSizeType
*
* The HAL_MDP_UBWC_MALSizeType lists all the possible values of MAL sizes
*
*/
typedef enum _HAL_MDP_UBWC_MALSizeType
{
  HAL_MDP_UBWC_MAL_32_BYTES        = 0x0,          /* MAL is 32 bytes */
  HAL_MDP_UBWC_MAL_64_BYTES        = 0x1,          /* MAL is 64 bytes */
} HAL_MDP_UBWC_MALSizeType;

/*!
* \enum HAL_MDP_UBWC_SwizzlingModeType
*
* The HAL_MDP_UBWC_SwizzlingModeType lists all the possible values of bank swizzling
*
*/
typedef enum _HAL_MDP_UBWC_SwizzlingModeType
{
  HAL_MDP_UBWC_SWIZZLING_MODE_DISABLE        = 0x0,          /* Disable Bank Swizzling */
  HAL_MDP_UBWC_SWIZZLING_MODE_ENABLE         = 0x1,          /* Enable Bank Swizzling */
} HAL_MDP_UBWC_SwizzlingModeType;

/*!
* \enum HAL_MDP_UBWC_BankSpreadModeType
*
* The HAL_MDP_UBWC_BankSpreadModeType lists all the possible values of bank spreading
*
*/
typedef enum _HAL_MDP_UBWC_BankSpreadModeType
{
  HAL_MDP_UBWC_BANK_SPREAD_MODE_DISABLE        = 0x0,          /* Disable Bank Spread */
  HAL_MDP_UBWC_BANK_SPREAD_MODE_ENABLE         = 0x1,          /* Enable Bank Spread */
} HAL_MDP_UBWC_BankSpreadModeType;

/*
 * two dual hard slice encoders, DSC pair 0 and DSC pair 1
 * each encoder has pair of single hard slice encoders
 * DSC pair 0: dsc_0, dsc_1
 * DSC pair 1: dsc_2, dsc_3
 */

typedef enum {
  HAL_MDP_DSC_V1_2a_2HS_2SS_2IN_10BIT_V1_2_420_422,   /* can only be used at dsc_2 and dsc_3 */
  HAL_MDP_DSC_V1_2a_2HS_2SS_2IN_10BIT_V1_2,           /* can be used at dsc_0, dsc_1, dsc_2 and dsc_3 */
} HAL_MDP_DSC_CoreFormatIndex;
...
#define HAL_MDP_QOS_LUT_TABLE_SIZE                            02   // Maximum LUT table size of Danger, Safe and Creq LUT
#define HAL_MDP_QOS_LUT_REGISTER_INDEX                        02   // Register Index 0 for QSeed Disabled Mode and 1 for QSeed Enabled Mode

#define HAL_ROT_MAX_RETRIES_FOR_VBIF_PATH_RESET_COMPLETE      32
...
typedef enum _HAL_MDP_PhyInterfaceId
{
   ...
   HAL_MDP_PHYSICAL_INTERFACE_6,             /**< INTF_6 */
   HAL_MDP_PHYSICAL_INTERFACE_7,             /**< INTF_7 */  
   HAL_MDP_PHYSICAL_INTERFACE_8,             /**< INTF_8 */
...
/*!
 * \enum _HAL_MDP_TrafficCtrl_VBIFQosType
 *
 * The _HAL_MDP_TrafficCtrl_VBIFQosType lists 8 levels of VBIF QoS latency for memory access.
 *
 */
typedef enum _HAL_MDP_TrafficCtrl_VBIFQosType
{
  HAL_MDP_TRFCTRL_VBIF_QOS_LVL0 = 0x00000000,    /* Reserved, for testing only */
  HAL_MDP_TRFCTRL_VBIF_QOS_LVL1 = 0x00000001,    /* VBIF QOS priority level 1  */
  HAL_MDP_TRFCTRL_VBIF_QOS_LVL2 = 0x00000002,    /* VBIF QOS priority level 2  */
  HAL_MDP_TRFCTRL_VBIF_QOS_LVL3 = 0x00000003,    /* VBIF QOS priority level 3  */
  HAL_MDP_TRFCTRL_VBIF_QOS_LVL4 = 0x00000004,    /* VBIF QOS priority level 4  */
  HAL_MDP_TRFCTRL_VBIF_QOS_LVL5 = 0x00000005,    /* VBIF QOS priority level 6  */
  HAL_MDP_TRFCTRL_VBIF_QOS_LVL6 = 0x00000006,    /* VBIF QOS priority level 7  */
  HAL_MDP_TRFCTRL_VBIF_QOS_LVL7 = 0x00000007,    /* VBIF QOS priority level 8  */
  HAL_MDP_TRFCTRL_VBIF_QOS_MAX,
  HAL_MDP_TRFCTRL_VBIF_QOS_FORCE_32BIT = 0x7FFFFFFF

} HAL_MDP_TrafficCtrl_VBIFQosType;
/*!
...
{
   uint32             uVBIFQosRemapper000;            /*QOS remapper register settings for register 000       */
   uint32             uVBIFQosRemapper001;            /*QOS remapper register settings for register 001       */
   uint32             uVBIFQosRemapper010;            /*QOS remapper register settings for register 010       */
   uint32             uVBIFQosRemapper011;            /*QOS remapper register settings for register 011       */
   uint32             uVBIFQosRemapper100;            /*QOS remapper register settings for register 100       */
   uint32             uVBIFQosRemapper101;            /*QOS remapper register settings for register 101       */
   uint32             uVBIFQosRemapper110;            /*QOS remapper register settings for register 110       */
   uint32             uVBIFQosRemapper111;            /*QOS remapper register settings for register 111       */
}  HAL_MDP_VBIFQOSRemappersType;
...
{
  uint32 uMaxEntryIndex;                          /* LUT max entry index equivalent to (Table size -1)       */
  uint32 uZeroIndexLutLevel;                      /* Minimum LUT Level corresponding to Index zero of table */
...
typedef struct _HAL_MDP_QoSLutInfo
{
  ...
  uint32          uSafeLutValue[HAL_MDP_QOS_LUT_TABLE_SIZE];                                   /* Safe   LUT value      */
  uint32          uCreqLutData[HAL_MDP_QOS_LUT_TABLE_SIZE][HAL_MDP_QOS_LUT_REGISTER_INDEX];    /* CReQ   LUT data table */
} HAL_MDP_QoSLutInfo;

/* HAL_MDP_QoSConstParam
 *
 * Structure to keep all constant configuration parameters of QoS
 */
...
{
  HAL_MDP_QoSLutInfo        *pLinearQoSInfo;           /* Linear QoS Settings    */
  HAL_MDP_QoSLutInfo        *pMacroTileQoSInfo;        /* Macrotile QoS Settings */
  HAL_MDP_QoSConstParam     *pConstParams;             /* QoS constant configuration parameters */
} HAL_MDP_SSPPQoSInfo;

/* HAL_MDP_UBWCConfigInfo
 *
 * Structure to keep all the settings for the UBWC configuration
 */
typedef struct _HAL_MDP_UBWCConfigInfo
{
  uint32 uHighestBankBit;            /* Highest bank bit value*/
  uint32 uMALSize;                   /* MAL size */
  uint32 uLvl1BankSwizzling;         /* Level 1 Bank Swizzling mode */
  uint32 uLvl2BankSwizzling;         /* Level 2 Bank Swizzling mode */
  uint32 uLvl3BankSwizzling;         /* Level 3 Bank Swizzling mode */
  uint32 uBankSpread;                /* Bank Spread */
  uint32 uMajorRevision;             /* Select UBWC Major Revision */
  uint32 uMinorRevision;             /* Select UBWC Minor Revision*/
  uint32 uMaxDDRChannels;            /* Number of channels to use for DDR memory access */
  uint32 uPredictionMode;            /* Valid for RGB565 only */
} HAL_MDP_UBWCConfigInfo;

/* HAL_MDP_GlobalMicroIdleSettingsInfo
 *
 * Global micro idle platform specific settings info
 */
typedef struct _HAL_MDP_GlobalMicroIdleSettingsInfo
{
  uint32 uFal10ExitCnt;        /**< Clock cycles in FAL10 danger before switching to FAL10 exit danger  */
  uint32 uFal10ExitDanger;     /**< Danger value when exiting FAL10 throttling                          */
  uint32 uFal10Danger;         /**< Danger value when in FAL10 throttling                               */
  uint32 uWDTimerGranularity;  /**< Clock ticks granularity                                             */
  uint32 uWDTimerLoadValue;    /**< Timer count up to value in granularity                              */
} HAL_MDP_GlobalMicroIdleSettingsInfo;

/* HAL_MDP_SSSP_MicroIdleSettingsInfo
 *
 * SSPP micro idle platform specific settings info
 */
typedef struct _HAL_MDP_SSSP_MicroIdleSettingsInfo
{
  uint32 uFAL1TargetIdleTime;         /**< FAL1 target idle time in ns         */
  uint32 uFAL10TargetIdleTime;        /**< FAL10 target idle time in ns        */
  uint32 uFAL10Threshold;             /**< Value dependant on max refresh rate */
} HAL_MDP_SSSP_MicroIdleSettingsInfo;

/* HAL_MDP_MicroIdleSettingsInfoType
 *
 * Micro idle settings info types
 */
typedef struct _HAL_MDP_MicroIdleSettingsInfoType
{
  HAL_MDP_SSSP_MicroIdleSettingsInfo  *psSSPPMicroIdleSettingsInfo;      /**< SSPP micro idle settings info   */
  HAL_MDP_GlobalMicroIdleSettingsInfo *psGlobalMicroIdleSettingsInfo;    /**< Global micro idle settings info */
} HAL_MDP_MicroIdleSettingsInfoType;
...
typedef struct _HAL_MDP_Hw_Private_Info
{
   ...
   /** SSPP Danger-safe-Creq QOS Settings */
   HAL_MDP_SSPPQoSInfo                 *psSSPPQoSInfo;

   /** UBWC Settings */
   HAL_MDP_UBWCConfigInfo               sUBWCConfig;
  
   /** Micro idle settings */
   HAL_MDP_MicroIdleSettingsInfoType   *psMicroIdleSettingsInfoType;
   
   /** DSC Encoder Format */
   HAL_MDP_DSC_CoreFormatIndex         *pDSCEncoderFormat;
...
extern uintPtr  uMDPCWBPingPongRegBaseOffset[HAL_MDP_CWB_PINGPONG_MAX];                  // CWB PingPong register offsets
...
extern uintPtr  uMDPDSCCoreBaseOffset[HAL_MDP_DSC_CORE_MAX];                             // DSC Core register offset
extern uintPtr  uMDPDSCEncBaseOffset[HAL_MDP_DSC_MAX];                                   // DSC Encoder register offset
extern uintPtr  uMDPDSCCtlBaseOffset[HAL_MDP_DSC_MAX];                                   // DSC Ctl register offset
extern uintPtr  uMDPVDCMCoreBaseOffset[HAL_MDP_VDCM_CORE_MAX];                           // VDCM Core register offset
extern uintPtr  uMDPVDCMEncBaseOffset[HAL_MDP_VDCM_MAX];                                 // VDCM Enc register offset
extern uintPtr  uMDPVDCMCtlBaseOffset[HAL_MDP_VDCM_MAX];                                 // VDCM Ctl register offset
...
extern uintPtr  uMDPIntfTearRegBaseOffset[HAL_MDP_PHYSICAL_INTERFACE_MAX];               // Physical Interface TEAR check register offset
extern uintPtr  uMDP3DMuxRegBaseOffset[HAL_MDP_3DMUX_MAX];                               // 3D Mux register offset
extern uintPtr  uMDPSprRegBaseOffset[HAL_MDP_SPR_MAX];                                   // SPR register offset
extern uintPtr  uMDPDemuraRegBaseOffset[HAL_MDP_DEMURA_MAX];                             // Demura register offset
...
#define HAL_MDP_GET_DATA_PATH_MASK()                        (pgsMdpHwInfo->sHwInfo.uValidDataPathMask)
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_TrafficCtrl_SetClientWatermarkLvl_8_1_0()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_MDP_TrafficCtrl_SetClientWatermarkLvl_8_1_0 (
                              HAL_MDP_TrafficCtrl_LatencyType  eLatency,
                              uint32                           uTotalSMPBytes,
                              uint32                           uFlags,
                              uintPtr                          uRegAddr);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_SSPP_SetQosConfig_9_2_0()
*/
/*!
* \brief
*  Recommended Source pipe QoS configuration
*
...
*
****************************************************************************/
void HAL_MDP_SSPP_SetQosConfig_9_2_0(HAL_MDP_SourcePipeId              eSourcePipe,
                                     HAL_MDP_TrafficCtrl_LatencyType   eLatency,
                                     HAL_MDP_Qos_ConfigType           *psQoSInfo,
                                     uint32                            uFlag);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_SSPP_SetQosConfig_10_0_0()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_MDP_SSPP_SetQosConfig_10_0_0(HAL_MDP_SourcePipeId              eSourcePipe,
                                      HAL_MDP_TrafficCtrl_LatencyType   eLatency,
                                      HAL_MDP_Qos_ConfigType           *psQoSInfo,
                                      uint32                            uFlags);
...
*
****************************************************************************/
uintPtr HAL_MDP_Get_ControlPath_BaseOffset(HAL_MDP_ControlPathId  eControlPath);

/****************************************************************************
*
** FUNCTION: HAL_MDP_Validate_ControlPathId()
*/
/*!
* \brief
*     Validates that Control Path Id is within allowed range
*
* \param [in] eControlPath         - Control Path ID (0, 1, 2, 3, 4)
*
* \retval HAL_MDSS_ErrorType
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_MDP_Validate_ControlPathId(HAL_MDP_ControlPathId  eControlPath);
