/** @file QusbTargetLibNull.c
  ...
  Copyright (c) 2015,2018, 2022-2023 Qualcomm Technologies, Inc. All rights reserved.
**/
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 06/23/22   krd     Added protype for few newly added functions
 ...
 * 
 * @brief       This function cancel transfer on halt ep and unstall ep and requeue transfer
 * 
 * @details     
 * 
 * @param core_id    
