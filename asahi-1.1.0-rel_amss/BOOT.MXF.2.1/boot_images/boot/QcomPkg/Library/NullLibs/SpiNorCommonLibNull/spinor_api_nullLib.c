...
----------  -----     ---------------------------------------------------
12/20/22    sc        Add support for background init start
08/16/21    ck        Corrected copyright
 ...
 *   in case if we are not able to do the background initialization in one shot
