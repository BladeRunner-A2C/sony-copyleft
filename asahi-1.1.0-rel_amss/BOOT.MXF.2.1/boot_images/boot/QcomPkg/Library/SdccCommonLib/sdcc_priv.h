 ...
 *
 * Copyright (c) 2014-2015,2017-2018,2020,2022 Qualcomm Technologies, Inc.
 * All Rights Reserved.
...
2020-06-04   jt      Update speed mode 
...
#define SDCC_NEGOTIATE_OCR          0x01FF8000   /* voltage 2.7-3.6 + S18R=1 */
...
#define SDCC_MEM_ACCESS_CMD_ARG(c, a, bl) \
   (((c) == SDCC_CARD_SDHC || (c) == SDCC_CARD_UHS1 || (c) == SDCC_CARD_MMCHC) ? (a) : ((a) * (bl)))
...
enum SD_CMD
{
   ...
   SD_CMD11_VOLTAGE_SWITCH = SD_CMD11_READ_DAT_UNTIL_STOP,
