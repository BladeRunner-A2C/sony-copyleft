...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/GLinkLib/xport_rpm/inc/xport_rpm_config.h#1 $
...
typedef struct _xport_rpm_config_type
{
  ...
  os_ipc_intr_type irq_out;         /* Interrupt      */
