...
/*===========================================================================
 ...
 Copyright (c) 2014-2015, 2020, 2023 by QUALCOMM Technologies, Incorporated.  
 All Rights Reserved.
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/GLinkLib/os/inc/glink_os_utils.h#1 $
...
*/
/*=========================================================================*/
static inline uint64 glink_os_add64(uint64 a, uint64 b)
{
  if (a > (ULONG_MAX - b))
  {
    ERR_FATAL("Integer overflow while doing addition(0x%X, 0x%X).", a, b, 0);
...
*/
/*=========================================================================*/
boolean glink_os_register_isr( os_ipc_intr_type *intr, os_isr_cb_fn isr, void *cb_data );
...
*/
/*=========================================================================*/
boolean glink_os_deregister_isr( os_ipc_intr_type *intr );
...
*/
/*=========================================================================*/
boolean glink_os_enable_interrupt( os_ipc_intr_type *intr, os_isr_cb_fn isr, void* cb_data );
...
*/
/*=========================================================================*/
boolean glink_os_disable_interrupt( os_ipc_intr_type *intr );
