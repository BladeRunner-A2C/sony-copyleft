 ...
 */
/*=============================================================================
     Copyright (c) 2014-2015, 2020, 2022-2023 QUALCOMM Technologies Incorporated.
     All rights reserved.
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/GLinkLib/core/inc/glink_transport_if.h#1 $
...
/** transport-specific check if link is down */
typedef boolean (*is_link_down_fn)
(
  glink_transport_if_type *if_ptr	/* Pointer to the interface instance */
);
/**
...
struct glink_transport_if {
  ...
  /** check with transport if link is down */
  is_link_down_fn					is_link_down;
