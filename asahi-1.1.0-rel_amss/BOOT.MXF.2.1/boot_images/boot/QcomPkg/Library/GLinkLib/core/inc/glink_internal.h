...
-----------------------------------------------------------------------------
Copyright (c) 2014-2015, 2018-2021, 2022-2023 QUALCOMM Technologies Incorporated
-----------------------------------------------------------------------------
===========================================================================*/
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/GLinkLib/core/inc/glink_internal.h#1 $
...
#define GLINK_XPORT_LINK_STATUS_MASK_DOWN        ((uint32)(1 << GLINK_XPORT_LINK_DOWN))
#define GLINK_XPORT_LINK_STATUS_MASK_NEGOTIATING ((uint32)(1 << GLINK_XPORT_LINK_NEGOTIATING))
#define GLINK_XPORT_LINK_STATUS_MASK_UP          ((uint32)(1 << GLINK_XPORT_LINK_UP))
#define GLINK_XPORT_LINK_STATUS_MASK_ANY         ((uint32)0xFFFFFFFF)
