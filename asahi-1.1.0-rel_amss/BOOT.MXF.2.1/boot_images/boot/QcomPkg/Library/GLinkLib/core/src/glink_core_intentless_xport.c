...
Copyright (c) 2014-2016, 2022 by QUALCOMM Technologies, Incorporated.  All Rights
Reserved.
===========================================================================*/
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/GLinkLib/core/src/glink_core_intentless_xport.c#1 $
...
)
{
  ...
  GLINK_OS_UNREFERENCED_PARAM( options );
  glink_os_free(pctx);
