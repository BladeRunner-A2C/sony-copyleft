 ...
 */
/*==============================================================================
     Copyright (c) 2014-2015, 2022 QUALCOMM Technologies Incorporated.
     All rights reserved.
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/GLinkLib/core/inc/glink_core_if.h#1 $
...
(
  ...
  uint32 options                        /* Request intent flag , single-threaded flag */
);
