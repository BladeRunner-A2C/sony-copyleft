...
ThreadIntf ThreadInst =
{
  ...
  .ThreadGetUnsafeSPCurrent = get_thread_unsafe_sp_current,
  .ThreadSetUnsafeSP = (THREAD_SET_THREAD_UNSAFE_SP)set_thread_unsafe_sp,
  .ThreadGetUnsafeStackPaddingSize = get_thread_unsafe_stack_padding_size,
  .ThreadGetUnsafeSPBase = get_thread_unsafe_sp_base,
  .ThreadGetCurrentPriority = get_current_thread_priority,
  .ThreadUpdateCurrentThreadPriority = update_current_thread_priority,
};
...
MpCpuIntf MpCpu = 
{
    ...
    .MpcoreSleepLoggingControl = &CoreSleepLoggingControl,
    .MpcoreUnplugCPU = &mpcore_unplug_cpu,
    .MpcoreHotplugCPU = &mpcore_hotplug_cpu,
    .MpcoreSetCurrCpuSleeping = mpcore_set_curr_cpu_sleeping,
    .MpcoreSetCurrCpuWakeup = mpcore_set_curr_cpu_wakeup,
	.MpcoreSleepCpuEx = &CoreSleepCpuEx,
	.RegisterPwrTransitionNotifyEx = &RegisterDevicePowerTransitionCallbackEx,
    .UnRegisterPwrTransitionNotifyEx = &UnRegisterDevicePowerTransitionCallbackEx,
	.MpcoreGetFunctionalCpuMask = mpcore_get_functional_cpu_mask,
};
