 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/SPMILib/src/core/SpmiUtils.h#1 $
 * $Change: 53083464 $
 * 
 *                              Edit History
 * Date     Description
...
#define SPMI_TIMEOUT_USEC  1000  //@rumi wa
...
typedef enum 
{
    ...
    PMIC_ARB_CMD_EXTENDED_PBS_REG_WRITE_LONG = 17,
    PMIC_ARB_CMD_MAX
} PmicArbCmd;
