 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/SPMILib/src/core/SpmiPic.c#1 $
 * $Change: 53083464 $
 */
...
Spmi_Result SpmiPic_SetInterruptEnabled(SpmiDevInfo *pDev, uint8 owner, uint16 channel, boolean enabled)
{
    ...
    SPMI_HWIO_OUT_FIELD( HWIO_SPMI_PIC_ACC_ENABLEn_ADDR( base_addr, pDev->busChanStart + channel ),
                         HWIO_SPMI_PIC_ACC_ENABLEn_INT_ACC_ENABLE,
                         enabled );
