 ...
 * @file:  SpmiOsImage.c
 * 
 * Copyright (c) 2013-2016,2018 by Qualcomm Technologies Incorporated. All Rights Reserved.
 * 
 * $DateTime: 2024/04/02 23:00:31 $
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/SPMILib/src/platform/os/xbl/SpmiOsImage.c#1 $
 * $Change: 53083464 $ 
 * 
 *                              Edit History
 * Date     Description
 * -------  -------------------------------------------------------------------
 * 01/25/18 Remove TimerLib dependency
