...
/* ===============================================================================
 ...
 ===============================================================================
  ...
  Copyright (c) 2017-2023, 2024 Qualcomm Technologies, Inc. All rights reserved.
...
#define CHIPINFO_PARTNUM_SDX_OLYMPIC_HYBRID     0x172
#define CHIPINFO_PARTNUM_SDX_OLYMPIC_SINGLEDIE  0x161
...
#define CHIPINFO_PARTNUM_SM_WAIPIO              0x187
#define CHIPINFO_PARTNUM_SMP_WAIPIO             0x188
#define CHIPINFO_PARTNUM_SM_FILLMORE            0x1D3
#define CHIPINFO_PARTNUM_SXR_AURORA             0x1CC
#define CHIPINFO_PARTNUM_SM_PALIMA              0x1D9
#define CHIPINFO_PARTNUM_SMP_PALIMA             0x1DA
#define CHIPINFO_PARTNUM_SM_NETRANI             0x1DB
#define CHIPINFO_PARTNUM_SM_PALIMA_LTE_ONLY     0x1C5
#define CHIPINFO_PARTNUM_SMP_FILLMORE           0x1B7
#define CHIPINFO_PARTNUM_SM_WAIPIO_LTE_ONLY     0x204
#define CHIPINFO_PARTNUM_SM_FILLMORE_LTE_ONLY   0x212
#define CHIPINFO_PARTNUM_QDU_LASSEN             0x1E4
#define CHIPINFO_PARTNUM_QRU_LASSEN             0x1E5
#define CHIPINFO_PARTNUM_SXR_HALLIDAY           0x1FD
#define CHIPINFO_PARTNUM_SM_KAILUA              0x1CA
#define CHIPINFO_PARTNUM_SMP_KAILUA             0x1CB
#define CHIPINFO_PARTNUM_SDX_PINNACLES          0x1B4
#define CHIPINFO_PARTNUM_SDX_PINNACLES_M        0x1F3
#define CHIPINFO_PARTNUM_SA_PINNACLES           0x1FA
#define CHIPINFO_PARTNUM_SA_PINNACLES_L         0x1F9
#define CHIPINFO_PARTNUM_SA_AMINI               0x20D
#define CHIPINFO_PARTNUM_SSG_AURORA             0x209
#define CHIPINFO_PARTNUM_SM_KAPITI              0x208
#define CHIPINFO_PARTNUM_SCP_HAMOA              0x21E
#define CHIPINFO_PARTNUM_SCP_HAMOA_10CORE       0x24E
#define CHIPINFO_PARTNUM_SCP_HAMOA_8CORE        0x269
#define CHIPINFO_PARTNUM_SDX_KUNO_SINGLEDIE     0x221
#define CHIPINFO_PARTNUM_SDX_KUNO_HYBRID        0x222
#define CHIPINFO_PARTNUM_SM_LANAI               0x227
#define CHIPINFO_PARTNUM_SMP_LANAI              0x228
#define CHIPINFO_PARTNUM_SSG2_AURORA            0x229
#define CHIPINFO_PARTNUM_QDU1010_LASSEN         0x219
#define CHIPINFO_PARTNUM_QRU1032_LASSEN         0x1EC
#define CHIPINFO_PARTNUM_QRU1052_LASSEN         0x21C
#define CHIPINFO_PARTNUM_QRU1062_LASSEN         0x21D
#define CHIPINFO_PARTNUM_SDX_PINNACLES_L        0x1F5
#define CHIPINFO_PARTNUM_SDX_PINNACLES_UL       0x1F4
#define CHIPINFO_PARTNUM_SM_PALAWAN             0x275
#define CHIPINFO_PARTNUM_SM_LAMMA               0x2A8
#define CHIPINFO_PARTNUM_SG_NETRANI             0x2AA
#define CHIPINFO_PARTNUM_SGP_NETRANI            0x2AB
#define CHIPINFO_PARTNUM_SCP_PURWA              0x2AD
#define CHIPINFO_PARTNUM_SM_KIMILOS             0x2B1
#define CHIPINFO_PARTNUM_SM_MILOS               0x2B7
#define CHIPINFO_PARTNUM_SMP_MILOS              0x2B9
#define CHIPINFO_PARTNUM_SMP_PALAWAN            0x2BA
#define CHIPINFO_PARTNUM_SMP_LAMMA              0x2BB
#define CHIPINFO_PARTNUM_QCM_LANAI              0x2C2
#define CHIPINFO_PARTNUM_QCS_LANAI              0x2C3
#define CHIPINFO_PARTNUM_QCM_MILOS              0x2D6
#define CHIPINFO_PARTNUM_QCS_MILOS              0x2D7

/*
 * Placeholders for currently unknown part numbers
 */
#define CHIPINFO_PARTNUM_UNKNOWN                0xFFFF
#define CHIPINFO_PARTNUM_SM_PAKALA              CHIPINFO_PARTNUM_UNKNOWN
