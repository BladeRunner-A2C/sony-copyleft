...
================================================================================
        Copyright (c) 2016-2017, 2019, 2022 Qualcomm Technologies, Inc.
               All Rights Reserved.
            QUALCOMM Proprietary/GTDR
================================================================================

  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ChipInfoLib/ChipInfoLoader.c#1 $
...
/*=========================================================================
      Macros
==========================================================================*/
#define CHIPINFO_MAX_MESSAGE_LENGTH 150
...
)
{
  ...
  MajorVersion                      = HWIO_INF(CHIPINFO_TCSR_SOC_HW_VERSION_REG, MAJOR_VERSION);
  MinorVersion                      = HWIO_INF(CHIPINFO_TCSR_SOC_HW_VERSION_REG, MINOR_VERSION);
  ChipInfoCtxt.nVersion             = CHIPINFO_VERSION(MajorVersion, MinorVersion);
  RawArchFamilyId                   = HWIO_INF(CHIPINFO_TCSR_SOC_HW_VERSION_REG, FAMILY_NUMBER);
  RawDeviceId                       = HWIO_INF(CHIPINFO_TCSR_SOC_HW_VERSION_REG, DEVICE_NUMBER);
  ...
  /*
   * Read SKU information.
   */
  ChipInfo_ReadSKU(&ChipInfoCtxt.eFeatureCode, &ChipInfoCtxt.ePCode);

  /*
   * Fill in data that requires chipset-specific processing
   */
