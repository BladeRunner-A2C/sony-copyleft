...
INITIALIZATION AND SEQUENCING REQUIREMENTS:  N/A
        ...
        Copyright (c) 2008, 2017, 2019, 2022, 2023 Qualcomm Technologies Inc.All rights reserved.

====================================================================

  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ChipInfoLib/DalChipInfoFwk.c#1 $
...
static DALResult
ChipInfo_DalChipInfo_GetDisabledCPUs(DalDeviceHandle *h, uint32 nCPUCluster, uint32 *pnMask)
{
  return ChipInfo_GetDisabledCPUs(nCPUCluster, pnMask);
}
...
ChipInfo_InitInterface(ChipInfoClientCtxt* pclientCtxt)
{
  static const DalChipInfo vtbl = {
    ...
    NULL,
    ChipInfo_DalChipInfo_GetDisabledCPUs,
  };
