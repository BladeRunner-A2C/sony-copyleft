/** @file  
  ...
  Copyright (c) 2011,2013-2014,2017-2018 Qualcomm Technologies, Inc. All rights reserved.
...
/*=============================================================================
 ...
 --------   ---      ----------------------------------------------------------
 02/06/18   ps       32bit mode switch protocol moved to envdxe
 07/19/17   c_vkuppa 32bit mode switch protocol
...
)
{
  ...
  if(TzStatus == SCM_SUCCESS)
  {
	...
	for (i = 0; i < NumParams; i++)
	{
		Parameters[i] = DirectParameters[i];
	}
  }
  else
  {
