/** @file ResetSystemLib.c
  ...
  Copyright (c) 2011-2017, 2020,2022 Qualcomm Technologies, Inc. All rights reserved.
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 11/05/20   kpa     Call ShutdownEfi after check for EfiAtRuntime
 10/23/20   kpa     Move ShutdownEfi before psci reset calls
 10/21/20   kpa     Use psci_calls for system reset
 07/23/20   am      Move Pmic Reset APIs under EfiAtRuntime check
  ...
  )
{
  ...
  DEBUG((EFI_D_INFO, "INFO: Type     :0x%x \n", ResetType));
  DEBUG((EFI_D_INFO, "INFO: DataSize :0x%x \n", DataSize));
