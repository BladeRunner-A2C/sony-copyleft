...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/IpcrtrLib/src/ipc_router_database.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 ...
 )
{
  ...
  ipc_router_proc_record_type *proc = NULL;
  ...
  switch(cr->crit)
  {
    ...
    case IPC_ROUTER_CRITERIA_PROCESSOR:
      ...
      LIST_FIND(g_client_tbls[find_proc_slot(cr->arguments.proc_arg)],
                proc, link, proc->processor_id == (cr->arguments.proc_arg));
