...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/IpcrtrLib/src/ipc_router_protocol.h#1 $
...
#define IPC_ROUTER_PROC_DOWN_MAGIC         0xE111
...
typedef struct
{
  ...
  union
  {
    ...
    ipc_router_proc_down_args proc_down_arg;
  }arguments;
...
typedef enum
{
  ...
  IPC_ROUTER_CONTROL_PROC_DOWN = 13
