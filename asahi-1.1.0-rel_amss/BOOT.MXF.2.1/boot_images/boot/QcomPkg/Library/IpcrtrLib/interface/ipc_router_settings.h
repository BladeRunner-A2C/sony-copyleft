...
DESCRIPTION
  ...
  ---------------------------------------------------------------------------
  Copyright (c) 2017 - 2018Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/IpcrtrLib/interface/ipc_router_settings.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
...
{
  const char   *remote_ss;
  uint32 tx_channel;  /* IPC Router -> MHI */
  uint32 rx_channel; /* MHI -> IPCROUTER */
} ipc_router_xal_mhi_param_type;
