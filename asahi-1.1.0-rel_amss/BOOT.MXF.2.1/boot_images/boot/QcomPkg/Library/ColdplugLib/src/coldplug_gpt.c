...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ColdplugLib/src/coldplug_gpt.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $

  when         who   what, where, why
  ----------   ---   ---------------------------------------------------------
  2020-11-16   rp    Allocate coldplug_partition to grow at runtime.
  2017-11-08   yps   Fixed compiler migration issue
...
static int gpt_is_entry_valid(struct coldplug_gpt_partition *gpt_entry)
{
	...
	buffer = (uint32 *)(void *)&gpt_entry->type_guid.data1;
