 ...
 *
 * Coldplug
 * Copyright (C) 2015,2019,2021,2023 QUALCOMM Technologies, Inc.
 *
 * Coldplug UFS Block Device.
 *
 ***********************************************************************/
...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ColdplugLib/src/coldplug_bdev_ufs.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
...
static int coldplug_bdev_ufs_get_total_lba(void *bdev_hdl, void *clun,
...
static struct coldplug_bdev_ops coldplug_bdev_ufs_ops = {
    ...
    coldplug_bdev_ufs_get_total_lba
};
