...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ColdplugLib/inc/coldplug_device.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
...
struct coldplug_partition {
	struct coldplug_partition *next;
	uint32 magic;
...
extern struct coldplug_partition coldplug_partitions;
extern uint32 coldplug_partitions_count;
extern uint32 coldplug_partitions_count_total;
