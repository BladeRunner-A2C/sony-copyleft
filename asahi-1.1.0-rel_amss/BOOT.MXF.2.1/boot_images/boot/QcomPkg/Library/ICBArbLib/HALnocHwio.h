...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ICBArbLib/HALnocHwio.h#1 $
...
#define NOC_IN(base,offset,regsym)                           __nochwio_in(base,offset,regsym)
#define NOC_INI(base,offset,size,regsym,index)               __nochwio_ini(base,offset,size,regsym,index)
#define NOC_INI2(base,offset,size,regsym,in1,in2)            __nochwio_ini2(base,offset,size,regsym,in1,in2)
#define NOC_INM(base,offset,regsym,mask)                     __nochwio_inm(base,offset,regsym,mask)
#define NOC_INMI(base,offset,size,regsym,index,mask)         __nochwio_inmi(base,offset,size,regsym,index,mask)
#define NOC_INMI2(base,offset,size,regsym,in1,in2,mask)      __nochwio_inmi2(base,offset,size,regsym,in1,in2,mask)
#define NOC_OUT(base,offset,regsym,val)                      __nochwio_out(base,offset,regsym,val)
#define NOC_OUTI(base,offset,size,regsym,index,val)          __nochwio_outi(base,offset,size,regsym,index,val)
#define NOC_OUTI2(base,offset,size,regsym,in1,in2,val)       __nochwio_outi2(base,offset,size,regsym,in1,in2,val)
#define NOC_OUTM(base,offset,regsym,mask,val)                __nochwio_outm(base,offset,regsym,mask,val)
#define NOC_OUTMI(base,offset,size,regsym,index,mask,val)    __nochwio_outmi(base,offset,size,regsym,index,mask,val)
#define NOC_OUTMI2(base,offset,size,regsym,in1,in2,mask,val) __nochwio_outmi2(base,offset,size,regsym,in1,in2,mask,val)
#define NOC_ADDR(base,offset,regsym)                         __nochwio_addr(base,offset,regsym)
...
#define NOC_INFI2(base,offset,size,regsym,in1,in2,field)      (NOC_INMI2(base,offset,size,regsym,in1,in2,NOC_FMSK(regsym,field)) >> NOC_SHFT(regsym,field))
...
#define NOC_OUTFI2(base,offset,size,regsym,in1,in2,field,val) NOC_OUTMI2(base,offset,size,regsym,in1,in2,NOC_FMSK(regsym, field), val << NOC_SHFT(regsym, field))

/* Cached field manipulation macro */
#define NOC_INFC(regval,regsym,field)           ((regval & NOC_FMSK(regsym,field)) >> NOC_SHFT(regsym,field))

#define __nochwio_in(base,offset,regsym)                           NOC_##regsym##_IN(base,offset)
#define __nochwio_ini(base,offset,size,regsym,index)               NOC_##regsym##_INI(base,offset,size,index)
#define __nochwio_ini2(base,offset,size,regsym,in1,in2)            NOC_##regsym##_INI2(base,offset,size,in1,in2)
#define __nochwio_inm(base,offset,regsym,mask)                     NOC_##regsym##_INM(base,offset,mask)
#define __nochwio_inmi(base,offset,size,regsym,index,mask)         NOC_##regsym##_INMI(base,offset,size,index,mask)
#define __nochwio_inmi2(base,offset,size,regsym,in1,in2,mask)      NOC_##regsym##_INMI2(base,offset,size,in1,in2,mask)
#define __nochwio_out(base,offset,regsym,val)                      NOC_##regsym##_OUT(base,offset,val)
#define __nochwio_outi(base,offset,size,regsym,index,val)          NOC_##regsym##_OUTI(base,offset,size,index,val)
#define __nochwio_outi2(base,offset,size,regsym,in1,in2,val)       NOC_##regsym##_OUTI2(base,offset,size,in1,in2,val)
#define __nochwio_outm(base,offset,regsym,mask,val)                NOC_##regsym##_OUTM(base,offset,mask,val)
#define __nochwio_outmi(base,offset,size,regsym,index,mask,val)    NOC_##regsym##_OUTMI(base,offset,size,index,mask,val)
#define __nochwio_outmi2(base,offset,size,regsym,in1,in2,mask,val) NOC_##regsym##_OUTMI2(base,offset,size,in1,in2,mask,val)
#define __nochwio_addr(base,offset,regsym)                         NOC_##regsym##_ADDR(base,offset)
