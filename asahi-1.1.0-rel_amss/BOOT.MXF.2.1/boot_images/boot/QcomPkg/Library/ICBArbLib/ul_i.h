...
-------------------------------------------------------------------------------
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ICBArbLib/ul_i.h#1 $
...
----------   ---     -----------------------------------------------------------
2021/01/14   sds     Update commit prototypes to improve logging
...
/** ul_int_post_init
 * @brief Flush post initialization hardware votes.
 * 
 */
void ul_int_post_init( void );

/** ul_int_resource_post_init
 * @brief Flush post initialization hardware votes for standalone nodes.
 * 
 */
void ul_int_resource_post_init( icb_standalone_node_type *node );

/** ul_int_deinit
 * 
 * 
 * @author seansw (04/19/2017)
 */
 ...
 *
 * @param The client requesting the change
