...
/*
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/ICBArbLib/BCMhwio.h#1 $
...
#define HWIO_RPMH_BCM_STATUS_BE_CDm_ADDR(base,m)                                ((base) + 0x00000800ULL + 0x4ULL * (m))
