...
const md_ss_region aop_md_ss_regions[NUM_OF_REGIONS_COUNT] =
{
  ...
  },
  {
    /* CODERAM */
      ...
      0,                    
      MD_REGION_VALID,
#if defined(LASSEN)	  /* Lassen coderam and dataram addresses got changed */
      0xB000000,               
      0x60000,
#else
	  0xB000000,
    ...
    /* DATARAM */
      ...
      0xB180000,           
      0x20000,	
#elif defined(PALAWAN) || defined(MILOS)
	  0xB0e0000,
	  0xC000,
#else
	  0xB0e0000,
...
void aop_mini_dump_init(void)
{
   ...
   ss_toc = &md_gtoc->md_ss_toc[MD_SS_AOP];
   ...
   /*Encryption not required for AOP*/
   ss_toc->encryption_required        = MD_SS_ENCR_NOTREQ;
   ss_toc->encryption_status          = MD_SS_ENCR_DONE;
