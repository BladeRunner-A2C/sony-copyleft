 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/flash_cfg_qpic_2_0.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
 * when         who     what, where, why
 * ---------   ---     ----------------------------------------------
 * 13/09/22     gk      Enabled multi-page read.
...
extern boolean flash_qpic_pagescope_enabled;
  ...
  */
  ...
  #define FLASH_MULTI_R_SUPPORT_COUNT 8
  #define FLASH_MULTI_W_SUPPORT_COUNT 1
