 ...
 *
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/NandHalLib/flash_hal_common.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 ...
 */
void flash_hal_get_next_ws_addr(uintnt *addr, uint32 num_of_dwords)
{
  *addr = 0;
  ...
  {
    *addr = (uintnt) &ws_buffer_info.ws_buf[ws_buffer_info.ws_cnt];
