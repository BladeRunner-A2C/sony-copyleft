 ...
 *
 * Copyright (c) 2008-2012,2017-2019,2020 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/NandHalLib/flashi_hal.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
 ...
 * 06/11/19     sa      Added variable for qpic step version.
 * 02/15/19     sa      Added support for PageSCope/Multipage.
 * 07/09/18     sa      Added QPIC_Version field to store QPIC major version.
...
/* QPIC 2.0 version */
#define FLASH_HAL_QPIC_CTRL_VERSION_2_0     0x20000000
#define FLASH_HAL_QPIC_CTRL_STEP_VERSION    0x00000000
...
enum flash_hal_page_layout_id
{
  ...
  FLASH_HAL_LAYOUT_16BIT_ECC_2K_544_0_X4,          /* 2K Page layout 1 for 16bit ecc */
  FLASH_HAL_LAYOUT_16BIT_ECC_2K_516_0_X3_500_16_X1,/* 2K Page layout 3 for 16bit ecc */
  ...
  FLASH_HAL_LAYOUT_16BIT_ECC_4K_544_0_X8,	   /* 4K Page layout 1 for 16bit ecc */
  FLASH_HAL_LAYOUT_16BIT_ECC_4K_516_0_X7_484_32_X1,/* 4K Page layout 3 for 16bit ecc */
...
struct flash_hal_ctlr_data
{
  ...
  uint32 qpic_major_version;           /* This stores info about the QPIC major version only */   
  uint32 qpic_step_version;		       /* This stores info about the QPIC step version only */ 		
};
...
struct flash_hal_ctlr_ops
{
  ...
  void (*flash_hal_get_predef_mem_usage) (struct flash_hal_ctlr_data *priv_data,
    uint32 no_of_pages, uintnt *mem_use);
  ...
  /* Reading Multi page */
  void (*flash_hal_read_multipage) (flash_hal_dev_info *dev_info, 
    struct flash_hal_predef_page_data *page_data, struct flash_hal_predef_op_list
    **op_list, enum flash_hal_status *status);
  ...
  /* Set/Get feature cmd */
  void (*flash_hal_feature_cmd) (flash_hal_dev_info *dev_info, struct
