 ...
 *
 * Copyright (c) 2012-2015, 2017-2018, 2020 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/NandHalLib/QpicLib/flashi_hal_nandc.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
...
#define FLASH_NAND_CTRL_BOOST_MODE_BMSK \
          HWIO_NAND_CTRL_BOOST_MODE_BMSK

#define FLASH_NAND_CTRL_BOOST_MODE_SHFT \
          HWIO_NAND_CTRL_BOOST_MODE_SHFT
...
#define FLASH_NAND_READ_LOCATION_LAST_CW_n_LAST \
          HWIO_NAND_READ_LOCATION_LAST_CW_n_LAST_BMSK

#define FLASH_NAND_READ_LOCATION_LAST_CW_n_SIZE_SHIFT \
          HWIO_NAND_READ_LOCATION_LAST_CW_n_SIZE_SHFT
...
#define HAL_QPIC_NANDC_FLASH_DEV_CMD_VLD_PADDR                  \
											  HWIO_PHYS(FLASH_DEV_CMD_VLD)
#define HAL_QPIC_NANDC_FLASH_DEV_CMD_VLD_DCPU_PADDR                  \
											  HWIO_PHYS(FLASH_DEV_CMD_VLD_DCPU)
...
#define HAL_QPIC_NANDC_NAND_CTRL_DCPU_PADDR               \
                                          HWIO_PHYS(NAND_CTRL_DCPU)
...
#define HAL_QPIC_NANDC_NAND_READ_LOCATION_LAST_CW_PADDR \
                                          HWIO_PHYSI(NAND_READ_LOCATION_LAST_CW_n, 0)
...
#define FLASH_DEV_CMD0_SET_FEATURE_CMD     0x10EFD060
...
#define FLASH_DEV_CMD1_GET_FEATURE_CMD     0xF00F30EE
...
#define FLASH_ERASE_16BIT_ECC_CHECK_SIZE2    26
