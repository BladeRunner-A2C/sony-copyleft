 ...
 *
 * Copyright (c) 2009-2012,2018-2020, 2022 Qualcomm Technologies, Inc.  All Rights Reserved.
 *==================================================================*/
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/NandHalLib/QpicLib/flashi_hal_nandc_predef_bam.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 07/22/22     sa      To check the AARCH.
...
#define IS_AARCH_64 					(sizeof(uint64)==sizeof(uintnt)) ? TRUE : FALSE  /* To check the compiler AARCH.*/
...
/* PAGESCOPE*/
  ...
  #define PAGESCOPE_INIT_PTR hal_nandc_bam_00_30_x1_pagescope_init  
  #define PAGESCOPE_EXEC_PTR hal_nandc_bam_00_30_x1_pagescope_exec
  
#else
  #define PAGESCOPE_INIT_PTR NULL
  #define PAGESCOPE_EXEC_PTR NULL
#endif
...
/* MULTIPAGE */
  ...
  #define MULTIPAGE_INIT_PTR hal_nandc_bam_00_30_x1_multipage_init
  #define MULTIPAGE_EXEC_PTR hal_nandc_bam_00_30_x1_multipage_exec
   
#else
  #define MULTIPAGE_INIT_PTR NULL
  #define MULTIPAGE_EXEC_PTR NULL
#endif
...
struct nandc_predef_reg_read_buff
{
  ...
  uint32 multipage_status_buffer;
  uint32 dummy_buffer;

  /* Write Buffers */
  uint64 spare_fill_buffer;
};
...
/* FOllowing struct stores the number of registers for different lists */
struct nandc_predef_reg_count
{
  uint8 total_nandc_config_list_registers;  /*Stores total number of config list registers*/
  uint8 total_nandc_locate_list_registers;  /*Stores total number of locate list registers*/
};
...
void hal_nandc_bam_read_pages(flash_hal_dev_info *dev_info,
  struct flash_hal_predef_page_data *page_data,
  struct flash_hal_predef_op_list **op_list, enum flash_hal_status  *status);
