 ...
 *
 * Copyright (c) 2008-2012, 2015, 2017, 2020 QUALCOMM Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/NandHalLib/flashi_hal_nand.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
...
#define FLASH_16BIT_ECC_NAND_SA_PER_CW   32   /* Spare Area per CW for 16bit BCH ECC */
...
#define FLASH_16BIT_ECC_NAND_BYTES_PER_CW (FLASH_NAND_UD_PER_CW +\
                                           FLASH_16BIT_ECC_NAND_SA_PER_CW)
...
#define NAND_16BIT_ECC_SIZE              26     /* ECC parity data size for 16bit BCH ECC NAND */
...
#define NAND_16BIT_ECC_SPARE_BYTES       6      /* Entire spare area size for x8,x16 NAND*/
...
#define NAND_16BIT_ECC_BAD_BLOCK_BYTE_NUM (NAND_16BIT_ECC_SIZE + NAND_16BIT_ECC_SPARE_BYTES + 1)
...
#define NAND_16BIT_ECC_SPARE_SIZE_8      (FLASH_16BIT_ECC_NAND_SA_PER_CW - \
                                          (NAND_16BIT_ECC_SIZE + NAND_BAD_BLK_BYTE_CNT_8BIT))
#define NAND_16BIT_ECC_SPARE_SIZE_16     (FLASH_16BIT_ECC_NAND_SA_PER_CW - \
                                          (NAND_16BIT_ECC_SIZE + NAND_BAD_BLK_BYTE_CNT_16BIT))
