 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/NandHalLib/flash_hal_nand_main.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
   ...
   struct flash_hal_page_layout *page_layout)
{
  ...
  main_addr = (uintnt) page_data->main_data;
  spare_addr = (uintnt) page_data->spare_data;
