 ...
 *
 * Copyright (c) 2011,2019-2020 Qualcomm Technologies, Inc.  All Rights Reserved
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/flash_dal_target.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 07/20/2020   sa      Ported Boost mode changes on olympic
 * 06/08/20     sa      Ported for Olympic.
 * 02/15/19     sa      Removed RW count to support pagescope/multipage.
...
*/
  ...
  #define FLASH_XFER_BOOST_MODE_DISABLED  TRUE  /* Transfer Boost Mode: TRUE - Disabled, FALSE - Enabled */ 
      ...
      //TODO optimize memory for 64-bit changing from 3KB to 4KB
      //#define FLASH_HAL_WS_BUFF_SIZE_BYTES    3072  /* OTP Support needed */
      #define FLASH_HAL_WS_BUFF_SIZE_BYTES    (6 * 1024)  /* OTP Support needed */
    #endif
  #else
