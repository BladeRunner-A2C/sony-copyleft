 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/flash_bam_wrapper.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
...
#define NAND_BAM_BASE_PHY_ADDR     (uint32) (QPIC_QPIC_BASE + 0x4000)
#define NAND_BAM_BASE_ADDR         (uint32) (QPIC_QPIC_BASE + 0x4000)
