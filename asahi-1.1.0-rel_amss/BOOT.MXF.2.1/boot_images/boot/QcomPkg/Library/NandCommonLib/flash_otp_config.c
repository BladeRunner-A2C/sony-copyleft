 ...
 *
 *          Copyright (c) 2008-2009,2011-2012, 2018-2020 Qualcomm Technologies, Inc Incorporated.
 *          All Rights Reserved.
 ...
 *   order.
 *
 *   $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/flash_otp_config.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 06/08/20     sa      Ported for Olympic.
 * 03/05/18     eo      Clean up
...
/* 
 * DISCLAIMER: 
 *              "OEMs need to appropriately work with the memory vendors to include 
