 ...
 *
 * Copyright (c) 2008-2012,2020 Qualcomm Technologies, Inc.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/flash_dal_util.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
...
#define SET_FLASH_DBG_CLIENT_CTX(x)    flash_dbg.client_ctxt_base = (uintnt)x
#define SET_FLASH_DBG_OP_LIST_BASE(x)  flash_dbg.op_list_base = (uintnt)x
