 ...
 *
 * Copyright (c) 2008-2013, 2019-2020,2022 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/flash_nand_partition.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
...
int nand_retrieve_mibib_internal(flash_client_ctxt *client_ctxt)
{
  ...
  {
    client_ctxt->client_data.partition_block_limit   = MIBIB_BLOCK_SEARCH_MAX_AUTO;
	max_mibib_block = MIBIB_BLOCK_SEARCH_MAX_AUTO;
  }
  else
  {
    client_ctxt->client_data.partition_block_limit   = MIBIB_BLOCK_SEARCH_MAX;
	max_mibib_block = MIBIB_BLOCK_SEARCH_MAX ;
  }
  ...
  while ((cur_block <= max_mibib_block))
  {
