 ...
 * DESCRIPTION: 
 *
 * Copyright (c) 2008-2009, 2011-2012, 2020 Qualcomm Technologies, Inc.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/flash_nand_config.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
...
#else
  #define FLASH_MAX_BB_ENTRIES  1       /**< Maximum bad block entries */
#endif
...
#define FLASH_MAX_TIMING_MODES 6      /**< Maximum number of timing modes: 0 to 5 */
...
{
  uintnt xfer_count;                      /**< Transfer steps count */
  uintnt xfer_data[FLASH_MAX_TIMING_MODES][FLASH_MAX_XFER_STEPS]; /**< Transfer steps data */
};
