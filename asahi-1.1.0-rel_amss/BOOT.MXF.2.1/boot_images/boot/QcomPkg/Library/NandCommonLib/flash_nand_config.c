 ...
 *
 * Copyright (c) 2011-2015, 2017, 2018, 2020, 2023 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
 ...
 *   order.
 *
 *  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/NandCommonLib/flash_nand_config.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
 *
 *
 * when         who     what, where, why
 * ----------   ---     ----------------------------------------------
 * 01/24/23     gk      Updated Nanya NAND part comments.
...
static struct flash_nand_params supported_nand_devices[] =
{
  ...
  /* This configuration supports the following parts.
     1. Toshiba TC58NYG2S0HBA14 flash ( x8 part), non-ONFI1.0
     2. Nanya NM4484NSPAXAE flash (1.8V, x8 part) 
