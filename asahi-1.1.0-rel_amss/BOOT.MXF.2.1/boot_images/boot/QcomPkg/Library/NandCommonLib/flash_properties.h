 ...
 *
 * Copyright (c) 2008-2012,2019-2020, 2023 Qualcomm Technologies, Inc.  All Rights Reserved.
 *===========================================================================*/
 ...
 * ----------   ---     ----------------------------------------------
 * 03/22/23     ck      Added com_dtypes.h
 * 10/29/20     sa      Added tbl for setting GPIO.
 * 06/08/20     sa      Ported for Olympic.
 * 05/06/19     sa      Removed unused profiling code.
...
enum flash_property_id
{
  ...
  FLASH_NAND_CONFIG_GPIO,          /* Set TLMM GPIO for NAND */
  FLASH_PROPERTY_ID_MAX = 0xFF     /* Maximum property IDs */
};

/* Bits to indicate probing NAND*/
...
/* Structure defining the GPIO config function */
typedef struct
{
  void (*set_gpio_config)(void);
} flash_config_gpio_tbl;
