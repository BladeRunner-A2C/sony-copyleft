...
/*
  ...
  Copyright (c) 2020-2021,2023 QUALCOMM Technologies Incorporated.  All Rights Reserved.
  QUALCOMM Proprietary and Confidential.

  ====================================================================

  $Header: //components/dev/core.boot/6.1/saurku.core.boot.6.1.Hamoa_clock_lib_Enhance_Lib/QcomPkg/Drivers/ClockDxe/ClockDriver.h#1 $
...
/* =========================================================================
**  Function : Clock_LogStateToUart
** =========================================================================*/
/**
 * Inertnal function to Clock_DumpClockState, it returns the clock logs.
*/
...
ClockResult Clock_GetCESTAId(ClockHandle hClient, const char *szName, ClockIdType *pId);
...
ClockResult Clock_DumpClocksState ( ClockDrvCtxt *pDrvCtxt, uint32 nFlags );
