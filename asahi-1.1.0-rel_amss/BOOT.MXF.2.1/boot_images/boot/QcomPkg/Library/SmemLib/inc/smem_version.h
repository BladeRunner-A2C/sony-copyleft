...
DEPENDENCIES
 ...
 Copyright (c)  2008-2012,2016, 2021 Qualcomm Technologies, Inc. All Rights Reserved.
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/SmemLib/inc/smem_version.h#1 $
...
#elif defined(MPROC_NPU_PROC)
  #define SMEM_VERSION_INFO_OFFSET        16
#elif defined(MPROC_WPSS_PROC)
  #define SMEM_VERSION_INFO_OFFSET        17
#else
