...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/SmemLib/src/smem.c#1 $
...
int32 smem_alloc_ex(smem_alloc_params_type *params)
{
  ...
  else
  {
    ...
    SMEM_OS_LOG_INFO(5, "smem_alloc_ex: SMEM alloc_ex failed with err=%d! smem_type=%d, remote=%d, "
