...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/SmemLib/src/smem_legacy.c#1 $
...
{
  uint32 offset = (uint32)(uintptr_t)buffer - (uint32)(uintptr_t)SMEM_INFO_SMEM_BASE_ADDR();
