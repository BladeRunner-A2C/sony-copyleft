 ...
 *                            --------------------
 *       Copyright (c) 2015 - 2016, 2022 Qualcomm Technologies Incorporated.
 *                            All Rights Reserved.
...
void i2c_test_signal_event (); //Declared prototype to pacify Misra.

void i2c_test_wait_for_event (void)
{
//    rex_wait(TEST_SIGNAL_GENERIC_SIGNAL);
//    rex_clr_sigs(p_tcb, TEST_SIGNAL_GENERIC_SIGNAL);
}

void i2c_test_signal_event (void)
{
