...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/app/pon/src/pm_app_pon_log.c#1 $
$Author: cirrusp4svc $
...
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  char* fault_reason1[8] = {"GP_FAULT0", "GP_FAULT1", "GP_FAULT2", "GP_FAULT3", "MBG_FAULT", "OVLO", "UVLO", "AVDD_RB"};
