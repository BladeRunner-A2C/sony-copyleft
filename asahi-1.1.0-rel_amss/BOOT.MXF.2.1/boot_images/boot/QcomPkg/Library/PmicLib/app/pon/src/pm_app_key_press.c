...
--------   ---     ---------------------------------------------------------- 
03/09/23   ck      Added com_dtypes.h
...
static pm_err_flag_type pm_app_pwrkey_check_press_conditions(boolean* chk_condtions);
...
pm_app_pwrkey_long_press_check(pm_pon_pwrkey_dbnc_chk_at_type  dbnc_chk_at)
{
  ...
  err_flag = pm_app_pwrkey_check_press_conditions(&chk_condtions);
...
pm_app_pwrkey_check_press_conditions(boolean* chk_condtions)
{
  pm_err_flag_type            err_flag = PM_ERR_FLAG_SUCCESS;
