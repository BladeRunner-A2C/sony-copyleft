 ...
 *
 *
 *  \n &copy; Copyright (c) 2012-2018  by QUALCOMM Technologies Incorporated, All Rights Reserved
 */
...
--------   ---     ----------------------------------------------------------
05/05/18   sv      Updated to support SMB1351
...
typedef struct
{
   pm_smb_batif_low_battery_threshold  vlowbatt_threshold;
   pm_param_config_enable_type          enable_config;
} pm_sbl_smb_vlowbatt_threshold_data_type;
...
typedef struct
{
    pm_sbl_smb_vlowbatt_threshold_data_type          dbc_bootup_volt_threshold;
    pm_sbl_temp_threshold_data_type                  fg_skin_hot_threshold; 
    pm_sbl_temp_threshold_data_type                  fg_skin_too_hot_threshold; 
    pm_sbl_temp_threshold_data_type                  fg_charger_hot_threshold; 
    pm_sbl_temp_threshold_data_type                  fg_charger_too_hot_threshold; 
 ...
 */
pm_err_flag_type pm_sbl_chg_config_vbat_low_threshold(pm_smb_batif_low_battery_threshold vlowbatt_threshold_data);
 ...
 *        pm_driver_init()
 */
pm_err_flag_type pm_sbl_chg_check_weak_battery_status();
