...
/*============================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/adc/devices/common/src/AdcScalingUtil.c#1 $$DateTime: 2024/04/02 23:00:31 $$Author: cirrusp4svc $
...
/*===========================================================================
  ...
  FUNCTION        VAdcScaleDieTempInverse
...
{
   /*
    * Add 273150 to convert temp from Kelvin to mDegC.
    *
    * Multiply by 2 to convert from  micro-Kelvin to microvolt.
    */
   *puMicrovolts = (uint32)((nPhysical + 273150) * 2);
...
/*===========================================================================
  ...
  FUNCTION        VAdcScaleChgTempInverse
...
{
   *puMicrovolts = (uint32)(4 * (377500 - nPhysical));
