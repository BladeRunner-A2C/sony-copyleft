...
============================================================================*/
/* $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/adc/devices/common/protected/DDIAdcDevice.h#1 $ */
...
#endif
   DALResult (*ProcessConversionResult)(DalDeviceHandle *_h, uint32 uChannelIdx, uint32 uAdcCode, AdcDeviceResultType *pAdcDeviceResult);
   DALResult (*ProcessConversionResultInverse)(DalDeviceHandle *_h, uint32 uChannelIdx, int32 nPhysical, AdcDeviceResultType *pAdcDeviceResult);
};
...
/**
   ...
   @param  eDeviceId [in] The device ID to attach to
...
*/
#define DAL_AdcDeviceDeviceAttach(eDeviceId,hDalDevice)\
        VAdc_DalAdcDevice_Attach(NULL, eDeviceId, hDalDevice)

DALResult VAdc_DalAdcDevice_Attach(const char *pszArg, DALDEVICEID DeviceId, DalDeviceHandle **phDalDevice);
...
*/
static __inline DALResult
DalAdcDevice_ProcessConversionResult(DalDeviceHandle *_h, uint32 uChannelIdx, uint32 uAdcCode, AdcDeviceResultType *pAdcDeviceResult)
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->ProcessConversionResult( _h, uChannelIdx, uAdcCode, pAdcDeviceResult);
}
...
*/
static __inline DALResult
DalAdcDevice_ProcessConversionResultInverse(DalDeviceHandle *_h, uint32 uChannelIdx, int32 nPhysical, AdcDeviceResultType *pAdcDeviceResult)
{
   return ((DalAdcDeviceHandle *)_h)->pVtbl->ProcessConversionResultInverse( _h, uChannelIdx, nPhysical, pAdcDeviceResult);
}
