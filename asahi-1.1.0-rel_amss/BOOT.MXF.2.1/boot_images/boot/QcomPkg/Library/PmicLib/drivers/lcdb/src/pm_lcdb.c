...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/drivers/lcdb/src/pm_lcdb.c#1 $
$Author: cirrusp4svc $
...
#define ADDRESS(x) (lcdb_ptr->base_address + lcdb_ptr->lcdb_reg_table->x)
