...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/drivers/lpg/src/pm_lpg_driver.h#1 $
$Author: cirrusp4svc $
...
typedef struct
{
  ...
  pm_register_address_type pause_hi_multiplier;          //  0x052
  pm_register_address_type pause_lo_multiplier;          //  0x054
