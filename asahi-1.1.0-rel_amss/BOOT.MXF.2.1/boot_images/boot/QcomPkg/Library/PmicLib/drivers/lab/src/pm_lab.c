...
*  &copy;
*  Copyright (c) 2014-2020 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/drivers/lab/src/pm_lab.c#1 $
$Author: cirrusp4svc $
...
pm_err_flag_type pm_lab_lcd_amoled_sel(uint32 device_index, boolean en_amoled_mode)
{
  ...
  {
    pm_register_address_type lcd_amoled_sel = lab_ptr->base_address + lab_ptr->lab_reg_table->lcd_amoled_sel;
...
pm_err_flag_type pm_lab_lab_module_rdy(uint32 device_index, boolean lab_rdy)
{
  ...
  {
    pm_register_address_type module_rdy = lab_ptr->base_address + lab_ptr->lab_reg_table->module_rdy;
...
pm_err_flag_type pm_lab_en_lab_module(uint32 device_index, boolean en_module)
{
  ...
  {
    pm_register_address_type enable_ctl = lab_ptr->base_address + lab_ptr->lab_reg_table->enable_ctl;
...
pm_err_flag_type pm_lab_ibb_rdy_en(uint32 device_index, boolean ibb_en_rdy)
{
  ...
  {
    pm_register_address_type ibb_en_rdy_reg = lab_ptr->base_address + lab_ptr->lab_reg_table->ibb_en_rdy;
...
pm_err_flag_type pm_lab_get_lab_status(uint32 device_index, pm_lab_status_type* lab_status)
{
  ...
  pm_register_address_type precharge_ctl = lab_ptr->base_address + lab_ptr->lab_reg_table->precharge_ctl;
  ...
  pm_register_address_type output_voltage = lab_ptr->base_address + lab_ptr->lab_reg_table->output_voltage;
  ...
  pm_register_address_type status1 = lab_ptr->base_address + lab_ptr->lab_reg_table->status1;
  ...
  pm_register_address_type current_sense = lab_ptr->base_address + lab_ptr->lab_reg_table->current_sense;
  ...
  pm_register_address_type ps_ctl = lab_ptr->base_address + lab_ptr->lab_reg_table->ps_ctl;
...
static inline pm_err_flag_type pm_lab_unlock_perph_write(pm_lab_data_type *lab_ptr)
{
  ...
  {
    pm_register_address_type sec_access = lab_ptr->base_address + lab_ptr->lab_reg_table->sec_access;
