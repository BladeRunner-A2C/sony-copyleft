...
===========================================================================*/
pm_err_flag_type
pm_schg_dcdc_otg_enable(uint32 bus_id, uint32 pmic_index, boolean enable)
{
  ...
  else
  {
    ...
    err_flag = pm_schg_dcdc_config_otg(bus_id, pmic_index, PM_SCHG_DCDC_OTG_CFG_OTG_EN_SRC_CFG, FALSE); //0 = OTG Enable Source Command

    pm_register_address_type cmd_otg = ADDRESS(cmd_otg);
    err_flag |= pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, cmd_otg, 0x1, data);
  }
...
pm_err_flag_type
pm_schg_dcdc_config_otg(uint32 bus_id, uint32 pmic_index, pm_schg_dcdc_otg_cfg_type otg_cfg_type, boolean set_value)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, otg_cfg, mask, data);
  }
...
pm_err_flag_type
pm_schg_dcdc_set_otg_current_limit(uint32 bus_id, uint32 pmic_index, uint32 otg_limit_ma)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, otg_current_limit_cfg, mask, data);
  }
...
pm_err_flag_type
pm_schg_dcdc_get_otg_status(uint32 bus_id, uint32 pmic_index, pm_schg_dcdc_otg_status_type *otg_status)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_mask_ex(bus_id, SLAVE_ID, otg_status_addr, read_mask, &data);
...
pm_err_flag_type
pm_schg_dcdc_get_icl_status(uint32 bus_id, uint32 pmic_index, pm_schg_dcdc_icl_status_type *icl_status)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  ...
  else
  {
    ...
    err_flag |= pm_comm_read_byte_array_ex(bus_id, SLAVE_ID, otg_icl_status, 5, data);
...
pm_err_flag_type
pm_schg_dcdc_configure_vsysmin(uint32 bus_id, uint32 pmic_index, uint32 vsysmin_mv)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, address, mask, data);
  }
...
pm_err_flag_type
pm_schg_dcdc_get_power_path_status(uint32 bus_id, uint32 pmic_index, pm_schg_dcdc_power_path_status *power_path_status)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
...
pm_err_flag_type
pm_schg_dcdc_set_eng_sdcdc_cfg1(uint32 bus_id, uint32 pmic_index, uint8 reg_val)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  {
    pm_register_address_type eng_sdcdc_cfg1_reg = ADDRESS(eng_sdcdc_cfg1);
    err_flag = pm_comm_write_byte_ex(bus_id, SLAVE_ID, eng_sdcdc_cfg1_reg, data);
  }
