...
#define PM_SCHG_USB_USBIN_MAX_CURRENT_LIMIT_CFG_MV    6350
...
===========================================================================*/
pm_err_flag_type
pm_schg_usb_irq_enable(uint32 bus_id, uint32 pmic_index, pm_schg_usb_irq_type irq, boolean enable)
{
...
pm_err_flag_type
pm_schg_usb_irq_clear(uint32 bus_id, uint32 pmic_index, pm_schg_usb_irq_type irq)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 1 << irq;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
...
pm_err_flag_type
pm_schg_usb_irq_set_trigger(uint32 bus_id, uint32 pmic_index, pm_schg_usb_irq_type irq, pm_irq_trigger_type trigger)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 1 << irq;
...
pm_err_flag_type
pm_schg_usb_irq_status(uint32 bus_id, uint32 pmic_index, pm_schg_usb_irq_type irq, pm_irq_status_type type, boolean *status)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
...
pm_err_flag_type
pm_schg_usb_set_usbin_adptr_allowance(uint32 bus_id, uint32 pmic_index, pm_schg_usb_usbin_adapter_allowance_type adptr_allowance)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  ...
  if (NULL == schg_ptr)
  {
    err_flag = PM_ERR_FLAG_FEATURE_NOT_SUPPORTED;
           ...
           (adptr_allowance > PM_SCHG_USB_USBIN_ADAPTER_ALLOW_5V_TO_9V && adptr_allowance < PM_SCHG_USB_USBIN_ADAPTER_ALLOW_5V_TO_12V15V))
  {
    err_flag = PM_ERR_FLAG_INVALID_PARAMETER;
  }
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, usbin_adapter_allow_cfg, 0x0F, data);
  }
...
pm_err_flag_type
pm_schg_usb_get_usbin_adptr_allowance(uint32 bus_id, uint32 pmic_index, pm_schg_usb_usbin_adapter_allowance_type *adptr_allowance)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  {
    pm_register_address_type usbin_adapter_allow_cfg = ADDRESS(usbin_adapter_allow_cfg);
    err_flag = pm_comm_read_byte_ex(bus_id, SLAVE_ID, usbin_adapter_allow_cfg, &data);
...
pm_err_flag_type
pm_schg_usb_get_apsd_status(uint32 bus_id, uint32 pmic_index, pm_schg_usb_apsd_status_type apsd_status_type, boolean *result)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_ex(bus_id, SLAVE_ID, apsd_status, &data);
    if (PM_ERR_FLAG_SUCCESS == err_flag)
    {
...
pm_err_flag_type
pm_schg_usb_get_apsd_result_status(uint32 bus_id, uint32 pmic_index, pm_chg_charger_port_type *apsd_result)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    *apsd_result = PM_CHARGER_PORT_TYPE_INVALID;
    ...
    err_flag = pm_comm_read_byte_ex(bus_id, SLAVE_ID, apsd_result_status, &data);
    if (PM_ERR_FLAG_SUCCESS == err_flag)
    {
...
pm_err_flag_type
pm_schg_usb_configure_usbin_icl_options(uint32 bus_id, uint32 pmic_index, pm_schg_usb_icl_options_type icl_options, boolean set_value)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, usbin_icl_options, mask, data);
  }
...
pm_err_flag_type
pm_schg_usb_set_usbin_current_limit_cfg(uint32 bus_id, uint32 pmic_index, uint32 usbin_current_limit)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_ex(bus_id, SLAVE_ID, usbin_current_limit_cfg, data);
  }
...
pm_err_flag_type
pm_schg_usb_rerun_apsd(uint32 bus_id, uint32 pmic_index)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag |= pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, apsd_cfg_reg, 0x1, 0x1);
  }
...
pm_err_flag_type
pm_schg_usb_set_usbin_option1_cfg(uint32 bus_id, uint32 pmic_index, pm_schg_usb_usbin_options_1_cfg usbin_cfg, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, usbin_option1_cfg, (1 << usbin_cfg), data);
  }
...
pm_err_flag_type
pm_schg_usb_set_usbin_suspend(uint32 bus_id, uint32 pmic_index, boolean set_value)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, cmd_il, 0x01, set_value ? 0x01 : 0x00);
  }
...
pm_err_flag_type
pm_schg_usb_get_usbin_option1_cfg(uint32 bus_id, uint32 pmic_index, pm_schg_usb_usbin_options_1_cfg usbin_cfg, boolean *enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  {
    pm_register_address_type usbin_option1_cfg = ADDRESS(usbin_options_1_cfg);
    err_flag = pm_comm_read_byte_mask_ex(bus_id, SLAVE_ID, usbin_option1_cfg, (1 << usbin_cfg), &data);
...
pm_err_flag_type
pm_schg_usb_aicl_options_cfg(uint32 bus_id, uint32 pmic_index, pm_schg_usb_aicl_cfg_type aicl_cfg_type, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = enable ? 0xFF : 0x00;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, usbin_aicl_options_cfg, mask, data);
  }
...
pm_err_flag_type
pm_schg_usb_enable_icl_override_after_apsd(uint32 bus_id, uint32 pmic_index, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 0x10;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, usbin_load_cfg, mask, data);
  }
