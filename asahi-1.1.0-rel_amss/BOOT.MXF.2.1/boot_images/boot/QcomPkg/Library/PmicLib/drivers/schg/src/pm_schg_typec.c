...
===========================================================================*/
pm_err_flag_type
pm_schg_usb_get_typec_status(uint32 bus_id, uint32 pmic_index, pm_chg_typec_status_type *typec_status)
{
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_array_ex(bus_id, SLAVE_ID, address, 6, (uint8 *)&typec_port_status);
    ...
    else if (typec_port_status[0] & 0x10)
    {
      typec_status->dfp_curr_adv = PM_TYPEC_CURR_ADV_DAM_3000MA;
    }
    else if (typec_port_status[0] & 0x20)
    {
      typec_status->dfp_curr_adv = PM_TYPEC_CURR_ADV_DAM_1500MA;
    }
    else if (typec_port_status[0] & 0x40)
    {
      typec_status->dfp_curr_adv = PM_TYPEC_CURR_ADV_DAM_500MA;
    }
    else
    {
...
pm_err_flag_type
pm_schg_usb_get_typec_vbus_status(uint32 bus_id, uint32 pmic_index, boolean *vbus_status)
{
  pm_err_flag_type err_flag  = PM_ERR_FLAG_SUCCESS;
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_ex(bus_id, SLAVE_ID, address, &data);
...
pm_err_flag_type
pm_schg_usb_typec_get_port_role(uint32 bus_id, uint32 pmic_index, pm_chg_typec_port_role_type *port_role)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  ...
  *port_role = PM_CHG_TYPEC_ROLE_INVALID;
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_array_ex(bus_id, SLAVE_ID, address, sizeof(typec_port_status), typec_port_status);
...
pm_err_flag_type
pm_schg_usb_typec_set_port_role(uint32 bus_id, uint32 pmic_index, pm_chg_typec_port_role_type port_role)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0x00;
  uint8 mask = 0x06;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, type_c_mode_cfg, mask, data);
  }
  return err_flag;
}

pm_err_flag_type
pm_schg_usb_typec_vconn_enable(uint32 bus_id, uint32 pmic_index, pm_schg_usb_typec_vconn_enable_type enable_type)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  pm_register_data_type data = 0x00;
  ...
  else
  {
    ...
    data = enable_type;
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, type_c_intrpt_enb_software_ctrl, mask, data);
  }
...
pm_err_flag_type
pm_schg_usb_typec_disable(uint32 bus_id, uint32 pmic_index, boolean disable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  uint8 mask = 0x01;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, type_c_intrpt_enb_software_ctrl, mask, disable ? 0x1 : 0x0);
  }
...
pm_err_flag_type
pm_schg_usb_typec_enable_try_sink_mode(uint32 bus_id, uint32 pmic_index, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, type_c_cfg_3, mask, data);
  }
...
pm_err_flag_type
pm_schg_typec_en_dbg_access_snk(uint32 bus_id, uint32 pmic_index, boolean EnDbgAccessSnk)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, type_c_snk_cfg, mask, data);
  }
...
pm_err_flag_type
pm_schg_typec_en_fmb(uint32 bus_id, uint32 pmic_index, boolean EnFmb)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
...
pm_err_flag_type
pm_schg_typec_get_dam_connect_sts(uint32 bus_id, uint32 pmic_index, boolean *ConnectSts)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_mask_ex(bus_id, SLAVE_ID, type_c_access_status, mask, &data);
    if (ConnectSts != NULL)
    {
      *ConnectSts = data ? 1 : 0;
    }
...
pm_err_flag_type
pm_schg_typec_set_dam_icl(uint32 bus_id, uint32 pmic_index, pm_schg_usb_typec_dam_icl_sel icl_sel)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
