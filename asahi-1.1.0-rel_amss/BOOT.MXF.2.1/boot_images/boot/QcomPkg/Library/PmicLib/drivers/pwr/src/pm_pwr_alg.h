 ...
 *  \brief   
 *  \details  
 *  \n &copy; Copyright 2012-2023 Qualcomm Technologies, Inc. All Rights Reserved
 */
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/drivers/pwr/src/pm_pwr_alg.h#1 $
$Author: cirrusp4svc $
...
typedef struct
{
    ...
    pm_register_address_type    STATUS2;           // STATUS2                 0x09
    pm_register_address_type    STATUS3;           // STATUS                          0x0A
    pm_register_address_type    STATUS4;           // STATUS                  0x0B
    pm_register_address_type    AHC_CTL1_HR;       // AHC_CTL1_HR             0x31
    ...
    pm_register_address_type    OCP_CTL2;          // OCP_CTL2                0x89
    pm_register_address_type    BROADCAST_CFG;     // BROADCAST_CFG           0x8B
    pm_register_address_type    PD_CTL;            // PD_CTL                  0xA0                             0x48   
    pm_register_address_type    GANG_CTL1;         // GANG_CTL1               0xC0    0x00                     0x00	
