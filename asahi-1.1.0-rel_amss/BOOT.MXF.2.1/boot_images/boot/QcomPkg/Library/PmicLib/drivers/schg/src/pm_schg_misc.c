...
pm_err_flag_type
pm_schg_misc_irq_enable(uint32 bus_id, uint32 pmic_index, pm_schg_misc_irq_type irq, boolean enable)
{
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, irq_reg, data, data);
  }
...
pm_err_flag_type
pm_schg_misc_irq_clear(uint32 bus_id, uint32 pmic_index, pm_schg_misc_irq_type irq)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 1 << irq;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, int_latched_clr, data, data);
  }
...
pm_err_flag_type
pm_schg_misc_irq_set_trigger(uint32 bus_id, uint32 pmic_index, pm_schg_misc_irq_type irq, pm_irq_trigger_type trigger)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 1 << irq;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, int_set_type, mask, set_type);
    err_flag |= pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, int_polarity_high, mask, polarity_high);
    err_flag |= pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, int_polarity_low, mask, polarity_low);
  }
...
pm_err_flag_type
pm_schg_misc_irq_status(uint32 bus_id, uint32 pmic_index, pm_schg_misc_irq_type irq, pm_irq_status_type type, boolean *status)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_mask_ex(bus_id, SLAVE_ID, int_sts, mask, &data);
...
pm_err_flag_type
pm_schg_misc_get_sysok_reason(uint32 bus_id, uint32 pmic_index, pm_schg_misc_sysok_reason_type *sysok_reason)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_ex(bus_id, SLAVE_ID, sysok_reason_status, &data);

    *sysok_reason = (pm_schg_misc_sysok_reason_type)(data & 0x07);
  }
...
pm_err_flag_type
pm_schg_misc_get_misc_wdog_status(uint32 bus_id, uint32 device_index, pm_schg_misc_wdog_status *misc_wdog_sts)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, device_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_read_byte_ex(bus_id, SLAVE_ID, misc_wdog_sts_reg, &data);
...
pm_err_flag_type
pm_schg_misc_en_afp(uint32 bus_id, uint32 pmic_index)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = PM_BIT(0);
  boolean enable = TRUE;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, afp_mode, mask, (pm_register_data_type)enable);
  }
...
pm_err_flag_type
pm_schg_misc_bark_bite_wdog_pet(uint32 bus_id, uint32 pmic_index)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  uint8 mask = PM_BIT(0);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, wdog_pet, mask, 0x01);
  }
...
pm_err_flag_type
pm_schg_misc_config_wdog(uint32 bus_id, uint32 pmic_index, pm_schg_misc_wdog_cfg_type misc_wd_cfg)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    data = (misc_wd_cfg.watchdog_trigger_afp_en << 0x7) | (misc_wd_cfg.bark_wdog_int_en << 0x6) | (misc_wd_cfg.bite_wdog_int_en << 5) |
           (misc_wd_cfg.wdog_timer_en_on_plugin << 1) | (misc_wd_cfg.wdog_timer_en << 0);
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, wd_cfg_reg, 0xE3, data);
  }
...
/*This API configures the charger watchdog */
pm_err_flag_type
pm_schg_misc_get_config_wdog(uint32 bus_id, uint32 pmic_index, pm_schg_misc_wdog_cfg_type *misc_wd_cfg)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  {
    pm_register_address_type wd_cfg_reg = ADDRESS(wd_cfg);
    err_flag = pm_comm_read_byte_mask_ex(bus_id, SLAVE_ID, wd_cfg_reg, 0xE3, &data);
...
pm_err_flag_type
pm_schg_misc_set_snarl_bark_bite_wd_cfg(uint32 bus_id, uint32 pmic_index, pm_schg_misc_sbb_wd_cfg misc_wd_sbb_cfg)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    data = ((misc_wd_sbb_cfg.bite_wdog_disable_charging_cfg << 0x7) |
            (misc_wd_sbb_cfg.snarl_wdog_timeout << 0x4) |
            (misc_wd_sbb_cfg.bark_wdog_timeout << 2) |
            (misc_wd_sbb_cfg.bite_wdog_timeout));
    err_flag = pm_comm_write_byte_ex(bus_id, SLAVE_ID, wd_sbb_cfg_reg, data);
  }
...
pm_err_flag_type
pm_schg_misc_get_snarl_bark_bite_wd_cfg(uint32 bus_id, uint32 pmic_index, pm_schg_misc_sbb_wd_cfg *misc_wd_sbb_cfg)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_register_data_type data = 0;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  {
    pm_register_address_type wd_sbb_cfg_reg = ADDRESS(snarl_bark_bite_wd_cfg);
    err_flag = pm_comm_read_byte_ex(bus_id, SLAVE_ID, wd_sbb_cfg_reg, &data);
...
pm_err_flag_type
pm_schg_misc_set_aicl_rerun_time_cfg(uint32 bus_id, uint32 pmic_index, pm_schg_misc_aicl_rerun_time_cfg aicl_rerun_time)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, pmic_index);
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, aicl_cfg_reg, 0x03, aicl_rerun_time);
  }
...
pm_err_flag_type
pm_schg_misc_set_thermreg_src_cfg(uint32 bus_id, uint32 device_index, pm_schg_misc_therm_src_cfg_type src_cfg_type, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 1 << src_cfg_type;
  pm_register_data_type data = (enable? 0x1 : 0x0) << src_cfg_type;
  ...
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, misc_therm_src_cfg, mask, data);
  }
...
pm_err_flag_type
pm_schg_misc_set_die_temp_thresholds(uint32 bus_id, uint32 device_index, int32 hot_threshold, int32 too_hot_threshold)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 0xFF;
  ...
  else
  {
    ...
    err_flag |= pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, die_temp_h_msb, mask, (uint8)((hot_threshold & 0xFF00) >> 8));

    pm_register_address_type die_temp_h_lsb = ADDRESS(die_temp_h_lsb);
    err_flag |= pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, die_temp_h_lsb, mask, (uint8)(hot_threshold & 0xFF));

    pm_register_address_type die_temp_l_msb = ADDRESS(die_temp_l_msb);
    err_flag |= pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, die_temp_l_msb, mask, (uint8)((too_hot_threshold & 0xFF00) >> 8));

    pm_register_address_type die_temp_l_lsb = ADDRESS(die_temp_l_lsb);
    err_flag |= pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, die_temp_l_lsb, mask, (uint8)(too_hot_threshold & 0xFF));
  }
...
pm_err_flag_type
pm_schg_misc_aicl_cmd(uint32 bus_id, uint32 device_index, pm_schg_misc_aicl_cmd_type cmd)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, device_index);
  ...
  else if(PM_SCHG_MISC_AICL_CMD_INVALID <= cmd)
  {
    err_flag = PM_ERR_FLAG_INVALID_PARAMETER;
  }
  else
  {
    ...
    err_flag = pm_comm_write_byte_mask_ex(bus_id, SLAVE_ID, aicl_cmd_reg, data, mask);
  }
...
pm_err_flag_type
pm_schg_misc_set_eng_sdcdc_cfg39(uint32 bus_id, uint32 device_index, uint8 reg_val)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  pm_schg_data_type *schg_ptr = pm_schg_get_data(bus_id, device_index);
  pm_register_data_type data = (pm_register_data_type)reg_val;
  ...
  {
    pm_register_address_type eng_sdcdc_cfg39_reg = ADDRESS(eng_sdcdc_cfg39);
    err_flag = pm_comm_write_byte_ex(bus_id, SLAVE_ID, eng_sdcdc_cfg39_reg, data);
  }
