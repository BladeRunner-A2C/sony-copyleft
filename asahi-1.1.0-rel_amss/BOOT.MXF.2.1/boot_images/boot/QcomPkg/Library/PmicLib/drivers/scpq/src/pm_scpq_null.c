...
pm_err_flag_type pm_scpq_typec_set_dam_icl(uint32 pmic_index, pm_scpq_usb_typec_dam_icl_sel icl_sel)
{
  return PM_ERR_FLAG_SUCCESS;
}

pm_err_flag_type pm_scpq_misc_set_vin_adc_mux_sel(uint32 pmic_index, pm_scpq_misc_vin_div16_mux_sel_type vin_mux_sel)
{
  return PM_ERR_FLAG_SUCCESS;
}
