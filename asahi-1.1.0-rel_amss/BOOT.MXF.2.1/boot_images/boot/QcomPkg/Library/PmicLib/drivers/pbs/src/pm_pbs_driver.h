...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/drivers/pbs/src/pm_pbs_driver.h#1 $
$Author: cirrusp4svc $
...
pm_pbs_data_type* pm_pbs_get_data(uint32 bus_id, uint32 pmic_index);
 ...
 *
 * @param[in]  bus_id: 0 for primary spmi bus, 1 for secondary spmi bus
