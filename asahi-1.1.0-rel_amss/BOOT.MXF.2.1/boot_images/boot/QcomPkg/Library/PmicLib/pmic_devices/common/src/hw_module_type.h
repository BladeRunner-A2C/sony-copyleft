...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/pmic_devices/common/src/hw_module_type.h#1 $
$Author: cirrusp4svc $
$DateTime: 2024/04/02 23:00:31 $
when       who     what, where, why
--------   ---     ------------------------------------------------
11/20/17     aab     Updated ldo and FTS types
...
typedef enum
{
    ...
    PM_HW_MODULE_VDDGEN = 40,
    PM_HW_MODULE_BOB = 41,
    PM_HW_MODULE_OLEDB = 44,
    PM_HW_MODULE_LCDB = 45,
    PM_HW_MODULE_SDAM = 46,
    PM_HW_MODULE_CHARGER_2S = 48,
    PM_HW_MODULE_HAPTICS_BOOST = 49,
...
typedef enum
{
    ...
    PM_HW_MODULE_PON_AON_LPI = 6,
    PM_HW_MODULE_PON_GEN2_NO_XVDD_RB = 7,
    PM_HW_MODULE_PON_PBS_GEN3 = 8,
    PM_HW_MODULE_PON_HLOS_GEN3 = 9,
...
typedef enum
{
    ...
    PM_HW_MODULE_CHARGER_BSI = 16,
    PM_HW_MODULE_CHARGER_BSI_MIPI_BIF = 17,
    PM_HW_MODULE_CHARGER_VDDGEN_COINCELL = 18,
    ...
    PM_HW_MODULE_CHARGER_SCPQ_P_CHGR2 = 0x7F,
    PM_HW_MODULE_CHARGER_SCPQ_P_CHGR = 0x80,
    PM_HW_MODULE_CHARGER_SCPQ_P_DCDC = 0x81,
    PM_HW_MODULE_CHARGER_SCPQ_P_BATIF = 0x82,
    PM_HW_MODULE_CHARGER_SCPQ_P_USB = 0x83,
    PM_HW_MODULE_CHARGER_SCPQ_P_WLS = 0x84,
    PM_HW_MODULE_CHARGER_SCPQ_P_TYPEC = 0x85,
    PM_HW_MODULE_CHARGER_SCPQ_P_MISC = 0x86,
    PM_HW_MODULE_CHARGER_SCPQ_P_CHGR2_V2 = 0xA8,
    PM_HW_MODULE_CHARGER_SCPQ_P_CHGR_V2 = 0xA9,
    PM_HW_MODULE_CHARGER_SCPQ_P_DCDC_V2 = 0xAA,
    PM_HW_MODULE_CHARGER_SCPQ_P_BATIF_V2 = 0xAB,
    PM_HW_MODULE_CHARGER_SCPQ_P_USB_V2 = 0xAC,
    PM_HW_MODULE_CHARGER_SCPQ_P_WLS_V2 = 0xAD,
    PM_HW_MODULE_CHARGER_SCPQ_P_TYPEC_V2 = 0xAE,
    PM_HW_MODULE_CHARGER_SCPQ_P_MISC_V2 = 0xAF,
    PM_HW_MODULE_CHARGER_SCPQ_HS_CHGR = 0x89,
    PM_HW_MODULE_CHARGER_SCPQ_HS_DCDC = 0x8A,
    PM_HW_MODULE_CHARGER_SCPQ_HS_BATIF = 0x8B,
    PM_HW_MODULE_CHARGER_SCPQ_HS_USB = 0x8C,
    PM_HW_MODULE_CHARGER_SCPQ_HS_TYPEC = 0x8D,
    PM_HW_MODULE_CHARGER_SCPQ_HS_MISC = 0x8E,
	PM_HW_MODULE_CHARGER_SCPQ_HC_CHGR = 0xB0,
    PM_HW_MODULE_CHARGER_SCPQ_HC_DCDC = 0xB1,
    PM_HW_MODULE_CHARGER_SCPQ_HC_BATIF = 0xB2,
    PM_HW_MODULE_CHARGER_SCPQ_HC_USB = 0xB3,
    PM_HW_MODULE_CHARGER_SCPQ_HC_TYPEC = 0xB4,
    PM_HW_MODULE_CHARGER_SCPQ_HC_MISC = 0xB5,
    PM_HW_MODULE_CHARGER_INVALID
}pm_hw_module_charger_subtype;

typedef enum
{
    PM_HW_MODULE_CHARGER_2S_Reserved    = 0,
    PM_HW_MODULE_CHARGER_2S_SCHG_CHGR   = 1,
    PM_HW_MODULE_CHARGER_2S_SCHG_DCDC   = 2,
    PM_HW_MODULE_CHARGER_2S_SCHG_BATIF  = 3,
    PM_HW_MODULE_CHARGER_2S_SCHG_USB    = 5,
    PM_HW_MODULE_CHARGER_2S_SCHG_TYPE_C = 6,
    PM_HW_MODULE_CHARGER_2S_SCHG_MISC   = 7,
    PM_HW_MODULE_CHARGER_2S_INVALID
}pm_hw_module_charger_2s_subtype;


typedef enum
{
    PM_HW_MODULE_FG_Reserved = 0,
    PM_HW_MODULE_QBG_MAIN = 5,
    PM_HW_MODULE_QBG_IRQ = 6,
...
typedef enum
{
    ...
    PM_HW_MODULE_LDO_510_N300_100      = 106,
    PM_HW_MODULE_LDO_510_N600_100      = 107,
    PM_HW_MODULE_LDO_510_N1200_100     = 108,
    ...
    PM_HW_MODULE_LDO_510_LV_P600_100   = 115,
    ...
    PM_HW_MODULE_LDO_510_MV_P600_500   = 125,
    PM_HW_MODULE_LDO_510_MV_P300_VIB   = 126,
    PM_HW_MODULE_LDO_510_N1200_100_FT  = 127,
    PM_HW_MODULE_LDO_512_N300_100      = 128, 
    PM_HW_MODULE_LDO_512_N600_100      = 129,
    PM_HW_MODULE_LDO_512_N1200_100     = 130, 
    PM_HW_MODULE_LDO_512_N300_160      = 131, 
    PM_HW_MODULE_LDO_512_N600_160      = 132,
    PM_HW_MODULE_LDO_512_N1200_160     = 133,
    PM_HW_MODULE_LDO_512_LV_P50_100    = 134,
    PM_HW_MODULE_LDO_512_LV_P150_100   = 135,
    PM_HW_MODULE_LDO_512_LV_P300_100   = 136,
    PM_HW_MODULE_LDO_512_LV_P600_100   = 137,
    PM_HW_MODULE_LDO_512_LV_P1200_100  = 138,
    PM_HW_MODULE_LDO_512_LV_P50_160    = 139,
    PM_HW_MODULE_LDO_512_LV_P150_160   = 140,
    PM_HW_MODULE_LDO_512_LV_P300_160   = 141,
    PM_HW_MODULE_LDO_512_LV_P600_160   = 142,
    PM_HW_MODULE_LDO_512_LV_P1200_160  = 143,
    PM_HW_MODULE_LDO_512_MV_P50_500    = 144,
    PM_HW_MODULE_LDO_512_MV_P150_500   = 145,
    PM_HW_MODULE_LDO_512_MV_P300_500   = 146,
    PM_HW_MODULE_LDO_512_MV_P600_500   = 147,
    PM_HW_MODULE_LDO_515_LV_N300_100   = 171,
    PM_HW_MODULE_LDO_515_LV_N600_100   = 172,
    PM_HW_MODULE_LDO_515_LV_N1200_100  = 173,
    PM_HW_MODULE_LDO_515_LV_N2000_100  = 174,
    PM_HW_MODULE_LDO_515_LV_N300_160   = 175,
    PM_HW_MODULE_LDO_515_LV_N600_160   = 176,
    PM_HW_MODULE_LDO_515_LV_N1200_160  = 177,
    PM_HW_MODULE_LDO_515_LV_N2000_160  = 178,
    PM_HW_MODULE_LDO_515_MV_P600_500   = 179,
...
typedef enum
{
    ...
    PM_HW_MODULE_CLOCK_XO_CORE_76P8MHZ = 4,
	...
	PM_HW_MODULE_CLOCK_TCXO_CAL = 17,
...
typedef enum
{
    ...
    PM_HW_MODULE_GPIO_GPIOLV_VIN2 = 18,
    PM_HW_MODULE_GPIO_GPIOMV_VIN3 = 19,
...
typedef enum
{
    ...
    PM_HW_MODULE_FTS__FTS520_CTL = 14,
    PM_HW_MODULE_FTS__FTS525_CLX = 16,
    PM_HW_MODULE_FTS__FTS525_CTL = 17,
    PM_HW_MODULE_FTS__FTS526_CTL = 20,
    PM_HW_MODULE_FTS__FTS526_CLX = 21,
...
typedef enum
{
    ...
    PM_HW_MODULE_LPG_LUT  = 16,
    PM_HW_MODULE_LPG_CHAN = 17,
    PM_HW_MODULE_LPG_PWM_REV_B = 11,
    PM_HW_MODULE_LPG_PWM_REV_C = 12,
...
typedef enum
{
    ...
    PM_HW_MODULE_HAPTICS_CFG      = 0xA,
    PM_HW_MODULE_HAPTICS_PATTERN  = 0xB,
	PM_HW_MODULE_VIB_VIB          = 0x7E,
}pm_hw_module_haptics_subtype;

typedef enum
{
    PM_HW_MODULE_LAB_Reserved = 0,
    PM_HW_MODULE_SUBTYPE_LAB  = 0x1,
    PM_HW_MODULE_SUBTYPE_AB  = 0x5,
}pm_hw_module_lab_subtype;
...
typedef enum
{
    ...
    PM_HW_MODULE_BOB_CONFIG_PERIPH_SUBTYPE = 7,
    PM_HW_MODULE_BOB_MONITORING_PERIPH = 8,
    PM_HW_MODULE_BOB_INVALID,
}pm_hw_module_bob_subtype;

typedef enum
{
    PM_HW_MODULE_INTERFACE_EUSB_REPEATER = 0xE,
}pm_hw_module_interface_subtype;
