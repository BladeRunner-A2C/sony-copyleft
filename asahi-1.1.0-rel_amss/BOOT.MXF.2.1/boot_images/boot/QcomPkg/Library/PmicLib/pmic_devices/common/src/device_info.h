...
*   \n
*   \n &copy; Copyright 2010-2017,2021 QUALCOMM Technologies Incorporated, All Rights Reserved
*/
/*===================================================================
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/pmic_devices/common/src/device_info.h#1 $
$Author: cirrusp4svc $
...
/** 
 * @name pm_get_num_of_sid_supported_ex 
 *  
 * @brief This function is called to get max supported slave ids of the 
 *        PMIC device. Each PMIC device has 2 slave ids. 
 * 
 * @param[in]  bus_id 
 * @param[in]  pmic_index
 *
