...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/framework/src/pm_sbl_smem.c#1 $
$Author: cirrusp4svc $
...
static pm_err_flag_type pm_pon_reasons_store_smem (void) 
{
  ...
  pon_peripheral_info.base_address = PON_PBS_BASE;
