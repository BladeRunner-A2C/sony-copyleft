...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/framework/inc/pm_device.h#1 $
$Author: cirrusp4svc $
 ...
 *
 */
pm_err_flag_type pm_spmi_dynamic_chnl_init(boolean init_hw);
 ...
 * @name pm_spmi_ac_cfg 
 *  
 * @brief This function enforces access control policy on RGs
 *
 *
 * @return  pm_err_flag_type 
 *
