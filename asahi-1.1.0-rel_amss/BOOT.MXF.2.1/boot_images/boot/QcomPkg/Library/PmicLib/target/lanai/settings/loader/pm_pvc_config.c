...
#define APPS2_PORT      2   /* APPS Port 2  */
#define MGPI_PVC_PORT   5   /* MGPI PVC Port 5*/
...
{
  {0x4, 0xAA40}, /* S6E_CTRL_VSET_LB */
  {0x4, 0xAA41}, /* S6E_CTRL_VSET_UB */
  {0x4, 0xAA45}, /* S6E_CTRL_MODE_CTL */
  {0x4, 0xAA46}  /* S6E_CTRL_EN_CTL */
};
...
{
  {0x4, 0x9B40}, /* S1E_CTRL_VSET_LB */
  {0x4, 0x9B41}, /* S1E_CTRL_VSET_UB */
  {0x4, 0x9B45}, /* S1E_CTRL_MODE_CTL */
  {0x4, 0x9B46}  /* S1E_CTRL_EN_CTL */
};
 ...
 * pm_pvc_apps2_addr
 *
 * PVC port addr for APPS2 Silver cluster block.
 */
SpmiCfg_Ppid pm_pvc_apps2_addr[] =
{
  {0x4, 0xA440}, /* S4E_CTRL_VSET_LB */
  {0x4, 0xA441}, /* S4E_CTRL_VSET_UB */
  {0x4, 0xA445}, /* S4E_CTRL_MODE_CTL */
  {0x4, 0xA446}  /* S4E_CTRL_EN_CTL */
};

const SpmiCfg_PvcPortCfg pm_pvc_apps2_cfg = {APPS2_PORT, SPMI_ACCESS_PRIORITY_LOW, pm_pvc_apps2_addr, sizeof(pm_pvc_apps2_addr)/sizeof(SpmiCfg_Ppid)};
 ...
 */
const SpmiCfg_PvcPortCfg* pm_arb_pvc_port_cfg[] = {&pm_pvc_apps0_cfg, &pm_pvc_apps1_cfg, &pm_pvc_apps2_cfg, &pm_pvc_mgpi_cfg};
...
const SpmiBusCfg_VioctlCfg pm_vioctl_cfg2 =
{
   0,                    /**< SPMI BUS ID*/
   6,                    /**< VIOCTL port ID*/
   0x01,                 /**< Self clear enable*/
...
const SpmiBusCfg_VioctlCfg* pm_vioctl_cfg[] = {&pm_vioctl_cfg0, &pm_vioctl_cfg1, &pm_vioctl_cfg2};
...
{
  PM_ADD_PROP_CONFIG( PM_PROP_PVC_PORT_CFG, pm_arb_pvc_port_cfg),
  PM_ADD_PROP_CONFIG( PM_PROP_MGPI_PORT_CFG, pm_mgpi_port_cfg),
  PM_ADD_PROP_CONFIG( PM_PROP_PVC_PORT_CFG_SIZE, pm_arb_pvc_port_cfg_size),
  PM_ADD_PROP_CONFIG( PM_PROP_MGPI_PORT_CFG_SIZE, pm_mgpi_port_cfg_size),
  PM_ADD_PROP_CONFIG( PM_PROP_VIOCTL_CFG, pm_vioctl_cfg),
  PM_ADD_PROP_CONFIG( PM_PROP_VIOCTL_CFG_SIZE, pm_vioctl_cfg_size),
};
