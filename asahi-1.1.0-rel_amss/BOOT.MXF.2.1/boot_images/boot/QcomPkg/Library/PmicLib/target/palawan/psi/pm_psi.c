...
$Header: //components/dev/core.boot/6.1/syejare.core.boot.6.1.palawan_adding_3101/QcomPkg/Library/PmicLib/target/lanai/psi/pm_psi.c#1 $ 
$DateTime: 2023/01/30 21:02:31 $  $Author: syejare $
...
struct pm_sbl_config_buffer {
	...
	pm_pbs_ram_data_type      pm_pbs_seq_e[PM_PBS_RAM_E_SIZE+1];
...
struct pm_sbl_config_buffer pm_sbl_config_data = {
	...
	.pm_pbs_seq_e = PM_PBS_RAM_E_DATA,
...
pm_pbs_ram_data_type* pm_pbs_seq[] = {
	...
	pm_sbl_config_data.pm_pbs_seq_e,
};
