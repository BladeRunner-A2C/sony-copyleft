...
const pm_prm_vreg_data_type
pm_pam_disp_prim_amoled_g_ldo2 [] =
{
     /*     mode    voltage(mV)  enable*/
    { PM_PRM_VREG_MODE_LPM, 0, PM_PRM_DEV_DISABLE },  // GENERIC_OFF
    { PM_PRM_VREG_MODE_LPM, 1700, PM_PRM_DEV_ENABLE },  // GENERIC_STANDBY
    { PM_PRM_VREG_MODE_NPM, 1700, PM_PRM_DEV_ENABLE }  // GENERIC_ACTIVE
};
#endif /* FEATURE_XBOOT */
...
pm_pam_disp_prim_amoled_rails_info [] = 
{
    ...
    { (void*)pm_pam_disp_prim_amoled_g_ldo2, PM_PRM_RSRC_VRM_VREG },
#endif /* FEATURE_XBOOT */
}; 
...
pm_pam_deps_disp_prim_amoled [] =
{
    ...
    PM_PRM_CLIENT_VREG_DEP ( g,  ldo, 2 ),
#endif /* FEATURE_XBOOT */
};
...
pm_prm_device_rsrc_data [] =
{
    ...
    PM_PRM_DEV_RSRC_VREG ( g, ldo, 2, PM_PRM_RSRC_LDO,  PM_PRM_RPMH, PM_LDO_2),
#endif /* FEATURE_XBOOT */
};
