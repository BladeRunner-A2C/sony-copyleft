...
{
  {0x3, 0x9B40}, /* S1D_CTRL_VSET_LB */
  {0x3, 0x9B41}, /* S1D_CTRL_VSET_UB */
  {0x3, 0x9B45}, /* S1D_CTRL_MODE_CTL */
  {0x3, 0x9B46}  /* S1D_CTRL_EN_CTL */
};
...
{
  {0x3, 0x9E40}, /* S2D_CTRL_VSET_LB */
  {0x3, 0x9E41}, /* S2D_CTRL_VSET_UB */
  {0x3, 0x9E45}, /* S2D_CTRL_MODE_CTL */
  {0x3, 0x9E46}  /* S2D_CTRL_EN_CTL */
};
...
{
  {0x1, 0xD546}, /* MGPI0, UICC1, 21B */
  {0x0, 0x5A49}, /* MGPI1, NFC, LN_CLK7 */
  {0x0, 0x0},    /* MGPI2, Spare */
  {0x0, 0x0},    /* MGPI3, Spare MGPI, used by WLAN to be configured by MGPI module */
  {0x1, 0xCD46}, /* MGPI4, SD card, 13B*/
  {0x1, 0xD446}, /* MGPI5, UICC0, L20B */
  {0x2, 0xC244}, /* MGPI6, AOP PDC TRIGGER, L2C */
