...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/PmicLib/prm/src/pm_prm_device_update.c#1 $
                          ...
                          pm_prm_vreg_data_type *pam_data)
{
  ...
  switch(rsrc_data->rsrc_key)
  {
    ...
    default:
      PM_LOG_MSG_ERR_FATAL("Invalid RSRC Key provided for %a", 
