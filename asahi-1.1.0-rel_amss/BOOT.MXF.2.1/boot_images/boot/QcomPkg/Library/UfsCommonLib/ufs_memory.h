...
/*=============================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/UfsCommonLib/ufs_memory.h#1 $
...
#define UFS_IDN_bAvailableWriteBoosterBufferSize  0x1d
#define UFS_IDN_dCurrentWriteBoosterBufferSize    0x1f
 ...
 *
 * Input:  hufs - Pointer to the UFS handle structure
 * Input:  AvailBufferSize - Pointer to the write booster available buffer size                      
 * Return: EOK for success, EIO if IO error is encountered
 * */
 ...
 *
 * Input:  hufs - Pointer to the UFS handle structure
 * Input:  CurBufferSize - Pointer to the write booster current buffer size 
 * Return: EOK for success, EIO if IO error is encountered
 * */
...
/*
 * Finish UFS reinit (NOP, fDeviceInit, request sense, gear switch)
 *
 * Input:  hufs - Pointer to the UFS handle structure
 * Return: EOK for success, error otherwise
 * */
...
/*
 * Dump the UFS registers when requested by client.
 *
 * Input:  hufs - Pointer to the UFS handle structure
 *         reg_mask - Types of registers to dump
 * Return: EOK for success, error otherwise
 * */
