...
typedef enum
{
  ...
  DSI_DISPLAY_PROPERTYID_SPLITLINK_BROADCAST,           /**< Enable DCS command broadcast mode for Split Link panel */
...
typedef struct
{
  ...
  DSI_LaneMapType           eDisplayLane[DSI_LaneMap_MAX];   /**<Lane mapping from core to phy                          */
...
typedef struct
{
  ...
  DSI_VdcmCmdModeConfigType     sVDCMCmdConfig;         /**< VDCM compression configuration*/
...
typedef struct
{
  ...
  DSI_VdcmVideoModeConfigType   sVDCMVideoConfig;       /**< VDCM compression configuration        */
}DSI_VideoConfigType;
...
typedef union
{
  ...
  bool32                   bSplitLinkCmdBroadcast;    /**< DSI_DISPLAY_PROPERTYID_SPLITLINK_BROADCAST   */
