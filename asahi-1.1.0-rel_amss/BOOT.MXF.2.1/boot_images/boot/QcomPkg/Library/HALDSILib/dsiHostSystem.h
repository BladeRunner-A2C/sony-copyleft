...
/*
 * addr: start address to be flushed
 * size: size of memory to be flushed
 */
#define DSI_OSAL_MB_Ex(addr, size)                                        MDP_OSAL_MB_Ex(addr, size)
...
/* -----------------------------------------------------------------------
**
** FUNCTION: dsiSystem_GetDSIVersion()
**
** DESCRIPTION:
**   Get DSI controller version
**
** INPUT:
**   hDevice          - DSI device handle
**   pDSIVersionInfo  - DSI controller version
**
** OUTPUT
**   pDSIVersionInfo  - DSI controller version
**
