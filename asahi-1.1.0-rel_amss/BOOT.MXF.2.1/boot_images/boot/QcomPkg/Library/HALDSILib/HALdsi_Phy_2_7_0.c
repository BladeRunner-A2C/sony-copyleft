...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhyDisable()
*/
/*!
* \brief
*     Disables DSI Phy.
...
*
****************************************************************************/
void HAL_DSI_2_7_0_PhyDisable(DSI_Device_IDType   eDeviceId)
{
  uintPtr uOffset = HAL_DSI_GetRegBaseOffset(eDeviceId);
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhyPllEnable()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_DSI_2_7_0_PhyPllEnable(DSI_Device_IDType eDeviceId, bool32 bEnable)
{
  uintPtr uOffset = HAL_DSI_GetRegBaseOffset(eDeviceId);
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhyPllPowerCtrl()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhyPllPowerCtrl(DSI_Device_IDType   eDeviceId,
                                                 bool32              bPllPowerUp)
{
  HAL_MDSS_ErrorType   eStatus     = HAL_MDSS_STATUS_SUCCESS;
  /*
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhySetup()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhySetup(DSI_Device_IDType          eDeviceId,
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhyPllSetup()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhyPllSetup(HAL_DSI_PhyConfigType       *psDsiPhyConfig,
                                             HAL_DSI_PhyConfigInfoType   *psDsiPhyConfigInfo)
{
  HAL_MDSS_ErrorType        eStatus           = HAL_MDSS_STATUS_SUCCESS;
  ...
  else
  {
    ...
    if (TRUE == sPhySettings.bCPhyMode)
    {
      /* dsi_cmn_init start */
      ...
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_PEMPH_CTRL_0_ADDR,             0x00000011);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_PEMPH_CTRL_1_ADDR,             0x00000001);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_TOP_CTRL_ADDR,  0x00000000);
    ...
    else
    {
      ...
      if (sPhySettings.uDesiredBitClkFreq <= 1500000000)
      {
        uVRegCtrl0      = 0x44;
      ...
      /* VREG_CTRL_0P2 */
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_1_ADDR,                   0x00000019);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_3_ADDR,                        0x00000000);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_STR_SWI_CAL_SEL_CTRL_ADDR,     0x00000000);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_HSTX_STR_CTRL_0_ADDR,          0x00000088);
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhySetupTimingParams()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhySetupTimingParams(HAL_DSI_TimingSettingType *pTimingParameters)
{
  HAL_MDSS_ErrorType           eStatus             = HAL_MDSS_STATUS_SUCCESS;
  HAL_DSI_PHY_TimingConfigType sTimingConfig;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhyPllReConfigure()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhyPllReConfigure(HAL_DSI_PhyConfigType       *psDsiPhyConfig,
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhyPllInitialize()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_DSI_2_7_0_PhyPllInitialize(void)
{
  ...
  {
    HAL_DSI_2_7_0_PhyPllPowerCtrl((DSI_Device_IDType)uControllerIndex, TRUE);
  }
}

/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhySetProperty()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhySetProperty(DSI_Device_IDType              eDeviceId,
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhyGetProperty
*/
/*!
* \brief
...
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhyGetProperty(DSI_Device_IDType              eDeviceId,
                                                HAL_DSI_PhyPropertyType        eProperty,
                                                HAL_DSI_PhyPropertyParamsType *pPropertyData)
{
  HAL_MDSS_ErrorType eStatus = HAL_MDSS_STATUS_SUCCESS;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_7_0_PhyGetPllCodes
*/
/*!
* \brief
*   Get PLL codes
...
*                             
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_7_0_PhyGetPllCodes(DSI_Device_IDType               eDeviceId,
...
HAL_DSI_PhyFunctionTable HAL_DSI_FunctionTable(2, 7, 0) = {
  HAL_DSI_2_7_0_PhyPllInitialize,
  HAL_DSI_2_7_0_PhyDisable,
  HAL_DSI_2_7_0_PhyPllEnable,
  HAL_DSI_2_7_0_PhyPllPowerCtrl,
  HAL_DSI_2_7_0_PhySetup,
  HAL_DSI_2_7_0_PhyPllSetup,
  HAL_DSI_2_7_0_PhySetupTimingParams,
  HAL_DSI_2_7_0_PhyPllReConfigure,
  HAL_DSI_2_7_0_PhySetProperty,
  HAL_DSI_2_7_0_PhyGetProperty,
  HAL_DSI_2_7_0_PhyGetPllCodes,
};
