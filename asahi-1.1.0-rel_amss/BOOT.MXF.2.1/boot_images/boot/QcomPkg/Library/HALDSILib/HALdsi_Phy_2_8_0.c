...
#define HAL_DSI_PHY_T_HS_RQST_MAX                   0xFF
...
#define HAL_DSI_PHY_T_CLK_PRE_PARAM5                2.5f
...
#define HAL_DSI_PHY_T_CLK_POST_PARAM6               1.0f
#define HAL_DSI_PHY_T_CLK_POST_PARAM7               8.0f
#define HAL_DSI_PHY_T_CLK_POST_PARAM8               2.5f
#define HAL_DSI_PHY_T_CLK_POST_MAX                  0xFF

/* D-Phy Range Factors */
#define HAL_DSI_DPHY_RANGEFACTOR_0P05               0.05f
#define HAL_DSI_DPHY_RANGEFACTOR_1                  1.0f
#define HAL_DSI_DPHY_RANGEFACTOR_4                  4.0f
#define HAL_DSI_DPHY_RANGEFACTOR_5                  5.0f
#define HAL_DSI_DPHY_RANGEFACTOR_30                 30.0f
...
#define HAL_DSI_PLL_CLOCK_INVERTORS_FREQ_LEVEL_2    3500
...
#define HAL_DSI_PLL_SSC_ADJ_PER                     0             /* Reference cycles per SSC step */
...
#define HAL_DSI_PLL_PLL_FAST_PWRUP                  0
...
#define HAL_DSI_LANE_TX_DCTRL_2                     0x46           /* TX Dctrl for Lane 3 */
...
#define HAL_DSI_CPHY_RANGEFACTOR_0P05               0.05f
#define HAL_DSI_CPHY_RANGEFACTOR_1                  1.0f
#define HAL_DSI_CPHY_RANGEFACTOR_10                 10.0f
#define HAL_DSI_CPHY_RANGEFACTOR_20                 20.0f
#define HAL_DSI_CPHY_RANGEFACTOR_50                 50.0f
#define HAL_DSI_CPHY_RANGEFACTOR_80                 80.0f

/* Access macro for asMargingParam */
#define MDP_GET_TIMINGMARGINPARAM(_timingmargin_)    ((_timingmargin_ < HAL_DSI_PHY_TIMING_MAX)? &asMargingParam[_timingmargin_] : NULL)
...
typedef struct _HAL_DSI_PHY_PhySettingsType
{
  ...
  bool32                       bCPhyMode;
  uint32                       uDesiredBitClkFreq;
  bool32                       bSplitLink;
  bool32                       bEnableLP11AtInit;
  uint32                       uLaneMask;
...
/*!
 * \struct HAL_RangeFactorMarginParamType
 *
 * DSI PHY timing margin parameters.
 */
typedef struct _HAL_RangeFactorMarginParamType
{
  float fRangeFacotr_TclkPrepare;
  float fRangeFacotr_THsPrepare;
  float fRangeFacotr_TNomax;
  float fRangeFacotr_Trail;
  float fRangeFacotr_THsZero;
  float fRangeFacotr_TClkPre;
  float fRangeFacotr_TClkPost;
  float fRangeFacotr_TClkZero;
  float fRangeFacotr_InitDeskew;
  float fRangeFacotr_PeriodicDeskew;
} HAL_RangeFactorMarginParamType;
...
static HAL_RangeFactorMarginParamType asMargingParam[HAL_DSI_PHY_TIMING_MAX] = {
  /*TclkPrepare THsPrepare TNomax Trail  THsZero TClkPre TClkPost TClkZero InitDeskew PeriodicDeskew; */
    {50.0f,     50.0f,     5.0f,  10.0f, 10.0f,  0.5f,   0.5f,    2.0f,    5.0f,      5.0f }, /* HAL_DSI_PHY_TIMING_REDUCED_MARGIN */
    {50.0f,     50.0f,     10.0f, 30.0f, 10.0f,  1.25f,  5.0f,    2.0f,    5.0f,      5.0f }, /* HAL_DSI_PHY_TIMING_REGULAR_MARGIN */
};

/****************************************************************************
*
** FUNCTION: HAL_DSI_Phy_Get_CMN_DSILaneCtrl0Val()
*/
/*!
* \brief
*     calculates the DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0 register value, based on which lanes have to be enabled.
*
*
* \param [in]  pSettings - Phy settings;
*
* \retval  Register value ;
*
****************************************************************************/
static uint32 HAL_DSI_Phy_Get_CMN_DSILaneCtrl0Val(HAL_DSI_PHY_PhySettingsType  *pSettings)
{
  uint32 uRegVal = 0;

  uRegVal = HWIO_OUT_FLD(uRegVal, DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0 , DLN0_EN,  ((pSettings->uLaneMask & (1 << DSI_LaneMap_0)) ? 1 : 0));
  uRegVal = HWIO_OUT_FLD(uRegVal, DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0 , DLN1_EN,  ((pSettings->uLaneMask & (1 << DSI_LaneMap_1)) ? 1 : 0));
  uRegVal = HWIO_OUT_FLD(uRegVal, DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0 , DLN2_EN,  ((pSettings->uLaneMask & (1 << DSI_LaneMap_2)) ? 1 : 0));
  uRegVal = HWIO_OUT_FLD(uRegVal, DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0 , DLN3_EN,  ((pSettings->uLaneMask & (1 << DSI_LaneMap_3)) ? 1 : 0));
  uRegVal = HWIO_OUT_FLD(uRegVal, DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0 , CLKLN_EN, 1);
...
static uintPtr HAL_DSI_Phy_GetLaneOffset(DSI_LaneIDType eLaneId)
{
  ...
  uLaneBlockOffset[DSI_LaneID_CLKSL]  = HWIO_DSI_0_PHY_DSIPHY_CKLNSL_CFG0_ADDR - HWIO_DSI_0_PHY_DSIPHY_DLN0_CFG0_ADDR;
...
static uint32 HAL_DSI_Phy_GetTxDctrl(DSI_LaneIDType eLaneId)
{
  ...
  else
  {
    const uint8 uTxDctrlTable[DSI_LaneID_Max] =
    {
      ...
      HAL_DSI_LANE_TX_DCTRL_3  //DSI_LaneID_CLKSL, CLK lane for split link using the same setting as CLK lane.
    };
...
static void HAL_DSI_Phy_PllBiasEnable(DSI_Device_IDType eDeviceId, bool32 bEnable)
{
  ...
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PERF_OPTIMIZE_ADDR, 0x00000022);
}
...
static void HAL_DSI_Phy_PllGlobalClockEnable(DSI_Device_IDType eDeviceId, bool32 bEnable)
{
  ...
  uClkCfg = HWIO_OUT_FLD(uClkCfg, DSI_0_PHY_DSIPHY_CMN_CLK_CFG1, CLK_EN_SEL, uClkEnable);
...
static void HAL_DSI_Phy_TriggerSleepB(DSI_Device_IDType eDeviceId, bool32 bTrigger)
{
  ...
  uint32             uCmnCtrl4   = in_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_4_ADDR);
  
  uCmnCtrl = HWIO_OUT_FLD(uCmnCtrl, DSI_0_PHY_DSIPHY_CMN_CTRL_3, SLEEP_B, bTrigger);

  /* SLEEP_B */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_3_ADDR, uCmnCtrl);

  /* HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_4_ADDR to be programmed to 0x04 for SM7250*/
  uCmnCtrl4 = HWIO_OUT_FLD(uCmnCtrl, DSI_0_PHY_DSIPHY_CMN_CTRL_4, DCTRL_GLBL_2, 0x04);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_4_ADDR, uCmnCtrl4); 
}
...
static void HAL_DSI_Phy_PllSetSource(HAL_DSI_PhyConfigType       *psDsiPhyConfig )
{
  ...
  {
    uClkCfg = HWIO_OUT_FLD(uClkCfg, DSI_0_PHY_DSIPHY_CMN_CLK_CFG1, DSICLK_SEL, psDsiPhyConfig->eDsiClkSel);
  }
...
static HAL_MDSS_ErrorType HAL_DSI_Phy_WaitForRefgen(DSI_Device_IDType eDeviceId)
{
  ...
  /* Set Refgen Request */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_DIGTOP_SPARE10_ADDR, 0x00000001);
                                ...
                                HAL_DSI_PHY_PhySettingsType  *pSettings)
{
  ...
  /* Deassert sleep_b */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_3_ADDR, 0x00000000);
  
  /* Power up DIGTOP & PLL */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_0_ADDR, 0x00000020);
  ...
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_4_ADDR,    0x4);

  if (pSettings->bEnableLP11AtInit)
  {
    if (TRUE == pSettings->bCPhyMode)
    {
      ...
      uRegVal = HAL_DSI_Phy_Get_CMN_DSILaneCtrl0Val(pSettings);

      /* Lane selection */
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0_ADDR, uRegVal);
    }
    else
    {
      if (TRUE == pSettings->bSplitLink)
      {
        /* power up all lanes */
        out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_0_ADDR,         0x000000FF);
        out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0_ADDR, 0x0000003F);
      }
      else
      {
        /* power up all lanes */
...
static void HAL_DSI_Phy_ResyncFIFO(DSI_Device_IDType eDeviceId)
{
  ...
  /* Resync FIFO*/
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_RBUF_CTRL_ADDR, 0x00000000);
                                                            ...
                                                            HAL_DSI_PHY_TimingConfigType *psTimingConfig)
{
  ...
  HAL_RangeFactorMarginParamType  *psMarginParam         = MDP_GET_TIMINGMARGINPARAM(pTimingParameters->eTimingMargin);
  
  if ((NULL == pPreDefinedTimings) ||
      (NULL == psMarginParam))
  {
  ...
  else
  {
    ...
    uint32                 uT_hs_trail;
    uint32                 uT_hs_rqst;
    uint32                 uT_hs_rqstClk;
    uint32                 uHalfByteClkEn;
    uint32                 uHalfByteClkEnClk;
    uint32                 uT_hs_exit;
    uint32                 uT_ta_go;
    uint32                 uT_ta_sure;
    uint32                 uT_ta_get;
    ...
    uHalfByteClkEn    = (120000000 > pTimingParameters->uBitclock) ? 1 : 0;
    uHalfByteClkEnClk = (9000000   > pTimingParameters->uBitclock) ? 1 : 0;
    
    /**********************************************************************************
        DSIPHY 4.0.0 DPHY timing
    **********************************************************************************/
    ...
    else
    {
      ...
      iVal = HAL_DSI_Phy_Roundup(((fMax - fMin) * psMarginParam->fRangeFacotr_TclkPrepare / HAL_DSI_PHY_PERCENT_DENOMENATOR) + fMin);
    ...
    {
      float fTClkZeroMargin;

      if ((HAL_DSI_PHY_TIMING_REDUCED_MARGIN == pTimingParameters->eTimingMargin) &&
          (pTimingParameters->uBitclock      >= 1500000000))
      {
        fTClkZeroMargin = HAL_DSI_DPHY_RANGEFACTOR_4;
      }
      else
      {
        fTClkZeroMargin = psMarginParam->fRangeFacotr_TClkZero;
      }
      ...
      iVal = HAL_DSI_Phy_Roundup(((iMax - iMin) * fTClkZeroMargin / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iMin);
    ...
    else
    {
      ...
      if ((HAL_DSI_PHY_TIMING_REDUCED_MARGIN == pTimingParameters->eTimingMargin) &&
          (pTimingParameters->uBitclock      >= 1000000000))
      {
        fTrailMargin = HAL_DSI_DPHY_RANGEFACTOR_30;
      }
      else
      {
        fTrailMargin = psMarginParam->fRangeFacotr_Trail;
      }
      ...
      iVal         = HAL_DSI_Phy_Roundup(((iMax - iMin) * fTrailMargin / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iMin);
    ...
    else
    {
      ...
      iVal = HAL_DSI_Phy_Roundup(((iMax - iMin) * psMarginParam->fRangeFacotr_THsPrepare / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iMin);
    ...
    {
      float fTHsZeroMargin;

      if ((HAL_DSI_PHY_TIMING_REDUCED_MARGIN == pTimingParameters->eTimingMargin) &&
          (pTimingParameters->uRefreshRate   >= 0x780000))
      {
        fTHsZeroMargin = HAL_DSI_DPHY_RANGEFACTOR_5;
      }
      else
      {
        fTHsZeroMargin = psMarginParam->fRangeFacotr_THsZero;
      }
      ...
      iVal = HAL_DSI_Phy_Roundup(((iMax - iMin) * fTHsZeroMargin / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iMin);
    ...
    if (pPreDefinedTimings->bTimingHSRequestOverride)
    {
      ...
      uT_hs_rqstClk = pPreDefinedTimings->uTimingHSRequestValue;
    }
    else
    {
      float fHsRqstMargin = (pTimingParameters->uBitclock >= 500000000) ? HAL_DSI_DPHY_RANGEFACTOR_1 : HAL_DSI_DPHY_RANGEFACTOR_0P05;
      ...
      iVal          = HAL_DSI_Phy_CheckNegative(iVal);
      iVal          = HAL_DSI_Phy_Roundup((HAL_DSI_PHY_T_HS_RQST_MAX - iVal) * (fHsRqstMargin / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iVal);
      uT_hs_rqst    = HAL_DSI_Phy_CheckNegative(iVal);

      fVal          = (HAL_DSI_PHY_T_HS_RQST_PARAM1 / fUiBitclk) + (HAL_DSI_PHY_T_HS_RQST_PARAM2 * uHalfByteClkEnClk);
      iVal          = HAL_DSI_Phy_Roundup((fVal - HAL_DSI_PHY_T_HS_RQST_PARAM3) / HAL_DSI_PHY_T_HS_RQST_PARAM3);
      iVal          = HAL_DSI_Phy_CheckNegative(iVal);
      iVal          = HAL_DSI_Phy_Roundup((HAL_DSI_PHY_T_HS_RQST_MAX - iVal) * (fHsRqstMargin / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iVal);
      uT_hs_rqstClk = HAL_DSI_Phy_CheckNegative(iVal);
      uT_hs_rqst    = MAX(uT_hs_rqst, uT_hs_rqstClk);
    }
    ...
    else
    {
      ...
      iVal       = HAL_DSI_Phy_Roundup(((iMax - iMin) * psMarginParam->fRangeFacotr_TNomax / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iMin);
    ...
    else
    {
      ...
      fVal        = (fMin + (uT_clk_trail + HAL_DSI_PHY_T_CLK_POST_PARAM6) *
                     HAL_DSI_PHY_T_CLK_POST_PARAM7 * fUiBitclk + HAL_DSI_PHY_T_CLK_POST_PARAM8 * fUiBitclk) / 
                    (HAL_DSI_PHY_T_CLK_POST_PARAM4 * fUiBitclk);
      iMin        = HAL_DSI_Phy_Roundup(fVal) - HAL_DSI_PHY_T_CLK_POST_PARAM5;
      iMax        = HAL_DSI_PHY_T_CLK_POST_MAX;
      iVal        = HAL_DSI_Phy_Roundup((iMax - iMin) * (psMarginParam->fRangeFacotr_TClkPost / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iMin);
    ...
    else
    {
      ...
      fVal       = (fMin + (uT_hs_rqstClk + HAL_DSI_PHY_T_CLK_PRE_PARAM4 + uT_clk_prepare + uT_clk_zero + HAL_DSI_PHY_T_CLK_PRE_PARAM4) * 
                    HAL_DSI_PHY_T_CLK_PRE_PARAM1 * fUiBitclk - HAL_DSI_PHY_T_CLK_PRE_PARAM5 * fUiBitclk);
      ...
      fVal       = (iMax - iMin) * (psMarginParam->fRangeFacotr_TClkPre / HAL_DSI_PHY_PERCENT_DENOMENATOR) + iMin;
      iVal       = HAL_DSI_Phy_Roundup(fVal);
      ...
      {
        uT_clk_pre = HAL_DSI_Phy_Roundup(iVal / 2);
                                                                 ...
                                                                 HAL_DSI_PHY_TimingConfigType *psTimingConfig)
{
  ...
  else
  {
     ...
     {
       fVal  = 300 - HAL_DSI_CPHY_T3_PREPARE_MIN - HAL_DSI_CPHY_T3_PREBEGIN_CNT_MIN * fUiBitclk;
       fVal1 = HAL_DSI_CPHY_T3_PREBEGIN_CNT_MAX * fUiBitclk;
       fVal  = (fVal < fVal1) ? fVal : fVal1;
       ...
       iMax -= 1;
       fMax = (float)HAL_DSI_Phy_CheckNegative(iMax);
       iVal = HAL_DSI_Phy_Roundup((fMax - fMin) * (HAL_DSI_CPHY_RANGEFACTOR_20 / HAL_DSI_PHY_PERCENT_DENOMENATOR) + fMin);
     ...
     else
     {
       ...
       iMax -= 1;
       fMax = (float)HAL_DSI_Phy_CheckNegative(iMax);
       iVal = HAL_DSI_Phy_Roundup((fMax - fMin) * (HAL_DSI_CPHY_RANGEFACTOR_80 / HAL_DSI_PHY_PERCENT_DENOMENATOR) + fMin);
     ...
     {
      float fHsRqstMargin = (pTimingParameters->uBitclock >= 500000000) ? HAL_DSI_CPHY_RANGEFACTOR_1 : HAL_DSI_CPHY_RANGEFACTOR_0P05;
       ...
       fMax       = (float)HAL_DSI_Phy_CheckNegative(iMax);
       iVal       = HAL_DSI_Phy_Roundup((fMax - fMin) * (fHsRqstMargin / HAL_DSI_PHY_PERCENT_DENOMENATOR) + fMin);
       uT_hs_rqst = HAL_DSI_Phy_CheckNegative(iVal);
     }
...
static void HAL_DSI_Phy_CommitTimingParams(DSI_Device_IDType eDeviceId, HAL_DSI_PHY_TimingConfigType *pTimingConfig)
{
  ...
  /* T_CLK_PRE */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_TIMING_CTRL_12_ADDR,                pTimingConfig->uT_CLK_PRE);
  /* T_CLK_POST */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_TIMING_CTRL_13_ADDR,                pTimingConfig->uT_CLK_POST);  
...
static void HAL_DSI_Phy_CommitTimingParams_CPhy(DSI_Device_IDType eDeviceId, HAL_DSI_PHY_TimingConfigType *pTimingConfig)
{
  ...
  /* VREG_CTRL */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_0_ADDR, 0x00000045);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_1_ADDR, 0x00000041);
...
static HAL_MDSS_ErrorType HAL_DSI_Phy_SetupLanePhy(DSI_Device_IDType eDeviceId, DSI_LaneIDType eLaneId, HAL_DSI_PHY_LaneConfigType *pConfig)
{
  ...
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_DLN0_CFG0_ADDR,       0x00000000);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_DLN0_CFG1_ADDR,       0x00000000);
  ...
  if (DSI_LaneID_0 == eLaneId)
  {
    out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_DLN0_CFG2_ADDR, 0);
  }
  else
  {
...
static HAL_MDSS_ErrorType HAL_DSI_Phy_SetupLanePhy_CPhy(DSI_Device_IDType eDeviceId, DSI_LaneIDType eLaneId, HAL_DSI_PHY_LaneConfigType *pConfig)
{
  ...
  {
    /* DLN3_TX_DCTRL */
    out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_DLN0_TX_DCTRL_ADDR, 0x00000006);
  }
  else
  {
    if (DSI_LaneID_0 == eLaneId)
    ...
    /* DSIPHY_LPRX_DLY */
    out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_DLN0_CFG2_ADDR,      0x0000000A);

    out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_DLN0_TX_DCTRL_ADDR,  0x00000040);
  }
  return eStatus;
}
                                  ...
                                  HAL_DSI_PHY_PllConfigType   *pPllConfig)
{
  ...
  else
  {
    ...
    if (0 == uSSCConfig)
    {
      ...
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_CONTROL_ADDR, uRegVal);
    }
    else
    {
      /* SSC Div PER */
      uRegVal = pPllConfig->uSSCPER & HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_DIV_PER_LOW_1_RMSK;
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_DIV_PER_LOW_1_ADDR, uRegVal);

      uRegVal = (pPllConfig->uSSCPER >> 8) & HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_DIV_PER_HIGH_1_RMSK;
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_DIV_PER_HIGH_1_ADDR, uRegVal);

      /* SSC Step Size */
      uRegVal = pPllConfig->uSSCStepSize & HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_STEPSIZE_LOW_1_RMSK;
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_STEPSIZE_LOW_1_ADDR, uRegVal);

      uRegVal = (pPllConfig->uSSCStepSize >> 8) & HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_STEPSIZE_HIGH_1_RMSK;
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_STEPSIZE_HIGH_1_ADDR, uRegVal);

      /* SSC Adj PER */
      uRegVal = pPllConfig->uSSCAdjPER & HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_ADJPER_LOW_1_RMSK;
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_ADJPER_LOW_1_ADDR, uRegVal);

      uRegVal = (pPllConfig->uSSCAdjPER >> 8) & HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_ADJPER_HIGH_1_RMSK;
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_ADJPER_HIGH_1_ADDR, uRegVal);

      /* SSC Control */
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SSC_CONTROL_ADDR, uSSCConfig);
    }
  }
                                  ...
                                  HAL_DSI_PHY_PllConfigType   *pPllConfig)
{
  ...
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_CORE_INPUT_OVERRIDE_ADDR, 0x10);  /* pll enable + core reset */
  ...
  uRegVal = HWIO_OUT_FLD(uRegVal, DSI_0_PHY_DSIPHY_PLL_PLL_OUTDIV_RATE,  PLL_OUTDIV_2, uPllPostDiv);
  ...
  uVCOConfig          = (pPllConfig->fActualFreqMHz > 1557) ? 0x00 : 0x08;
  ...
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_ANALOG_CONTROLS_FIVE_1_ADDR, uAnalogControlsFive);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_ANALOG_CONTROLS_FIVE_ADDR, uAnalogControlsFive);

  /* VCO Config */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_VCO_CONFIG_1_ADDR, uVCOConfig);

  /* Clock inverters */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_CLOCK_INVERTERS_1_ADDR, uClockInverters);

  /* cmode */
  if(pPllConfig->bCPhyMode)
  {
     /* dsiclk_sel == 3, clk90_level_shifter is required */
     out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_CMODE_1_ADDR,                      0x00000000);
  }
  else
  {
     /* Disable clk90_level_shifter for DPhy */
     out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_CMODE_1_ADDR,                      0x00000010);
  }

  /* Frequency independent registers */
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_LOCK_MIN_DELAY_ADDR,           0x00000000);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_RST_CONTROLS_ADDR,             0x00000011);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_FASTLOCK_CONTROL_ADDR,             0x0000003F);
  ...
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_DIGITAL_TIMERS_TWO_ADDR,       0x00000008);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_PROP_GAIN_RATE_1_ADDR,         0x0000000A);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_BAND_SEL_RATE_1_ADDR,          0x000000C0);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_INT_GAIN_IFILT_BAND_1_ADDR,    0x00000084);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PLL_INT_GAIN_IFILT_BAND_1_ADDR,    0x00000082);
  ...
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_PFILT_ADDR,                        0x0000002F);
  out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_IFILT_ADDR,                        0x0000002A);
  ...
  {
    out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_ANALOG_CONTROLS_THREE_ADDR,    0x0000008B);
    out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_SYSTEM_MUXES_ADDR,             0x000000e0);
    out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_PLL_CALIBRATION_SETTINGS_ADDR,     0x00000044);
  }
}
...
static void HAL_DSI_Phy_ResetPhy(DSI_Device_IDType eDeviceId)
{
  ...
  /* Reset phy to clear out the lanes, pll */
...
*
****************************************************************************/
static HAL_MDSS_ErrorType HAL_DSI_Phy_LaneConfig(DSI_Device_IDType           eDeviceID,
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_Phy_LaneConfig_CPhy()
*/
/*!
* \brief
*     Configure the Lane Map for CPhy
*
* \param [in]  eDeviceId     - DSI core ID
* \param [in]  paDisplayLane - pointer to lane map array
*
...
*
****************************************************************************/
static HAL_MDSS_ErrorType HAL_DSI_Phy_LaneConfig_CPhy(DSI_Device_IDType           eDeviceID,
                                                      HAL_DSI_LanePropertyType   *psLaneProperty)
{
  HAL_MDSS_ErrorType  eStatus    = HAL_MDSS_STATUS_SUCCESS;
  uint32              uLaneCtrl1 = 0;
...
*
****************************************************************************/
static HAL_MDSS_ErrorType HAL_DSI_PhyGetLaneStatus(DSI_Device_IDType   eDeviceID,
                                                   uint32             *puDsiStatus)
{
  HAL_MDSS_ErrorType  eStatus      = HAL_MDSS_STATUS_SUCCESS;
  uintPtr             uOffset      = HAL_DSI_GetRegBaseOffset(eDeviceID);
...
*
****************************************************************************/
static uint32  HAL_DSI_Phy_DsiClk_Divider(HAL_DSI_PhyConfigType       *psDsiPhyConfig,
                                          HAL_DSI_PhyConfigInfoType   *psDsiPhyConfigInfo)
{
  ...
  HAL_DSI_PhyClkSelType eDsiClkSel   = psDsiPhyConfig->eDsiClkSel;
  uint32                bpp          = psDsiPhyConfig->uBitsPerPixel / 8;
  uint32                uNumerator   = uM_Val * bpp ;
  uint32                uDenominator = uN_Val * bpp;
  float                 fVal;
  uint32                uDivCtrl;

  if (psDsiPhyConfig->bCPhyMode) /* C-phy */
  {
    /* Div ctrl is Post Multiplexer divider to derive the pclk and it varies on panel type i.e CPhy or Dphy*/
    if (HAL_DSI_PHY_CLK_SEL_3 == eDsiClkSel)
    {
      uNumerator   *= psDsiPhyConfig->uPhyPostDiv;
      uDenominator *= 8;
    }
    else if (HAL_DSI_PHY_CLK_SEL_2 == eDsiClkSel)
    {
      uNumerator   *= ( 7 * psDsiPhyConfig->uPhyPostDiv);
      uDenominator *= 16;

    }
    else if (HAL_DSI_PHY_CLK_SEL_0 == eDsiClkSel)
    {
      uNumerator   *= 7;
      uDenominator *= 16;

    }
    fVal = (float)uNumerator / (float)uDenominator;
  ...
  {
    fVal = (float)(uM_Val * psDsiPhyConfig->uBitsPerPixel) / (float)(uN_Val);

    if (HAL_DSI_PHY_CLK_SEL_1 == eDsiClkSel)
    {
      fVal /= 2.0f;
    }

    fVal = fVal /(float)psDsiPhyConfig->uNumOfDataLanes;
...
*
****************************************************************************/
static void  HAL_DSI_Phy_DsiClk_Sel(HAL_DSI_PhyConfigType       *psDsiPhyConfig, 
                                    HAL_DSI_PhyConfigInfoType   *psDsiPhyConfigInfo)
{     
  HAL_DSI_PhyClkSelType eDsiClkSel = HAL_DSI_PHY_CLK_SEL_0;

  /* Dsi CLk select is a pclk Multiplexer Select value, based on the dsi clk select value dviders will be changed and pclk will be calculated */

  if (psDsiPhyConfig->bCPhyMode) /* C-phy */
  {
    if ((psDsiPhyConfig->uBitsPerPixel == 24) ||
        ((psDsiPhyConfig->uBitsPerPixel == 16) &&
         (psDsiPhyConfig->uNumOfDataLanes == 2)) ||
        ((psDsiPhyConfig->uBitsPerPixel == 30) && 
         (psDsiPhyConfig->uNumOfDataLanes == 1)))
    {
      /* For 24bpp or (16bpp & 2 Lanes) or (30 Bbpp 1 Lane) CPhy 1 trio source frequency is source select 3 mean source frequency is =  (vco *  pllpost div /3.5) */
      eDsiClkSel = HAL_DSI_PHY_CLK_SEL_3;         
    }
    else if ((psDsiPhyConfig->uBitsPerPixel == 3) &&
             (psDsiPhyConfig->uNumOfDataLanes >= 2))
    {
      /* For (3bpp & morethan or equal to 2 Lanes)  CPhy 1 trio source frequency is source select 2 mean source frequency is =  (vco *  pllpost div) */
      eDsiClkSel = HAL_DSI_PHY_CLK_SEL_2;         
    }
    else
    {
      /* For (30bpp & more than 1 Lane) and other combinations as such,  CPhy 1 trio source frequency is source select 0 mean source frequency is =  (vco * phy post div * pllpost div)  */
      eDsiClkSel = HAL_DSI_PHY_CLK_SEL_0;         
    }
  }
  else   /* D-Phy */
  {
    if (((psDsiPhyConfig->uBitsPerPixel == 30) &&
         ((psDsiPhyConfig->uNumOfDataLanes == 2) ||
         (psDsiPhyConfig->uNumOfDataLanes == 4))) ||
         ((psDsiPhyConfig->uBitsPerPixel == 3) &&
          (psDsiPhyConfig->uNumOfDataLanes >= 3)))
    {
      /* For (30bpp and (2 Lanes or 4 lanes)) or (3 Bpp and if more than or equal to 3 lanes)  DPhy 1 trio source frequency is source select 0 mean source frequency is =  (vco * phy post div * pllpost div)  */
      eDsiClkSel = HAL_DSI_PHY_CLK_SEL_0;           
    }
    else
    {
      /* For other combinations of bpp and no of lanes DPhy 1 trio source frequency is source select 1 mean source frequency is =  (vco * phy post div * pllpost div / 2)  */
      eDsiClkSel = HAL_DSI_PHY_CLK_SEL_1;           
    }
  }

  psDsiPhyConfig->eDsiClkSel = eDsiClkSel;
}
...
*
****************************************************************************/
static void  HAL_DSI_Phy_MND_Divider(HAL_DSI_PhyConfigType       *psDsiPhyConfig, 
                                     HAL_DSI_PhyConfigInfoType   *psDsiPhyConfigInfo)
{     
  uint32    uM_Val              = 1;
  uint32    uN_Val              = 1;
...
*
****************************************************************************/
static float  HAL_DSI_Phy_CalcClockDivider(HAL_DSI_PhyConfigType       *psDsiPhyConfig, 
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhyDisable()
*/
/*!
* \brief
*     Disables DSI Phy.
...
*
****************************************************************************/
void HAL_DSI_2_8_0_PhyDisable(DSI_Device_IDType   eDeviceId)
{
  uintPtr uOffset = HAL_DSI_GetRegBaseOffset(eDeviceId);
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhyPllEnable()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_DSI_2_8_0_PhyPllEnable(DSI_Device_IDType eDeviceId, bool32 bEnable)
{
  uintPtr uOffset = HAL_DSI_GetRegBaseOffset(eDeviceId);
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhyPllPowerCtrl()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_8_0_PhyPllPowerCtrl(DSI_Device_IDType   eDeviceId,
                                                 bool32              bPllPowerUp)
{
  HAL_MDSS_ErrorType   eStatus     = HAL_MDSS_STATUS_SUCCESS;
  /*
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhySetup()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_8_0_PhySetup(DSI_Device_IDType          eDeviceId,
                                          HAL_DSI_PhyConfigType     *psDsiPhyConfig)
{
  ...
  sPhySettings.bSplitLink         = (0 != (psDsiPhyConfig->uConfigFlags & HAL_DSI_PHY_CONFIGFLAG_SPLITLINK))? TRUE : FALSE;
  sPhySettings.bEnableLP11AtInit  = psDsiPhyConfig->bEnableLP11AtInit;
  sPhySettings.uLaneMask          = psDsiPhyConfig->uLaneMask;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhyPllSetup()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_8_0_PhyPllSetup(HAL_DSI_PhyConfigType       *psDsiPhyConfig,
                                             HAL_DSI_PhyConfigInfoType   *psDsiPhyConfigInfo)
{
  HAL_MDSS_ErrorType        eStatus           = HAL_MDSS_STATUS_SUCCESS;
  ...
  else
  {
    ...
    sPhySettings.bCPhyMode          = psDsiPhyConfig->bCPhyMode;
    sPhySettings.uDesiredBitClkFreq = psDsiPhyConfig->uDesiredBitClkFreq;
    sPhySettings.bSplitLink         = (0 != (psDsiPhyConfig->uConfigFlags & HAL_DSI_PHY_CONFIGFLAG_SPLITLINK))? TRUE : FALSE;
    sPhySettings.uLaneMask        = psDsiPhyConfig->uLaneMask;

    DSI_OSAL_MemZero(&sPllConfig,  sizeof(HAL_DSI_PHY_PllConfigType));

    if (TRUE == psDsiPhyConfig->bCPhyMode)
    {
      uint32 uStrSwiCalSelCtrl = 0;
      uint32 uRescodeTopCtrl   = 0;
      uint32 uCtrl2            = 0;
      uint32 uPemphCtrl0       = 0;
      uint32 uPemphCtrl1       = 0;

      if (psDsiPhyConfig->uDesiredBitClkFreq <= 1500000000)
      {
        uStrSwiCalSelCtrl = 0;
        uRescodeTopCtrl   = 0x3d;
        uCtrl2            = 0;
        uPemphCtrl0       = 0;
        uPemphCtrl1       = 0;
      }
      ...
      {
        uStrSwiCalSelCtrl = 0x02;
        uRescodeTopCtrl   = 0x01;
        uCtrl2            = 0x64;
        uPemphCtrl0       = 0x22;
        uPemphCtrl1       = 0x02;
      }

      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_STR_SWI_CAL_SEL_CTRL_ADDR,     uStrSwiCalSelCtrl);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_2_ADDR,                        uCtrl2);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_PEMPH_CTRL_0_ADDR,             uPemphCtrl0);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_PEMPH_CTRL_1_ADDR,             uPemphCtrl1);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_TOP_CTRL_ADDR,  uRescodeTopCtrl);
      ...
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_1_ADDR,                   0x00000041);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_3_ADDR,                        0x00000000);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_HSTX_STR_CTRL_0_ADDR,          0x00000088);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_MID_CTRL_ADDR,  0x00000000);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_BOT_CTRL_ADDR,  0x00000000);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_LPTX_STR_CTRL_ADDR,            0x00000055);
      ...
      uRegVal = HAL_DSI_Phy_Get_CMN_DSILaneCtrl0Val(&sPhySettings);

      /* Lane selection */
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0_ADDR, uRegVal);

      /* dsi_lane_init */
      HAL_DSI_Phy_SetupLanePhy_CPhy(eDeviceId, DSI_LaneID_0,   &sPhySettings.sLaneConfig);
      HAL_DSI_Phy_SetupLanePhy_CPhy(eDeviceId, DSI_LaneID_1,   &sPhySettings.sLaneConfig);
      HAL_DSI_Phy_SetupLanePhy_CPhy(eDeviceId, DSI_LaneID_2,   &sPhySettings.sLaneConfig);
      HAL_DSI_Phy_SetupLanePhy_CPhy(eDeviceId, DSI_LaneID_3,   &sPhySettings.sLaneConfig);
    }
    else
    {
      uint32 uRescodeTopCtrl = 0;
      uint32 uRescodeBotCtrl = 0;
      uint32 uVRegCtrl0      = 0;
      ...
      if (psDsiPhyConfig->uDesiredBitClkFreq <= 1500000000)
      {
        uVRegCtrl0      = 0x44;
        uRescodeTopCtrl = 0x3D;
        uRescodeBotCtrl = 0x38;
      }
      else
      {
        uVRegCtrl0      = 0x44;
        uRescodeTopCtrl = 0x01;
        uRescodeBotCtrl = 0x39;
      }

      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_VREG_CTRL_0_ADDR,                   uVRegCtrl0);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_TOP_CTRL_ADDR,  uRescodeTopCtrl);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_RESCODE_OFFSET_BOT_CTRL_ADDR,  uRescodeBotCtrl);

      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_3_ADDR,                        0x00000000);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_STR_SWI_CAL_SEL_CTRL_ADDR,     0x00000000);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_HSTX_STR_CTRL_0_ADDR,          0x00000088);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_PEMPH_CTRL_0_ADDR,             0x00000000);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_LPTX_STR_CTRL_ADDR,            0x00000055);

      /* dsi_cmn_init end */

      if (TRUE == sPhySettings.bSplitLink)
      {
        uint32 uRegVal = in_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_CTRL_ADDR);

        uRegVal        = HWIO_OUT_FLD(uRegVal, DSI_0_PHY_DSIPHY_CMN_GLBL_CTRL, SPLIT_LINK_ENABLE, 1);
        out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_GLBL_CTRL_ADDR, uRegVal);

        /* Remove PLL, DIG and all lanes from pwrdn */
        out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CTRL_0_ADDR,             0x000000FF);
        out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_DSI_LANE_CTRL0_ADDR,     0x0000003F);
        out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_SL_DSI_LANE_CTRL1_ADDR,  0x03);
      }
      else
      {
        /* Remove PLL, DIG and all lanes from pwrdn */
      ...
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CLK_CFG0_ADDR,       0x00000001);
      out_dword(uOffset + HWIO_DSI_0_PHY_DSIPHY_CMN_CLK_CFG0_ADDR,       0x00000001);

      /* dsi_lane_init */
      HAL_DSI_Phy_SetupLanePhy(eDeviceId, DSI_LaneID_0,     &sPhySettings.sLaneConfig);
      HAL_DSI_Phy_SetupLanePhy(eDeviceId, DSI_LaneID_1,     &sPhySettings.sLaneConfig);
      HAL_DSI_Phy_SetupLanePhy(eDeviceId, DSI_LaneID_2,     &sPhySettings.sLaneConfig);
      HAL_DSI_Phy_SetupLanePhy(eDeviceId, DSI_LaneID_3,     &sPhySettings.sLaneConfig);
      HAL_DSI_Phy_SetupLanePhy(eDeviceId, DSI_LaneID_CLK,   &sPhySettings.sLaneConfig);
      if (sPhySettings.bSplitLink)
      {
        HAL_DSI_Phy_SetupLanePhy(eDeviceId, DSI_LaneID_CLKSL, &sPhySettings.sLaneConfig);
      }
    }
    ...
    else
    {
      ...
      else
      {
        ...
        /* Fast Power Up */
        sPllConfig.uFastPwrUp = HAL_DSI_PLL_PLL_FAST_PWRUP;
        ...
        if (HAL_MDSS_STATUS_SUCCESS == eStatus)
        {
          ...
          if (HAL_MDSS_STATUS_SUCCESS != eStatus)
          {
            //Reset Phy if pll lock fails during dynamic refresh rates
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhySetupTimingParams()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_8_0_PhySetupTimingParams(HAL_DSI_TimingSettingType *pTimingParameters)
{
  HAL_MDSS_ErrorType           eStatus             = HAL_MDSS_STATUS_SUCCESS;
  HAL_DSI_PHY_TimingConfigType sTimingConfig;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhyPllReConfigure()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_8_0_PhyPllReConfigure(HAL_DSI_PhyConfigType       *psDsiPhyConfig,
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhyPllInitialize()
*/
/*!
* \brief
...
*
****************************************************************************/
void HAL_DSI_2_8_0_PhyPllInitialize(void)
{
  ...
  {
    HAL_DSI_2_8_0_PhyPllPowerCtrl((DSI_Device_IDType)uControllerIndex, TRUE);
  }
}

/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhySetProperty()
*/
/*!
* \brief
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_8_0_PhySetProperty(DSI_Device_IDType              eDeviceId,
                                                ...
                                                HAL_DSI_PhyPropertyParamsType *pPropertyData)
{
  ...
  switch (eProperty)
  {
    ...
    case HAL_DSI_PHY_PROPERTYID_LANECONFIG:
      if (TRUE == HAL_DSI_IsCPhyModeEnabled(eDeviceId))
      {
        eStatus = HAL_DSI_Phy_LaneConfig_CPhy(eDeviceId, &pPropertyData->sLaneConfig);
      }
      else
      {
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhyGetProperty
*/
/*!
* \brief
...
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_8_0_PhyGetProperty(DSI_Device_IDType              eDeviceId,
                                                HAL_DSI_PhyPropertyType        eProperty,
                                                HAL_DSI_PhyPropertyParamsType *pPropertyData)
{
  HAL_MDSS_ErrorType eStatus = HAL_MDSS_STATUS_SUCCESS;
...
/****************************************************************************
*
** FUNCTION: HAL_DSI_2_8_0_PhyGetPllCodes
*/
/*!
* \brief
*   Get PLL codes
...
*                             
****************************************************************************/
HAL_MDSS_ErrorType HAL_DSI_2_8_0_PhyGetPllCodes(DSI_Device_IDType               eDeviceId,
...
/* Init Phy Function Table */
HAL_DSI_PhyFunctionTable HAL_DSI_FunctionTable(2, 8, 0) = {
  HAL_DSI_2_8_0_PhyPllInitialize,
  HAL_DSI_2_8_0_PhyDisable,
  HAL_DSI_2_8_0_PhyPllEnable,
  HAL_DSI_2_8_0_PhyPllPowerCtrl,
  HAL_DSI_2_8_0_PhySetup,
  HAL_DSI_2_8_0_PhyPllSetup,
  HAL_DSI_2_8_0_PhySetupTimingParams,
  HAL_DSI_2_8_0_PhyPllReConfigure,
  HAL_DSI_2_8_0_PhySetProperty,
  HAL_DSI_2_8_0_PhyGetProperty,
  HAL_DSI_2_8_0_PhyGetPllCodes,
};
