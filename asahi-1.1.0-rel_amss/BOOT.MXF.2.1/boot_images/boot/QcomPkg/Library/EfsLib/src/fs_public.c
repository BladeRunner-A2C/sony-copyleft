 ...
 * Copyright (C) 2002-2021 QUALCOMM Technologies, Inc.
 *
...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Library/EfsLib/src/fs_public.c#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
...
efs_boot_init_romfs (void)
{
  ...
  {
    {"/", NULL, 0},
    {EFS_BOOT_MOUNT_POINT_NAME_1, NULL, 0},
    {EFS_BOOT_MOUNT_POINT_NAME_2, NULL, 0},
    {EFS_BOOT_MOUNT_POINT_NAME_3, NULL, 0},
    {EFS_BOOT_MOUNT_POINT_NAME_4, NULL, 0},
    {EFS_BOOT_MOUNT_POINT_NAME_5, NULL, 0},
    {EFS_BOOT_MOUNT_POINT_NAME_6, NULL, 0},
    {NULL, NULL, 0}
  };
