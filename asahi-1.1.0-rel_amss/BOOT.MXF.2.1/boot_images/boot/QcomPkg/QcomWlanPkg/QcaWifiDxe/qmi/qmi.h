...
#define QMI_ERR_AUTHENTICATION_FAILED_V01  0x22
...
struct qmi_ops {
	...
	void (*msg_handler)(struct qmi_handle *qmi,
...
struct qmi_handle {
	...
	list_entry_t lookups;
    list_entry_t lookup_results;
    list_entry_t services;
