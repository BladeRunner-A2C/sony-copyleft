...
struct mhi_controller {
	...
	list_entry_t transition_list;
	spinlock_t transition_lock;
	spinlock_t wlock;
	struct mhi_link_info mhi_link_info;

    list_entry_t mhi_dev_list;
...
#define BHI_DEFAULT_ALIGNMENT (0x4000)
#define BHI_MAX_IMAGE_SIZE    (0x40000)
...
/**
 * mhi_poll - Poll for any available data in event-ring
 * @mhi_dev: Device associated with the channels
...
/* debugging apis */
#define mhi_dbg pr_debug
#define mhi_err pr_err
#define mhi_warn pr_warn
#define mhi_verb pr_verb
