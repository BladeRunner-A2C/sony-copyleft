...
struct mhi_ctxt {
	...
	void*      er_ctxt_dma_mapping;
	dma_addr_t chan_ctxt_addr;
	void*      chan_ctxt_dma_mapping;
	dma_addr_t cmd_ctxt_addr;
	void*      cmd_ctxt_dma_mapping;
};
...
#define MHI_MSIVEC_INVALID 0xFFFFFFFF
...
struct mhi_event {
	...
	//struct tasklet_struct task; //switch tasklet to function pointer
	void (*task)(struct mhi_event *data);
	spinlock_t lock;
...
void mhi_memset_reg(struct mhi_controller *mhi_cntrl, void __iomem *base, u32 offset, u8 c, u32 size);
...
{
	void *buf = pci_dma_alloc_coherent(mhi_cntrl->cntrl_dev, size, dma_handle,
				       dma_mapping_addr);
...
static inline void mhi_free_coherent(struct mhi_controller *mhi_cntrl,
                     ...
                     void *dma_mapping_addr)
{
	pci_dma_free_coherent(mhi_cntrl->cntrl_dev, size, vaddr, 
        dma_handle, dma_mapping_addr);
}
...
#define MHI_RDDM_POLL_TIMEOUT   10000 /* ms */
