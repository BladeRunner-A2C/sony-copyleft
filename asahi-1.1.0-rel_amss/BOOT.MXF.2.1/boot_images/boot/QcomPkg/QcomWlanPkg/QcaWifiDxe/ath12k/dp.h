...
struct ath12k_mon_data {
	...
	list_entry_t dp_rx_mon_mpdu_list;
...
#define DP_RXDMA_BUF_PENDING_SIZE  1024
...
struct ath12k_dp {
	...
	list_entry_t reo_cmd_list;
	list_entry_t reo_cmd_cache_flush_list;
	...
	u32 num_spt_pages;
	list_entry_t rx_desc_free_list;
	list_entry_t rx_desc_used_list;
	/* protects the free and used desc list */
	spinlock_t rx_desc_lock;

	list_entry_t tx_desc_free_list[ATH12K_HW_MAX_QUEUES];
	list_entry_t tx_desc_used_list[ATH12K_HW_MAX_QUEUES];
...
#define HTT_USR_RATE_PREAMBLE(_val) \
		(u8)u32_get_bits(_val, HTT_PPDU_STATS_USER_RATE_FLAGS_PREAMBLE_M)
#define HTT_USR_RATE_BW(_val) \
		(u8)u32_get_bits(_val, HTT_PPDU_STATS_USER_RATE_FLAGS_BW_M)
#define HTT_USR_RATE_NSS(_val) \
		(u8)u32_get_bits(_val, HTT_PPDU_STATS_USER_RATE_FLAGS_NSS_M)
#define HTT_USR_RATE_MCS(_val) \
		(u8)u32_get_bits(_val, HTT_PPDU_STATS_USER_RATE_FLAGS_MCS_M)
#define HTT_USR_RATE_GI(_val) \
		(u8)u32_get_bits(_val, HTT_PPDU_STATS_USER_RATE_FLAGS_GI_M)
#define HTT_USR_RATE_DCM(_val) \
		(u8)u32_get_bits(_val, HTT_PPDU_STATS_USER_RATE_FLAGS_DCM_M)
