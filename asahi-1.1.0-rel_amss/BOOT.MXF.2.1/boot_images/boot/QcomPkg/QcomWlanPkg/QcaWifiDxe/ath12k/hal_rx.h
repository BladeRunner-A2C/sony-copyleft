...
#define HAL_RX_MPDU_INFO_PN_GET_BYTE1(__val) \
	(u8)le32_get_bits((__val), GENMASK(7, 0))

#define HAL_RX_MPDU_INFO_PN_GET_BYTE2(__val) \
	(u8)le32_get_bits((__val), GENMASK(15, 8))

#define HAL_RX_MPDU_INFO_PN_GET_BYTE3(__val) \
	(u8)le32_get_bits((__val), GENMASK(23, 16))

#define HAL_RX_MPDU_INFO_PN_GET_BYTE4(__val) \
	(u8)le32_get_bits((__val), GENMASK(31, 24))
...
static inline u8 ath12k_he_ru_tones_to_nl80211_he_ru_alloc(u16 ru_tones)
{
	u8 ret = 0;
