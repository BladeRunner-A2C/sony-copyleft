...
struct ath12k_hif_ops {
	...
	int (*dump)(struct ath12k_base *sc);
	int (*dump_sram)(struct ath12k_base *sc);
};
...
static inline int ath12k_hif_dump_target(struct ath12k_base *ab)
{
    return ab->hif.ops->dump(ab);
}

static inline int ath12k_hif_dump_sram(struct ath12k_base *ab)
{
