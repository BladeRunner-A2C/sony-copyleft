...
#define ATH12K_SRAM_DUP_FILE_NAME	L"sram.bin"
...
struct ath12k_hw_params {
	...
	u32 rddm_size;
	const struct ath12k_hw_sram_dump *sram_dump;
};
...
static inline
u8 ath12k_hw_get_mac_from_pdev_id(const struct ath12k_hw_params *hw,
				   int pdev_idx)
{
