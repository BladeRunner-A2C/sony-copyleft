...
#define CE_COUNT MIN(ab->hw_params.ce_count, MAX_CE_COUNT)
...
/* CE address/mask */
#define CE_HOST_IE_ADDRESS(ab)		((ab)->hw_params.regs->hal_ce_host_ie)
#define CE_HOST_IE_2_ADDRESS(ab)	((ab)->hw_params.regs->hal_ce_host_ie2)
...
struct ath11k_ce_pipe {
    ...
    struct sk_buff_pool rx_skb_pool;

	int (*send_cb)(struct ath11k_ce_pipe *);
	void (*recv_cb)(struct ath11k_base *, struct sk_buff *);
...
extern const struct ce_attr ath11k_host_ce_config_qca6x90[];
