...
#define HAL_CE0_SRC_REG_BASE(ab)	((ab)->hw_params.regs->hal_ce0_src_reg_base)
#define HAL_CE0_DST_REG_BASE(ab)	((ab)->hw_params.regs->hal_ce0_dst_reg_base)
#define HAL_CE1_SRC_REG_BASE(ab)	((ab)->hw_params.regs->hal_ce1_src_reg_base)
#define HAL_CE1_DST_REG_BASE(ab)	((ab)->hw_params.regs->hal_ce1_dst_reg_base)
...
#define HAL_WBM_IDLE_LINK_RING_MISC_ADDR(ab) \
	((ab)->hw_params.regs->hal_wbm_idle_link_ring_misc_addr)
...
struct ath11k_hal {
	...
	const struct hal_rx_ops *rx_ops;
};
