...
struct wmi_pdev_set_hw_mode_response_event {
    u32 pdev_id;
    u32 status;
    u32 cfgd_hw_mode_index;
    u32 num_vdev_mac_entries;
} __packed;
#pragma pack()
...
#define ATH11K_VDEV_DELETE_TIMEOUT_HZ (3 * HZ)
...
#define WLAN_SCAN_MAX_NUM_CHANNELS      128
...
struct mgmt_rx_event_params {
	...
	u32 channel;
	u32 snr;
	s8 rssi_ctl[WLAN_MGMT_TXRX_HOST_MAX_ANTENNA];
	u32 rate;
...
#pragma pack(1)
struct wmi_sar_limit_cmd_row{
	u32 tlv_header; /* TLV tag and len; tag equals WMITLV_TAG_STRUC_wmi_sar_limit_cmd_row */
	u32 band_id;
	u32 chain_id;
	u32 mod_id;
	union {
...
struct wmi_sar_limit_cmd_params {
	u32 sar_enable;
	u32 num_limit_rows;
	u32 commit_limits;
...
#if 0
size_t ath11k_wmi_fw_stats_num_peers(list_entry_t *head);
size_t ath11k_wmi_fw_stats_num_peers_extd(list_entry_t *head);
size_t ath11k_wmi_fw_stats_num_vdevs(list_entry_t *head);
