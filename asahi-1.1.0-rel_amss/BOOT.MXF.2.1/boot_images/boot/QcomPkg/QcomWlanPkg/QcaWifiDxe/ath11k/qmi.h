...
#define ATH11K_QMI_WLANFW_TIMEOUT_MS		5000 * 12
...
#define ATH11K_QMI_DEFAULT_CAL_FILE_NAME	L"caldata.bin"
...
#define ATH11K_QMI_WLFW_MM_DEFAULT_ALIGNMENT (0x10000UL)
...
enum ath11k_bdf_type {
	ATH11K_BDF_BIN = 1,
	ATH11K_BDF_REGDB = 4,
	ATH11K_BDF_MAX_FILE_TYPE,
};
...
struct target_mem_chunk {
	...
	u32 type;
	dma_addr_t paddr;
    dma_addr_t aligned_paddr;
	void *p_dma_mapping_addr;
	void *vaddr;
    void *aligned_vaddr;
};
