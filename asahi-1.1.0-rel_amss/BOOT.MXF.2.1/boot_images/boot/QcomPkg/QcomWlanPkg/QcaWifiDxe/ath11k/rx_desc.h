...
/* For the following sub fields, QCA6490 is different from 
 * QCA6290/QCA6390
 *
 *  QCA6490
...
#pragma pack(1)
struct hal_rx_desc_qca6390 {
	__le32 msdu_end_tag;
	struct rx_msdu_end_qca6390 msdu_end;
	__le32 rx_attn_tag;
	struct rx_attention attention;
	__le32 msdu_start_tag;
	struct rx_msdu_start_qca6390 msdu_start;
	u8 rx_padding0[HAL_RX_DESC_PADDING0_BYTES];
	__le32 mpdu_start_tag;
	struct rx_mpdu_start_qca6390 mpdu_start;
	__le32 mpdu_end_tag;
...
struct hal_rx_desc_qca6490 {
	__le32 msdu_end_tag;
	struct rx_msdu_end_qca6490 msdu_end;
	__le32 rx_attn_tag;
	struct rx_attention attention;
	__le32 msdu_start_tag;
	struct rx_msdu_start_qca6490 msdu_start;
	u8 rx_padding0[HAL_RX_DESC_PADDING0_BYTES];
	__le32 mpdu_start_tag;
	struct rx_mpdu_start_qca6490 mpdu_start;
	__le32 mpdu_end_tag;
	struct rx_mpdu_end mpdu_end;
	u8 rx_padding1[HAL_RX_DESC_PADDING1_BYTES];
	__le32 hdr_status_tag;
...
struct hal_rx_desc {
	union {
		struct hal_rx_desc_qca6390 qca6390;
		struct hal_rx_desc_qca6490 qca6490;
	} u;
} __packed;
#pragma pack()
