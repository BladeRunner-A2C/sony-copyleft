...
enum ath11k_hw_rev {
	ATH11K_HW_INVALID,
	ATH11K_HW_QCA6390,
	ATH11K_HW_QCA6490_HW11,
	ATH11K_HW_QCA6490_HW20,
};
...
#define  ATH11K_MAC_START_TIMEOUT (10 * HZ)
...
enum ath11k_dev_flags {
	...
	ATH11K_FLAG_MAC_STOPPED,
	ATH11K_FLAG_MAC_STARTING
};
...
struct ath11k_vif {
	...
	u32 aid;
	u8 bssid[ETH_ALEN];
	struct ieee80211_bitrate_mask bitrate_mask;
	int num_legacy_stations;
	u32 rtscts_prot_mode;
	int txpower;
...
struct ath11k_sta {
	...
	struct ieee80211_rate_info txrate;
	struct ieee80211_rate_info last_txrate;
	u64 rx_duration;
	u64 tx_duration;
	u8 rssi_comb;
...
struct ath11k {
	...
	//struct survey_info survey[ATH11K_NUM_CHANS]; //TODO
...
struct ath11k_base {
	...
	struct completion hw_mode_ready;
    ...
    struct delayed_work rx_replenish_retry;
    ...
    struct delayed_work mon_reap_work;
...
extern const struct ce_pipe_config ath11k_target_ce_config_wlan_qca6x90[];
extern const struct service_to_pipe ath11k_target_service_to_ce_map_wlan_qca6x90[];
...
static inline struct ath11k_skb_cb *ATH11K_SKB_CB(struct sk_buff *skb)
{
	...
	return (struct ath11k_skb_cb *)&IEEE80211_SKB_CB(skb)->u.driver_data;
}
...
{
	return (struct ath11k_vif *)ieee80211_vif_get_priv_data(vif);
}
