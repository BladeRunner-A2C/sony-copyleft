...
#define HAL_WBM_RELEASE_INFO0_TQM_RELEASE_REASON	GENMASK(15, 13)
#define HAL_WBM_RELEASE_INFO0_RXDMA_PUSH_REASON		GENMASK(17, 16)
#define HAL_WBM_RELEASE_INFO0_RXDMA_ERROR_CODE		GENMASK(22, 18)
#define HAL_WBM_RELEASE_INFO0_REO_PUSH_REASON		GENMASK(24, 23)
#define HAL_WBM_RELEASE_INFO0_REO_ERROR_CODE		GENMASK(29, 25)
#define HAL_WBM_RELEASE_INFO0_WBM_INTERNAL_ERROR	BIT(30)
