...
Copyright 2005, 2006, 2010-2014, 2017-2018, 2020-2023 by Qualcomm Technologies Incorporated.
All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*===========================================================================
...
--------   ---     ----------------------------------------------------------
12/09/20   ck      Removed remapping macros
07/16/20   rakhi   Increased SCRIPT_BUF_SIZE to 32768
06/11/20   yps     Added dload_mem_debug_copy_restricted_region
07/10/18   yps     Added DL_LOG for ramdump logging
...
===========================================================================*/
#define RESTRICTED_REGION_READ_BUFFER_SIZE 0x1000
...
===========================================================================*/
void dload_mem_debug_init(boot_handle config_context_handle);
...
FUNCTION dload_mem_debug_get_entry_by_filename

DESCRIPTION
  This function returns the entry based on input file name.

DEPENDENCIES
  None.

RETURN VALUE
  Region entry pointer
  NULL if not present
...
ramdump_table_type* dload_mem_debug_get_entry_by_filename (char* filename);
...
===========================================================================*/
uint8 dload_mem_debug_save_pref(uint32 i);
...
===========================================================================*/
uint64 dload_mem_debug_mem_base(uint32 i);
...
===========================================================================*/
uint64 dload_mem_debug_mem_length(uint32 i);
...
===========================================================================*/
char *dload_mem_debug_desc(uint32 i);
...
===========================================================================*/
char *dload_mem_debug_filename(uint32 i);
