...
bl_error_boot_type rd_sahara_format_init (boot_handle media_if)
{
  ...
  do
  {
    ...
    cache_if->WriteBackInvalidateDataCacheRange ((void *)SCL_SBL1_DDR_ZI_BASE, SCL_SBL1_DDR_ZI_SIZE);
    cache_if->WriteBackInvalidateDataCacheRange ((void *)SCL_IMEM_BASE, SCL_IMEM_SIZE);
