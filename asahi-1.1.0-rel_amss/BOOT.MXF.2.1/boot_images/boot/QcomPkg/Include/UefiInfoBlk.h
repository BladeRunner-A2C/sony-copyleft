/** @file UefiInfoBlk.h
  ...
  Copyright (c) 2012-2017, 2021, 2022 Qualcomm Technologies, Inc.  All Rights Reserved.
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 09/13/22   sree    Increasing uefi info block entries of each ver 0x0001000F and IframePtr array size entries to 12 instead 8 
 04/27/21   am      Add system register fields
 11/02/17   yg      Add scheduler related fields
...
#define UEFI_INFO_BLOCK_VERSION    0x00010010
...
typedef struct {             /* Offsets:   32 bit    64 bit   */
  ...
  /* Ver 0x0001000B */                            
  VOID*        CrashContext;           /*   0xE4      0x128    */

  /* Ver 0x0001000C */                            
  VOID*        ThreadList;             /*   0xE8      0x130    */
  VOID*        ThreadStats;            /*   0xEC      0x138    */

  /* Ver 0x0001000D */                            
  BOOLEAN      ForceDisableHWWdog;     /*   0xF0      0x140    */
  
  /* Ver 0x0001000E */ 
  INT32        BootCore;               /*   0xF4      0x144    */
  
  /* Ver 0x0001000F */                            
  UINTN        VBAR_EL1[12];            /*   0xF8      0x148    */
  UINTN        TPIDR_EL1[12];           /*   0x118     0x188    */
  UINTN        TTBR0_EL1[12];           /*   0x138     0x1C8    */
  UINTN        TCR_EL1[12];             /*   0x158     0x208    */
  UINTN        MAIR_EL1[12];            /*   0x178     0x248    */
  UINTN        CPACR_EL1[12];           /*   0x198     0x288    */
  UINTN        SCTLR_EL1[12];           /*   0x1B8     0x2C8    */
  UINTN        CntvTval[12];            /*   0x1D8     0x308    */
  UINTN        CntvCval[12];            /*   0x1F8     0x348    */
  UINTN        CntvCtl[12];             /*   0x218     0x388    */
  UINTN        ISR_EL1[12];             /*   0x238     0x3C8    */
  UINT32       QTMR_CTNV_CVAL_LO;      /*   0x258     0x408    */
  UINT32       QTMR_CTNV_CVAL_HI;      /*   0x25C     0x40C    */
  UINT32       QTMR_CTNV_LO;           /*   0x260     0x410    */
  UINT32       QTMR_CTNV_HI;           /*   0x264     0x414    */

  /* Ver 0x00010010 */ 
  UINT64       IframePtr[12];            /*   0x268     0x418    */
