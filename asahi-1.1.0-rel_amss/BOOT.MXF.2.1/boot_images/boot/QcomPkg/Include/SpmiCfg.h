 ...
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/SpmiCfg.h#1 $
 * $Change: 53083464 $ 
 * 
 *                              Edit History
 * Date     Description
...
typedef SpmiBusCfg_ChnlOperation SpmiCfg_ChnlOperation;
typedef SpmiBusCfg_OemChannelCfg SpmiCfg_OemChannelCfg;
//******************************************************************************
 ...
 * @see SpmiCfg_DeInit
 */
static inline Spmi_Result SpmiCfg_Init(boolean initHw)
{
 ...
 * @see SpmiCfg_Init
 */
static inline Spmi_Result SpmiCfg_DeInit(void)
{
 ...
 */
static inline Spmi_Result SpmiCfg_GetChannelInfo(uint16 channel, SpmiCfg_ChannelCfg* chanCfg, SpmiCfg_RGConfig* rgCfg)
{
 ...
 */
static inline Spmi_Result SpmiCfg_GetPeripherialInfo(uint8 slaveId, uint8 periphId, SpmiCfg_ChannelCfg *chanCfg)
{
 ...
 * @return  SPMI_SUCCESS on success, error code on error
 */
static inline Spmi_Result SpmiCfg_SetDynamicChannelMode(boolean enabled)
{
...
static inline  Spmi_Result SpmiCfg_ConfigureChannels(SpmiCfg_ChannelCfg* entries, uint32 numEntries)
{
 ...
 * @return  SPMI_SUCCESS on success, error code on error
 */
static inline Spmi_Result SpmiCfg_CalculateRGConfig(SpmiCfg_RGConfig* rgCfg, uint32* rgCount)
{
 ...
 * @return  SPMI_SUCCESS on success, error code on error
 */
static inline Spmi_Result SpmiCfg_GetNumChannels(uint32 *numChan)
{
 ...
 */
static inline Spmi_Result SpmiCfg_ConfigurePvcPort(const SpmiCfg_PvcPortCfg* portCfg)
{
 ...
 */
static inline Spmi_Result SpmiCfg_SetPVCPortsEnabled(boolean enable)
{
 ...
 * @return  SPMI_SUCCESS on success, error code on failure
 */
static inline Spmi_Result SpmiCfg_ConfigureVrmPort(const SpmiCfg_VrmPortCfg* portCfg)
{
    return SpmiBusCfg_ConfigureVrmPort(portCfg);
}
 ...
 */
static inline Spmi_Result SpmiCfg_SetVrmPortsEnabled(boolean enable)
{
    return SpmiBusCfg_SetVrmPortsEnabled(enable);
}
 ...
 * @return  SPMI_SUCCESS on success, error code on failure
 */
static inline Spmi_Result SpmiCfg_ConfigureMgpiPort(const SpmiCfg_MgpiPortCfg* portCfg)
{
 ...
 */
static inline Spmi_Result SpmiCfg_SetMgpiPortsEnabled(boolean enable)
{
