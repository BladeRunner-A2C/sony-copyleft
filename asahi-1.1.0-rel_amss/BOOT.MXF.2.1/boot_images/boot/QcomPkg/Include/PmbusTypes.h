...
typedef struct
{
    ...
    uint32_t      slave_address;             /**< 7-bit I2C slave address. 7-bit I3C dynamic address */
...
#define PMBUS_STORE_USER_ALL_COMMAND                            0x15
...
// PMBUS_IC_DEVICE_ID_COMMAND
#define PMBUS_IC_DEVICE_ID_COMMAND_LENGTH                       0X06
...
//PMBUS_STORE_USER_ALL_COMMAND

#define PMBUS_STORE_USER_ALL_COMMAND_LENGTH                     PMBUS_INVALID_DATA_SIZE
#define PMBUS_STORE_USER_ALL_CHANNEL_SELECT                     PMBUS_CHANNEL_SELECT_GLOBAL
#define PMBUS_STORE_USER_ALL_DATA_FORMAT                        PMBUS_DATA_FORMAT_INVALID
#define PMBUS_STORE_USER_ALL_BUS_ACCESS                         PMBUS_ACCESS_TYPE_WRITE
