...
/*
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/IPCCDefs.h#1 $
...
typedef enum
{
  ...
  /**< Image Control Processor 0 */
  IPCC_C_CAM = 11,
  IPCC_C_ICP0 = IPCC_C_CAM,
  ...
  /**< Debug Client */
  IPCC_C_DBG = 45,
  IPCC_C_DUMMY = IPCC_C_DBG,

  /**< SOC Control Processor */
  IPCC_C_SOCCP = 46,

  /**< Image Control Processor 1 */
  IPCC_C_ICP1 = 47,

  /**< Camera Engine / Imaging Front End Client 0 */
  IPCC_C_IFE0 = 128,
  IPCC_C_CAM_ENG0 = IPCC_C_IFE0,

  /**< Camera Engine / Imaging Front End Client 1 */
  IPCC_C_IFE1 = 129,
  IPCC_C_CAM_ENG1 = IPCC_C_IFE1,

  /**< Camera Engine / Imaging Front End Client 2 */
  IPCC_C_IFE2 = 130,
  IPCC_C_CAM_ENG2 = IPCC_C_IFE2,

  /**< Camera Engine / Imaging Front End Client 3 */
  IPCC_C_IFE3 = 131,
  IPCC_C_CAM_ENG3 = IPCC_C_IFE3,

  /**< Camera Engine / Imaging Front End Client 4 */
  IPCC_C_IFE4 = 132,
  IPCC_C_CAM_ENG4 = IPCC_C_IFE4,

  /**< Camera Engine / Imaging Front End Client 5 */
  IPCC_C_IFE5 = 133,
  IPCC_C_CAM_ENG5 = IPCC_C_IFE5,

  /**< Camera Engine / Imaging Front End Client 6 */
  IPCC_C_IFE6 = 134,
  IPCC_C_CAM_ENG6 = IPCC_C_IFE6,

  /**< Camera Engine / Imaging Front End Client 7 */
  IPCC_C_IFE7 = 135,
  IPCC_C_CAM_ENG7 = IPCC_C_IFE7,
