...
DESCRIPTION
  ...
  Copyright 2004-2011,2013,2019-2020,2022 Qualcomm Technologies Incorporated. 
  All Rights Reserved.
...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/Library/flash_mibib.h#1 $
$DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
   
when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/27/22   gk      Added Jtagid for Pinnacles to differentiate from kuno
10/14/22   gml     Added sbl_b partition and updated mibib partition offsets
09/22/29   tvra    Add jtag_id and mibib boundries for auto targets.
06/08/20   sa      Ported for Olympic.
10/23/19   sa      Reduce the Mibib search block count.
...
#define JTAG_ID_AUTO_1         0x1FA
#define JTAG_ID_AUTO_2         0x1F9
#define JTAG_ID_PINNACLES_1    0x1B4
#define JTAG_ID_PINNACLES_2    0x1F3

#define MIBIB_BLOCK_SEARCH_MAX_AUTO         0x1E
#define MIBIB_BLOCK_SEARCH_MIN_AUTO         0x14
...
/* Scan for valid MIBIB from SBL till end of MIBIB partition.
 * The block after Mibib is EFS.
 * For the scenario when MIBIB update is done through fastboot,
 * fastboot will not have access to read EFS partition.
 * So scanning for MIBIB should only be done till the end of
 * MIBIB partition block. 
 */
#define MIBIB_BLOCK_SEARCH_MAX          0x1E

/* Skip, at minimum, the first 8 blocks to scan for partition table.  These blocks are 
 * reserved for SBL partition. 
 */
#define MIBIB_BLOCK_SEARCH_MIN          0x0A
