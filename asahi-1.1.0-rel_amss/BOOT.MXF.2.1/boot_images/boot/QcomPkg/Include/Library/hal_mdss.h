...
typedef  unsigned int       bool32;      /* Boolean value type. */
...
typedef enum _HAL_MDSS_ModuleType
{
	...
	HAL_MDSS_MODULE_DPTX0       = 0x00000100,
	HAL_MDSS_MODULE_DPTX1       = 0x00000200,
	HAL_MDSS_MODULE_DPTX2       = 0x00000400,
	HAL_MDSS_MODULE_DPTX3       = 0x00000800,
...
typedef enum _HAL_MDP_PixelFormatType
{
   ...
   HAL_MDP_PIXEL_FORMAT_YUV_END                          = HAL_MDP_PIXEL_FORMAT_Y_CB_CR_H2V1_16BPP,
   HAL_MDP_PIXEL_FORMAT_RGB_PLANAR_888_8BPP,
   HAL_MDP_PIXEL_FORMAT_PLANNAR_END                      = HAL_MDP_PIXEL_FORMAT_RGB_PLANAR_888_8BPP,
...
typedef struct _HAL_MDP_SWMappedHWBaseAddressesType
{
  ...
  uintPtr        uUSB4HostRouterAddress; /**< SW mapped USB4 Host Router HW block address */
  uintPtr        uQMPPhy0BaseAddress;    /**< SW mapped QMP PHY 0 HW block address */
  uintPtr        uQMPPhy1BaseAddress;    /**< SW mapped QMP PHY 1 HW block address */
