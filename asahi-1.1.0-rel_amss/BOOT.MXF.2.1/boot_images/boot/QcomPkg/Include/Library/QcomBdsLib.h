...
Copyright (c) 2014, 2016, 2017, 2020, 2021, 2023 Qualcomm Technologies, Inc. All Rights Reserved
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 03/02/23   cm      Added RegisterForResetNotification API
 02/01/21   cm      Added QcomBdsDetectBootHotKey,PlatformPreConsoleInit, PlatformSecurityInit,
                    SetupFwProvision, api prototypes from PlatformBdsLib , CapsuleUpdate
 09/14/20   cm      Added ProcessFvLoadingForFlashless
...
/** 
  Platform security initializations
...
/**
  Security Configs after Firmware Provision
**/
EFI_STATUS
EFIAPI
...
/** 
  Get Boot Hotkey Option

**/
EFI_STATUS
EFIAPI
QcomBdsDetectBootHotKey (BDS_INIT_OPTION *InitOption);
...
/**
  Process mounting FV's for flashless usecase 
**/
EFI_STATUS
ProcessFvLoadingForFlashless(
  ram_partition_type_t partition_type
  );
...
/**
  Process DT config to launch APP. 
**/
EFI_STATUS
EFIAPI
