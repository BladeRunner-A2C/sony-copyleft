...
/* IMEM display offset defined in IPCAT memory mapping: IMEM->Shared IMEM->Display Configuration */
#define IMEM_DISPLAY_CONFIG_OFFSET_9XX                0x0002ABA4
#define IMEM_DISPLAY_CONFIG_OFFSET                    0x00000BA4
...
typedef enum
{
  ...
  MDP_DISPLAY_PERIPHERAL_DP2       = 0x10, /* Display peripheral type DP2  */
  MDP_DISPLAY_PERIPHERAL_EDP0      = 0x20, /* Display peripheral type EDP0 */
} MDPDisplayPeripheralType;
...
*
****************************************************************************/
MDP_Status MDP_GetTextModes(MDP_ResolutionType** pTextModeList, uint32* uListLength);
...
/*!
* \brief
*   This function will return the display to be used for EDID protocols
*
* \param none
*
