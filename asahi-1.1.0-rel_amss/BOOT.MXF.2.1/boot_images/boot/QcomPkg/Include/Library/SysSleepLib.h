 ...
 *  
 * Copyright (c) 2018, 2020 - 2022 Qualcomm Technologies, Inc. All 
 * rights reserved. 
 * 
**/
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 09/26/19   md      Added APIs to disable sleep logs from draining to UART.
 ...
 * ToDo: Need to address the data type in SysSleep.c
 *****************************************************************************/
 ...
 *
 *  Put the core to sleep (Power collapse) for the given duration in milli sec
 *  on which the function is called. This also takes into account Sleep_State 
 *  passed by the client: It can be shallow or deep sleep state. 
 *
 * Returns POWER_SLEEP_SUCCESS on successfully sleeping or other POWER_SLEEP_*
 *   failure codes on failure.
 *
 ...
 *
 *****************************************************************************/
VOID SleepAborted (UINT32 CurCpu, INT32 Reason);
...
VOID DrainLogBuffertoNULL (VOID);
...
VOID PreSleepAction (VOID);

VOID MainSleepAction (VOID);

VOID PostSleepAction (CoreSleepStateType NewState);
