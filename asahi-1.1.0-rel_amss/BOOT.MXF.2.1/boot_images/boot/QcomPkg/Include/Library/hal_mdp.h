...
#define HAL_MDP_DEFAULT_CXO_CLK                                         19200000
...
/* Flag to indicate that Time Stamp register is there or not */
#define HAL_MDP_FLAG_TIMESTAMP_FEATURE                         HAL_MDSS_BIT(8)
/* Flag to indicate programmable fetch start feature */
#define HAL_MDP_FLAG_FEATURE_PROGRAMMABLE_FETCH_START          HAL_MDSS_BIT(6)
...
/* Used in uSetupFlags param of HAL_MDP_Interface_DualInterface_Config() to set the dsi master interface */
#define HAL_MDP_FLAGS_DSI_1_MASTER                             0x00000080

/* Used in uFlags param of HAL_MDP_ControlPath_Config() to configure multiple modules on the same control path */
#define HAL_MDP_FLAGS_SLAVE_CONTROL_PATH                       0x00000100


/* Demura configure parameter size */
#define DEMURA_CFG0_PARAM_LEN                                  8
#define DEMURA_CFG0_PARAM2_LEN                                 256
#define DEMURA_CFG1_PARAM_LEN                                  8
#define DEMURA_CFG1_PARAM0_LEN                                 153
#define DEMURA_CFG5_PARAM01_LEN                                4
#define DEMURA_CFG3_PARAM01_LEN                                4
...
typedef enum _HAL_MDP_SourcePipeId
{
   ...
   HAL_MDP_SOURCE_PIPE_VIG_END         = HAL_MDP_SOURCE_PIPE_VIG_3,
   ...
   HAL_MDP_SOURCE_PIPE_DMA_5,
   HAL_MDP_SOURCE_PIPE_DMA_END         = HAL_MDP_SOURCE_PIPE_DMA_5,
   ...
   HAL_MDP_SOURCE_PIPE_DMA_5_REC1,
   HAL_MDP_SOURCE_PIPE_SMART_DMA_END   = HAL_MDP_SOURCE_PIPE_DMA_5_REC1,
...
typedef enum _HAL_MDP_PingPongId
{
  ...
  HAL_MDP_PINGPONG_5,             /**< PingPong_5 */
  HAL_MDP_PINGPONG_6,             /**< PingPong_6 */
  HAL_MDP_PINGPONG_MAX,
  HAL_MDP_PINGPONG_FORCE_32BIT  = 0x7FFFFFFF
} HAL_MDP_PingPongId;

/*!
 * \enum HAL_MDP_CWB_PingPongId
 *
 * The \b HAL_MDP_CWB_PingPongId lists the CWB pingpong block identifications
 */
typedef enum _HAL_MDP_CWB_PingPongId
{
  HAL_MDP_CWB_PINGPONG_NONE         = 0x00000000,
  HAL_MDP_CWB_PINGPONG_0,             /**< CWB PingPong_0 */
  HAL_MDP_CWB_PINGPONG_1,             /**< CWB PingPong_1 */
  HAL_MDP_CWB_PINGPONG_2,             /**< CWB PingPong_2 */
  HAL_MDP_CWB_PINGPONG_3,             /**< CWB PingPong_2 */
  HAL_MDP_CWB_PINGPONG_MAX,
  HAL_MDP_CWB_PINGPONG_FORCE_32BIT  = 0x7FFFFFFF
} HAL_MDP_CWB_PingPongId;
...
typedef enum _HAL_MDP_InterfaceId
{
   ...
   HAL_MDP_INTERFACE_6,                            /**< Physical Interface 6 (INTF_6) */
   HAL_MDP_INTERFACE_7,                            /**< Physical Interface 7 (INTF_7) */
   HAL_MDP_INTERFACE_8,                            /**< Physical Interface 8 (INTF_8) */
...
/*!
* \enum HAL_MDP_TapPointType
*
* The \b Defines the available tap points
*
*/
typedef enum
{
  HAL_MDP_CWB_TAPPOINT_LAYERMIXER = 0,             /* TapPoint Layer Mixer */
  HAL_MDP_CWB_TAPPOINT_DSPP,                       /* TapPoint DSPP */
  HAL_MDP_CWB_TAPPOINT_POSTDEMURA,                 /* TapPoint POSTDEMURA */
  HAL_MDP_CWB_TAPPOINT_DISCONNECT,                 /* TapPoint to clear CWB config registers */

}HAL_MDP_CWB_TapPointType;
...
typedef enum _HAL_MDP_VBIF_ClientIDType
{
  ...
  HAL_MDP_VBIF_CLIENT_DMA4,
  HAL_MDP_VBIF_CLIENT_DMA5,
 ...
 *
 * The _HAL_MDP_SplitMUXId lists the Split muxer modules inside PPBs
 */
...
/*!
 * \enum _HAL_MDP_DSC_CORE
 *
 * The HAL_MDP_DSC_CORE lists the Display Stream Compression (DSC) Core
 * each DSC Core contains two Encoder engines
 */
typedef enum _HAL_MDP_DSC_CORE
{
   HAL_MDP_DSC_CORE_0,                   /**< DSC Core Pair 0 */
   HAL_MDP_DSC_CORE_1,                   /**< DSC Core Pair 1 */
   HAL_MDP_DSC_CORE_2,                   /**< DSC Core Pair 2  -- not presented */
   HAL_MDP_DSC_CORE_MAX,
   HAL_MDP_DSC_CORE_FORCE_32BIT          = 0x7FFFFFFF
} HAL_MDP_DSC_CORE;

/*!
 * \enum _HAL_MDP_VDCM_CORE
 *
 * The HAL_MDP_VDCM_CORE lists the VDCM Core
 * each VDCM Core contains two Encoder engines
 */
typedef enum _HAL_MDP_VDCM_CORE
{
   HAL_MDP_VDCM_CORE_0,                   /**< VDCM Core Pair 0 */
   HAL_MDP_VDCM_CORE_MAX,
   HAL_MDP_VDCM_CORE_FORCE_32BIT          = 0x7FFFFFFF
} HAL_MDP_VDCM_CORE;
...
typedef enum _HAL_MDP_DSCId
{
   ...
   HAL_MDP_DSC_0,                   /**< DSC ENCODER ENGINE 0 == Pair 0 -- 0, RGB */
   HAL_MDP_DSC_1,                   /**< DSC ENCODER ENGINE 1 == Pair 0 -- 1, RGB */
   HAL_MDP_DSC_2,                   /**< DSC ENCODER ENGINE 2 == Pair 1 -- 0, RGB + YUV */
   HAL_MDP_DSC_3,                   /**< DSC ENCODER ENGINE 3 == Pair 1 -- 1, RGB + YUV */
   HAL_MDP_DSC_4,                   /**< DSC ENCODER ENGINE 4  */
   HAL_MDP_DSC_5,                   /**< DSC ENCODER ENGINE 5  */
   HAL_MDP_DSC_MAX,
   HAL_MDP_DSC_FORCE_32BIT          = 0x7FFFFFFF
} HAL_MDP_DSCId;

/*!
 * \enum HAL_MDP_DSCColorSpaceType
 *
 * The HAL_MDP_DSCColorSpaceType lists the Display Stream Compression (DSC) color space types
 */
typedef enum _HAL_MDP_DSCColorSpaceType
{
  HAL_MDP_DSCCOLORSPACE_RGB,
  HAL_MDP_DSCCOLORSPACE_YUV,
  HAL_MDP_DSCCOLORSPACE_MAX,
  HAL_MDP_DSCCOLORSPACE_FORCE_32BIT   = 0x7FFFFFFF
} HAL_MDP_DSCColorSpaceType;

/*!
 * \enum HAL_MDP_DSCChromaType
 *
 * The HAL_MDP_DSCChromaType lists the Display Stream Compression (DSC) Chroma types
 */
typedef enum _HAL_MDP_DSCChromaType
{
  HAL_MDP_DSCCHROMA_RGB444,
  HAL_MDP_DSCCHROMA_YUV422,
  HAL_MDP_DSCCHROMA_YUV420,
  HAL_MDP_DSCCHROMA_MAX,
  HAL_MDP_DSCCHROMA_FORCE_32BIT       = 0x7FFFFFFF
} HAL_MDP_DSCChromaType;
/*!
 * \enum _HAL_MDP_VDCMId
 *
 * The HAL_MDP_VDCMId lists the VDCM Encoder engine module IDs
 */
typedef enum _HAL_MDP_VDCMId
{
   HAL_MDP_VDCM_NONE                 = 0x00000000,
   HAL_MDP_VDCM_0,
   HAL_MDP_VDCM_1,
   HAL_MDP_VDCM_2,
   HAL_MDP_VDCM_3,
   HAL_MDP_VDCM_MAX,
   HAL_MDP_VDCM_FORCE_32BIT          = 0x7FFFFFFF
} HAL_MDP_VDCMId;
   

/*!
 * \enum _HAL_MDP_3DMUXId
 *
 * The _HAL_MDP_3DMUXId lists the 3d muxer modules
 */
typedef enum _HAL_MDP_3DMUXId
{
   HAL_MDP_3DMUX_NONE                 = 0x00000000,
   HAL_MDP_3DMUX_0,                   /**< 3D MUXER 0 (PPB0 & PPB1)  */
   HAL_MDP_3DMUX_1,                   /**< 3D MUXER 1 (PPB2 & PPB3)  */
   HAL_MDP_3DMUX_2,                   /**< 3D MUXER 2 (PPB4 & PPB5)  */
   HAL_MDP_3DMUX_MAX,
   HAL_MDP_3DMUX_FORCE_32BIT          = 0x7FFFFFFF
} HAL_MDP_3DMUXId;

/*!
 * \enum _HAL_MDP_SprId
 *
 * The _HAL_MDP_SprId lists the spr block identifications
 */
typedef enum _HAL_MDP_SprId
{
  HAL_MDP_SPR_NONE                    = 0x00000000,
  HAL_MDP_SPR_0,                      /**< SPR_0 */
  HAL_MDP_SPR_1,                      /**< SPR_1 */
  HAL_MDP_SPR_2,                      /**< SPR_2 */
  HAL_MDP_SPR_3,                      /**< SPR_3 */
  HAL_MDP_SPR_MAX,
  HAL_MDP_SPR_FORCE_32BIT             = 0x7FFFFFFF
} HAL_MDP_SprId;

/*!
 * \enum _HAL_MDP_SprPack_Type
 *
 * The enumeration of SPR pack types
 */
typedef enum _HAL_MDP_SprPack_Type
{
  HAL_MDP_SPR_PACK_NONE               = 0x00000000,
  HAL_MDP_SPR_PACK_PENTILE,
  HAL_MDP_SPR_PACK_RGBW,
  HAL_MDP_SPR_PACK_YYGM,
  HAL_MDP_SPR_PACK_YYGW,
  HAL_MDP_SPR_BYPASS,
  HAL_MDP_SPR_PACK_MAX,
  HAL_MDP_SPR_PACK_FORCE_32BIT        = 0x7FFFFFFF
} HAL_MDP_SprPack_Type;

/*!
 * \enum _HAL_MDP_SprFilter_Type
 *
 * The enumeration of SPR filter types
 */
typedef enum _HAL_MDP_SprFilter_Type
{
  HAL_MDP_SPR_FILTER_NONE             = 0x00000000,
  HAL_MDP_SPR_FILTER_PIXELDROP,
  HAL_MDP_SPR_FILTER_BILINEAR,
  HAL_MDP_SPR_FILTER_FOURTAP,
  HAL_MDP_SPR_FILTER_ADAPTIVE,
  HAL_MDP_SPR_FILTER_2DAVG,
  HAL_MDP_SPR_FILTER_MAX,
  HAL_MDP_SPR_FILTER_FORCE_32BIT      = 0x7FFFFFFF
} HAL_MDP_SprFilter_Type;

/*!
 * \enum _HAL_MDP_SprAdaptiveMode_Type
 *
 * The enumeration of SPR adaptive mode types
 */
typedef enum _HAL_MDP_SprAdaptiveMode_Type
{
  HAL_MDP_SPR_ADAPTIVEMODE_NONE        = 0x00000000,
  HAL_MDP_SPR_ADAPTIVEMODE_YYGM,
  HAL_MDP_SPR_ADAPTIVEMODE_YYGW,
  HAL_MDP_SPR_ADAPTIVEMODE_MAX,
  HAL_MDP_SPR_ADAPTIVEMODE_FORCE_32BIT = 0x7FFFFFFF
} HAL_MDP_SprAdaptiveMode_Type;

/*!
 * \enum HAL_MDP_DemuraId
 *
 * The HAL_MDP_DemuraId lists the Demura block identifications
 */
typedef enum _HAL_MDP_DemuraId
{
  HAL_MDP_DEMURA_NONE = 0x00000000,
  HAL_MDP_DEMURA_0,                      /**< DEMURA_0 */
  HAL_MDP_DEMURA_1,                      /**< DEMURA_1 */
  HAL_MDP_DEMURA_2,                      /**< DEMURA_2 */
  HAL_MDP_DEMURA_3,                      /**< DEMURA_3 */
  HAL_MDP_DEMURA_MAX,
  HAL_MDP_DEMURA_FORCE_32BIT = 0x7FFFFFFF
} HAL_MDP_DemuraId;
...
typedef enum _HAL_MDP_BlendStageId
{
   ...
   HAL_MDP_BLEND_STAGE_7,                          /**< Blend Stage #7 (Output of blend stage#5 + one fore-ground layer)  */
   HAL_MDP_BLEND_STAGE_8,                          /**< Blend Stage #8 (Output of blend stage#5 + one fore-ground layer)  */
   HAL_MDP_BLEND_STAGE_9,                          /**< Blend Stage #9 (Output of blend stage#5 + one fore-ground layer)  */
   HAL_MDP_BLEND_STAGE_10,                         /**< Blend Stage #10 (Output of blend stage#5 + one fore-ground layer) */
...
typedef enum _HAL_MDP_InterfaceStandardType
{
   ...
   HAL_MDP_INTERFACE_STANDARD_LVDS           = 0x0000000A,     /**< LVDS                                          */
...
typedef enum _HAL_MDP_InterfaceConnectionType
{
   ...
   HAL_MDP_INTERFACE_CONNECTION_DP0,                                      /**< Display Port controller 0                     */
   HAL_MDP_INTERFACE_CONNECTION_DP1,                                      /**< Display Port controller 1                     */
   HAL_MDP_INTERFACE_CONNECTION_DP2,                                      /**< Display Port controller 2                     */
   HAL_MDP_INTERFACE_CONNECTION_DP3,                                      /**< Display Port controller 3                     */
...
typedef enum _HAL_ControlPath_Flush
{
   ...
   HAL_CONTROL_PATH_FLUSH_DMA4         = HAL_MDSS_BIT(13),  /**< DMA 4 FLUSH                 */
   HAL_CONTROL_PATH_FLUSH_DMA5         = HAL_MDSS_BIT(14),  /**< DMA 5 FLUSH                 */
   ...
   HAL_CONTROL_PATH_FLUSH_DSC          = HAL_MDSS_BIT(22),  /**< DSC FLUSH                   */
   HAL_CONTROL_PATH_FLUSH_MERGE_3D     = HAL_MDSS_BIT(23),  /**< 3D MUX FLUSH                */
   ...
   HAL_CONTROL_PATH_FLUSH_CWB          = HAL_MDSS_BIT(28),  /**< CWB FLUSH                   */
   HAL_CONTROL_PATH_FLUSH_DSPP         = HAL_MDSS_BIT(29),  /**< DSPP FLUSH                  */
   HAL_CONTROL_PATH_FLUSH_PERIPH       = HAL_MDSS_BIT(30),  /**< PERIPHERAL FLUSH            */
   HAL_CONTROL_PATH_FLUSH_INTF         = HAL_MDSS_BIT(31),  /**< INTERFACE FLUSH             */
...
/*!
 * \enum HAL_MDP_Interface_VsyncSelectType
 *
 * The \b HAL_MDP_Interface_VsyncSelectType provides the list of external vsync sources
 * 
 */
typedef enum _HAL_MDP_Interface_VsyncSelectType
{
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_VSYNC_0_GPIO = 0x00000000,         /**< vsync 0 from gpio */
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_VSYNC_1_GPIO = 0x00000001,         /**< vsync 1 from gpio */
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_VSYNC_2_GPIO = 0x00000002,         /**< vsync 2 from gpio */
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_TE_INTF_0    = 0x00000003,         /**< vsync(TE) from interface 0 panel */
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_TE_INTF_1    = 0x00000004,         /**< vsync(TE) from interface 1 panel */
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_TE_INTF_2    = 0x00000005,         /**< vsync(TE) from interface 2 panel */
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_TE_INTF_3    = 0x00000006,         /**< vsync(TE) from interface 3 panel */
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_MAX,
    HAL_MDP_INTERFACE_VSYNC_SELECT_TYPE_FORCE_32BIT  = 0x7FFFFFFF
} HAL_MDP_Interface_VsyncSelectType;

/*!
 * \enum HAL_MDP_PingPong_VsyncSelectType
 *
 * The \b HAL_MDP_PingPong_VsyncSelectType provides the list of external vsync sources
 * This structure is deprecated, and will be removed in future revision
 */
...
typedef enum _HAL_MDP_PCC_TYPE
{
    ...
    HAL_MDP_PCC_TYPE3            = 0x00000002,       /**< PCC TYPE 3 */
...
/*!
* \enum HAL_MDP_DSPPModuleType
*
* The HAL_MDP_DSPPModuleType lists the modules in DSPP
*/
typedef enum _HAL_MDP_DSPPModuleType
{
  HAL_MDP_DSPPMODULE_NONE                 = 0x00000000,
  HAL_MDP_DSPPMODULE_SB                   = HAL_MDSS_BIT(0),
  HAL_MDP_DSPPMODULE_RC                   = HAL_MDSS_BIT(1),
  HAL_MDP_DSPPMODULE_DEMURA               = HAL_MDSS_BIT(2),
  HAL_MDP_DSPPMODULE_SPR                  = HAL_MDSS_BIT(3),
  HAL_MDP_DSPPMODULE_LTM                  = HAL_MDSS_BIT(4),
  HAL_MDP_DSPPMODULE_ROI_BYPASS           = HAL_MDSS_BIT(6),
  HAL_MDP_DSPPMODULE_PGC                  = HAL_MDSS_BIT(7),
  HAL_MDP_DSPPMODULE_PCC                  = HAL_MDSS_BIT(8),
  HAL_MDP_DSPPMODULE_GAMUT                = HAL_MDSS_BIT(9),
  HAL_MDP_DSPPMODULE_IGC                  = HAL_MDSS_BIT(10),
  HAL_MDP_DSPPMODULE_PA_LUTV              = HAL_MDSS_BIT(11),
  HAL_MDP_DSPPMODULE_PA                   = HAL_MDSS_BIT(12),
  HAL_MDP_DSPPMODULE_MAX,
  HAL_MDP_DSPPMODULE_FORCE_32BIT = 0x7FFFFFFF
} HAL_MDP_DSPPModuleType;

/*!
 * \enum HAL_MDP_QoSFlagType
 *
 * The HAL_MDP_QoSFlagType lists the different commit mode configuration
 */
typedef enum _HAL_MDP_QoSFlagType
{
  HAL_MDP_QOS_FLAG_QSEED_ENABLED    = 0x00000001, /**< Flag to indicate QSEED is enabled or not, used for QOS Configuration HAL_MDP_Qos_ConfigType.uFlags */
  HAL_MDP_QOS_FLAG_LANDSCAPE_PANEL  = 0x00000002, /**< Flag to indicate panel is landscape mode or not, used for QOS Configuration HAL_MDP_Qos_ConfigType.uFlags*/
  HAL_MDP_QOS_FLAG_MAX,
  HAL_MDP_QOS_FLAG_32BIT            = 0x7FFFFFFF
} HAL_MDP_QoSFlagType;

/*!
 * \enum HAL_MDP_IntfMiscCtlFlagType
 *
 * The HAL_MDP_IntfMiscCtlFlagType lists the interface misc control flag
 */
typedef enum _HAL_MDP_IntfMiscCtlFlagType
{
  HAL_MDP_INTF_MISCCTL_FLAG_NONE          = 0x00000000, 
  HAL_MDP_INTF_MISCCTL_FLAG_PIXEL_DRAIN   = 0x00000001, /**< Flag to indicate pixel drain is enabled  without acknowledge from peripheral */
} HAL_MDP_IntfMiscCtlFlagType;
...
typedef struct _HAL_MDP_HwInfo
{
   ...
   uint32                  uValidDataPathMask;                          /**< Mask for data path                               */
} HAL_MDP_HwInfo;
...
typedef struct
{
  ...
  uint32                             uFps;            /**< frame rate in Hz                     */
  uint32                             uHeightTotalPx;  /**< Total Height                         */
  uint32                             uFlags;          /**< QoS flags, eg.Qseed, landscape_panel */
}HAL_MDP_Qos_ConfigType;
...
typedef struct _HAL_MDP_PhyIntf_TimingGenConfigType
{
   ...
   bool32                                 bTwoPixelsPerPclk;            /**< two pixels per pclk from mdp to dsi                       */
   ...
   uint32                                 uPclkPerLine;                 /**< Pclks per Line if compression enabled                     */
 ...
 * This structure is deprecated and will be removed in future revisions
 * 
 * Notes:
 *     - uVsyncCount:
...
/*!
 * \struct HAL_MDP_Interface_VsyncConfigType
 *
 * The \b HAL_MDP_Interface_VsyncConfigType configures the vsync counter in the pingpong block
 *
 * Notes:
 *     - uVsyncCount:
 *               Normally, vsync count is calculated by: 
 ...
 *       counter before it wraps around. Otherwise, double interrupts will happen.
 */
typedef struct _HAL_MDP_Interface_VsyncConfigType
{
  bool32                        bEnableAutoRefresh;         /**< enable auto refresh                           */
  uint32                        uAutoRefreshFrameNumDiv;    /**< frame divisor for auto refresh                */
  uint32                        uVsyncCount;                /**< vsync sync count for one line                 */
  ...
  uint32                        uVsyncWrPtrIrqLine;         /**< write-pointer interrupt line                  */
  uint32                        uVsyncInitValue;            /**< value loaded to read-pointer at vsync edge    */
} HAL_MDP_Interface_VsyncConfigType;


/*!
 * \struct HAL_MDP_Interface_TEConfigType
 *
 * The \b HAL_MDP_Interface_TEConfigType configures the tear check in the pingpong block
 *
 *
 *                                             (line)      (RD) (WR)    (RD)
 *                              (height)    -->  |           /   /       /
 ...
 *                                                           
 */ 
typedef struct _HAL_MDP_Interface_TEConfigType
{
   bool32                              bDedicatedTEPin;              /**< using dedicated pin for tear check             */
   HAL_MDP_Interface_VsyncSelectType   eVsyncSelect;                 /**< external vsync source select                   */
...
} HAL_MDP_Interface_TEConfigType;
...
/*!
 * \struct HAL_MDP_Interface_TEEnableType
 *
 * The \b HAL_MDP_Interface_TEEnableType enable/disable the tear check block
 */
typedef struct _HAL_MDP_Interface_TEEnableType
{
    bool32                 bEnable;             /**< enable tear check        */
    bool32                 bGuardWindowEn;      /**< enable guard window      */
    bool32                 bDMAScheduleEn;      /**< enable DSI DMA schedule  */
    bool32                 bSingleUpdate;       /**< enable single frame update per TE  */
} HAL_MDP_Interface_TEEnableType;

/*!
 * \struct HAL_MDP_Interface_VsyncEnableType
 *
 * The \b HAL_MDP_Interface_VsyncEnableType enable/disable the vsync counter
 */
typedef struct _HAL_MDP_Interface_VsyncEnableType
{
    bool32                 bEnable;             /**< enable vsync counter */
} HAL_MDP_Interface_VsyncEnableType;

/*!
 * \struct HAL_MDP_Interface_AutoRefreshEnableType
 *
 * The \b HAL_MDP_Interface_AutoRefreshEnableType enable/disable the auto-refresh
 */
typedef struct _HAL_MDP_Interface_AutoRefreshEnableType
{
    bool32                 bEnable;                   /**< enable auto-refresh */
    uint32                 uAutoRefreshFrameNumDiv;   /**< frame divisor for auto refresh */
} HAL_MDP_Interface_AutoRefreshEnableType;
...
typedef struct _HAL_MDP_DSC_EncoderConfigType
{
   ...
   uint32                              uSliceHeight;
   uint32                              uSliceWidth;
   uint32                              uBPC;                        /** Input : bit per component */
   uint32                              uBPP;                        /** Output: bit per pixel */
   uint32                              bBlockPredEnable;

   uint32                              uNumOfActiveSS;               /** soft slice */
   uint32                              uNumOfActiveHS;               /** hard slice */
   uint32                              bVideoMode;                   /** video mode */
   ...
   uint32                              uSlicePerPacket;              /**< Display stream compression slice per packet */
   uint32                              uPclkPerLine;                 /**< Total pclks per line/per encoder */
   uint32                              uSlicePerInterface;           /**< Slice per interface */
   HAL_MDP_DSCChromaType               eDSCChromaFormat;             /**< DSC chroma format */
...
typedef struct _HAL_MDP_InterfaceConfigType
{
   ...
   HAL_MDP_PingPongId                          ePingPongId[2];            /**< ID of pingpong that sources this interface                           */
   HAL_MDP_Interface_AutoRefreshEnableType    *pIntrAutoRefreshEnable;    /**< Auto-refresh enable                                                  */   
   HAL_MDP_Interface_VsyncEnableType          *pIntrVsyncEnable;          /**< VSYNC counter enable                                                 */
   HAL_MDP_Interface_TEEnableType             *pIntrTEEnable;             /**< Tear check enable                                                    */   
   HAL_MDP_Interface_VsyncConfigType          *pIntrVsyncConfig;          /**< vsync config                                                         */
   HAL_MDP_Interface_TEConfigType             *pIntrTEConfig;             /**< tear check config                                                    */
   HAL_MDP_IntfMiscCtlFlagType                *pMiscControlFlag;          /**< Bit flag for INTF misc ctl mapped to HAL_MDP_IntfMiscCtlFlagType     */
} HAL_MDP_InterfaceConfigType;


/*!
 * \struct HAL_MDP_PingPongBufferSizeLimitType
 *
 * The \b HAL_MDP_PingPongBufferSizeLimitType set the limit of PingPong buffer size.
 */
typedef struct _HAL_MDP_PingPongBufferSizeLimitType
{
  uint32  uDisplayWidth;    /**< Panel width in pixel              */
  uint32  uNumMixers;       /**< Number of Mixers used on panel    */
} HAL_MDP_PingPongBufferSizeLimitType;
...
typedef struct _HAL_MDP_PingPongConfigType
{
   ...
   HAL_MDP_PingPongBufferSizeLimitType      *pPingPingBufferSize;    /**< PPB size limit                    */
...
typedef struct _HAL_MDP_DSCInfoType
{
   ...
   void                               *pDSC;                /**< save dsc configuration during initialization */
   HAL_MDP_PingPongId                 *pePingPongId;        /**< PingPong ID selected by DSC Mux */
} HAL_MDP_DSCInfoType;
...
typedef struct _HAL_MDP_InterfaceInfoParamsType
{
   ...
   float                                      *pfFPSFuse;              /**< Refresh rate SW fuse setting                               */
} HAL_MDP_InterfaceInfoParamsType;
...
/*!
 * \struct HAL_MDP_ControlPath_ModulesType
 *
 * Structure definition for active modules in control path
 */
typedef struct _HAL_MDP_ControlPath_ModulesType
{
   HAL_MDP_DSCId       uDSCId;
   HAL_MDP_VDCMId      uVDCMId;
   HAL_MDP_3DMUXId     u3DMuxId;
   HAL_MDP_PingPongId  uPingPongId;

} HAL_MDP_ControlPath_ModulesType;


/*!
 * \struct HAL_MDP_ControlPath_FetchPipeActiveType
 *
 * Structure definition for active fetch pipe in control path
 */
typedef struct _HAL_MDP_ControlPath_FetchPipeActiveType
{
  HAL_MDP_SourcePipeId eSourcePipeId;
  bool32               bPipeActive;
} HAL_MDP_ControlPath_FetchPipeActiveType;


/*!
 * \struct HAL_MDP_ControlPath_DSPPFlushType
 *
 * Structure definition for DSPP flush info in control path
 */
typedef struct _HAL_MDP_ControlPath_DSPPFlushType
{
  HAL_MDP_DestinationPipeId eDestinationPipeId;
  HAL_MDP_DSPPModuleType    eDsppMoudle;
} HAL_MDP_ControlPath_DSPPFlushType;

/*!
 * \struct HAL_MDP_ControlPath_MicroIdleConfigType
 *
 * Structure definition for configuring micro idle
 */
typedef struct _HAL_MDP_ControlPath_MicroIdleConfigType
{
  bool32 bEnable;
} HAL_MDP_ControlPath_MicroIdleConfigType;
...
typedef struct _HAL_MDP_ControlPathConfigType
{
   ...
   HAL_MDP_ControlPath_ModulesType           *psModulesConfig;
   HAL_MDP_ControlPath_FetchPipeActiveType   *psFetchPipeActiveConfig;
   HAL_MDP_ControlPath_DSPPFlushType         *psDsppFlushConfig;
   HAL_MDP_ControlPath_MicroIdleConfigType   *psMicroIdleConfig;
...
/*!
 * \struct HAL_MDP_SSPP_MicroIdleConfigType
 *
 * Structure definition for configuring source pipe micro idle HW
 */
typedef struct _HAL_MDP_SSPP_MicroIdleConfigType
{
  bool32      bEnable;         /**< Enable micro idle on the source pipe if set to TRUE       */
  uint32      uLineTime;       /**< Line time used to calculate source pipe micro idle params */
} HAL_MDP_SSPP_MicroIdleConfigType;

/*!
 * \struct HAL_MDP_GlobalMicroIdleConfigType
 *
 * Structure definition for configuring global micro idle HW
 */
typedef struct _HAL_MDP_GlobalMicroIdleConfigType
{
  bool32      bControllerEnable;      /**< Flag to enable/disable global micro idle controller  */
  bool32      bWDTimerEnable;         /**< Flag to enable/disable micro idle watchdog timer     */
  bool32      bCounterEnable;         /**< Flag to enable/disable micro idle counter            */
} HAL_MDP_GlobalMicroIdleConfigType;
...
/*!
 * \struct _HAL_MDP_CWBConfigType
 *
 * Structure definition for configuring CWB
 */
typedef struct _HAL_MDP_CWBConfigType
{
  HAL_MDP_ControlPathId     eControlPathId;
  HAL_MDP_LayerMixerId      eLayerMasterMixerId;
  HAL_MDP_CWB_TapPointType  eTapPoint;
  uint32                    uNumMixers;
} HAL_MDP_CWBConfigType;

/*!
 * \struct _HAL_MDP_DataPath_ROIConfigType
 *
 * Structure definition for configuring ROI in WB hardware
 */
typedef struct _HAL_MDP_DataPath_ROIConfigType
{
  bool32 bCropEnabled;                                      /**< Enable/disable cropping               */
  uint32 uPosX;                                             /**< Width offset for cropping             */
  uint32 uPosY;                                             /**< Height Offset for cropping            */
} HAL_MDP_DataPath_ROIConfigType;

/*!
 * \struct HAL_MDP_CWB_DitherConfigType
 *
 * Structure definition for configuring Dither in WB hardware
 */
typedef struct _HAL_MDP_CWB_DitherConfigType
{
  HAL_MDP_CWB_PingPongId             eCWBPingPongId;
  HAL_MDP_PingPong_DitherConfigType* psPingPongDitherConfig;

} HAL_MDP_CWB_DitherConfigType;
...
typedef struct _HAL_MDP_DataPathConfigType
{
   ...
   HAL_MDP_DataPath_ROIConfigType      *psROIConfig;
   HAL_MDP_CWBConfigType               *psCWBConfig;
   HAL_MDP_CWB_DitherConfigType        *psCWBDitherConfig;
...
typedef struct _HAL_MDP_SourcePipeConfigType
{
   ...
   HAL_MDP_SSPP_MicroIdleConfigType          *psMicroIdleConfig;
...
/*!
 * \struct _HAL_MDP_SprDataConfigType
 *
 * SPR data configuration parameters
 */
typedef struct _HAL_MDP_SprDataConfigType
{
  uint32                        uNumMixers;
  int8                          aAdaptiveMode[20];
  HAL_MDP_SprAdaptiveMode_Type  eAdaptiveMode;
  int8                          aFilterType[20];
  HAL_MDP_SprFilter_Type        eFilterType;
  bool32                        bAdaptiveStrengthsOverride;
  uint32                        aAdaptiveStrengths[5];
  bool32                        bFilterCoeffsOverride;
  int32                         aFilterCoeffs[16];
  uint32                        uPhaseInc;
  uint32                        uPhaseRepeat;
  bool32                        bColorPhaseOffsetsRedOverride;
  int32                         aColorPhaseOffsetsRed[6];
  bool32                        bColorPhaseOffsetsGreenOverride;
  int32                         aColorPhaseOffsetsGreen[6];
  bool32                        bColorPhaseOffsetsBlueOverride;
  int32                         aColorPhaseOffsetsBlue[6];
  bool32                        bColorPhaseOffsetsWhiteOverride;
  int32                         aColorPhaseOffsetsWhite[6];
} HAL_MDP_SprDataConfigType;


/*!
 * \struct MDP_DemuraDataConfigType
 *
 * Demura data configuration parameters
 */
typedef struct _MDP_DemuraDataConfigType
{
  uint32 uDisplayWidth;
  uint32 uDisplayHeight;
  uint32 uHFCWidth;

  uint32 uPentile;
  uint8  uCfg0En;
  uint32 uCfg0Param0Len;
  uint32 uCfg0Param0[DEMURA_CFG0_PARAM_LEN];
  uint32 uCfg0Param1Len;
  uint8  uCfg0Param1[DEMURA_CFG0_PARAM_LEN];
  uint32 uCfg0Param2Len;
  uint64 uCfg0Param2C0[DEMURA_CFG0_PARAM2_LEN];
  uint64 uCfg0Param2C1[DEMURA_CFG0_PARAM2_LEN];
  uint64 uCfg0Param2C2[DEMURA_CFG0_PARAM2_LEN];
  uint32 uCfg0Param3Len;
  uint8  uCfg0Param3C0[DEMURA_CFG0_PARAM_LEN];
  uint8  uCfg0Param3C1[DEMURA_CFG0_PARAM_LEN];
  uint8  uCfg0Param3C2[DEMURA_CFG0_PARAM_LEN];
  uint32 uCfg0Param4Len;
  uint8  uCfg0Param4[DEMURA_CFG0_PARAM_LEN];

  uint8  uCfg1En;
  uint8  uCfg1HighIdx;
  uint8  uCfg1LowIdx;
  uint32 uCfg01Param0Len;
  uint16 uCfg01Param0[DEMURA_CFG1_PARAM_LEN];
  uint32 uCfg1Param0Len;
  uint16 uCfg1Param0C0[DEMURA_CFG1_PARAM0_LEN];
  uint16 uCfg1Param0C1[DEMURA_CFG1_PARAM0_LEN];
  uint16 uCfg1Param0C2[DEMURA_CFG1_PARAM0_LEN];

  uint8  uCfg2En;
  uint8  uCfg3En;
  uint32 uCfg3Param0Len;
  uint32 uCfg3Param0A[DEMURA_CFG3_PARAM01_LEN];
  uint32 uCfg3Param0B[DEMURA_CFG3_PARAM01_LEN];
  uint32 uCfg3ABAdj;

  uint8  uCfg4En;

  uint8  uCfg5En;
  uint32 uCfg5Param0Len;
  uint16 uCfg5Param0[DEMURA_CFG5_PARAM01_LEN];
  uint32 uCfg5Param1Len;
  uint16 uCfg5Param1[DEMURA_CFG5_PARAM01_LEN];
...
HAL_MDSS_ErrorType HAL_MDP_VBif_QOSSetup(HAL_MDP_VbifId eVbidId,
                                         uint32         uFlags);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_Interface_SetProperty()
*/
/*!
* \brief
...
*
* \param [in]   eInterfaceId          - Interface id
* \param [out]  pInterfaceConfig      - Info data
* \param [in]   uSetPropertyFlags     - Reserved
*
* \retval HAL_MDSS_ErrorType
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_MDP_Interface_SetProperty(HAL_MDP_InterfaceId              eInterfaceId,
                                                 HAL_MDP_InterfaceConfigType     *pInterfaceConfig,
                                                 uint32                           uSetPropertyFlags);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_GlobalMicroIdleConfig()
*/
/*!
* \brief
*     Configure global micro idle registers (controller, WD timer, counter)
*
* \param [in]   *psGlobalUidleCfg - Global micro idle config info
*
* \retval None
*
****************************************************************************/
void HAL_MDP_GlobalMicroIdleConfig(HAL_MDP_GlobalMicroIdleConfigType* psGlobalUidleCfg);
