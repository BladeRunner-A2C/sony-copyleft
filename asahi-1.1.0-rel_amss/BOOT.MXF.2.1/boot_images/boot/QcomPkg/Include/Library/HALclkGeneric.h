...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/Library/HALclkGeneric.h#1 $
...
==============================================================================
      Copyright (c) 2011-2018,2021,2022 QUALCOMM Technologies Incorporated.
                    All Rights Reserved.
...
#define HAL_CLK_BRANCH_CTRL_REG_CLK_DIS_BMSK                           0x00400000
...
#define HAL_CLK_GDSCR_RETAIN_FF_ENABLE_BMSK                            0x00000800
...
/*
 * Common distributed switch HW control fields (*_GDS_HW_CTRL register)
 */

 #define HAL_CLK_GDS_HW_CTRL_PWR_ON_STATUS_FMSK                        0x80000000
...
/*
 * Common divider fields (*_HIDR register)
 */
#define HAL_CLK_HIDR_CLK_DIV_HID_FMSK                                  0x0000001F
#define HAL_CLK_HIDR_CLK_DIV_HID_SHFT                                  0
...
void               HAL_clk_GenericConfigDomainMux       ( HAL_clk_ClockDomainDescType *pmClockDomainDesc, const HAL_clk_ClockMuxConfigType *pmConfig );
 ...
 */
void    HAL_clk_GenericDividerConfigDivider ( HAL_clk_DividerDescType  *pmDividerDesc, uint32 nDiv2x );
