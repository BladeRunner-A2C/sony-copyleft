...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/Library/qmi_idl_lib_internal.h#1 $
...
#define LAST_TLV (1 << 7)
/*TODO: Change this macro name and its uses since there is another global macro used in UEFI with the same name */
//#define OPTIONAL (1 << 6)
