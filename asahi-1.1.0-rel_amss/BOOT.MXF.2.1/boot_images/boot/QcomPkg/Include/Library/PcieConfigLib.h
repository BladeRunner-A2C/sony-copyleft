/** @file PcieConfigLib.h
  ...
  Copyright (c) 2012-2016, 2022-2023 Qualcomm Technologies Inc. All rights reserved.
 ...
 * corresponding to the root port index passed
 *
 * @param[in]  UINT32 RootPortIndex
...
/***************************************************************************//**
* @fn PcieConfigLibGetSegmentNumber
* @brief returns the segment number of the root port
*
* PCIe configuration Library API to get the segment number
*
* @param[in]  UINT32 RootPort Index
* @param[out] A pointer to fill in the segment number
*
* @retval EFI_SUCCESS       Segment number is obtained and filled output param
* @retval other             Appropriate error number.
******************************************************************************/
EFI_STATUS
EFIAPI
PcieConfigLibGetSegmentNumber(
   UINT32   RootPortIndex,
   UINT32  *SegmentNumber);

/***************************************************************************//**
* @fn PcieConfigLibSetupIoSpace
*
* @retval EFI_SUCCESS       Segment number is obtained and filled output param
* @retval other             Appropriate error number.
******************************************************************************/
EFI_STATUS
EFIAPI
PcieConfigLibSetupIoSpace (UINT32 RootPortIndex,
                           UINT64 Base,
                           UINT64 Limit,
                           UINT64 IOAddr);
