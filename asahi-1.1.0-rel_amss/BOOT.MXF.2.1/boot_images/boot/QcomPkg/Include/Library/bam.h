...
/*
===============================================================================
   Copyright (c) 2012-2014, 2020, 2022, 2023 QUALCOMM Technologies Incorporated
                          All Rights Reserved.
...
typedef enum
{
   BAM_IOVEC_FLAG_INT       = 0x80,  /**<  Generate interrupt */
   BAM_IOVEC_FLAG_EOT       = 0x40,  /**<  Generate end-of-transfer indication */
   BAM_IOVEC_FLAG_EOB       = 0x20,  /**<  Generate end-of-block indication */
   BAM_IOVEC_FLAG_NWD       = 0x10,  /**<  Generate notify when done */
   BAM_IOVEC_FLAG_CMD       = 0x08,  /**<  Submit a command descriptor */
   BAM_IOVEC_FLAG_LCK       = 0x04,  /**<  Lock the bam to the pipe's group
                                             (will remain locked until desc
                                              with unlock bit is submitted by a
                                              pipe from the locking pipe's grp ) */
   BAM_IOVEC_FLAG_UNLCK     = 0x02,  /**<  Unlock the bam */
   BAM_IOVEC_FLAG_IMM_CMD   = 0x01,  /**<  Submit an immediate command descriptor */

   BAM_IOVEC_FLAG_NO_SUBMIT = 0x00,  /**<  Do not submit descriptor to hardware */
...
typedef struct _bamconfig
{
  ...
  uint32 bam_mti_irq_pa;  /**< MTI interrupt generation address - Valid only
                               ...
                               above */
  void  *data;            /**< Additional caller provided memory/buffer(not to be used in MPSS image) */
} bam_config_type;
