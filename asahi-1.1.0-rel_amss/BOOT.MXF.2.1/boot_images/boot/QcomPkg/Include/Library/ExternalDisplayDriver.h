...
/************************************************************************************************************
*
** FUNCTION: ExtDisp_SetConnectionStatus()
*/
/*!
* \brief
*   Set external display connection status
*
* \param [in]   eDisplayId           - display id
...
*
**************************************************************************************************************/
MDP_Status ExtDisp_SetConnectionStatus(MDP_Display_IDType eDisplayId, bool32 bConnected, MDP_HotPlugEventDataType *pHotPlugData);

/************************************************************************************************************
*
** FUNCTION: ExtDisp_TunneledOpen()
*/
/*!
* \brief
*    Perform external display tunneled mode open.
*
* \param [in]      eDisplayId             - Display Id
* \param [in]      uFlags                 - Associated flags
*
...
*
**************************************************************************************************************/
MDP_Status ExtDisp_TunneledOpen(MDP_Display_IDType eDisplayId, uint32 uFlags);
