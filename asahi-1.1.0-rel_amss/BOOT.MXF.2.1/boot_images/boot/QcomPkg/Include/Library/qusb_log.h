 ...
 * @note        
 *
 *              Copyright 2012, 2017,2022-2023 Qualcomm Technologies Incorporated.
 *              All Rights Reserved.
...
typedef enum
{
  ...
  AL_BULK_INIT_EXIT_LOG = 0xF,
  
  AL_BULK_SHUTDOWN_LOG = 0x10,
  AL_BULK_RECEIVE_LOG,
  ...
  AL_CTX_INIT_LOG,
  AL_CTX_INIT_FAIL_LOG,
  AL_CTX_INIT_AGAIN_LOG,
  AL_CTX_FREE_LOG,
  AL_CTX_FREE_FAIL_LOG = 0x1F,
  AL_CTX_FREE_REDUNDANT_LOG = 0x20,
  AL_CTX_NULL_LOG,

  //DCD Layer Logs 
  DCD_UPDATE_PACKET_SIZE_LOG =0x30,
  DCD_NOTIFY_LOG,
  ...
  //Get Descriptor logs 
  HANDLE_GET_DESCRIPTOR_LOG =0x40,
  ...
  XFER_NOT_READY_DATA_IN_STATUS2_STAGE_ERROR_LOG =0x8F,
  XFER_NOT_READY_INCORRECT_DIR_STATUS2_ERROR_LOG =0x90,
  ...
  DCI_SET_ADDRESS_LOG =0xBF,
  DCI_STALL_ENDPOINT_LOG =0xC0,
  ...
  DCI_GET_MAX_PACKET_SIZE_LOG =0xCF,
  DCI_HANDLE_SET_SELECT_LOG = 0xD0,
  ...
  DCI_DEFAULT_CASE_LOG =0xDF,
  DCI_VBUS_STATE_CHANGE_LOG =0xE0,
  DCI_VBUS_REMOVAL_LOG,
  DCI_CTX_INIT_LOG,
  DCI_CTX_INIT_FAIL_LOG,
  DCI_CTX_INIT_AGAIN_LOG,
  DCI_CTX_FREE_LOG,
  DCI_CTX_FREE_FAIL_LOG,
  DCI_CTX_FREE_REDUNDANT_LOG,
  DCI_CTX_NULL_LOG,

  //MEM Adapt layer logs
  USB_MEM_ALLOC_SUCCESS_LOG =0x100,
  USB_MEM_ALLOC_SUCCESS_REUSE_LOG,
  USB_MEM_ALLOC_FAIL_LOG,
  USB_MEM_HANDLE_POOL_FULL_LOG,
  USB_MEM_POOL_FULL_LOG,
  USB_MEM_FREE_SUCCESS_LOG,
  USB_MEM_ALREADY_FREE_LOG,
  USB_MEM_FREE_FAIL_LOG,
  USB_MEM_POOL_IDX_LOG,
  USB_MEM_IDX_LOG,
  USB_MEM_PTR_LOG,
  USB_MEM_SIZE_LOG,
  USB_MEM_IS_ACTIVE_LOG,
  USB_MEM_HANDLE_FREE_FAIL_LOG,
  USB_MEM_HANDLE_FREE_SUCCESS_LOG,

  //FD Layer logs 
  HDLC_INIT_RX_LOG =0x110,
  HDLC_NOTIFY_CB_LOG,
  ...
  FD_CTX_INIT_LOG,
  FD_CTX_INIT_FAIL_LOG,
  FD_CTX_INIT_AGAIN_LOG,
  FD_CTX_FREE_LOG,
  FD_CTX_FREE_FAIL_LOG,
  FD_CTX_FREE_REDUNDANT_LOG,
  FD_CTX_NULL_LOG =0x130,
  
  //Cfg Log 
  QUSB_DCI_HWIO_REG_ARRAY_PROCESS__START_LOG =0x140,
  ...
  DCI_HANDLE_TRANSFER_COMPLETE_URB_NOT_ACTIVE_ERROR_LOG,
  DCI_NULL_POINTER_ERROR_LOG,
  DCI_MEMORY_OUT_OF_BOUNDS_ERROR_LOG =0x20F,
  DCI_INSUFFCIENT_HW_RSRC_LOG = 0x210,
  ...
  //timer logs 
  QUSB_QTIMER_IS_ALREADY_RUNNING_LOG =0x280, 
  QUSB_START_TIMER_LOG,
  QUSB_STOP_TIMER_LOG,
  QUSB_CHECK_QTIMER_FOR_EXPIRY_LOG,
  
  //Fast Enum Logs
  FAST_ENUM_NULL_PTR_ERROR_LOG = 0x290,
  ...
  RUMI_UTMI_FREQ_LOG = 0x2A0,
  RUMI_PIPE_FREQ_LOG,
  RUMI_PHY_FREQ_LOG,

  AL_NON_MAX_PKT_BUF_EXTRA_SIZE_LOG =0x2B0,
  AL_NON_MAX_PKT_BUF_MAX_PKT_SIZE_LOG, 
  AL_NON_MAX_PKT_BUF_RX_TRANSFER_SIZE_LOG,
  AL_NON_MAX_PKT_BUF_RECIEVE_RX_LOG, 
  AL_NON_MAX_PKT_BUF_RX_COMPLETE_LOG,
  AL_NON_MAX_PKT_BUF_RX_COMPLETE_EXTRA_DATA_LOG,
  AL_NON_MAX_PKT_BUF_RX_COMPLETE_LESS_DATA_LOG,
  AL_NON_MAX_PKT_BUF_USED_TWICE_LOG,
  AL_NON_MAX_PKT_BUF_MORE_DATA_ERROR_LOG,

  QUSB_DCI_APB_REG_READ_LOG = 0x2c0,
  QUSB_DCI_APB_REG_WRITE_LOG,
  QUSB_DCI_APB_REG_READ__FAIL_LOG,
  QUSB_DCI_APB_REG_WRITE__FAIL_LOG,

  DTB_GET_PROP_SIZE_LOG = 0x2d0,
  DTB_WRONG_PARAMETER_LOG,
  DTB_ERROR_LOG,
  
  LDR_PMI_NOT_DETECT_LOG = 0x2e0,
  LDR_VBUS_DET_ERROR_LOG,
  LDR_VBUS_LOW_LOG,
  LDR_CHGR_PORT_DET_ERROR_LOG,
  LDR_CHGR_TIMEOUT_LOG,

  CACHE__ONLY_MALLOC_LOG = 0x2f0,
  CACHE__FLUSH_LOG,
  CACHE__INVAL_LOG,
  CACHE__DCI_HANDLE_TRANSFER_COMPLETE_LOG,
  CACHE__DCI_HANDLE_CTRL_TRANSFER_LOG,
  CACHE__DCI_HANDLE_USB_RESET_LOG,
  CACHE__PRE_CTRL_TRB,

  USB_SHARED_I2C_PROCESS_CFG_FAIL__BAD_PARAMETER_LOG = 0x400,
  USB_SHARED_SPMI_PROCESS_CFG_FAIL__BAD_PARAMETER_LOG,

  USB_SHARED_SPMI_ENABLE_LOG = 0x410,
  USB_SHARED_SPMI_READ_LOG,
  USB_SHARED_SPMI_WRITE_LOG,
  USB_SHARED_SPMI_WRITE_FAIL_LOG,
  USB_SHARED_SPMI_READ_FAIL_LOG,
  USB_SHARED_SPMI_ENABLE_FAIL_LOG,
  USB_SHARED_SPMI_READ_FAIL__BAD_PARAMETER_LOG,
  USB_SHARED_SPMI_WRITE_FAIL__BAD_PARAMETER_LOG,

  REDRIVER_SET_MODE_LOG = 0x420,
  REDRIVER_INIT_LOG,
  REDRIVER_INIT_FAIL_LOG,
  REDRIVER_INIT_FAIL__BAD_PARAMETER_LOG,
  REDRIVER_INIT_FAIL__ALREADY_OPEN_LOG,
  REDRIVER_SET_MODE_FAIL__WRONG_MODE_LOG,
  REDRIVER_INIT_FAIL__OPEN_LOG,
  

  REPEATER_INIT_FAIL_LOG = 0x430,
  REPEATER_INIT_LOG,
  REPEATER_INIT_FAIL__SPMI_INIT_LOG,
  REPEATER_INIT_FAIL__SPMI_TUNE_LOG,
  RETIMER_INIT_FAIL_LOG = 0x440,

  WCD_INIT_FAIL__OPEN_LOG = 0x450,
...
// no-op the API call
#define qusb_log(a, b, c)
#define qusb_bus_log(a, b, c)
#define qusb_error_log(a, b, c)

#endif // QUSB_ENABLE_LOGGING
typedef enum
{
  QUSB_LOG_LDR,
  QUSB_LOG_TYPE_MAX
