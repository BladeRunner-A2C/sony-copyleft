...
Copyright 2011-2016,2018 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================*/
...
--------   --------     ------------------------------------------------------
04/11/23   vk           Add boot set
01/04/21   ds           Added DT address and size
04/12/18   kpa          Added boot_device_type
11/07/17   bd           Add uint32 uefi_image_magic
...
struct boot_shared_imem_cookie_type
{
  ...
  uint32 uefi_image_magic;

  /* Boot Device option */
  uint32 boot_device_type;
  
  /* Boot DT address in DDR*/
  uint64 boot_devtree_addr;
  
  /* Boot DT size */
  uint64 boot_devtree_size;

  /* Boot set for recovery boot */
  uint32 boot_set_type;
