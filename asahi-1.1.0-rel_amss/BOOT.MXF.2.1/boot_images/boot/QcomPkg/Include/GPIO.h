...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/GPIO.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/30/21   ara     Added device tree specific APIs.
...
/**
  ...
  @return
  GPIO_SUCCESS -- The operation completed successfully.
  GPIO_ERROR   -- The parameters are invalid or the configuration not found.
