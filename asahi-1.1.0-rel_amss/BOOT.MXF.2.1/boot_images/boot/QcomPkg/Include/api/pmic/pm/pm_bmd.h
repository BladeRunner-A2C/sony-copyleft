 ...
 *   the PMIC BMD module.
 *
 *  \n &copy; Copyright (c) 2017-2022 QUALCOMM Technologies Incorporated. All Rights Reserved.
 */
...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/pmic/pm/pm_bmd.h#1 $
...
/**
 * @brief This function retrieves the source of BMD
 *
 * @param[in]  bus_id:
 *               0 for primary spmi bus
 *               1 for secondary spmi bus
 ...
 *               0 for primary pmic
 *               1 for secondary pmic
 * @param[out] bmd_sel: @pm_bmd_src_ctl_sel_type for more info
 *
 * @return  pm_err_flag_type
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
 *          version of the PMIC.
