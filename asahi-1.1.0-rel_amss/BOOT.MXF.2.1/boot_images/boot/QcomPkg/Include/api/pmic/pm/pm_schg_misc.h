...
/**
* @brief This API sets eng_sdcdc_cfg39
*
* @details
*  This API sets eng_sdcdc_cfg39
*
* @param[in]  bus_id:
*               0 for primary spmi bus
*               1 for secondary spmi bus
...
*          PM_ERR_FLAG_SUCCESS               = SUCCESS.
*/
pm_err_flag_type pm_schg_misc_set_eng_sdcdc_cfg39(uint32 bus_id, uint32 device_index, uint8 reg_val);
