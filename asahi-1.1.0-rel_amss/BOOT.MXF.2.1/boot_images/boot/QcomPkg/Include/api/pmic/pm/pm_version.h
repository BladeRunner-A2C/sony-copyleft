...
typedef enum
{
   ...
   PMIC_IS_PM1010H   = 62,
   PMIC_IS_PM7325    = 63,
   PMIC_IS_PM8010    = 65,	//leica2
   PMIC_IS_PMG1110   = 67, //secojr
   PMIC_IS_VOODOO6   = 69,
   PMIC_IS_VOODOO8   = 70, 
   PMIC_IS_KOHALA    = 71,
   PMIC_IS_NALOJR    = 72, //nalo jr
   PMIC_IS_HUMU      = 73,
   PMIC_IS_AZURA     = 74,
   PMIC_IS_SCULPINA  = 76,
   PMIC_IS_BONEFISH  = 80,
   PMIC_IS_MORRO     = 81,
   PMIC_IS_COSWORTH  = 82,
   PMIC_IS_DONINGTON = 83,
   PMIC_IS_ETNA      = 85,
   PMIC_IS_COTTID_L  = 89,
   PMIC_IS_COTTID_ND = 90,
   PMIC_IS_COTTID_A  = 91,
...
typedef struct
{
  ...
  uint32         nSlaveCount;            /**< Slave Count on PmicModel */
} pm_device_info_type;
