...
/*! \file
*  \n
*  \brief  pm_schg_chgr.h PMIC-SCHG MODULE RELATED DECLARATION
...
typedef enum
{
  PM_SCHG_CHGR_PRE_CHARGE_CURRENT,       //pre_charge current
  PM_SCHG_CHGR_FAST_CHARGE_CURRENT,      //fast charge current
  PM_SCHG_CHGR_TERMINATION_CURRENT,      //termination current
  PM_SCHG_TCCC_CHGR_TERMINATION_CURRENT, //tccc termination current
  PM_SCHG_CHGR_CURRENT_TYPE_INVALID,     //invalid
...
typedef enum
{
  ...
  PM_SCHG_BATT_CHGR_STATUS_DISABLED,
...
typedef struct
{
  ...
  boolean pre_rchg; //Pre-recharge Status
  boolean reserved2;
...
/**
* @brief This function gets the JEITA temperature thresholds
*
* @details
*  This API gets the JEITA temperature thresholds for soft and hard limits.
*
* @param[in]  bus_id:
*               0 for primary spmi bus
*               1 for secondary spmi bus
...
* @param[in] pmic_index:         The pmic_index of charger module.
* @param[in] pm_schg_chgr_jeita_threshold_type       Jeita zone to be configured
* @param[out] jeita_threshold      Temperature value for the JEITA zone
*
*
* @return  pm_err_flag_type
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
