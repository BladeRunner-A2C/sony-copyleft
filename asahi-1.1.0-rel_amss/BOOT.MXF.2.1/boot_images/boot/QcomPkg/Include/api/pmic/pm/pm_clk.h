...
typedef uint32 pm_clk_drv_strength_type;
...
*/
pm_err_flag_type pm_clk_drv_strength(uint32 bus_id, uint32 pmic_chip, pm_clk_type clk_type, pm_clk_drv_strength_type strength);
...
* @return pm_err_flag_type PM_ERR_FLAG_SUCCESS if successful
*/
pm_err_flag_type pm_clk_sw_enable(uint32 bus_id, uint32 pmic_chip, pm_clk_type clk_type, pm_on_off_type on_off);
...
* @return pm_err_flag_type PM_ERR_FLAG_SUCCESS if successful
*/
pm_err_flag_type pm_clk_pull_down(uint32 bus_id, uint32 pmic_chip, pm_clk_type clk_type, pm_on_off_type on_off);
...
* @return pm_err_flag_type PM_ERR_FLAG_SUCCESS if successful
*/
pm_err_flag_type pm_clk_pin_ctrled(uint32 bus_id, uint32 pmic_chip, pm_clk_type clk_type, pm_on_off_type on_off);
...
* @return pm_err_flag_type PM_ERR_FLAG_SUCCESS if successful 
*/ 
pm_err_flag_type pm_clk_set_out_clk_div(uint32 bus_id, uint32 pmic_device_index, pm_clk_type clk, uint32 divider);
...
* @return pm_err_flag_type PM_ERR_FLAG_SUCCESS if successful 
*/ 
pm_err_flag_type pm_clk_get_status(uint32 bus_id, uint32 pmic_chip, pm_clk_type clk, pm_clk_status_type *clk_status);
