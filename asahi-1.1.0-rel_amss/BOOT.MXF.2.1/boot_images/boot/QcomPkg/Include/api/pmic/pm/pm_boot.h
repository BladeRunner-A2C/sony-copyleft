 ...
 *   
 *  Copyright (c) 2011,2014-2017,2021,2023 Qualcomm Technologies, Inc. All rights reserved.
...
/*! \brief This function initializes device without PSI
 *  \return Error flag.
 *
 */ 
pm_err_flag_type 
...
/**
 * @brief This function returns the PSI config memory info
 * 
 * @details
 *   This function returns the memory base address 
 *   and size used to hold the PSI configuration structure
 *   
 * @param[out] base_addr:  PSI data structure start address
 * @param[out] buf_size:  PSI data structure size in bytes
 *
 * @return pm_err_flag_type PM_ERR_FLAG_INVALID = ERROR. 
 *         PM_ERR_FLAG_SUCCESS = SUCCESS.
 *
...
/**
 * @brief This function major and minor number of PMIC OTP
 * 
 * @details
 *   This function returns the memory base address 
 *   and size used to hold the PSI configuration structure
 *   
 * @param[out] major :  OTP major number
 * @param[out] minor :  OTP minor number
 * @return pm_err_flag_type PM_ERR_FLAG_INVALID = ERROR. 
 *         PM_ERR_FLAG_SUCCESS = SUCCESS.
 *
 *
...
/**
 * @brief This function returns ASPD Done status
 * 
 * @details
 *   This function returns the APSD status
 *   return
 *   APSD Completed = TRUE
 *   APSD Not completed = FALSE
 *   
 * @param[out] major :  APSD Done status
 * @return pm_err_flag_type PM_ERR_FLAG_INVALID = ERROR. 
 *         PM_ERR_FLAG_SUCCESS = SUCCESS.
 *
 *
