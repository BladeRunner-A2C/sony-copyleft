...
/** 
  @enum pm_pbs_core_type
  @brief PBS Core types
 */
typedef enum 
{  
  PM_PBS_CORE_1  = 0,
 ...
 * @param[in] core: PBS Core type. Refer enum 
 ...
 */
pm_err_flag_type 
pm_pbs_client_enable(uint32 bus_id, uint32 pmic_device_index, pm_pbs_core_type pbs_core, pm_pbs_client_type client, boolean enable);
 ...
 */
pm_err_flag_type 
pm_pbs_client_enable_status(uint32 bus_id, uint32 pmic_device_index, pm_pbs_core_type pbs_core, pm_pbs_client_type client, boolean *status);
 ...
 */
pm_err_flag_type 
pm_pbs_client_sw_trigger(uint32 bus_id, uint32 pmic_chip, pm_pbs_core_type pbs_core, pm_pbs_client_type client, pm_pbs_client_trigger trigger, 
 ...
 */
pm_err_flag_type
pm_pbs_client_hw_trigger_enable(uint32 bus_id, uint32 pmic_chip, pm_pbs_core_type pbs_core_index, pm_pbs_client_type pbs_client_index, 
                                pm_pbs_client_trigger hw_trigger, pm_pbs_client_trigger_edge_type trigger_edge, boolean enable);
