...
pm_err_flag_type
pm_schg_dcdc_set_ref_max_psns(uint32 bus_id, uint32 pmic_index, uint32 current_mA);
...
/**
* @brief This function sets eng_sdcdc_cfg1
*
* @param[in]  bus_id:
*               0 for primary spmi bus
*               1 for secondary spmi bus
* 
* @param[in] pmic_index:         The pmic_index of charger module.
* @param[in] reg_val:            reg val to set to this register
*
* @return  pm_err_flag_type
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
*                                              version of the PMIC.
