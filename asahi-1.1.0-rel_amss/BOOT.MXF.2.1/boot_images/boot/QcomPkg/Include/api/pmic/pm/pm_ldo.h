...
Copyright (c) 2011 - 2023 by QUALCOMM Technologies Inc.  All Rights Reserved.
===========================================================================*/
 ...
 */
pm_err_flag_type 
pm_ldo_sw_enable(uint8 pmic_chip, uint8  ldo_peripheral_index, pm_on_off_type  on_off, boolean wait_for_settle);
...
pm_err_flag_type 
pm_ldo_volt_level(uint8 pmic_chip, uint8 ldo_peripheral_index, pm_volt_level_type volt_level, boolean wait_for_settle);
 ...
 */
pm_err_flag_type 
pm_ldo_uls(uint8 pmic_chip, uint8 ldo_peripheral_index, pm_volt_level_type volt_level);
...
/** Enables or disables the LDO OCP 
 * @name 
 *     pm_ldo_ocp_enable
 *
 * @description
 *     Enables the OCP for LDO.
 * 
...
/** Enables or disables the LDO self shutdown OCP 
 * @name 
 *     pm_ldo_ocp_self_dhutdown_enable
 *
 * @description
 *     Enables the self shutdown OCP for LDO.
 * 
 * @param[in]  pmic_chip. PMIC_A:0,PMIC_B=1,PMIC_C:2,PMIC_D:3,PMIC_E:4,PMIC_F:5,PMIC_G:6
 * @param[in]  ldo_peripheral_index:
 *                LDO peripheral 
...
/** Enables or disables the LDO AHC(Auto Headroom Control).
 * @name 
 *     pm_ldo_ahc_enable
 *
 * @description
 *     Enables the AHC for LDO. Ensure AHC on parent rail is also enabled.
 * 
 * @param[in]  pmic_chip. PMIC_A:0,PMIC_B=1,PMIC_C:2,PMIC_D:3,PMIC_E:4,PMIC_F:5,PMIC_G:6
 * @param[in]  ldo_peripheral_index:
 *                LDO peripheral 
 ...
 */
pm_err_flag_type
pm_ldo_ahc_enable(uint8 pmic_chip, uint8 ldo_peripheral_index, pm_on_off_type on_off);

/** Returns ahc status of the LDOs.
 ...
 */
pm_err_flag_type 
pm_ldo_ahc_status(uint8 pmic_chip, uint8 ldo_peripheral_index, pm_on_off_type* on_off);

/** return ldo mode at ocp.
...
*/
pm_err_flag_type
pm_ldo_ocp_mode_status(uint8 pmic_chip, uint8 peripheral_index, boolean *ocp_mode_status);

/** return ldo ocp response config at ocp.
    ...
    @param[in] peripheral_index       LDO peripheral index.
                                      ...
                                      LDO peripheral). See
                                      @xnameref{hdr:ldoPeripheralIndex}.
    @param[in]  ldo_ocp_resp          0 = default
                                      1 = INT
