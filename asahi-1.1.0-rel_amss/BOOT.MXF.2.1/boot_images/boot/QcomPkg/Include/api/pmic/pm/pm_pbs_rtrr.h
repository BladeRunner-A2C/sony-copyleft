 ...
 *  \n
 *  \n &copy; Copyright 2016-2017, 2021 QUALCOMM Technologies Incorporated, All Rights Reserved
 */
/* =======================================================================
                             Edit History
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/pmic/pm/pm_pbs_rtrr.h#1 $
...
pm_err_flag_type
pm_pbs_rtrr_ram_dump(uint32 bus_id, uint32 slave_id, pm_pbs_rtrr_dump_data_type *rtrr_info_ptr);
