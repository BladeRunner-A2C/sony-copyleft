...
typedef enum
{
    PM_QUIET_MODE__FORCE_PFM_DITHER_ENABLED,
    PM_QUIET_MODE__PWM,      
    PM_QUIET_MODE__INVALID
}pm_smps_quiet_mode_buck_operation_type;
...
/** Enables or disables the SMPS rail.
    ...
    @param[in] wait_for_settle         TRUE if you want to wait for rail to settle. Otherwise FALSE	
 
    @return 
    Error flag type -- See #pm_err_flag_type.
 */
pm_err_flag_type 
pm_smps_sw_enable(uint8 pmic_chip, uint8  smps_peripheral_index, pm_on_off_type  on_off, boolean wait_for_settle);
 ...
 */
pm_err_flag_type 
pm_smps_volt_level(uint8 pmic_chip, uint8 smps_peripheral_index, pm_volt_level_type volt_level, boolean wait_for_settle);
...
/** Selects a frequency for the SMPS. Each SMPS can operate under a
    ...
    @param[in] volt_level            Variable that carry the voltage level request in
                                     microvolts (uint32).
 ...
 */
pm_err_flag_type 
pm_smps_set_uls(uint8 pmic_chip, uint8 smps_peripheral_index, pm_volt_level_type volt_level);
...
/**
  Sets global quiet mode enable for SMPS.
    ...
    @param[in] pm_quiet_mode_follow_type
                                              PM_QUIET_MODE_FOLLOW__DISABLE
                                              PM_QUIET_MODE_FOLLOW__QUIET
	@return 
    Error flag type -- See #pm_err_flag_type.
 */
pm_err_flag_type 
pm_smps_quiet_mode_mask(uint8 pmic_chip, uint8 smps_peripheral_index, pm_quiet_mode_follow_type quiet_mode);
...
/**
 * @name 
 *     pm_smps_quiet_mode_buck_mode
 *
 * @description
 *    Set quiet mode for buck_mode.
 *     
 * @param[in] pmic_chip             Primary: 0, Secondary: 1. 
 * 
 * @param[in] smps_peripheral_index SMPS peripheral index. Starts at 
...
/**
 * @name 
 *     pm_smps_global_quiet_mode_pin_ctl_enable
 *
 * @description
 *    Set quiet mode pin_ct.
 *  
 * @param pmic_chip             Primary: 0, Secondary: 1.
 * @param 
 *     pm_on_off_type : PM_ON/PM_OFF
 *
 * @return 
 *     error flag type - pm_err_flag_type
 */
...
/** Configures to clear VREG_OCP status of the SMPS .
    ...
    @param[in] *ocp_info              Contains OCP status of the regulator.
...
/** Enables or disables the SMPS Latch Enable.
    @name 
       pm_smps_ocp_latch_en
    @param[in] pmic_chip             Primary PMIC: 0, Secondary PMIC: 1.
...
/** Enables or disables the SMPS AHC(Auto Headroom Control).
 * @name 
 *     pm_smps_ahc_enable
 *
 * @description
 *     Enables the AHC for SMPS.
 * 
 * @param[in]  pmic_chip. PMIC_A:0,PMIC_B=1,PMIC_C:2,PMIC_D:3,PMIC_E:4,PMIC_F:5,PMIC_G:6
 * @param[in]  smps_peripheral_index:
 *                SMPS peripheral 
 * @param[in]  on_off:  
 ...
 */
pm_err_flag_type
pm_smps_ahc_enable(uint8 pmic_chip, uint8 smps_peripheral_index, pm_on_off_type on_off);

/** Returns ahc status of the SMPS.
 ...
 */
pm_err_flag_type
pm_smps_ahc_status(uint8 pmic_chip, uint8 smps_peripheral_index, pm_on_off_type *on_off);

/** Enables or disables the smps OCP 
 * @name 
 *     pm_smps_ocp_enable
 *
 * @description
 *     Enables the OCP for smps.
 * 
 * @param[in]  pmic_chip. PMIC_A:0,PMIC_B=1,PMIC_C:2,PMIC_D:3,PMIC_E:4,PMIC_F:5,PMIC_G:6
 * @param[in]  smps_peripheral_index:
 *                smps peripheral
 * @param[in] sw_mode :
 *              Selects the mode of a regulator : NPM and LPM supported
 *                    
 * @param[in]  on_off:  
 *                Refer to pm_resources_and_types.h for
 *                the enum info.
 ...
 */
pm_err_flag_type
pm_smps_ocp_enable( uint8 pmic_chip, uint8  smps_peripheral_index, pm_sw_mode_type sw_mode, pm_on_off_type  on_off);

/** Sets the reserve headroom for the SMPS AHC(Auto Headroom Control).
 * @name 
 *     pm_smps_ahc_set_headroom
 *
 * @description
 *     Sets the reserve & Max HR of AHC for SMPS.
 * 
 * @param[in]  pmic_chip. PMIC_A:0,PMIC_B=1,PMIC_C:2,PMIC_D:3,PMIC_E:4,PMIC_F:5,PMIC_G:6
 * @param[in]  smps_peripheral_index:
 *                SMPS peripheral 
 ...
 */
pm_err_flag_type
pm_smps_ahc_set_headroom(uint8 pmic_chip, uint8 smps_peripheral_index, uint8 headroom);
...
/** Returns ahc status of the SMPS.
    ...
    @param[in] smps_peripheral_index SMPS peripheral index. Starts at 
                                     0 (for the first SMPS peripheral).
                                     See @xnameref{hdr:smpsPeripheralIndex}.
    @param[in]  ocp_mode_status       1= NPM mode @OCP
                                      0= LPM mode @OCP
