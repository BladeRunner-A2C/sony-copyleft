 ...
 *
 *  \n &copy; Copyright (c) 2009-2020 QUALCOMM Technologies Incorporated. All Rights Reserved.
 */
...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/pmic/pm/pm_coincell.h#1 $
...
enum 
{
  PM_COINCELL_RSET_2K1    =  0,
  PM_COINCELL_RSET_1K7    =  1,
  PM_COINCELL_RSET_1K62   =  PM_COINCELL_RSET_1K7,
  PM_COINCELL_RSET_1K25   =  PM_COINCELL_RSET_1K7,
  PM_COINCELL_RSET_1K2    =  2,
  PM_COINCELL_RSET_1K15   =  PM_COINCELL_RSET_1K2,
  PM_COINCELL_RSET_0K75   =  PM_COINCELL_RSET_1K2,
  PM_COINCELL_RSET_0K8    =  3 ,
  PM_COINCELL_RSET_0K717  =  PM_COINCELL_RSET_0K8,
  PM_COINCELL_RSET_0K15   =  PM_COINCELL_RSET_0K8,
...
pm_err_flag_type 
pm_coincell_set_charging_voltage(uint8 pmic_chip, uint32 coin_chg_rset_value);
