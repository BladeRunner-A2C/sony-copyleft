...
*/
pm_err_flag_type pm_clk_xo_mode(uint32 bus_id, uint32 pmic_chip, pm_clk_type clk_type, pm_clk_xo_mode_type mode);
...
* @return pm_err_flag_type PM_ERR_FLAG_SUCCESS if successful
*/
pm_err_flag_type pm_clk_xo_trim(uint32 bus_id, uint32 pmic_chip, pm_clk_type clk_type, uint32 trim_value);
