...
/*! \file
*  \n
*  \brief  pm_schg_usb.h PMIC-SCHG MODULE RELATED DECLARATION 
...
typedef enum
{
  ...
  PM_SCHG_USB_IRQ_REVI,                           //High when USB_IN voltage is below the Reverse-current threshold (VREVI = VSYS - ~130mV)
...
typedef enum
{
  ...
  PM_SCHG_USB_USBIN_ADAPTER_ALLOW_12V15V             = 4,
  PM_SCHG_USB_USBIN_ADAPTER_ALLOW_5V_OR_12V15V       = 5,
  PM_SCHG_USB_USBIN_ADAPTER_ALLOW_9V_TO_12V15V       = 6,
  PM_SCHG_USB_USBIN_ADAPTER_ALLOW_5V_OR_9V_TO_12V15V = 7,
  PM_SCHG_USB_USBIN_ADAPTER_ALLOW_5V_TO_9V           = 8,
  PM_SCHG_USB_USBIN_ADAPTER_ALLOW_5V_TO_12V15V       = 12,
  PM_SCHG_USB_USBIN_ADAPTER_ALLOW_INVALID,
} pm_schg_usb_usbin_adapter_allowance_type;

typedef enum
{
  PM_SCHG_USB_APSD_STATUS_APSD_DTC_STATUS_DONE,        //APSD Detection Done
  PM_SCHG_USB_APSD_STATUS_QC_CHARGER,                  //Quick Charge Detection Done
  PM_SCHG_USB_APSD_STATUS_QC_AUTH_DONE_STATUS,         //QC Authentication Algorithm Done
  PM_SCHG_USB_APSD_STATUS_VADP_CHANGE_DONE_AFTER_AUTH, //Adaptive Voltage Change Done after Authentication
  PM_SCHG_USB_APSD_STATUS_ENUMERATION_DONE,            //SDP Enumeration Done
  PM_SCHG_USB_APSD_STATUS_SLOW_PLUGIN_TIMEOUT,         //Slow Plugin Timeout Expired
  PM_SCHG_USB_APSD_STATUS_HVDCP_CKECK_TIMEOUT,         // HVDCP detection timeout
  PM_SCHG_USB_APSD_STATUS_INVALID,                     //invalid
...
typedef enum
{
  ...
  PM_SCHG_USB_BC1P2_SRC_DETECT,
  PM_SCHG_USB_USBIN_OPTIONS1_CFG_4,
 ...
 * 
 * @param[in] pmic_index: The pmic_index of charger module.
 * @param[in] irq:        SCHG irq type. Refer enum pm_schg_usb_irq_type.
 *
 *
 * @return  pm_err_flag_type 
 *          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
 ...
 * @param[in] pmic_index: The pmic_index of charger module.
 * @param[in] irq:        SCHG irq type. Refer enum pm_schg_usb_irq_type.  
 * @param[in] trigger:    One of different irq triggers. Refer enum pm_irq_trigger_type 
 ...
 * 
 * @param[in] pmic_index: The pmic_index of charger module.
 * @param[in] irq:        SCHG irq type. Refer enum pm_Smbb_irq_type. 
...
* 
* @param[in] pmic_index:      The pmic_index of charger module.
* @param[in] adptr_allowance: Refer  pm_schg_usb_usbin_adapter_allowance_type for more info
* 
*
* @return  pm_err_flag_type 
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
...
* 
* @param[in] pmic_index:       The pmic_index of charger module.
* @param[out] adptr_allowance: Refer pm_schg_usb_usbin_adapter_allowance_type for more info
*
*
* @return  pm_err_flag_type 
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
...
* 
* @param[in] pmic_index: The pmic_index of charger module.
* @param[out] apsd_result  Refer #pm_chg_charger_port_type. These value could be OR-ed
*
*
* @return  pm_err_flag_type 
*          PM_ERR_FLAG_FEATURE_NOT_SUPPORTED = Feature not available on this
