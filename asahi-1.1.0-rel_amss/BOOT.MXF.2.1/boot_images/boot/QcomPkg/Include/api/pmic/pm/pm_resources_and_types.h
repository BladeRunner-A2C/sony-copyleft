...
#define VREG_TYPE_STRING_LEN        5   // MAX("SMPS", "LDO", "BOB")
...
/**
 * Regulator OCP information.
 */
typedef struct 
{   
   boolean  ocp_occured;                        /**< OCP status of the regulator.               */
   boolean  is_ocp_mode_supported;              /**< Does regulator contain ocp mode register.  */
   uint8    ocp_mode_status;                    /**< Mode of the regulator at ocp.              */
   char     vreg_type[VREG_TYPE_STRING_LEN];    /**< Regulator type, "SMPS"/"LDO"/"BOB".        */
} pm_vreg_ocp_info_type;
