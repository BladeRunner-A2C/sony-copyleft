 ...
 *         power rail driver.
 *  \n
 *  \n &copy; Copyright 2016-2018, 2023 QUALCOMM Technologies Incorporated, All Rights Reserved
 */
/* ======================================================================= */
...
/* =======================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/pmic/pm/pm_bob.h#1 $
...
/** Configures RGB headroom
    ...
    @param[in] peripheral_index       BOB peripheral index.
                                      ...
                                      BOB peripheral). See
                                      @xnameref{hdr:ldoPeripheralIndex}.
    @param[in] volt_level             voltage in millivolt for headroom
