/*******************************************************************************
 ...
 Copyright (c) 2013-2014,2019-2020 Qualcomm Technologies Incorporated.
 All rights reserved.
 ******************************************************************************/
/*==============================================================================
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/boot/ddr_common_v3_5.h#1 $
$DateTime: 2024/04/02 23:00:31 $
$Author: cirrusp4svc $
================================================================================*/

#ifndef DDR_COMMON_V3_5_H
#define DDR_COMMON_V3_5_H
...
}__attribute__( ( aligned ( 8 ) ) ) DDR_CHANNEL;
...
}__attribute__( ( aligned ( 8 ) ) ) DDR_CHIPSELECT;
...
}__attribute__( ( aligned ( 8 ) ) ) DDR_SNS_STATUS;
...
}__attribute__( ( aligned ( 8 ) ) ) DDR_MANUFACTURES;
...
}__attribute__( ( aligned ( 8 ) ) ) ddr_interleave_type;     
...
}__attribute__( ( aligned ( 8 ) ) ) ddr_interface_state;
...
}__attribute__( ( aligned ( 8 ) ) ) ddr_size_info;
...
}__attribute__( ( aligned ( 8 ) ) ) ddr_size_partition;
...
typedef struct
{
  ...
  uint32 ddr_cs0_addr[MAX_IDX];  /**< DDR start address of Interface and chip select 0. */
  uint32 ddr_cs1_addr[MAX_IDX];  /**< DDR start address of Interface and chip select 1. */
  
  uint32 ddr_cs0_remapped_addr[MAX_IDX];  /**< DDR remapped start address of Interface and chip select 0. */
  uint32 ddr_cs1_remapped_addr[MAX_IDX];  /**< DDR remapped start address of Interface and chip select 1. */
  
  uint32 highest_bank_bit; /**< DDR Highest bank bit based on detected topology */
}__attribute__( ( aligned ( 8 ) ) ) ddr_sns_size_info;


/** @} */ /* end_addtogroup ddr_data_structures */

#endif  /* DDR_COMMON_V3_5_H */
