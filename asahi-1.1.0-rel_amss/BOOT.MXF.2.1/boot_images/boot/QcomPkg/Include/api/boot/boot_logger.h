...
Copyright 2010-2012, 2014-2017, 2019-2023 by Qualcomm Technologies, Incorporated.
All Rights Reserved.
============================================================================*/
...
--------   --------     ------------------------------------------------------
04/27/23   ak           Added boot_log_cluster_core
...
**  Function : boot_log_cluster_core
...
* 
* @brief  
*   Logs the SBL Boot Cluster and Core.
*
* @par Dependencies
*   None
*
...
*  
*/
void boot_log_cluster_core(void);
