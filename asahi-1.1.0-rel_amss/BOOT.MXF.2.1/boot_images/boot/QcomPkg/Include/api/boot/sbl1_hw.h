...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/boot/sbl1_hw.h#1 $
...
* 
* @brief
*   This function initializes tsens.
* 
* @param[in] 
*   None 
*     
...
* 
*/
bl_error_boot_type tsens_init_if(boot_handle config_context_handle);
#endif
