 ...
 ******************************************************************************/
/*==============================================================================
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/boot/ddr_common.h#1 $
...
--------   ---     ------------------------------------------------------------
11/21/22   bpk     moved enum DARE_REGION_ID to "SocPkg\<Target>\Include\ddr_target_common.h" for target specific
...
typedef struct
{
    uint32 shrm_dmem_secure_region_start_addr;
    uint32 shrm_dmem_secure_region_end_addr;
    uint32 shrm_dmem_secure_region_size_in_bytes;
    uint32 tme_fw_auth_flag;
}SHRM_DMEM_INFO_STRUCT; 
