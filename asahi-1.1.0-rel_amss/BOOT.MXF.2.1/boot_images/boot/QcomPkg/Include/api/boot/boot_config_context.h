...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/boot/boot_config_context.h#1 $
$DateTime: 2024/04/02 23:00:31 $
$Author: cirrusp4svc $

when        who      what, where, why
----------  ---      ----------------------------------------------------------
02/15/23    ck       Renamed all EDK2 entries
01/26/23    suhas    Added CONFIG_CONTEXT_PARTITION_INTERFACE
10/05/22    ck       Added socket related additions
...
typedef enum
{
  ...
  CONFIG_CONTEXT_PARTITION_INTERFACE,                           //config_context_global_values
  ...
  CONFIG_CONTEXT_CACHE_INTERFACE,                               //config_context_global_values
  CONFIG_CONTEXT_ARM_INTERFACE,                                 //config_context_global_values
