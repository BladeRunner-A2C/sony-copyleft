 ...
 *
 * Copyright (c) 2014-2015, 2018, 2020-2023
...
2022-01-17   ss      Added sdcc_handle_partial_open()
2021-04-27   jt      Add sdcc_handle_enable_retuning()
2020-06-04   jt      Add power management support  
2018-07-13   jt      Add UHS1 card type 
...
typedef enum
{
   ...
   SDCC_CARD_UHS1    = 7  /**< SD UHS-1 card */
} SDCC_CARD_TYPE;
...
typedef struct 
{
   UINT8  speed_mode;             /**< Current speed mode */
   UINT8  volt_corner;            /**< Current voltage corner */
} sdcc_op_mode_info;
...
/** \details
 * This function first initializes the SDCC controller with minimal configuration
 * to fetch device tree configuration and later do a full initialization using sdcc_handle_open
 * @param[in] driveno
 *    a valid drive number between 0 and the total number of card slots - 1
 *
 * @param[in] phy_partition_num
 ...
 *
 */
struct sdcc_device *sdcc_handle_partial_open( INT16 driveno, UINT32 phy_partition_num );
...
/******************************************************************************
* Name: sdcc_handle_get_operational_mode_capabilities
*
* Description:
*  This function provides information about speed modes and voltage corners.
*
* Arguments:
*    handle[IN]         : a pointer to the SDCC device that was returned from
*                         sdcc_handle_open()
*    capabilities[OUT]  : information about the speed modes and voltage corners
* 
* Returns:
*    SDCC_NO_ERROR if successful
*    Error code otherwise
*
******************************************************************************/
SDCC_STATUS sdcc_handle_get_operational_mode_capabilities (struct sdcc_device *handle, 
                                                           void *capabilities);

/******************************************************************************
* Name: sdcc_handle_get_operational_mode_info
*
* Description:
*  This function gets the current information about the operating speed
*  mode and voltage corner. 
*
* Arguments:
*    handle[IN]         : a pointer to the SDCC device that was returned from
*                         sdcc_handle_open()
*    curr_info[OUT]     : information about the current operating mode
* 
* Returns:
*    SDCC_NO_ERROR if successful
*    Error code otherwise
*
******************************************************************************/
SDCC_STATUS sdcc_handle_get_operational_mode_info (struct sdcc_device *handle, 
                                                   sdcc_op_mode_info *curr_info);

/******************************************************************************
* Name: sdcc_handle_set_speed
*
* Description:
*  This function sets the SDCC speed mode, keeping the existing voltage
*  corner.
*
* Arguments:
*    handle[IN]         : a pointer to the SDCC device that was returned from
*                         sdcc_handle_open()
*    speed_mode[IN]     : speed mode to switch to
* 
* Returns:
*    SDCC_NO_ERROR if successful
*    Error code otherwise
*
******************************************************************************/
SDCC_STATUS sdcc_handle_set_speed (struct sdcc_device *handle, UINT8 speed_mode);

/******************************************************************************
* Name: sdcc_handle_configure_volt_corner
*
* Description:
*  This function changes the SDCC operating mode based on the voltage corner,
*  keeping the existing speed mode.
*
* Arguments:
*    handle[IN]         : a pointer to the SDCC device that was returned from
*                         sdcc_handle_open()
*    volt_corner[IN]    : voltage corner to switch to 
* 
* Returns:
*    SDCC_NO_ERROR if successful
*    Error code otherwise
*
******************************************************************************/
SDCC_STATUS sdcc_handle_configure_volt_corner (struct sdcc_device *handle, 
                                               UINT8 volt_corner);

/******************************************************************************
* Name: sdcc_handle_set_operational_mode
*
* Description:
*  This function sets the SDCC operating mode.
*
* Arguments:
*    handle[IN]         : a pointer to the SDCC device that was returned from
*                         sdcc_handle_open()
...
*
******************************************************************************/
SDCC_STATUS sdcc_handle_set_operational_mode (struct sdcc_device *handle, 
                                              UINT8 volt_corner, 
                                              UINT8 speed_mode);

/******************************************************************************
* Name: sdcc_handle_enable_retuning
*
* Description:
*  This function enables retuning for HS200 and higher modes
*
* Arguments:
*    handle[IN]         : a pointer to the SDCC device that was returned from
*                         sdcc_handle_open()
...
*
******************************************************************************/
SDCC_STATUS sdcc_handle_enable_retuning (struct sdcc_device *handle);
