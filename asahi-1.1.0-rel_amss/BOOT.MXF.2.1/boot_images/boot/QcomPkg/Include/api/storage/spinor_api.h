 ...
 *
 * Copyright (c) 2017, 2022, 2023 Qualcomm Technologies Incorporated.
 * All Rights Reserved.
...
#define SPINOR_DEVICE_SLOT_NOT_OPEN       (-7)  /**< Device related to the slot not opened */
...
/**********************************************************
 * Starts the background initialization of the spinor
 * device.
 *
 * @param init_context
