...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/storage/coldplug_api.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $
...
/*************************************************************************//**
 * The device configuration types that coldplug supports.
*****************************************************************************/
enum coldplug_set_cfg_type
{
	COLDPLUG_SET_CFG_LOW_POWER,
	COLDPLUG_SET_CFG_PERFORMANCE
};
 ...
 *
 * @lun_no
 *   LUN to set as active bootable partition [1 or 2].
 *
 * @return:
 *   Upon success the COLDPLUG_RESULT_SUCCESS will be returned otherwise
 *   an appropriate error code will be returned. For a complete list of
...
/*************************************************************************//**
 * @par Name:
 *   coldplug_get_bootable_partition - Gets the LUN set as active bootable partition
 *
 * @par Description:
 *   Gets the LUN set as the active bootable partition. This function will call
 *   the underlying storage driver APIs xxx_open() and xxx_get_info()
 *   Refer to the underlying storage driver's API documentation for more
 *   details.
 *
 * @param dev_type
 ...
 *
 * @out_lun_no
 *   LUN set as the active bootable partition [1 or 2].
 *
 * @return:
 *   Upon success the COLDPLUG_RESULT_SUCCESS will be returned otherwise
 *   an appropriate error code will be returned. For a complete list of
...
/*************************************************************************//**
 * @par Name:
 *   coldplug_set_config - Sets the configuration of the storage device
 *
 * @par Description:
 *   This API will set the configuration type of the storage device.  
 *
 * @param dev_type
 *   Coldplug device type (eg: eMMC or UFS). See enum coldplug_device_type for
 *   the complete list of all the coldplug devices.
 ...
 *
 * @cfg
 *   Coldplug configuration for the storage device. Please see
 *   enum coldplug_set_cfg_type for full list of all configuration types.
 *
 * @return:
 *   Upon success the COLDPLUG_RESULT_SUCCESS will be returned otherwise
 *   an appropriate error code will be returned. For a complete list of
