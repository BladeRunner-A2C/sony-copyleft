...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/storage/coldplug_config.h#1 $ $DateTime: 2024/04/02 23:00:31 $ $Author: cirrusp4svc $

  when         who   what, where, why
  ----------   ---   ---------------------------------------------------------
  2023-02-11   sc    Set the spinor max slots to 2
  2020-11-16   eo    Set the coldplug max partitions count to 256
  2019-06-04   eo    Increase max lun count in all slots from 8 to 9
  2019-03-08   ds    Increase max coldplug partition from 100 to 128
...
/*************************************************************************//**
 * ::COLDPLUG_MAX_NVME_SLOTS
 * The maximum number of NVME slots possible in an target.
*****************************************************************************/
#ifndef COLDPLUG_MAX_NVME_SLOTS
  #define COLDPLUG_MAX_NVME_SLOTS (1)
#endif
...
*****************************************************************************/
  ...
  #define COLDPLUG_MAX_SPI_NOR_SLOTS (2)
#endif
...
*****************************************************************************/
  ...
  #define COLDPLUG_MAX_PARTITIONS (256)
#endif
