...
09/29/22   ck             Added SECBOOT_MPSS_OEM_PD_SW_TYPE & SECBOOT_MPSS_OEM_PD_DTB_SW_TYPE
05/16/22   ajesu          Added SECBOOT_CPUCP_DTB_SW_TYPE
04/19/22   lpatel         Added SECBOOT_KERNEL_BOOT_SW_TYPE
03/01/22   ck             Added SECBOOT_Q6_MPSS_DTB_CONFIG_SW_TYPE
01/07/22   lpatel         Added SECBOOT_DMA_GSIFW_SW_TYPE
03/11/21   ck             Added SECBOOT_TOOLS_SW_TYPE, SECBOOT_QUANTUM_SW_TYPE, SECBOOT_QUEST_SW_TYPE
02/26/21   ck             Added SECBOOT_XBLRAMDUMP_SW_TYPE
...
#define SECBOOT_SMSS_SW_TYPE                 0x39
#define SECBOOT_TOOLS_SW_TYPE                0x3A
#define SECBOOT_QUANTUM_SW_TYPE              0x3B
#define SECBOOT_QUEST_SW_TYPE                0x3C
#define SECBOOT_AOP_CONFIG_SW_TYPE           0x3D
#define SECBOOT_XBLRAMDUMP_SW_TYPE           0x42
#define SECBOOT_Q6_MPSS_DTB_CONFIG_SW_TYPE   0x51
#define SECBOOT_DMA_GSIFW_SW_TYPE            0x61
#define SECBOOT_MPSS_OEM_PD_SW_TYPE          0x63
#define SECBOOT_CPUCP_DTB_SW_TYPE            0x64
#define SECBOOT_KERNEL_BOOT_SW_TYPE          0x71
#define SECBOOT_MPSS_OEM_PD_DTB_SW_TYPE      0x7A
#define SECBOOT_SOCCP_SW_TYPE                0x88
#define SECBOOT_SOCCP_DEBUG_SW_TYPE          0x89
#define SECBOOT_SOCCP_DCD_SW_TYPE            0x8A
