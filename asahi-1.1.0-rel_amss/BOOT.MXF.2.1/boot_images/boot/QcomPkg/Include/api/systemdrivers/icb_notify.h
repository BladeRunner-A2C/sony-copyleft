...
-------------------------------------------------------------------------------
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/systemdrivers/icb_notify.h#1 $
...
typedef enum
{
  ...
  ICB_NOTIFY_CROSSING_CHANGED, /**< Any node change, thresholds ignored. */
  ICB_NOTIFY_CROSSING_ALL,     /**< All node updates (even to the same value), thresholds ignored. */
