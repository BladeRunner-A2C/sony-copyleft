 ...
 * 
 * $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/api/systemdrivers/ddiaxicfg.h#1 $ 
 * $DateTime: 2024/04/02 23:00:31 $ 
 * $Author: cirrusp4svc $ 
 * 
 * when         who     what, where, why
 * ----------   ---     ---------------------------------------------------
 * 03/11/2021   sds     Add Critical/NonCritical fields to regulator
 * 02/25/2021   sds     Update for qnoc 4.7
...
/* QNOC 4.x, max qos regulators is 4.
 * We already have 1 by default in the structure, so extra is 3. */ 
#define AXICFG_EXTRA_REGULATOR_CNT 3
...
typedef struct
{
  ...
  bool                       qosDisable;
  uint32_t                   numExtraRegulators;
  Axicfg_RegulatorType       extraRegulators[AXICFG_EXTRA_REGULATOR_CNT];
  Axicfg_RegulatorModeType   extraRegulatorModes[AXICFG_EXTRA_REGULATOR_CNT];
