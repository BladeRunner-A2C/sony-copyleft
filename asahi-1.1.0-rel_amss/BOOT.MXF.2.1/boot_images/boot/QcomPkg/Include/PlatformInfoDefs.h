...
/*
  ...
  Copyright (c) 2013-2014, 2022, 2023 Qualcomm Technologies,Inc. All rights reserved.
...
typedef enum
{
  ...
  DALPLATFORMINFO_TYPE_MTP_MDM      = DALPLATFORMINFO_TYPE_MTP, /**< Target is a MDM MTP device. */
  DALPLATFORMINFO_TYPE_MTP_MSM      = DALPLATFORMINFO_TYPE_MTP, /**< Target is a MSM MTP device. */
  ...
  DALPLATFORMINFO_TYPE_X100         = 0x27,  /**< Target is a PCIe X100 card */
  DALPLATFORMINFO_TYPE_CRD          = 0x28,  /**< Compute Reference Device */
 ...
 */
#define DALPLATFORMINFO_SMEM_FORMAT DALPLATFORMINFO_VERSION(0, 19)
