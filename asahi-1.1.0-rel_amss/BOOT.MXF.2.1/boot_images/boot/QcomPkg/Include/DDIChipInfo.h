...
===========================================================================
             Copyright (c) 2011,2014, 2016-2017, 2023 QUALCOMM Technologies, Inc. All rights reserved.
============================================================================
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/DDIChipInfo.h#1 $
...
struct DalChipInfo
{
   ...
   DALResult (*SafePointerPlaceholder)(DalDeviceHandle * _h, ChipInfoPartType ePart, uint32 *pnMask); //added to avoid pointer misalignments.
   DALResult (*GetDisabledCPUs)(DalDeviceHandle * _h, uint32 nCPUCluster, uint32 *pnMask);
   // Deprecated. Do not add new APIs here. Use ChipInfo.h instead.
};
...
/* ============================================================================
**  Function : DalChipInfo_GetDisabledCPUs
* ============================================================================
*/
/**
  Retrieve the disabled cores in the selected CPU cluster
  See ChipInfo.h for more information.

  @param[in,out]  _h         Dal Device Handle given by the caller.
  @param[in]      nCPUCluster The CPU cluster to check for disabled cores.
  @param[out]     pnMask      Pointer to a uint32 whose bits will be set to 1
                                if the corresponding core is disabled.
...
*/
static __inline DALResult
DalChipInfo_GetDisabledCPUs(DalDeviceHandle * _h, uint32 nCPUCluster, uint32 *pnMask)
{
  return ((DalChipInfoHandle *)_h)->pVtbl->GetDisabledCPUs(_h, nCPUCluster, pnMask);
}
/**
  @}
*/ /* end_group Functions */
