...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/TlmmDefs.h#1 $
...
=============================================================================
Copyright (c) 2010 - 2014, 2022 QUALCOMM Technologies Incorporated.  All Rights Reserved.  
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
#define DAL_GPIO_CFG_EX(gpio, func, dir, pull, drive, strongpull) \
         (((gpio) & 0x3FF)<< 4 | \
          ((func) & 0xF)|        \
          ((dir)  & 0x1) << 14|  \
          ((pull) & 0x3) << 15|  \
          ...
          ((strongpull)& 0x1) << 30)
#else
#define DAL_GPIO_CFG_EX(gpio, func, dir, pull, drive)
#endif /* end DOXYGEN_SHOULD_SKIP_THIS */
...
*/
#ifndef DOXYGEN_SHOULD_SKIP_THIS
#define DAL_GPIO_STRONG_PULL(config)      (((config) >> 30) & 0x1)
#else
#define DAL_GPIO_STRONG_PULL(config)
#endif /* end DOXYGEN_SHOULD_SKIP_THIS */
