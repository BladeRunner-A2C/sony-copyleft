...
/**
  Protocol version.
*/
#define EFI_PMICGLINK_PROTOCOL_REVISION_9 0x0000000000010009
#define PMIC_GLINK_REVISION EFI_PMICGLINK_PROTOCOL_REVISION_9
...
typedef struct _EFI_PM_GLINK_CHARGER_POWER
{
  EFI_PMIC_GLINK_CHARGING_SOURCE charging_source;
  UINT32 voltage_mv;
  UINT32 current_ma;
}EFI_PM_GLINK_CHARGER_POWER;
...
*/
typedef
EFI_STATUS(EFIAPI *EFI_PMIC_GLINK_CONNECT)(void);

/* EFI_PMIC_GLINK_DISCONNECT */
/** @ingroup efi_pmicGlinkConnect
@par Summary
open glink channel 
...
*/
typedef
EFI_STATUS(EFIAPI *EFI_PMIC_GLINK_DISCONNECT)(void);
...
*/
typedef
EFI_STATUS(EFIAPI *EFI_PMIC_GLINK_CPDLOG_CONNECT)(void);

/* EFI_PMIC_GLINK_CPDLOG_DISCONNECT */
/** @ingroup efi_pmicGlinkConnect
@par Summary
open glink channel 
...
*/
typedef
EFI_STATUS(EFIAPI *EFI_PMIC_GLINK_CPDLOG_DISCONNECT)(void);
...
/* EFI_PMIC_GLINK_GET_CHARGER_POWER */
/** @ingroup efi_pmicGlinkGetChargerPower
@par Summary
Get Charger Power Information

@param[out] pChargerPower      :  charger source, voltage, current
...
*/
typedef
EFI_STATUS(EFIAPI *EFI_PMIC_GLINK_GET_CHARGER_POWER)(
...
/* EFI_PMIC_GLINK_OEM_EXTENSION */
/** @ingroup efi_pmicGlinkReadBuffer
@par Summary
read the 64 byte data array
@param[in] size
@param[out/in] pDataBuffer:  UINT32*
...
*/
typedef
EFI_STATUS(EFIAPI *EFI_PMIC_GLINK_OEM_EXTENSION)(
...
struct _EFI_PMIC_GLINK_PROTOCOL
{
    ...
    EFI_PMIC_GLINK_DISCONNECT                 Disconnect;             /* GLink Close */
    EFI_PMIC_GLINK_CPDLOG_DISCONNECT          CpdlogDisconnect;       /* Logging Glink Close */
    EFI_PMIC_GLINK_GET_CHARGER_POWER          GetChargerPower;        /* Get charger source, voltage, current */
    ...
    EFI_PMIC_GLINK_OEM_EXTENSION              OemExtention;           /*Write and Read OEM data buffer, add in EFI_PMICGLINK_PROTOCOL_REVISION_8*/
};
