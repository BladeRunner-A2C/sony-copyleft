/*===============================================================================
  Copyright (c) 2017-2019, 2021-2023 Qualcomm Technologies, Inc.  All Rights Reserved.
  ...
  --------   ---         --------------------------------------------------------
  03/30/23   cm          Added NonFatal support in PIL_SUBSYS_CFG_TYPE.
  01/10/23   rk          Added compressed file support in PIL_SUBSYS_CFG_TYPE.
                         This will enable decompression of compressed images.
                         Updated versions: PIL_SUBSYS_CFG_VERSION_V4
                         and PIL_PROTOCOL_VERSION_V5
...
#define EFI_PIL_PROTOCOL_VERSION    EFI_PIL_PROTOCOL_VERSION_V5
...
/*Added new cfg version PIL_SUBSYS_CFG_VERSION_V4 */
#define EFI_PIL_PROTOCOL_VERSION_V5 0x0000000000010005
...
typedef struct _PIL_SUBSYS_CFG_TYPE_
{
    ...
    //
    // If image is in Lzma compressed format then this is
    // TRUE. Currently only Lzma compression is supported.
    //
    BOOLEAN IsFileCompressed OPTIONAL;                 /*Added in PIL_SUBSYS_CFG_VERSION_V4 */

    //
    // During AutoLoad
	// If image is NonFatal, and load not successful should be ok to proceed 
    // Else should Assert(in Debug) or Panic(in Release)
    //
	BOOLEAN NonFatal OPTIONAL;                           /*Added in PIL_SUBSYS_CFG_VERSION_V5 */
