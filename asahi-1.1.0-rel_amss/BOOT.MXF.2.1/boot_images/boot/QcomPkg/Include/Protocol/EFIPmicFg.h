...
*/
/*=============================================================================
  Copyright (c) 2014 - 2022 Qualcomm Technologies, Incorporated.
  All rights reserved.
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
01/18/22    sch     Add ability to get SDAM pm index of gauge params
...
11/27/17    ra      Removing battery missing config from FG
...
/**
  Protocol version.
*/
#define PMIC_FG_REVISION 0x0000000000010019
...
typedef enum
{
  BATT_ID_OHMS_PU_100K,
  BATT_ID_OHMS_PU_30K,
  BATT_ID_OHMS_PU_400K,
  BATT_ID_OHMS_PU_INVALID,
} EFI_PM_BATTID_PULLUP_TYPE;
...
typedef struct
{
  ...
  UINT8 BattMissingAction;
  /**<  action to be taken when batt missing */
  
  EFI_PM_BATTID_PULLUP_TYPE IdPullup;
  /**<  Pullup resistance used to detect Battery ID */
  
  UINT8 BattMissingBootMinPower;
  /**< minimum input power required for battery missing boot */
...
/* EFI_PMIC_FG_BASIC_IS_BATTERY_MISSING */
/** @ingroup efi_pmicFgInit
  @par Summary
  Provides PMIC Index for FG Module
...
*/
typedef
EFI_STATUS(EFIAPI *EFI_PMIC_FG_BASIC_IS_BATTERY_PRESENT)(
  IN UINT32 PmicDeviceIndex,
  OUT BOOLEAN *battery_present
);

typedef
EFI_STATUS(EFIAPI *EFI_PMIC_FG_BASIC_GET_BATTERY_TYPE)(
  IN UINT32 PmicDeviceIndex,
  OUT EFI_PM_FG_BATT_TYPE* battery_type
);

/** EFI_PMIC_FG_GET_GAUGE_SDAM_INFO **/
/** @ingroup efi_pmicFgInit
 *   @par Summary
 *   Gets SDAM PMIC Index and SDAM Index of QG parameters.
 *
 *   @param[out] SdamPmicIndex: Pointer to QG SDAM PMIC Index
 *   @param[out] SdamIndex: Pointer to SDAM Index
 *
 *   @return
 *   EFI_SUCCESS           -- Function completed successfully. \n
 *   EFI_INVALID_PARAMETER -- Parameter is invalid. \n
 ...
 *   */
typedef
EFI_STATUS(EFIAPI *EFI_PMIC_FG_GET_GAUGE_SDAM_INFO)(
...
struct _EFI_QCOM_PMIC_FG_BASIC_PROTOCOL
{
  ...
  EFI_PMIC_FG_BASIC_IS_BATTERY_PRESENT   QBGIsBatteryPresent;
  EFI_PMIC_FG_BASIC_GET_BATTERY_TYPE     QBGGetBatteryType;
  EFI_PMIC_FG_GET_GAUGE_SDAM_INFO        FGGetPmicGaugeSDAMInfo;
};
