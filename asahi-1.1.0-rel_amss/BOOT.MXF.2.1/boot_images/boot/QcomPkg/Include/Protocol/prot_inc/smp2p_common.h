...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Include/Protocol/prot_inc/smp2p_common.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/10/12   ar      Initial revision.
===========================================================================*/

#ifndef SMP2P_COMMON_H_
#define SMP2P_COMMON_H_
