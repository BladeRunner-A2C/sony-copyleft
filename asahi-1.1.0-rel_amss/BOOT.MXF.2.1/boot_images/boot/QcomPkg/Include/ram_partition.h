...
/*==============================================================================
                  Copyright 2008-2022 Qualcomm Technologies, Inc.
                            All Rights Reserved.
...
--------   ---     -------------------------------------------------------------
04/21/22   ck      Added RAM_PARTITION_ABL_MEMORY
05/19/21   rama    Added used_ram_info_type
07/20/20   rhy     Added Tools_FV, Quantum and Quest entries
04/19/18   daison  Add granule size field in RAM partition entry
...
typedef enum 
{
  ...
  RAM_PARTITION_APPS_MEMORY,           /**< hlos usage memory */  
  ...
  RAM_PARTITION_ABL_MEMORY,            /**< abl usage memory */
...
/**
 * Used RAM info struct.
 */
struct used_ram_info_type {
  uintnt start_address;        /**< Partition start address */
  uintnt length;               /**< Partition length */
};
