...
/*
 * Handler for Boot AutoLaunch Enable Command
 */
EFI_STATUS
AutoLaunch(CHAR8* Arg);

/*
 * Handler for Boot AutoLaunch Disable Command
 */
EFI_STATUS
...
ToggleHWWdog(VOID);
/*
 * MinidumpTALoading enable/disable
 */
EFI_STATUS
...
/*
 * Handler to Toggle MemMap Display
 */
EFI_STATUS
...
/*
 * Toggle Charging Limit in uefi on/off
 */
EFI_STATUS
ToggleChargingLimit(VOID);

/*
 * Toggle Battery Authentication in uefi on/off
 */
EFI_STATUS
ToggleBatteryAuthentication(VOID);

/*
 * Toggle Unauthenticated Battery Charging in uefi on/off
 */
EFI_STATUS
...
/*
 * Handler for SetUsbConfigTertiaryPort Command
 */
EFI_STATUS
SetUsbConfigTertiaryPort (CHAR8* Arg);

/*
 * Handler for SetUsbConfigMP Command
 */
EFI_STATUS
SetUsbConfigMP (CHAR8* Arg);

/*
 * Handler for SetUsbDevicePort Command
 */
EFI_STATUS
...
/*
 * Handler to EnableHighSpeedOnlyForPrimary for Primary Port only.
 */
EFI_STATUS
EnableHighSpeedOnlyForPrimary (CHAR8* Arg);

/*
 * Handler to EnableHighSpeedOnlyForSecondary for Secondary Port only.
 */
EFI_STATUS
EnableHighSpeedOnlyForSecondary (CHAR8* Arg);

/*
 * Handler to EnableHighSpeedOnlyForTertiary for Tertiary only.
 */
EFI_STATUS
EnableHighSpeedOnlyForTertiary (CHAR8* Arg);

/*
 * Handler to EnableHighSpeedOnlyForMP for MultiPort only.
 */
EFI_STATUS
EnableHighSpeedOnlyForMP (CHAR8* Arg);

/*
 * Handler for SetUsbMultiPortDisableBitfield Command
 */
EFI_STATUS
SetUsbMultiPortDisableBitfield (CHAR8* Arg);

/*
 * Handler to EnableUsbDPBondedPrimary for Primary Port only.
 */
EFI_STATUS
EnableUsbDPBondedPrimary (CHAR8* Arg);

/*
 * Handler to EnableUsbDPBondedSecondary for Secondary Port only.
 */
EFI_STATUS
EnableUsbDPBondedSecondary (CHAR8* Arg);

/*
 * Handler to EnableUsbDPBondedTertiary for Tertiary Port only.
 */
EFI_STATUS
EnableUsbDPBondedTertiary (CHAR8* Arg);

/*
 * Handler for ToggleEnableUsb4Uefi Command.
 */
EFI_STATUS
...
/*
 * Toggle Wake on LAN enable/disable
 */
EFI_STATUS
...
/*
 * Handler for SetUsb3HLOSConfigPrimaryPort Command
 */
EFI_STATUS
SetUsb3HLOSConfigPrimaryPort (CHAR8* Arg);

/*
 * Handler for SetUsb3HLOSConfigSecondaryPort Command
 */
EFI_STATUS
SetUsb3HLOSConfigSecondaryPort (CHAR8* Arg);

/*
 * Handler for SetUsb3HLOSConfigTertiaryPort Command
 */
EFI_STATUS
SetUsb3HLOSConfigTertiaryPort (CHAR8* Arg);

/*
 * Handler for SetUsb4HLOSConfigPrimaryPort Command
 */
EFI_STATUS
SetUsb4HLOSConfigPrimaryPort (CHAR8* Arg);

/*
 * Handler for SetUsb4HLOSConfigSecondaryPort Command
 */
EFI_STATUS
SetUsb4HLOSConfigSecondaryPort (CHAR8* Arg);

/*
 * Handler for SetUsb4HLOSConfigTertiaryPort Command
 */
EFI_STATUS
