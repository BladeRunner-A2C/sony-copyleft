...
ProcessCommand (UINTN Argc, CHAR8** Argv)
{
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "AutoLaunch") == 0)
    AutoLaunch((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "AutoLaunchDisable") == 0)
    AutoLaunchDisable((CHAR8*) ArgStr);
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ToggleMinidumpTALoad") == 0)
    ToggleMinidumpTALoad();
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "EnableUsbDPBondedPrimary") == 0)
    EnableUsbDPBondedPrimary((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "EnableUsbDPBondedSecondary") == 0)
    EnableUsbDPBondedSecondary((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "EnableUsbDPBondedTertiary") == 0)
    EnableUsbDPBondedTertiary((CHAR8*) ArgStr);
