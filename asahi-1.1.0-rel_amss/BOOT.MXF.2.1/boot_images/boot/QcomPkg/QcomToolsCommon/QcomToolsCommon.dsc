#/** @file QcomToolsCommon.dsc
# QcomToolsCommon package.
#
# Copyright (c) 2016-2020, 2022-2023 Qualcomm Technologies, Inc. All rights reserved.
...
#  EblAddExternalCommandLib|EmbeddedPkg/Library/EblAddExternalCommandLib/EblAddExternalCommandLib.inf
  ...
  EfiFileLib|Qcomkg/Library/EfiFileLib/EfiFileLib.inf
  ...
  MemoryProfileInfoLib|MdeModulePkg/Application/MemoryProfileInfo/MemoryProfileInfo.inf
  ...
  BdsInputLib|QcomPkg/Library/BdsInputLib/BdsInputLib.inf
  ...
  SmemLib|QcomPkg/Library/SmemLib/SmemLibXBLCore.inf
  ...
  FvParserLib|QcomPkg/Library/FvParserLib/FvParserLib.inf
  FvDecompressLib|QcomPkg/Library/FvDecompressLib/FvDecompressLib.inf

  EudLib|QcomPkg/Library/EudLib/EudLib.inf
...
[BuildOptions.ARM]
  ...
  GCC:*_*_*_ARCHCC_FLAGS  == -fno-common -mtune=cortex-a53 -include $(WORKSPACE)/QcomPkg/Include/Library/DebugLib.h -DQCOM_EDK2_PATCH -mno-thumb
...
[Components.common]
  ...
  # Tools Applications
  #
  QcomPkg/QcomToolsCommon/CmdApp/CmdApp.inf
  QcomPkg/QcomToolsCommon/ListVars/ListVars.inf
  QcomPkg/QcomToolsCommon/MenuApp/MenuApp.inf
  #QcomPkg/QcomToolsCommon/PayloadApp/PayloadApp.inf
  QcomPkg/QcomToolsCommon/Pgm/Pgm.inf
  QcomPkg/QcomToolsCommon/DelBootVars/DelBootVars.inf
  QcomPkg/QcomToolsCommon/RPMBProvision/RPMBProvision.inf
  QcomPkg/QcomToolsCommon/RPMBErase/RPMBErase.inf {
   <LibraryClasses>
     DebugLib|MdePkg/Library/BaseDebugLibNull/BaseDebugLibNull.inf
  }
  QcomPkg/QcomToolsCommon/UsbfnMsdApp/UsbfnMsdApp.inf
  QcomPkg/QcomToolsCommon/SecurityToggleApp/SecurityToggleApp.inf
  QcomPkg/QcomToolsCommon/DebugPolicyToggleApp/DebugPolicyToggleApp.inf
  QcomPkg/QcomToolsCommon/FeatureEnablerToggleApp/FeatureEnablerToggleApp.inf
  #QCOM Driver enumeration controller
  QcomPkg/QcomToolsCommon/WinDsdtUpdateControllerUI/WinDsdtUpdateControllerUI.inf
  QcomPkg/QcomToolsCommon/CapsuleApp/CapsuleApp.inf
  QcomPkg/Ebl/Ebl.inf

  QcomPkg/QcomToolsCommon/MpTest/MpTest.inf
  MdeModulePkg/Application/MemoryProfileInfo/MemoryProfileInfo.inf
  QcomPkg/QcomToolsCommon/RecoveryApp/RecoveryApp.inf
