...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/SocPkg/Library/TLMMHWLib/hal/hw/v1/HALgpio.h#1 $
...
#define HAL_GPIO_GET_STRONG_PULL(reg) (((reg) >> 13) & 0x1)
