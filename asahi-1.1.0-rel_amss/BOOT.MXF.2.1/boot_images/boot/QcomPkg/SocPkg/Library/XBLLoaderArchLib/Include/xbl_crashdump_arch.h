#ifndef XBL_CRASHDUMP_ARCH_H
#define XBL_CRASHDUMP_ARCH_H
...
Copyright 2021-23 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
============================================================================*/
...
--------   ---     ---------------------------------------------------------- 
03/01/23   krd     updated arm struct
12/19/22   rama    Renamed sbl_crashdump_arch.h to xbl_crashdump_arch.h
...
typedef struct
{
  ...
  uint32 sbl_boot_imem_dump_addr;      // Location in DDR where BOOT IMEM region is dumped
  uint32 sbl_boot_imem_addr;           // Address of BOOT IMEM region
  uint32 sbl_boot_imem_size;           // Size of BOOT IMEM region
  uint32 sbl_shared_imem_dump_addr;    // Location in DDR where SHARED IMEM region is dumped
  uint32 sbl_shared_imem_addr;         // Address of SHARED IMEM region
  uint32 sbl_shared_imem_size;         // Size of SHARED IMEM region  
...
/*===========================================================================
**  Function :  boot_crash_dump_handler_init
** ==========================================================================
*/
/*!
* 
* @brief
*   This initializes the boot_crash_dump_data struct consumed by boot_crashdump_handler
*
* @param[in] 
*        
* @par Dependencies
...
*/
bl_error_boot_type boot_crash_dump_handler_init(void);
