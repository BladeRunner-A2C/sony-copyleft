...
/**
  ...
  'Include' filters applied: SDE_RSCC_RSCC_RSC_REG_BASE[SDE_RSCC_RSCC_RSC] 
...
/*
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/SocPkg/Library/PdcTargetLib/inc/hwio/845/display/pdcHal_hwio.h#1 $
...
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_ADDR(d,t,n)                         (RPMH_PDC_DISPLAY_DISPLAY_PDC_REG_BASE      + 0x00001308 + 0xC8 * (t) + 0x8 * (n) + 0x10000 * (d))
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_RMSK                                0xffffffff
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_MAXd                                         0
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_MAXt                                         2
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_MAXn                                         3
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_INI3(d,t,n)        \
        in_dword_masked(HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_ADDR(d,t,n), HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_RMSK)
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_INMI3(d,t,n,mask)    \
        in_dword_masked(HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_ADDR(d,t,n), mask)
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_READ_RESPONSE_DATA_BMSK             0xffffffff
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_READ_RESPONSE_DATA_SHFT                    0x0
...
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_MSGID_RMSK                                                     0x1010f
...
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_MSGID_MSG_LENGTH_BMSK                                              0xf
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_MSGID_MSG_LENGTH_SHFT                                              0x0

#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_ADDR_ADDR(t,n)                                              (RPMH_PDC_DISPLAY_DISPLAY_PDC_REG_BASE      + 0x00005510 + 0xC8 * (t) + 0x10 * (n))
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_ADDR_RMSK                                                      0x7ffff
...
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_ADDR_OFFSET_BMSK                                                0xffff
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_ADDR_OFFSET_SHFT                                                   0x0

#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DATA_ADDR(t,n)                                              (RPMH_PDC_DISPLAY_DISPLAY_PDC_REG_BASE      + 0x00005514 + 0xC8 * (t) + 0x10 * (n))
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DATA_RMSK                                                   0xffffffff
...
#define HWIO_RPMH_PDC_DISPLAY_TCSt_CMDn_DATA_TCS_CMD_DATA_BMSK                                      0xffffffff
