...
/*
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/SocPkg/Library/PdcTargetLib/seq/hal/hwio/845/pdc_seq_hwio.h#1 $
...
#define MODEM_PDC_REG_BASE                                                                        (AOSS_BASE      + 0x002a0000)
...
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_ADDR(base,d,t,n)                                   ((base) + 0x00001308 + 0xC8 * (t) + 0x8 * (n) + 0x10000 * (d))
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_RMSK                                               0xffffffff
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_MAXd                                                        1
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_MAXt                                                        2
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_MAXn                                                        3
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_INI3(base,d,t,n)        \
        in_dword_masked(HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_ADDR(base,d,t,n), HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_RMSK)
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_INMI3(base,d,t,n,mask)    \
        in_dword_masked(HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_ADDR(base,d,t,n), mask)
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_READ_RESPONSE_DATA_BMSK                            0xffffffff
#define HWIO_TCSt_CMDn_DRVd_READ_RESPONSE_DATA_READ_RESPONSE_DATA_SHFT                                   0x0
...
#define HWIO_TCSt_CMDn_MSGID_RMSK                                                                    0x1010f
...
#define HWIO_TCSt_CMDn_MSGID_MSG_LENGTH_BMSK                                                             0xf
#define HWIO_TCSt_CMDn_MSGID_MSG_LENGTH_SHFT                                                             0x0

#define HWIO_TCSt_CMDn_ADDR_ADDR(base,t,n)                                                        ((base) + 0x00005510 + 0xC8 * (t) + 0x10 * (n))
#define HWIO_TCSt_CMDn_ADDR_RMSK                                                                     0x7ffff
...
#define HWIO_TCSt_CMDn_ADDR_OFFSET_BMSK                                                               0xffff
#define HWIO_TCSt_CMDn_ADDR_OFFSET_SHFT                                                                  0x0

#define HWIO_TCSt_CMDn_DATA_ADDR(base,t,n)                                                        ((base) + 0x00005514 + 0xC8 * (t) + 0x10 * (n))
#define HWIO_TCSt_CMDn_DATA_RMSK                                                                  0xffffffff
...
#define HWIO_TCSt_CMDn_DATA_TCS_CMD_DATA_BMSK                                                     0xffffffff
...
#define MODEM_PDC_SEQ_MEM_REG_BASE                                    (AOSS_BASE      + 0x004a0000)
...
#define HWIO_RSC_PARAM_SOLVER_CONFIG_DRVd_RMSK                                                                   0x31f1f1f
...
#define HWIO_RSC_STATUS0_DRVd_RMSK                                                                              0xffffffff
...
#define HWIO_RSC_STATUS0_DRVd_STATUS_SLEEP_CTL_FSM_BMSK                                                         0xffffffff
...
#define HWIO_RSC_STATUS1_DRVd_STATUS_TBD_BMSK                                                                   0xffffffff
#define HWIO_RSC_STATUS1_DRVd_STATUS_TBD_SHFT                                                                          0x0

#define HWIO_RSC_STATUS2_DRVd_ADDR(base,d)                                                                      ((base) + 0x00000018 + 0x10000 * (d))
#define HWIO_RSC_STATUS2_DRVd_RMSK                                                                              0xffffffff
...
#define HWIO_RSC_STATUS2_DRVd_STATUS_TBD_BMSK                                                                   0xffffffff
#define HWIO_RSC_STATUS2_DRVd_STATUS_TBD_SHFT                                                                          0x0
