...
static bool HAL_clk_LucidOlePLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static bool HAL_clk_LucidOlePLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
static void HAL_clk_LucidOlePLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
static bool HAL_clk_LucidOlePLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode );
static bool HAL_clk_LucidOlePLLEnableVote       ( HAL_clk_SourceDescType *pSource );
static bool HAL_clk_LucidOlePLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
...
static bool HAL_clk_LucidOlePLLEnableVote
(
...
static bool HAL_clk_LucidOlePLLEnable
(
  HAL_clk_SourceDescType        *pSource,
...
static bool HAL_clk_LucidOlePLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
static bool HAL_clk_LucidOlePLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
static bool HAL_clk_LucidOlePLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_LucidOlePLLConfigPLLNormal(pSource, pConfig);
...
static bool HAL_clk_LucidOlePLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
