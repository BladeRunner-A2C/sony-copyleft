...
FILE:         HALclkZondaEkaPLL.c

DESCRIPTION:
  This file contains the clock HAL code for the Zonda Eka PLL control.
...
bool HAL_clk_ZondaEkaPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
bool HAL_clk_ZondaEkaPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
void HAL_clk_ZondaEkaPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
bool HAL_clk_ZondaEkaPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode );
bool HAL_clk_ZondaEkaPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
void HAL_clk_ZondaEkaPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );
...
/*
 * HAL_clk_ZondaEkaPLLControl
 *
 * Control function array for the Zonda PLLs.
 */
HAL_clk_SourceControlType HAL_clk_ZondaekaPLLControl =
{
  .Enable           = HAL_clk_ZondaEkaPLLEnable,
  .IsEnabled        = HAL_clk_ZondaEkaPLLIsEnabled,
  .Config           = HAL_clk_ZondaEkaPLLConfig,
  .ConfigPLL        = HAL_clk_ZondaEkaPLLConfigPLL,
  .SetCalConfig     = HAL_clk_ZondaEkaPLLSetCalConfig,
  .SetRegSettings   = HAL_clk_ZondaEkaPLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_ZondaEkaPLLPostDivToHW
**
** ======================================================================== */

uint32_t HAL_clk_ZondaEkaPLLPostDivToHW (uint32_t nDivider)
{
  switch (nDivider)
  {
    case 0:
...
} /* END HAL_clk_ZondaEkaPLLPostDivToHW */

 
/* ===========================================================================
**  HAL_clk_ZondaEkaPLLEnable
**
...
bool HAL_clk_ZondaEkaPLLEnable
(
...
)
{
   ...
   */
  if (HAL_clk_ZondaEkaPLLIsEnabled(pSource))
  {
    return TRUE;
  }
...
} /* END of HAL_clk_ZondaEkaPLLEnable */


/* ===========================================================================
**  HAL_clk_ZondaEkaPLLIsEnabled
**
** ======================================================================== */

bool HAL_clk_ZondaEkaPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_ZondaEkaPLLIsEnabled */


/* ===========================================================================
**  HAL_clk_ZondaEkaPLLConfig
**
** ======================================================================== */

void HAL_clk_ZondaEkaPLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
} /* END HAL_clk_ZondaEkaPLLConfig */


/* ===========================================================================
**  HAL_clk_ZondaEkaPLLConfigPLLNormal
**
** ======================================================================== */

bool HAL_clk_ZondaEkaPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
)
{
  ...
  nUserUVal |= HWIO_FVAL(PLL_USER_CTL_U, POST_DIV_CONTROL,
    HAL_clk_ZondaEkaPLLPostDivToHW(pConfig->PostDivs.Zonda.nMain));
...
} /* END HAL_clk_ZondaEkaPLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_ZondaEkaPLLConfigPLL
**
** ======================================================================== */

bool HAL_clk_ZondaEkaPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_ZondaEkaPLLConfigPLLNormal(pSource, pConfig);

    default:
      return FALSE;
  }

} /* END HAL_clk_ZondaEkaPLLConfigPLL */


/* ===========================================================================
**  HAL_clk_ZondaEkaPLLSetCalConfig
**
** ======================================================================== */

bool HAL_clk_ZondaEkaPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_ZondaEkaPLLSetRegSettings
**
** ======================================================================== */

void HAL_clk_ZondaEkaPLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
...
} /* END HAL_clk_ZondaEkaPLLSetRegSettings */
