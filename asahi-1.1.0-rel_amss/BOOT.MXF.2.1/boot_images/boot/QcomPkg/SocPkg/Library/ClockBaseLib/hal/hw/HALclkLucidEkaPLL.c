...
static bool HAL_clk_LucidEkaPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static bool HAL_clk_LucidEkaPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
static void HAL_clk_LucidEkaPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
static bool HAL_clk_LucidEkaPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode );
static bool HAL_clk_LucidEkaPLLEnableVote       ( HAL_clk_SourceDescType *pSource );
static bool HAL_clk_LucidEkaPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
...
static bool HAL_clk_LucidEkaPLLEnableVote
(
...
static bool HAL_clk_LucidEkaPLLEnable
(
  HAL_clk_SourceDescType        *pSource,
...
static bool HAL_clk_LucidEkaPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
static bool HAL_clk_LucidEkaPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
static bool HAL_clk_LucidEkaPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_LucidEkaPLLConfigPLLNormal(pSource, pConfig);
...
static bool HAL_clk_LucidEkaPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
} /* END HAL_clk_LucidEkaPLLSetRegSettings */
