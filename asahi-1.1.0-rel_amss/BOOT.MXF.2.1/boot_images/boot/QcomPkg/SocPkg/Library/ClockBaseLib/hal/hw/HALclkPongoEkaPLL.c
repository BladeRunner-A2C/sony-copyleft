...
$Header: //components/rel/core.boot/6.1/QcomPkg/SocPkg/Library/ClockBaseLib/hal/hw/HALclkPongoEkaPLL.c#2 $
 ...
 */
bool HAL_clk_PongoEkaPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
bool HAL_clk_PongoEkaPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
void HAL_clk_PongoEkaPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
bool HAL_clk_PongoEkaPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode );
bool HAL_clk_PongoEkaPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
void HAL_clk_PongoEkaPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );
...
/*
 * HAL_clk_PongoEkaPLLControl
 *
 * Control function array for the Pongo PLLs.
 */
HAL_clk_SourceControlType HAL_clk_PongoekaPLLControl =
{
  .Enable           = HAL_clk_PongoEkaPLLEnable,
  .IsEnabled        = HAL_clk_PongoEkaPLLIsEnabled,
  .Config           = HAL_clk_PongoEkaPLLConfig,
  .ConfigPLL        = HAL_clk_PongoEkaPLLConfigPLL,
  .SetCalConfig     = HAL_clk_PongoEkaPLLSetCalConfig,
  .SetRegSettings   = HAL_clk_PongoEkaPLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_PongoEkaPLLPostDivToHW
**
** ======================================================================== */

uint32_t HAL_clk_PongoEkaPLLPostDivToHW (uint32_t nDivider)
{
  if (nDivider)
  {
    nDivider--;
...
} /* END HAL_clk_PongoEkaPLLPostDivToHW */


/* ===========================================================================
**  HAL_clk_PongoEkaPLLPostDivFromHW
**
** ======================================================================== */

uint32_t HAL_clk_PongoEkaPLLPostDivFromHW (uint32_t nDivider)
{
  return nDivider + 1;

} /* END HAL_clk_PongoEkaPLLPostDivFromHW */



/* ===========================================================================
**  HAL_clk_PongoEkaPLLEnable
**
** ======================================================================== */

bool HAL_clk_PongoEkaPLLEnable
(
...
)
{
   ...
   */
  if (HAL_clk_PongoEkaPLLIsEnabled(pSource))
  {
    return TRUE;
  }
...
} /* END HAL_clk_PongoEkaPLLEnable */


/* ===========================================================================
**  HAL_clk_PongoEkaPLLIsEnabled
**
** ======================================================================== */

bool HAL_clk_PongoEkaPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_PongoEkaPLLIsEnabled */


/* ===========================================================================
**  HAL_clk_PongoEkaPLLConfig
**
** ======================================================================== */

void HAL_clk_PongoEkaPLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
} /* END HAL_clk_PongoEkaPLLConfig */


/* ===========================================================================
**  HAL_clk_PongoEkaPLLConfigPLLNormal
**
** ======================================================================== */

bool HAL_clk_PongoEkaPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
)
{
  ...
  nUserVal |= HWIO_FVAL(PLL_USER_CTL, POST_DIV_RATIO_MAIN,
    HAL_clk_PongoEkaPLLPostDivToHW(pConfig->PostDivs.Pongoeka.nMain));

  nUserVal |= HWIO_FVAL(PLL_USER_CTL, POST_DIV_RATIO_EVEN,
    HAL_clk_PongoEkaPLLPostDivToHW(pConfig->PostDivs.Pongoeka.nEven));
...
} /* END HAL_clk_PongoEkaPLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_PongoEkaPLLConfigPLL
**
** ======================================================================== */

bool HAL_clk_PongoEkaPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_PongoEkaPLLConfigPLLNormal(pSource, pConfig);

    default:
      return FALSE;
  }

} /* END HAL_clk_PongoEkaPLLConfigPLL */


/* ===========================================================================
**  HAL_clk_PongoEkaPLLSetCalConfig
**
** ======================================================================== */

bool HAL_clk_PongoEkaPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_PongoEkaPLLSetRegSettings
**
** ======================================================================== */

void HAL_clk_PongoEkaPLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
...
} /* END HAL_clk_PongoEkaPLLSetRegSettings */
