...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/SocPkg/Library/ClockBaseLib/hal/hw/HALclkPongoEvoPLL.c#1 $
 ...
 */
bool HAL_clk_PongoEvoPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
bool HAL_clk_PongoEvoPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
void HAL_clk_PongoEvoPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
bool HAL_clk_PongoEvoPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode );
bool HAL_clk_PongoEvoPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
void HAL_clk_PongoEvoPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );
...
uint32_t HAL_clk_PongoEvoPLLPostDivToHW (uint32_t nDivider)
{
  if (nDivider)
  {
    nDivider--;
...
uint32_t HAL_clk_PongoEvoPLLPostDivFromHW (uint32_t nDivider)
{
  return nDivider + 1;
...
bool HAL_clk_PongoEvoPLLEnable
(
...
bool HAL_clk_PongoEvoPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
void HAL_clk_PongoEvoPLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
bool HAL_clk_PongoEvoPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
bool HAL_clk_PongoEvoPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_PongoEvoPLLConfigPLLNormal(pSource, pConfig);
...
bool HAL_clk_PongoEvoPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
void HAL_clk_PongoEvoPLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
