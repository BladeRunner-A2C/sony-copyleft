...
static bool HAL_clk_TaycanPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
static bool HAL_clk_TaycanPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
static void HAL_clk_TaycanPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
static bool HAL_clk_TaycanPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode );
static bool HAL_clk_TaycanPLLEnableVote       ( HAL_clk_SourceDescType *pSource );
static bool HAL_clk_TaycanPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
static void HAL_clk_TaycanPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );
...
/*
 * HAL_clk_TaycanPLLControl
 *
 * Control function array for the Taycan PLLs.
 */
HAL_clk_SourceControlType HAL_clk_TaycanevoPLLControl =
{
  .Enable           = HAL_clk_TaycanPLLEnable,
  .IsEnabled        = HAL_clk_TaycanPLLIsEnabled,
  .Config           = HAL_clk_TaycanPLLConfig,
  .ConfigPLL        = HAL_clk_TaycanPLLConfigPLL,
  .EnableVote       = HAL_clk_TaycanPLLEnableVote,
  .SetCalConfig     = HAL_clk_TaycanPLLSetCalConfig,
  .SetRegSettings   = HAL_clk_TaycanPLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_TaycanPLLEnableVote
**
** ======================================================================== */

static bool HAL_clk_TaycanPLLEnableVote
(
...
} /* END HAL_clk_TaycanPLLEnableVote */


/* ===========================================================================
**  HAL_clk_TaycanPLLEnable
**
...
static bool HAL_clk_TaycanPLLEnable
(
  HAL_clk_SourceDescType        *pSource,
...
)
{
   ...
   */
  return HAL_clk_ValidateRegSetTimeout(
           HAL_CLK_PLL_HWIO_ADDR(PLL_MODE, pSource),
           HWIO_FMSK(PLL_MODE, PLL_LOCK_DET),
           HAL_CLK_LOCK_TIMEOUT_US);

} /* END of HAL_clk_TaycanPLLEnable */


/* ===========================================================================
**  HAL_clk_TaycanPLLIsEnabled
**
** ======================================================================== */

static bool HAL_clk_TaycanPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_TaycanPLLIsEnabled */


/* ===========================================================================
**  HAL_clk_TaycanPLLConfig
**
** ======================================================================== */

static void HAL_clk_TaycanPLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
} /* END HAL_clk_TaycanPLLConfig */


/* ===========================================================================
**  HAL_clk_TaycanPLLConfigPLLNormal
**
**  Returns:
**    bool - TRUE if successfully configured. FALSE otherwise.
** ======================================================================== */

static bool HAL_clk_TaycanPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
} /* END HAL_clk_TaycanPLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_TaycanPLLConfigPLL
**
**  Returns:
**    bool - TRUE if successfully configured. FALSE otherwise.
** ======================================================================== */

static bool HAL_clk_TaycanPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_TaycanPLLConfigPLLNormal(pSource, pConfig);

    default:
      return FALSE;
  }

} /* END HAL_clk_TaycanPLLConfigPLL */


/* ===========================================================================
**  HAL_clk_TaycanPLLSetCalConfig
**
** ======================================================================== */

static bool HAL_clk_TaycanPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_TaycanPLLSetRegSettings
**
** ======================================================================== */

static void HAL_clk_TaycanPLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
...
} /* END HAL_clk_TaycanPLLSetRegSettings */
