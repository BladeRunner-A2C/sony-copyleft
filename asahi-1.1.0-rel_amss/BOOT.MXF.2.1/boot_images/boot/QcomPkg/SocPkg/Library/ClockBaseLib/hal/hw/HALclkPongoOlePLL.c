...
/*
 * HAL_clk_PongoOlePLLControl
 *
 * Control function array for the Pongo PLLs.
 */
HAL_clk_SourceControlType HAL_clk_PongoolePLLControl =
{
  ...
  .SetRegSettings   = HAL_clk_PongoOlePLLSetRegSettings,
};
...
/* ===========================================================================
**  HAL_clk_PongoOlePLLPostDivToHW
**
** ======================================================================== */

uint32_t HAL_clk_PongoOlePLLPostDivToHW (uint32_t nDivider)
{
  if (nDivider)
  {
    nDivider--;
...
} /* END HAL_clk_PongoOlePLLPostDivToHW */


/* ===========================================================================
**  HAL_clk_PongoOlePLLPostDivFromHW
**
** ======================================================================== */

uint32_t HAL_clk_PongoOlePLLPostDivFromHW (uint32_t nDivider)
{
  return nDivider + 1;

} /* END HAL_clk_PongoOlePLLPostDivFromHW */



/* ===========================================================================
**  HAL_clk_PongoOlePLLEnable
**
** ======================================================================== */

bool HAL_clk_PongoOlePLLEnable
(
...
)
{
   ...
   */
  if (HAL_clk_PongoOlePLLIsEnabled(pSource))
  {
    return TRUE;
  }
...
} /* END HAL_clk_PongoOlePLLEnable */


/* ===========================================================================
**  HAL_clk_PongoOlePLLIsEnabled
**
** ======================================================================== */

bool HAL_clk_PongoOlePLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
} /* END HAL_clk_PongoOlePLLIsEnabled */


/* ===========================================================================
**  HAL_clk_PongoOlePLLConfig
**
** ======================================================================== */

void HAL_clk_PongoOlePLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
} /* END HAL_clk_PongoOlePLLConfig */


/* ===========================================================================
**  HAL_clk_PongoOlePLLConfigPLLNormal
**
** ======================================================================== */

bool HAL_clk_PongoOlePLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
)
{
  ...
  nUserVal |= HWIO_FVAL(PLL_USER_CTL, POST_DIV_RATIO_MAIN,
    HAL_clk_PongoOlePLLPostDivToHW(pConfig->PostDivs.Pongoole.nMain));

  nUserVal |= HWIO_FVAL(PLL_USER_CTL, POST_DIV_RATIO_EVEN,
    HAL_clk_PongoOlePLLPostDivToHW(pConfig->PostDivs.Pongoole.nEven));
...
} /* END HAL_clk_PongoOlePLLConfigPLLNormal */


/* ===========================================================================
**  HAL_clk_PongoOlePLLConfigPLL
**
** ======================================================================== */

bool HAL_clk_PongoOlePLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_PongoOlePLLConfigPLLNormal(pSource, pConfig);

    default:
      return FALSE;
  }

} /* END HAL_clk_PongoOlePLLConfigPLL */


/* ===========================================================================
**  HAL_clk_PongoOlePLLSetCalConfig
**
** ======================================================================== */

bool HAL_clk_PongoOlePLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
/* ===========================================================================
**  HAL_clk_PongoOlePLLSetRegSettings
**
** ======================================================================== */

void HAL_clk_PongoOlePLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
...
} /* END HAL_clk_PongoOlePLLSetRegSettings */
