...
bool HAL_clk_ZondaOlePLLEnableVote       ( HAL_clk_SourceDescType *pSource );
...
bool HAL_clk_ZondaOlePLLEnableVote
(
...
uint32_t HAL_clk_ZondaOlePLLPostDivToHW (uint32_t nDivider)
{
  switch (nDivider)
  {
    case 0:
...
bool HAL_clk_ZondaOlePLLEnable
(
  HAL_clk_SourceDescType        *pSource,
...
} /* END of HAL_clk_ZondaOlePLLEnable */
...
bool HAL_clk_ZondaOlePLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
void HAL_clk_ZondaOlePLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
bool HAL_clk_ZondaOlePLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
)
{
  ...
  nUserUVal |= HWIO_FVAL(PLL_USER_CTL_U, POST_DIV_CONTROL,
    HAL_clk_ZondaOlePLLPostDivToHW(pConfig->PostDivs.Zondaole.nEven));
...
bool HAL_clk_ZondaOlePLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_ZondaOlePLLConfigPLLNormal(pSource, pConfig);
...
bool HAL_clk_ZondaOlePLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
void HAL_clk_ZondaOlePLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
