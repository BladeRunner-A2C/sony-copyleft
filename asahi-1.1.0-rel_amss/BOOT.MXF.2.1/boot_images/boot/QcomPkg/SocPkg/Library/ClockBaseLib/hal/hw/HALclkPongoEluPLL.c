 ...
 */
bool HAL_clk_PongoEluPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
bool HAL_clk_PongoEluPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
void HAL_clk_PongoEluPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
bool HAL_clk_PongoEluPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode );
bool HAL_clk_PongoEluPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
void HAL_clk_PongoEluPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );
...
uint32_t HAL_clk_PongoEluPLLPostDivToHW (uint32_t nDivider)
{
  if (nDivider)
  {
    nDivider--;
...
uint32_t HAL_clk_PongoEluPLLPostDivFromHW (uint32_t nDivider)
{
  return nDivider + 1;
...
bool HAL_clk_PongoEluPLLEnable
(
...
bool HAL_clk_PongoEluPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
void HAL_clk_PongoEluPLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
bool HAL_clk_PongoEluPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
bool HAL_clk_PongoEluPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_PongoEluPLLConfigPLLNormal(pSource, pConfig);
...
bool HAL_clk_PongoEluPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
void HAL_clk_PongoEluPLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
