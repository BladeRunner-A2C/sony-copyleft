...
bool HAL_clk_ZondaEluPLLEnable           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceDisableModeType eMode, void *pData );
bool HAL_clk_ZondaEluPLLIsEnabled        ( HAL_clk_SourceDescType *pSource );
void HAL_clk_ZondaEluPLLConfig           ( HAL_clk_SourceDescType *pSource, HAL_clk_SourceConfigType eConfig );
bool HAL_clk_ZondaEluPLLConfigPLL        ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig, HAL_clk_SourceConfigMode eMode );
bool HAL_clk_ZondaEluPLLEnableVote       ( HAL_clk_SourceDescType *pSource );
bool HAL_clk_ZondaEluPLLSetCalConfig     ( HAL_clk_SourceDescType *pSource, const HAL_clk_PLLConfigType *pmConfig );
void HAL_clk_ZondaEluPLLSetRegSettings   ( HAL_clk_SourceDescType *pSource, const HAL_clk_SourceRegSettingsType *pmSettings );
...
bool HAL_clk_ZondaEluPLLEnableVote
(
...
uint32_t HAL_clk_ZondaEluPLLPostDivToHW (uint32_t nDivider)
{
  switch (nDivider)
  {
    case 0:
...
bool HAL_clk_ZondaEluPLLEnable
(
  HAL_clk_SourceDescType        *pSource,
...
} /* END of HAL_clk_ZondaEluPLLEnable */
...
bool HAL_clk_ZondaEluPLLIsEnabled
(
  HAL_clk_SourceDescType *pSource
)
{
...
void HAL_clk_ZondaEluPLLConfig
(
  HAL_clk_SourceDescType   *pSource,
...
bool HAL_clk_ZondaEluPLLConfigPLLNormal
(
  HAL_clk_SourceDescType      *pSource,
...
)
{
  ...
  if (bPLLInFSMMode)
  {
    ...
    HAL_CLK_PLL_HWIO_OUTF(PLL_MODE, pSource, PLL_BYPASSNL, 1);
  }
...
bool HAL_clk_ZondaEluPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig,
...
)
{
  switch (eMode)
  {
    case HAL_CLK_SOURCE_CONFIG_MODE_NORMAL:
      return HAL_clk_ZondaEluPLLConfigPLLNormal(pSource, pConfig);
...
bool HAL_clk_ZondaEluPLLSetCalConfig
(
  HAL_clk_SourceDescType      *pSource,
  const HAL_clk_PLLConfigType *pConfig
)
...
void HAL_clk_ZondaEluPLLSetRegSettings
(
  HAL_clk_SourceDescType              *pSource,
