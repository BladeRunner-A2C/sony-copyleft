...
#ifndef BOOT_PBL_SHARED_V2_H
#define BOOT_PBL_SHARED_V2_H
...
/*===========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/SocPkg/Library/BootPblSharedDataLib/boot_pbl_v2/boot_pbl_shared_v2.h#1 $

  when       who    what, where, why
  --------   ----   ---------------------------------------------------
  06/08/22   ds   Initial version created
...
#define PBL_XBL_SC_SHARED_DATA_VERSION 0x00020000
