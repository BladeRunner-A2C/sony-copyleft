...
/*=============================================================================
  ...
  Copyright 2023 - 2024 Qualcomm Technologies, Inc. All rights reserved
...
#define HSUART_01_CTS  TLMM_GPIO_CFG(0,  1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_01_RFR  TLMM_GPIO_CFG(1,  1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_01_TX   TLMM_GPIO_CFG(2,  1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_01_RX   TLMM_GPIO_CFG(3,  1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
...
#define HSUART_04_CTS  TLMM_GPIO_CFG(15, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_04_RFR  TLMM_GPIO_CFG(16, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_04_TX   TLMM_GPIO_CFG(17, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_04_RX   TLMM_GPIO_CFG(18, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)

#define HSUART_05_CTS  TLMM_GPIO_CFG(19, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_05_RFR  TLMM_GPIO_CFG(20, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_05_TX   TLMM_GPIO_CFG(21, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_05_RX   TLMM_GPIO_CFG(22, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)

#define HSUART_06_CTS  TLMM_GPIO_CFG(23, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_06_RFR  TLMM_GPIO_CFG(24, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_06_TX   TLMM_GPIO_CFG(25, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_06_RX   TLMM_GPIO_CFG(26, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)

#define HSUART_07_CTS  TLMM_GPIO_CFG(27, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_07_RFR  TLMM_GPIO_CFG(28, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_07_TX   TLMM_GPIO_CFG(29, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_07_RX   TLMM_GPIO_CFG(30, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)

//qup1 0
#define HSUART_08_CTS  TLMM_GPIO_CFG(32, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_08_RFR  TLMM_GPIO_CFG(33, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_08_TX   TLMM_GPIO_CFG(94, 3, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_08_RX   TLMM_GPIO_CFG(95, 3, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
//1
#define HSUART_09_CTS  TLMM_GPIO_CFG(36, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_09_RFR  TLMM_GPIO_CFG(37, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_09_TX   TLMM_GPIO_CFG(38, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_09_RX   TLMM_GPIO_CFG(39, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
//2
#define HSUART_10_CTS  TLMM_GPIO_CFG(40, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_10_RFR  TLMM_GPIO_CFG(41, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_10_TX   TLMM_GPIO_CFG(42, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_10_RX   TLMM_GPIO_CFG(43, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
//3
#define HSUART_11_CTS  TLMM_GPIO_CFG(92, 2, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_11_RFR  TLMM_GPIO_CFG(93, 2, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_11_TX   TLMM_GPIO_CFG(94, 2, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_11_RX   TLMM_GPIO_CFG(95, 2, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
//4
#define HSUART_12_CTS  TLMM_GPIO_CFG(48, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_12_RFR  TLMM_GPIO_CFG(49, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_12_TX   TLMM_GPIO_CFG(50, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_12_RX   TLMM_GPIO_CFG(51, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
//5
#define HSUART_13_CTS  TLMM_GPIO_CFG(55, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_13_RFR  TLMM_GPIO_CFG(56, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_13_TX   TLMM_GPIO_CFG(59, 3, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_13_RX   TLMM_GPIO_CFG(60, 3, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
//6
#define HSUART_14_CTS  TLMM_GPIO_CFG(59, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
#define HSUART_14_RFR  TLMM_GPIO_CFG(60, 1, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_14_TX   TLMM_GPIO_CFG(55, 2, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_UP,   HSAURT_TLMM_GPIO_2MA)
#define HSUART_14_RX   TLMM_GPIO_CFG(56, 2, TLMM_GPIO_OUTPUT, TLMM_GPIO_PULL_DOWN, HSAURT_TLMM_GPIO_2MA)
