...
{
   // MAIN_PORT
   0x00A94000,  // uart_base
   0x00AC0000,  // qup_common_base
   0x2001c191,  // gpio_tx_config
   0x200081a1,  // gpio_rx_config
   0,           // gpio_cts_config
   0,           // gpio_rfr_config
   0,           // clock_id_index	
   (void*)0,        // bus_clock_id
   "gcc_qupv3_wrap0_s5_clk",		//core_clock_id
   (void*)"gcc_qupv3_wrap0_s5_clk", // core_clock_id
   0,		//base_freq
...
UART_PROPERTIES rumi_devices =
{
   ...
   (void*)0,        // bus_clock_id
   "gcc_qupv3_wrap0_s5_clk",		 //core_clock_id
   (void*)"gcc_qupv3_wrap0_s5_clk", // core_clock_str
   0,		//base_freq
   0,          // irq number not used 
   0,  //TCSR base
   0,  // TCSR offset
...
uint8 __attribute__ ((aligned (4))) qup_v3_13_uart_fw[] =
{
...
{
   *base_ptr = qup_v3_13_uart_fw;
   return UART_SUCCESS;
}

UART_PROPERTIES* uart_settings_get_properties(uart_port_id port)
{
   uint32 soc_emulation_type = HWIO_TCSR_SOC_EMULATION_TYPE_IN & HWIO_TCSR_SOC_EMULATION_TYPE_RMSK;
