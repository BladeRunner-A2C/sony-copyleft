...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM6xxxv1 (milos_1.0):
      PLL_HSR   : 2.0
      AOSS_CC   : milos_aoss_cc_z_aoss_cc_7.1.1_p3q2r3.3_fp3 [milos_aoss_cc.r4]
      APSS_CC   : milos_apss_cc_milos_apss_1.0_p3q2r195.6261_fp9 [milos_apss_cc.r1]
      GCC       : milos_gcc_z_milos_clk_ctl_1.0_p3q3r23_fp12 [milos_gcc.r21]
      GPU_CC    : milos_gpu_cc_z_gpu_cc_milos_1.0_p3q2r10_fp8 [milos_gpu_cc.r2]
      TCSR_CC   : None
...
{'db_override': {'GCC': {'cbc': {'gcc_aggre_ufs_phy_axi_clk': {'func_group': 'ufs_phy'},
 ...
 'generators': [{'options': {'clock_flags': {'gcc_gpll0': ['DO_NOT_DISABLE'],
                             ...
                             'flat_structs': True,
                             'hal_ctl_structs': {'aoss_cc_pll1': 'HAL_clk_PongooleMilosPLLControl',
 ...
 */
extern HAL_clk_SourceControlType          HAL_clk_PongooleMilosPLLControl;
...
{
  { { 0x000081BB, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 18,  }, },
};
...
{
  { { 0x0000038F, HAL_CLK_PLL_FRAC_MODE_ALPHA, {{0}}                     , 37,  }, },
};
...
ClockSourceNodeType ClockSource_AOSSCC_AOSSCCPLL1 =
{
  ...
  .pmControl      = &HAL_clk_PongooleMilosPLLControl,
...
{
  {  200000000, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     6,     0,     0,     0x04 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  171428571, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     7,     0,     0,     0x03 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  100000000, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     12,    0,     0,     0x04 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  200000000, RAIL_VOLTAGE_LEVEL_SVS,        { 1,     6,     0,     0,     0x03 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCCONFIGNOC[] =
{
  ...
  {   75000000, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     16,    0,     0,     0x04 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  403000000, RAIL_VOLTAGE_LEVEL_NOM,        { 5,     4,     0,     0,     0x04 }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
};
...
{
  {  100000000, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     12,    0,     0,     0x05 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  600000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 1,     2,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  806000000, RAIL_VOLTAGE_LEVEL_NOM,        { 5,     2,     0,     0,     0x05 }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
};
...
{
  {  806000000, RAIL_VOLTAGE_LEVEL_NOM,        { 5,     2,     0,     0,     0x05 }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
  {  933000000, RAIL_VOLTAGE_LEVEL_TUR,        { 3,     2,     0,     0,     0x06 }, SRC_IDX_GCC_GCCGPLL5,                         0                   ,  },   /* Mux[3] = GCC_GPLL5_OUT_MAIN */
  { 1066000000, RAIL_VOLTAGE_LEVEL_TUR_L1,     { 4,     2,     0,     0,     0x07 }, SRC_IDX_GCC_GCCGPLL1,                         0                   ,  },   /* Mux[4] = GCC_GPLL1_OUT_MAIN */
};

/*
 * ClockDomainBSP_GCC_GCCMMSSQMIPCORE
 *
 * Used by:
 *   ClockDomain_GCC_GCCMMSSQMIPCORE
 */
static ClockMuxConfigType ClockDomainBSP_GCC_GCCMMSSQMIPCORE[] =
{
  {   75000000, RAIL_VOLTAGE_LEVEL_SVS,        { 1,     16,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  403000000, RAIL_VOLTAGE_LEVEL_NOM,        { 5,     4,     0,     0,     0x05 }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
};
...
{
  {  300000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 1,     4,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  200000000, RAIL_VOLTAGE_LEVEL_SVS,        { 1,     6,     0,     0,     0x07 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {    7372800, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     2,     384,   15625, 0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {   14745600, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     2,     768,   15625, 0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0x00 }, SRC_IDX_NULL,                                 0                   ,  },   /* Mux[0] = BI_TCXO */
  {   48000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     2,     4,     25,    0x02 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
};
...
{
  {  200000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     3,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
};
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCSDCC1APPS[] =
{
  ...
  {   20000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     10,    1,     3,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {   25000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     24,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {   50000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     12,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {  100000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     6,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {  192000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 2,     4,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL6,                         0                   ,  },   /* Mux[2] = GCC_GPLL6_OUT_MAIN */
  {  384000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 2,     2,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL6,                         0                   ,  },   /* Mux[2] = GCC_GPLL6_OUT_MAIN */
};
...
{
  {  100000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     6,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {  150000000, RAIL_VOLTAGE_LEVEL_SVS,        { 6,     4,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {  300000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 6,     2,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
};
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCSDCC2APPS[] =
{
  {     400000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     24,    1,     4,     0xFF }, SRC_IDX_NULL,                                 0                   ,  },   /* Mux[0] = BI_TCXO */
  {   25000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     24,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {   37500000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     16,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {   50000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     12,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
  {  100000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     6,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN */
...
{
  {  403000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 5,     4,     0,     0,     0x03 }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
};
...
{
  {  300000000, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     4,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
{
  {  403000000, RAIL_VOLTAGE_LEVEL_NOM,        { 5,     4,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
};
...
{
  {  200000000, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     6,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN */
};
...
ClockDomainNodeType ClockDomain_GCC_GCCMMSSQMIPCORE =
{
  .aBSP      = ClockDomainBSP_GCC_GCCMMSSQMIPCORE,
  .nBSPLen   = SIZEOF_ARRAY(ClockDomainBSP_GCC_GCCMMSSQMIPCORE),
  .eMaster   = CLOCK_MASTER_DEFAULT,
  .nCGRAddr   = HWIO_ADDR(GCC_MMSS_QMIP_CORE_CMD_RCGR),
};
...
ClockDomainNodeType ClockDomain_GCC_GCCQUPV3WRAP1QSPIREF =
{
  .aBSP      = ClockDomainBSP_GCC_GCCQUPV3WRAP0QSPIREF,
  .nBSPLen   = SIZEOF_ARRAY(ClockDomainBSP_GCC_GCCQUPV3WRAP0QSPIREF),
  .eMaster   = CLOCK_MASTER_DEFAULT,
...
static uint32_t aBranchEnable[] =
{
  ...
  // HWIO_ADDR(GCC_AGGRE_NOC_WEST_AXI_CENTER_TILE_CBCR), /* Defaults on. */
  // HWIO_ADDR(GCC_AGGRE_NOC_WEST_AXI_WEST_TILE_CBCR), /* Defaults on. */
  ...
  // HWIO_ADDR(GCC_CFG_NOC_AHB2PHY_XO_CBCR), /* Defaults on. */
  // HWIO_ADDR(GCC_CFG_NOC_AHB_CBCR), /* Defaults on. */
  // HWIO_ADDR(GCC_CFG_NOC_HF_MMNOC_AHB_CBCR), /* Defaults on. */
  // HWIO_ADDR(GCC_CFG_NOC_IPCC_AHB_CBCR), /* Defaults on. */
  // HWIO_ADDR(GCC_CFG_NOC_PCIE_EAST_AHB_CBCR), /* Defaults on. */
  ...
  // HWIO_ADDR(GCC_CNOC_SOUTH_QX_CENTER_TILE_CBCR), /* Defaults on. */
  // HWIO_ADDR(GCC_CNOC_SOUTH_QX_CBCR), /* Defaults on. */
  // HWIO_ADDR(GCC_CNOC_SOUTH_QX_PCIE_EAST_TILE_CBCR), /* Defaults on. */
  ...
  HWIO_ADDR(GCC_IPCC_CORE_DRAGONLINK_CBCR),
  HWIO_ADDR(GCC_LPASS_AGGRE_NOC_DDRSS_SHUB_CBCR),
  HWIO_ADDR(GCC_LPASS_AGGRE_NOC_DDRSS_SHUB_CLONE_CBCR),
  ...
  HWIO_ADDR(GCC_MMNOC_SF_NON_GDSC_AT_CBCR),
  ...
  // HWIO_ADDR(GCC_RDPM_CX_CBCR),   /* Disabled for CX/MX Peak Current Mitigation */
  HWIO_ADDR(GCC_RDPM_CX_DRAGONLINK_CBCR),
  HWIO_ADDR(GCC_RDPM_MXA_AHB_CBCR),
  // HWIO_ADDR(GCC_RDPM_MXA_CBCR),  /* Disabled for CX/MX Peak Current Mitigation */
  HWIO_ADDR(GCC_RDPM_MXA_DRAGONLINK_CBCR),
  HWIO_ADDR(GCC_RDPM_MXC_AHB_CBCR),
  // HWIO_ADDR(GCC_RDPM_MXC_CBCR),  /* Disabled for CX/MX Peak Current Mitigation */
...
static HAL_clk_RegisterMaskType aBranchVote[] =
{
   ...
   * gcc_tlmm_clk
   */
   { HWIO_ADDR(GCC_BOOT_CLK_BRANCH_ENA_VOTE), 0x134317B },

  /*
   * gcc_aggre_noc_pcie_south_axi_clk
   * gcc_aggre_noc_qup2_axi_clk
   ...
   */
   { HWIO_ADDR(GCC_BOOT_CLK_BRANCH_ENA_VOTE_1), 0xE03C0C00 },

  /*
   * gcc_anoc_pcie_at_clk
   ...
   */
   { HWIO_ADDR(GCC_BOOT_CLK_BRANCH_ENA_VOTE_2), 0x280F },
