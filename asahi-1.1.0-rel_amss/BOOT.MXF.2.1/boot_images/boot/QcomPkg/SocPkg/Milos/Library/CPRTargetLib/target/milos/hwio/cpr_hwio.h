...
#define CX_CPR3_REG_BASE_USED                                                                  0x3368
#define CX_CPR3_REG_BASE_PHYS                                                                  (CX_CPR3_BASE_PHYS + 0x00000000)
#define CX_CPR3_REG_BASE_OFFS                                                                  0x00000000

#define HWIO_CPR_VERSION_ADDR(x)                                                               ((x) + 0x0)
#define HWIO_CPR_VERSION_PHYS(x)                                                               ((x) + 0x0)
#define HWIO_CPR_VERSION_OFFS                                                                  (0x0)
...
#define HWIO_CPR_VERSION_MAJOR_SHFT                                                                    28
#define HWIO_CPR_VERSION_MINOR_BMSK                                                             0xfff0000
#define HWIO_CPR_VERSION_MINOR_SHFT                                                                    16
#define HWIO_CPR_VERSION_STEP_BMSK                                                                 0xffff
#define HWIO_CPR_VERSION_STEP_SHFT                                                                      0

#define HWIO_CPR_FSM_CTL_ADDR(x)                                                               ((x) + 0x4)
#define HWIO_CPR_FSM_CTL_PHYS(x)                                                               ((x) + 0x4)
#define HWIO_CPR_FSM_CTL_OFFS                                                                  (0x4)
...
#define HWIO_CPR_FSM_CTL_COUNT_REPEAT_SHFT                                                              9
#define HWIO_CPR_FSM_CTL_SET_HTOL_MODE_BMSK                                                         0x100
#define HWIO_CPR_FSM_CTL_SET_HTOL_MODE_SHFT                                                             8
#define HWIO_CPR_FSM_CTL_COUNT_MODE_BMSK                                                             0xc0
#define HWIO_CPR_FSM_CTL_COUNT_MODE_SHFT                                                                6
#define HWIO_CPR_FSM_CTL_IDLE_CLOCKS_BMSK                                                            0x3e
#define HWIO_CPR_FSM_CTL_IDLE_CLOCKS_SHFT                                                               1
#define HWIO_CPR_FSM_CTL_LOOP_EN_BMSK                                                                 0x1
#define HWIO_CPR_FSM_CTL_LOOP_EN_SHFT                                                                   0

#define HWIO_CPR_FSM_STA_ADDR(x)                                                               ((x) + 0x8)
#define HWIO_CPR_FSM_STA_PHYS(x)                                                               ((x) + 0x8)
#define HWIO_CPR_FSM_STA_OFFS                                                                  (0x8)
...
#define HWIO_CPR_FSM_STA_PAGE_IS_AGE_SHFT                                                               1
#define HWIO_CPR_FSM_STA_BUSY_BMSK                                                                    0x1
#define HWIO_CPR_FSM_STA_BUSY_SHFT                                                                      0

#define HWIO_CPR_TIMER_AUTO_CONT_ADDR(x)                                                       ((x) + 0xc)
#define HWIO_CPR_TIMER_AUTO_CONT_PHYS(x)                                                       ((x) + 0xc)
#define HWIO_CPR_TIMER_AUTO_CONT_OFFS                                                          (0xc)
...
#define HWIO_CPR_TIMER_AUTO_CONT_AUTO_CONT_INTERVAL_SHFT                                                0

#define HWIO_CPR_TIMER_CLAMP_ADDR(x)                                                           ((x) + 0x10)
#define HWIO_CPR_TIMER_CLAMP_PHYS(x)                                                           ((x) + 0x10)
#define HWIO_CPR_TIMER_CLAMP_OFFS                                                              (0x10)
#define HWIO_CPR_TIMER_CLAMP_RMSK                                                              0xf80008ff
...
#define HWIO_CPR_TIMER_CLAMP_CPR_DISABLE_VALID_SHFT                                                    31
#define HWIO_CPR_TIMER_CLAMP_GDHS_RESTART_ENABLE_BMSK                                          0x40000000
#define HWIO_CPR_TIMER_CLAMP_GDHS_RESTART_ENABLE_SHFT                                                  30
#define HWIO_CPR_TIMER_CLAMP_BHS_ON_RESTART_ENABLE_BMSK                                        0x20000000
#define HWIO_CPR_TIMER_CLAMP_BHS_ON_RESTART_ENABLE_SHFT                                                29
#define HWIO_CPR_TIMER_CLAMP_CLEAR_IRQ_WITH_CONT_EN_BMSK                                       0x10000000
#define HWIO_CPR_TIMER_CLAMP_CLEAR_IRQ_WITH_CONT_EN_SHFT                                               28
#define HWIO_CPR_TIMER_CLAMP_THREAD_AGGREGATION_EN_BMSK                                         0x8000000
#define HWIO_CPR_TIMER_CLAMP_THREAD_AGGREGATION_EN_SHFT                                                27
#define HWIO_CPR_TIMER_CLAMP_UPDATED_STARVATION_FEATURE_EN_BMSK                                     0x800
#define HWIO_CPR_TIMER_CLAMP_UPDATED_STARVATION_FEATURE_EN_SHFT                                        11
#define HWIO_CPR_TIMER_CLAMP_CLAMP_TIMER_INTERVAL_BMSK                                               0xff
#define HWIO_CPR_TIMER_CLAMP_CLAMP_TIMER_INTERVAL_SHFT                                                  0

#define HWIO_CPR_STEP_QUOT_INIT_ADDR(x)                                                        ((x) + 0x14)
#define HWIO_CPR_STEP_QUOT_INIT_PHYS(x)                                                        ((x) + 0x14)
#define HWIO_CPR_STEP_QUOT_INIT_OFFS                                                           (0x14)
...
#define HWIO_CPR_STEP_QUOT_INIT_STEP_QUOT_INIT_MAX_SHFT                                                 6
#define HWIO_CPR_STEP_QUOT_INIT_STEP_QUOT_INIT_MIN_BMSK                                              0x3f
#define HWIO_CPR_STEP_QUOT_INIT_STEP_QUOT_INIT_MIN_SHFT                                                 0

#define HWIO_CPR_BIST_CHAIN_CHECK0_ADDR(x)                                                     ((x) + 0x20)
#define HWIO_CPR_BIST_CHAIN_CHECK0_PHYS(x)                                                     ((x) + 0x20)
#define HWIO_CPR_BIST_CHAIN_CHECK0_OFFS                                                        (0x20)
...
#define HWIO_CPR_BIST_CHAIN_CHECK0_EN_CHAIN_CHECK_SHFT                                                 31
#define HWIO_CPR_BIST_CHAIN_CHECK0_SCLK_CNT_EXPECTED_BMSK                                           0xfff
#define HWIO_CPR_BIST_CHAIN_CHECK0_SCLK_CNT_EXPECTED_SHFT                                               0

#define HWIO_CPR_BIST_CHAIN_CHECK1_ADDR(x)                                                     ((x) + 0x24)
#define HWIO_CPR_BIST_CHAIN_CHECK1_PHYS(x)                                                     ((x) + 0x24)
#define HWIO_CPR_BIST_CHAIN_CHECK1_OFFS                                                        (0x24)
...
#define HWIO_CPR_BIST_CHAIN_CHECK1_SCLK_CNT_DONE_SHFT                                                  31
#define HWIO_CPR_BIST_CHAIN_CHECK1_SCLK_CNT_FAIL_BMSK                                          0x60000000
#define HWIO_CPR_BIST_CHAIN_CHECK1_SCLK_CNT_FAIL_SHFT                                                  29
#define HWIO_CPR_BIST_CHAIN_CHECK1_SCLK_CNT1_BMSK                                                0xfff000
#define HWIO_CPR_BIST_CHAIN_CHECK1_SCLK_CNT1_SHFT                                                      12
#define HWIO_CPR_BIST_CHAIN_CHECK1_SCLK_CNT0_BMSK                                                   0xfff
#define HWIO_CPR_BIST_CHAIN_CHECK1_SCLK_CNT0_SHFT                                                       0

#define HWIO_CPR_BIST_QUOT_CHECK0_ADDR(x)                                                      ((x) + 0x28)
#define HWIO_CPR_BIST_QUOT_CHECK0_PHYS(x)                                                      ((x) + 0x28)
#define HWIO_CPR_BIST_QUOT_CHECK0_OFFS                                                         (0x28)
...
#define HWIO_CPR_BIST_QUOT_CHECK0_FAIL_SHFT                                                            31
#define HWIO_CPR_BIST_QUOT_CHECK0_QUOT_ABSMAX_BMSK                                               0xfff000
#define HWIO_CPR_BIST_QUOT_CHECK0_QUOT_ABSMAX_SHFT                                                     12
#define HWIO_CPR_BIST_QUOT_CHECK0_QUOT_ABSMIN_BMSK                                                  0xfff
#define HWIO_CPR_BIST_QUOT_CHECK0_QUOT_ABSMIN_SHFT                                                      0

#define HWIO_CPR_BIST_QUOT_CHECK1_ADDR(x)                                                      ((x) + 0x2c)
#define HWIO_CPR_BIST_QUOT_CHECK1_PHYS(x)                                                      ((x) + 0x2c)
#define HWIO_CPR_BIST_QUOT_CHECK1_OFFS                                                         (0x2c)
...
#define HWIO_CPR_BIST_QUOT_CHECK1_FAIL_SEL_MAX_SHFT                                                    28
#define HWIO_CPR_BIST_QUOT_CHECK1_FAIL_SEL_MIN_BMSK                                             0xf000000
#define HWIO_CPR_BIST_QUOT_CHECK1_FAIL_SEL_MIN_SHFT                                                    24
#define HWIO_CPR_BIST_QUOT_CHECK1_FAIL_QUOT_MAX_BMSK                                             0xfff000
#define HWIO_CPR_BIST_QUOT_CHECK1_FAIL_QUOT_MAX_SHFT                                                   12
#define HWIO_CPR_BIST_QUOT_CHECK1_FAIL_QUOT_MIN_BMSK                                                0xfff
#define HWIO_CPR_BIST_QUOT_CHECK1_FAIL_QUOT_MIN_SHFT                                                    0

#define HWIO_CPR_BIST_FAIL_MAP_MIN_n_ADDR(base,n)                                              ((base) + 0X30 + (0x4*(n)))
#define HWIO_CPR_BIST_FAIL_MAP_MIN_n_PHYS(base,n)                                              ((base) + 0X30 + (0x4*(n)))
#define HWIO_CPR_BIST_FAIL_MAP_MIN_n_OFFS(n)                                                   (0X30 + (0x4*(n)))
...
#define HWIO_CPR_BIST_FAIL_MAP_MIN_n_BIST_FAIL_MAP_MIN_SHFT                                             0

#define HWIO_CPR_BIST_FAIL_MAP_MAX_n_ADDR(base,n)                                              ((base) + 0X50 + (0x4*(n)))
#define HWIO_CPR_BIST_FAIL_MAP_MAX_n_PHYS(base,n)                                              ((base) + 0X50 + (0x4*(n)))
#define HWIO_CPR_BIST_FAIL_MAP_MAX_n_OFFS(n)                                                   (0X50 + (0x4*(n)))
...
#define HWIO_CPR_BIST_FAIL_MAP_MAX_n_BIST_FAIL_MAP_MAX_SHFT                                             0

#define HWIO_CPR_DEBUG_ADDR(x)                                                                 ((x) + 0x70)
#define HWIO_CPR_DEBUG_PHYS(x)                                                                 ((x) + 0x70)
#define HWIO_CPR_DEBUG_OFFS                                                                    (0x70)
#define HWIO_CPR_DEBUG_RMSK                                                                       0x3ffff
...
#define HWIO_CPR_DEBUG_CPR_ACD_SELECT_BMSK                                                        0x3c000
#define HWIO_CPR_DEBUG_CPR_ACD_SELECT_SHFT                                                             14
#define HWIO_CPR_DEBUG_DEBUG_RO_SEL_BMSK                                                           0x3f00
#define HWIO_CPR_DEBUG_DEBUG_RO_SEL_SHFT                                                                8
#define HWIO_CPR_DEBUG_CPR_LOG_THREAD_SEL_BMSK                                                       0xe0
#define HWIO_CPR_DEBUG_CPR_LOG_THREAD_SEL_SHFT                                                          5
#define HWIO_CPR_DEBUG_DEBUG_BUS_SEL_BMSK                                                            0x1f
#define HWIO_CPR_DEBUG_DEBUG_BUS_SEL_SHFT                                                               0

#define HWIO_CPR_DEBUG_LOG_n_ADDR(base,n)                                                      ((base) + 0X80 + (0x4*(n)))
#define HWIO_CPR_DEBUG_LOG_n_PHYS(base,n)                                                      ((base) + 0X80 + (0x4*(n)))
#define HWIO_CPR_DEBUG_LOG_n_OFFS(n)                                                           (0X80 + (0x4*(n)))
...
#define HWIO_CPR_DEBUG_LOG_n_MID_COUNT_SHFT                                                            16
#define HWIO_CPR_DEBUG_LOG_n_UP_FLAG_BMSK                                                             0x8
#define HWIO_CPR_DEBUG_LOG_n_UP_FLAG_SHFT                                                               3
#define HWIO_CPR_DEBUG_LOG_n_MID_FLAG_BMSK                                                            0x4
#define HWIO_CPR_DEBUG_LOG_n_MID_FLAG_SHFT                                                              2
#define HWIO_CPR_DEBUG_LOG_n_DOWN_FLAG_BMSK                                                           0x2
#define HWIO_CPR_DEBUG_LOG_n_DOWN_FLAG_SHFT                                                             1

#define HWIO_CPR_GCNT0_ADDR(x)                                                                 ((x) + 0xa0)
#define HWIO_CPR_GCNT0_PHYS(x)                                                                 ((x) + 0xa0)
#define HWIO_CPR_GCNT0_OFFS                                                                    (0xa0)
...
#define HWIO_CPR_GCNT0_STEP_QUOT_INIT_PER_RO_KV0_SHFT                                                  10
#define HWIO_CPR_GCNT0_GCNT0_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT0_GCNT0_SHFT                                                                       0

#define HWIO_CPR_GCNT1_ADDR(x)                                                                 ((x) + 0xa4)
#define HWIO_CPR_GCNT1_PHYS(x)                                                                 ((x) + 0xa4)
#define HWIO_CPR_GCNT1_OFFS                                                                    (0xa4)
...
#define HWIO_CPR_GCNT1_STEP_QUOT_INIT_PER_RO_KV1_SHFT                                                  10
#define HWIO_CPR_GCNT1_GCNT1_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT1_GCNT1_SHFT                                                                       0

#define HWIO_CPR_GCNT2_ADDR(x)                                                                 ((x) + 0xa8)
#define HWIO_CPR_GCNT2_PHYS(x)                                                                 ((x) + 0xa8)
#define HWIO_CPR_GCNT2_OFFS                                                                    (0xa8)
...
#define HWIO_CPR_GCNT2_STEP_QUOT_INIT_PER_RO_KV2_SHFT                                                  10
#define HWIO_CPR_GCNT2_GCNT2_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT2_GCNT2_SHFT                                                                       0

#define HWIO_CPR_GCNT3_ADDR(x)                                                                 ((x) + 0xac)
#define HWIO_CPR_GCNT3_PHYS(x)                                                                 ((x) + 0xac)
#define HWIO_CPR_GCNT3_OFFS                                                                    (0xac)
...
#define HWIO_CPR_GCNT3_STEP_QUOT_INIT_PER_RO_KV3_SHFT                                                  10
#define HWIO_CPR_GCNT3_GCNT3_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT3_GCNT3_SHFT                                                                       0

#define HWIO_CPR_GCNT4_ADDR(x)                                                                 ((x) + 0xb0)
#define HWIO_CPR_GCNT4_PHYS(x)                                                                 ((x) + 0xb0)
#define HWIO_CPR_GCNT4_OFFS                                                                    (0xb0)
...
#define HWIO_CPR_GCNT4_STEP_QUOT_INIT_PER_RO_KV4_SHFT                                                  10
#define HWIO_CPR_GCNT4_GCNT4_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT4_GCNT4_SHFT                                                                       0

#define HWIO_CPR_GCNT5_ADDR(x)                                                                 ((x) + 0xb4)
#define HWIO_CPR_GCNT5_PHYS(x)                                                                 ((x) + 0xb4)
#define HWIO_CPR_GCNT5_OFFS                                                                    (0xb4)
...
#define HWIO_CPR_GCNT5_STEP_QUOT_INIT_PER_RO_KV5_SHFT                                                  10
#define HWIO_CPR_GCNT5_GCNT5_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT5_GCNT5_SHFT                                                                       0

#define HWIO_CPR_GCNT6_ADDR(x)                                                                 ((x) + 0xb8)
#define HWIO_CPR_GCNT6_PHYS(x)                                                                 ((x) + 0xb8)
#define HWIO_CPR_GCNT6_OFFS                                                                    (0xb8)
...
#define HWIO_CPR_GCNT6_STEP_QUOT_INIT_PER_RO_KV6_SHFT                                                  10
#define HWIO_CPR_GCNT6_GCNT6_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT6_GCNT6_SHFT                                                                       0

#define HWIO_CPR_GCNT7_ADDR(x)                                                                 ((x) + 0xbc)
#define HWIO_CPR_GCNT7_PHYS(x)                                                                 ((x) + 0xbc)
#define HWIO_CPR_GCNT7_OFFS                                                                    (0xbc)
...
#define HWIO_CPR_GCNT7_STEP_QUOT_INIT_PER_RO_KV7_SHFT                                                  10
#define HWIO_CPR_GCNT7_GCNT7_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT7_GCNT7_SHFT                                                                       0

#define HWIO_CPR_GCNT8_ADDR(x)                                                                 ((x) + 0xc0)
#define HWIO_CPR_GCNT8_PHYS(x)                                                                 ((x) + 0xc0)
#define HWIO_CPR_GCNT8_OFFS                                                                    (0xc0)
...
#define HWIO_CPR_GCNT8_STEP_QUOT_INIT_PER_RO_KV8_SHFT                                                  10
#define HWIO_CPR_GCNT8_GCNT8_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT8_GCNT8_SHFT                                                                       0

#define HWIO_CPR_GCNT9_ADDR(x)                                                                 ((x) + 0xc4)
#define HWIO_CPR_GCNT9_PHYS(x)                                                                 ((x) + 0xc4)
#define HWIO_CPR_GCNT9_OFFS                                                                    (0xc4)
...
#define HWIO_CPR_GCNT9_STEP_QUOT_INIT_PER_RO_KV9_SHFT                                                  10
#define HWIO_CPR_GCNT9_GCNT9_BMSK                                                                   0x3ff
#define HWIO_CPR_GCNT9_GCNT9_SHFT                                                                       0

#define HWIO_CPR_GCNT10_ADDR(x)                                                                ((x) + 0xc8)
#define HWIO_CPR_GCNT10_PHYS(x)                                                                ((x) + 0xc8)
#define HWIO_CPR_GCNT10_OFFS                                                                   (0xc8)
...
#define HWIO_CPR_GCNT10_STEP_QUOT_INIT_PER_RO_KV10_SHFT                                                10
#define HWIO_CPR_GCNT10_GCNT10_BMSK                                                                 0x3ff
#define HWIO_CPR_GCNT10_GCNT10_SHFT                                                                     0

#define HWIO_CPR_GCNT11_ADDR(x)                                                                ((x) + 0xcc)
#define HWIO_CPR_GCNT11_PHYS(x)                                                                ((x) + 0xcc)
#define HWIO_CPR_GCNT11_OFFS                                                                   (0xcc)
...
#define HWIO_CPR_GCNT11_STEP_QUOT_INIT_PER_RO_KV11_SHFT                                                10
#define HWIO_CPR_GCNT11_GCNT11_BMSK                                                                 0x3ff
#define HWIO_CPR_GCNT11_GCNT11_SHFT                                                                     0

#define HWIO_CPR_GCNT12_ADDR(x)                                                                ((x) + 0xd0)
#define HWIO_CPR_GCNT12_PHYS(x)                                                                ((x) + 0xd0)
#define HWIO_CPR_GCNT12_OFFS                                                                   (0xd0)
...
#define HWIO_CPR_GCNT12_STEP_QUOT_INIT_PER_RO_KV12_SHFT                                                10
#define HWIO_CPR_GCNT12_GCNT12_BMSK                                                                 0x3ff
#define HWIO_CPR_GCNT12_GCNT12_SHFT                                                                     0

#define HWIO_CPR_GCNT13_ADDR(x)                                                                ((x) + 0xd4)
#define HWIO_CPR_GCNT13_PHYS(x)                                                                ((x) + 0xd4)
#define HWIO_CPR_GCNT13_OFFS                                                                   (0xd4)
...
#define HWIO_CPR_GCNT13_STEP_QUOT_INIT_PER_RO_KV13_SHFT                                                10
#define HWIO_CPR_GCNT13_GCNT13_BMSK                                                                 0x3ff
#define HWIO_CPR_GCNT13_GCNT13_SHFT                                                                     0

#define HWIO_CPR_GCNT14_ADDR(x)                                                                ((x) + 0xd8)
#define HWIO_CPR_GCNT14_PHYS(x)                                                                ((x) + 0xd8)
#define HWIO_CPR_GCNT14_OFFS                                                                   (0xd8)
...
#define HWIO_CPR_GCNT14_STEP_QUOT_INIT_PER_RO_KV14_SHFT                                                10
#define HWIO_CPR_GCNT14_GCNT14_BMSK                                                                 0x3ff
#define HWIO_CPR_GCNT14_GCNT14_SHFT                                                                     0

#define HWIO_CPR_GCNT15_ADDR(x)                                                                ((x) + 0xdc)
#define HWIO_CPR_GCNT15_PHYS(x)                                                                ((x) + 0xdc)
#define HWIO_CPR_GCNT15_OFFS                                                                   (0xdc)
...
#define HWIO_CPR_GCNT15_STEP_QUOT_INIT_PER_RO_KV15_SHFT                                                10
#define HWIO_CPR_GCNT15_GCNT15_BMSK                                                                 0x3ff
#define HWIO_CPR_GCNT15_GCNT15_SHFT                                                                     0

#define HWIO_CPR_SENSOR_BYPASS_WRITEn_ADDR(base,n)                                             ((base) + 0XE0 + (0x4*(n)))
#define HWIO_CPR_SENSOR_BYPASS_WRITEn_PHYS(base,n)                                             ((base) + 0XE0 + (0x4*(n)))
#define HWIO_CPR_SENSOR_BYPASS_WRITEn_OFFS(n)                                                  (0XE0 + (0x4*(n)))
...
#define HWIO_CPR_SENSOR_BYPASS_WRITEn_SENSOR_BYPASS_SHFT                                                0

#define HWIO_CPR_SENSOR_BYPASS_READn_ADDR(base,n)                                              ((base) + 0X100 + (0x4*(n)))
#define HWIO_CPR_SENSOR_BYPASS_READn_PHYS(base,n)                                              ((base) + 0X100 + (0x4*(n)))
#define HWIO_CPR_SENSOR_BYPASS_READn_OFFS(n)                                                   (0X100 + (0x4*(n)))
...
#define HWIO_CPR_SENSOR_BYPASS_READn_SENSOR_BYPASS_SHFT                                                 0

#define HWIO_CPR_SENSOR_MASK_WRITEn_ADDR(base,n)                                               ((base) + 0X120 + (0x4*(n)))
#define HWIO_CPR_SENSOR_MASK_WRITEn_PHYS(base,n)                                               ((base) + 0X120 + (0x4*(n)))
#define HWIO_CPR_SENSOR_MASK_WRITEn_OFFS(n)                                                    (0X120 + (0x4*(n)))
...
#define HWIO_CPR_SENSOR_MASK_WRITEn_SENSOR_MASK_SHFT                                                    0

#define HWIO_CPR_SENSOR_MASK_READn_ADDR(base,n)                                                ((base) + 0X140 + (0x4*(n)))
#define HWIO_CPR_SENSOR_MASK_READn_PHYS(base,n)                                                ((base) + 0X140 + (0x4*(n)))
#define HWIO_CPR_SENSOR_MASK_READn_OFFS(n)                                                     (0X140 + (0x4*(n)))
...
#define HWIO_CPR_SENSOR_MASK_READn_SENSOR_MASK_SHFT                                                     0

#define HWIO_CPR_SENSOR_THREAD_n_ADDR(base,n)                                                  ((base) + 0X200 + (0x4*(n)))
#define HWIO_CPR_SENSOR_THREAD_n_PHYS(base,n)                                                  ((base) + 0X200 + (0x4*(n)))
#define HWIO_CPR_SENSOR_THREAD_n_OFFS(n)                                                       (0X200 + (0x4*(n)))
#define HWIO_CPR_SENSOR_THREAD_n_RMSK                                                                 0x1
#define HWIO_CPR_SENSOR_THREAD_n_MAXn                                                                  49
...
#define HWIO_CPR_SENSOR_THREAD_n_THREAD_ID_SHFT                                                         0

#define HWIO_CPR_GCNT16_ADDR(x)                                                                ((x) + 0x600)
#define HWIO_CPR_GCNT16_PHYS(x)                                                                ((x) + 0x600)
#define HWIO_CPR_GCNT16_OFFS                                                                   (0x600)
...
#define HWIO_CPR_GCNT16_GCNT16_SHFT                                                                     0

#define HWIO_CPR_GCNT17_ADDR(x)                                                                ((x) + 0x604)
#define HWIO_CPR_GCNT17_PHYS(x)                                                                ((x) + 0x604)
#define HWIO_CPR_GCNT17_OFFS                                                                   (0x604)
...
#define HWIO_CPR_GCNT17_GCNT17_SHFT                                                                     0

#define HWIO_CPR_GCNT18_ADDR(x)                                                                ((x) + 0x608)
#define HWIO_CPR_GCNT18_PHYS(x)                                                                ((x) + 0x608)
#define HWIO_CPR_GCNT18_OFFS                                                                   (0x608)
...
#define HWIO_CPR_GCNT18_GCNT18_SHFT                                                                     0

#define HWIO_CPR_GCNT19_ADDR(x)                                                                ((x) + 0x60c)
#define HWIO_CPR_GCNT19_PHYS(x)                                                                ((x) + 0x60c)
#define HWIO_CPR_GCNT19_OFFS                                                                   (0x60c)
...
#define HWIO_CPR_GCNT19_GCNT19_SHFT                                                                     0

#define HWIO_CPR_GCNT20_ADDR(x)                                                                ((x) + 0x610)
#define HWIO_CPR_GCNT20_PHYS(x)                                                                ((x) + 0x610)
#define HWIO_CPR_GCNT20_OFFS                                                                   (0x610)
...
#define HWIO_CPR_GCNT20_GCNT20_SHFT                                                                     0

#define HWIO_CPR_GCNT21_ADDR(x)                                                                ((x) + 0x614)
#define HWIO_CPR_GCNT21_PHYS(x)                                                                ((x) + 0x614)
#define HWIO_CPR_GCNT21_OFFS                                                                   (0x614)
...
#define HWIO_CPR_GCNT21_GCNT21_SHFT                                                                     0

#define HWIO_CPR_GCNT22_ADDR(x)                                                                ((x) + 0x618)
#define HWIO_CPR_GCNT22_PHYS(x)                                                                ((x) + 0x618)
#define HWIO_CPR_GCNT22_OFFS                                                                   (0x618)
...
#define HWIO_CPR_GCNT22_GCNT22_SHFT                                                                     0

#define HWIO_CPR_GCNT23_ADDR(x)                                                                ((x) + 0x61c)
#define HWIO_CPR_GCNT23_PHYS(x)                                                                ((x) + 0x61c)
#define HWIO_CPR_GCNT23_OFFS                                                                   (0x61c)
...
#define HWIO_CPR_GCNT23_GCNT23_SHFT                                                                     0

#define HWIO_CPR_GCNT24_ADDR(x)                                                                ((x) + 0x620)
#define HWIO_CPR_GCNT24_PHYS(x)                                                                ((x) + 0x620)
#define HWIO_CPR_GCNT24_OFFS                                                                   (0x620)
...
#define HWIO_CPR_GCNT24_GCNT24_SHFT                                                                     0

#define HWIO_CPR_GCNT25_ADDR(x)                                                                ((x) + 0x624)
#define HWIO_CPR_GCNT25_PHYS(x)                                                                ((x) + 0x624)
#define HWIO_CPR_GCNT25_OFFS                                                                   (0x624)
...
#define HWIO_CPR_GCNT25_GCNT25_SHFT                                                                     0

#define HWIO_CPR_GCNT26_ADDR(x)                                                                ((x) + 0x628)
#define HWIO_CPR_GCNT26_PHYS(x)                                                                ((x) + 0x628)
#define HWIO_CPR_GCNT26_OFFS                                                                   (0x628)
...
#define HWIO_CPR_GCNT26_GCNT26_SHFT                                                                     0

#define HWIO_CPR_GCNT27_ADDR(x)                                                                ((x) + 0x62c)
#define HWIO_CPR_GCNT27_PHYS(x)                                                                ((x) + 0x62c)
#define HWIO_CPR_GCNT27_OFFS                                                                   (0x62c)
...
#define HWIO_CPR_GCNT27_GCNT27_SHFT                                                                     0

#define HWIO_CPR_GCNT28_ADDR(x)                                                                ((x) + 0x630)
#define HWIO_CPR_GCNT28_PHYS(x)                                                                ((x) + 0x630)
#define HWIO_CPR_GCNT28_OFFS                                                                   (0x630)
...
#define HWIO_CPR_GCNT28_GCNT28_SHFT                                                                     0

#define HWIO_CPR_GCNT29_ADDR(x)                                                                ((x) + 0x634)
#define HWIO_CPR_GCNT29_PHYS(x)                                                                ((x) + 0x634)
#define HWIO_CPR_GCNT29_OFFS                                                                   (0x634)
...
#define HWIO_CPR_GCNT29_GCNT29_SHFT                                                                     0

#define HWIO_CPR_GCNT30_ADDR(x)                                                                ((x) + 0x638)
#define HWIO_CPR_GCNT30_PHYS(x)                                                                ((x) + 0x638)
#define HWIO_CPR_GCNT30_OFFS                                                                   (0x638)
...
#define HWIO_CPR_GCNT30_GCNT30_SHFT                                                                     0

#define HWIO_CPR_GCNT31_ADDR(x)                                                                ((x) + 0x63c)
#define HWIO_CPR_GCNT31_PHYS(x)                                                                ((x) + 0x63c)
#define HWIO_CPR_GCNT31_OFFS                                                                   (0x63c)
...
#define HWIO_CPR_GCNT31_GCNT31_SHFT                                                                     0

#define HWIO_CPR_GCNT32_ADDR(x)                                                                ((x) + 0x640)
#define HWIO_CPR_GCNT32_PHYS(x)                                                                ((x) + 0x640)
#define HWIO_CPR_GCNT32_OFFS                                                                   (0x640)
...
#define HWIO_CPR_GCNT32_GCNT32_SHFT                                                                     0

#define HWIO_CPR_GCNT33_ADDR(x)                                                                ((x) + 0x644)
#define HWIO_CPR_GCNT33_PHYS(x)                                                                ((x) + 0x644)
#define HWIO_CPR_GCNT33_OFFS                                                                   (0x644)
...
#define HWIO_CPR_GCNT33_GCNT33_SHFT                                                                     0

#define HWIO_CPR_GCNT34_ADDR(x)                                                                ((x) + 0x648)
#define HWIO_CPR_GCNT34_PHYS(x)                                                                ((x) + 0x648)
#define HWIO_CPR_GCNT34_OFFS                                                                   (0x648)
...
#define HWIO_CPR_GCNT34_GCNT34_SHFT                                                                     0

#define HWIO_CPR_GCNT35_ADDR(x)                                                                ((x) + 0x64c)
#define HWIO_CPR_GCNT35_PHYS(x)                                                                ((x) + 0x64c)
#define HWIO_CPR_GCNT35_OFFS                                                                   (0x64c)
...
#define HWIO_CPR_GCNT35_GCNT35_SHFT                                                                     0

#define HWIO_CPR_GCNT36_ADDR(x)                                                                ((x) + 0x650)
#define HWIO_CPR_GCNT36_PHYS(x)                                                                ((x) + 0x650)
#define HWIO_CPR_GCNT36_OFFS                                                                   (0x650)
...
#define HWIO_CPR_GCNT36_GCNT36_SHFT                                                                     0

#define HWIO_CPR_GCNT37_ADDR(x)                                                                ((x) + 0x654)
#define HWIO_CPR_GCNT37_PHYS(x)                                                                ((x) + 0x654)
#define HWIO_CPR_GCNT37_OFFS                                                                   (0x654)
...
#define HWIO_CPR_GCNT37_GCNT37_SHFT                                                                     0

#define HWIO_CPR_GCNT38_ADDR(x)                                                                ((x) + 0x658)
#define HWIO_CPR_GCNT38_PHYS(x)                                                                ((x) + 0x658)
#define HWIO_CPR_GCNT38_OFFS                                                                   (0x658)
...
#define HWIO_CPR_GCNT38_GCNT38_SHFT                                                                     0

#define HWIO_CPR_GCNT39_ADDR(x)                                                                ((x) + 0x65c)
#define HWIO_CPR_GCNT39_PHYS(x)                                                                ((x) + 0x65c)
#define HWIO_CPR_GCNT39_OFFS                                                                   (0x65c)
...
#define HWIO_CPR_GCNT39_GCNT39_SHFT                                                                     0

#define HWIO_CPR_GCNT40_ADDR(x)                                                                ((x) + 0x660)
#define HWIO_CPR_GCNT40_PHYS(x)                                                                ((x) + 0x660)
#define HWIO_CPR_GCNT40_OFFS                                                                   (0x660)
...
#define HWIO_CPR_GCNT40_GCNT40_SHFT                                                                     0

#define HWIO_CPR_GCNT41_ADDR(x)                                                                ((x) + 0x664)
#define HWIO_CPR_GCNT41_PHYS(x)                                                                ((x) + 0x664)
#define HWIO_CPR_GCNT41_OFFS                                                                   (0x664)
...
#define HWIO_CPR_GCNT41_GCNT41_SHFT                                                                     0

#define HWIO_CPR_GCNT42_ADDR(x)                                                                ((x) + 0x668)
#define HWIO_CPR_GCNT42_PHYS(x)                                                                ((x) + 0x668)
#define HWIO_CPR_GCNT42_OFFS                                                                   (0x668)
...
#define HWIO_CPR_GCNT42_GCNT42_SHFT                                                                     0

#define HWIO_CPR_GCNT43_ADDR(x)                                                                ((x) + 0x66c)
#define HWIO_CPR_GCNT43_PHYS(x)                                                                ((x) + 0x66c)
#define HWIO_CPR_GCNT43_OFFS                                                                   (0x66c)
...
#define HWIO_CPR_GCNT43_GCNT43_SHFT                                                                     0

#define HWIO_CPR_GCNT44_ADDR(x)                                                                ((x) + 0x670)
#define HWIO_CPR_GCNT44_PHYS(x)                                                                ((x) + 0x670)
#define HWIO_CPR_GCNT44_OFFS                                                                   (0x670)
...
#define HWIO_CPR_GCNT44_GCNT44_SHFT                                                                     0

#define HWIO_CPR_GCNT45_ADDR(x)                                                                ((x) + 0x674)
#define HWIO_CPR_GCNT45_PHYS(x)                                                                ((x) + 0x674)
#define HWIO_CPR_GCNT45_OFFS                                                                   (0x674)
...
#define HWIO_CPR_GCNT45_GCNT45_SHFT                                                                     0

#define HWIO_CPR_GCNT46_ADDR(x)                                                                ((x) + 0x678)
#define HWIO_CPR_GCNT46_PHYS(x)                                                                ((x) + 0x678)
#define HWIO_CPR_GCNT46_OFFS                                                                   (0x678)
...
#define HWIO_CPR_GCNT46_GCNT46_SHFT                                                                     0

#define HWIO_CPR_GCNT47_ADDR(x)                                                                ((x) + 0x67c)
#define HWIO_CPR_GCNT47_PHYS(x)                                                                ((x) + 0x67c)
#define HWIO_CPR_GCNT47_OFFS                                                                   (0x67c)
...
#define HWIO_CPR_GCNT47_GCNT47_SHFT                                                                     0

#define HWIO_CPR_GCNT48_ADDR(x)                                                                ((x) + 0x680)
#define HWIO_CPR_GCNT48_PHYS(x)                                                                ((x) + 0x680)
#define HWIO_CPR_GCNT48_OFFS                                                                   (0x680)
...
#define HWIO_CPR_GCNT48_GCNT48_SHFT                                                                     0

#define HWIO_CPR_GCNT49_ADDR(x)                                                                ((x) + 0x684)
#define HWIO_CPR_GCNT49_PHYS(x)                                                                ((x) + 0x684)
#define HWIO_CPR_GCNT49_OFFS                                                                   (0x684)
...
#define HWIO_CPR_GCNT49_GCNT49_SHFT                                                                     0

#define HWIO_CPR_GCNT50_ADDR(x)                                                                ((x) + 0x688)
#define HWIO_CPR_GCNT50_PHYS(x)                                                                ((x) + 0x688)
#define HWIO_CPR_GCNT50_OFFS                                                                   (0x688)
...
#define HWIO_CPR_GCNT50_GCNT50_SHFT                                                                     0

#define HWIO_CPR_GCNT51_ADDR(x)                                                                ((x) + 0x68c)
#define HWIO_CPR_GCNT51_PHYS(x)                                                                ((x) + 0x68c)
#define HWIO_CPR_GCNT51_OFFS                                                                   (0x68c)
...
#define HWIO_CPR_GCNT51_GCNT51_SHFT                                                                     0

#define HWIO_CPR_GCNT52_ADDR(x)                                                                ((x) + 0x690)
#define HWIO_CPR_GCNT52_PHYS(x)                                                                ((x) + 0x690)
#define HWIO_CPR_GCNT52_OFFS                                                                   (0x690)
...
#define HWIO_CPR_GCNT52_GCNT52_SHFT                                                                     0

#define HWIO_CPR_GCNT53_ADDR(x)                                                                ((x) + 0x694)
#define HWIO_CPR_GCNT53_PHYS(x)                                                                ((x) + 0x694)
#define HWIO_CPR_GCNT53_OFFS                                                                   (0x694)
...
#define HWIO_CPR_GCNT53_GCNT53_SHFT                                                                     0

#define HWIO_CPR_GCNT54_ADDR(x)                                                                ((x) + 0x698)
#define HWIO_CPR_GCNT54_PHYS(x)                                                                ((x) + 0x698)
#define HWIO_CPR_GCNT54_OFFS                                                                   (0x698)
...
#define HWIO_CPR_GCNT54_GCNT54_SHFT                                                                     0

#define HWIO_CPR_GCNT55_ADDR(x)                                                                ((x) + 0x69c)
#define HWIO_CPR_GCNT55_PHYS(x)                                                                ((x) + 0x69c)
#define HWIO_CPR_GCNT55_OFFS                                                                   (0x69c)
...
#define HWIO_CPR_GCNT55_GCNT55_SHFT                                                                     0

#define HWIO_CPR_GCNT56_ADDR(x)                                                                ((x) + 0x6a0)
#define HWIO_CPR_GCNT56_PHYS(x)                                                                ((x) + 0x6a0)
#define HWIO_CPR_GCNT56_OFFS                                                                   (0x6a0)
...
#define HWIO_CPR_GCNT56_GCNT56_SHFT                                                                     0

#define HWIO_CPR_GCNT57_ADDR(x)                                                                ((x) + 0x6a4)
#define HWIO_CPR_GCNT57_PHYS(x)                                                                ((x) + 0x6a4)
#define HWIO_CPR_GCNT57_OFFS                                                                   (0x6a4)
...
#define HWIO_CPR_GCNT57_GCNT57_SHFT                                                                     0

#define HWIO_CPR_GCNT58_ADDR(x)                                                                ((x) + 0x6a8)
#define HWIO_CPR_GCNT58_PHYS(x)                                                                ((x) + 0x6a8)
#define HWIO_CPR_GCNT58_OFFS                                                                   (0x6a8)
...
#define HWIO_CPR_GCNT58_GCNT58_SHFT                                                                     0

#define HWIO_CPR_GCNT59_ADDR(x)                                                                ((x) + 0x6ac)
#define HWIO_CPR_GCNT59_PHYS(x)                                                                ((x) + 0x6ac)
#define HWIO_CPR_GCNT59_OFFS                                                                   (0x6ac)
...
#define HWIO_CPR_GCNT59_GCNT59_SHFT                                                                     0

#define HWIO_CPR_GCNT60_ADDR(x)                                                                ((x) + 0x6b0)
#define HWIO_CPR_GCNT60_PHYS(x)                                                                ((x) + 0x6b0)
#define HWIO_CPR_GCNT60_OFFS                                                                   (0x6b0)
...
#define HWIO_CPR_GCNT60_GCNT60_SHFT                                                                     0

#define HWIO_CPR_GCNT61_ADDR(x)                                                                ((x) + 0x6b4)
#define HWIO_CPR_GCNT61_PHYS(x)                                                                ((x) + 0x6b4)
#define HWIO_CPR_GCNT61_OFFS                                                                   (0x6b4)
...
#define HWIO_CPR_GCNT61_GCNT61_SHFT                                                                     0

#define HWIO_CPR_GCNT62_ADDR(x)                                                                ((x) + 0x6b8)
#define HWIO_CPR_GCNT62_PHYS(x)                                                                ((x) + 0x6b8)
#define HWIO_CPR_GCNT62_OFFS                                                                   (0x6b8)
...
#define HWIO_CPR_GCNT62_GCNT62_SHFT                                                                     0

#define HWIO_CPR_GCNT63_ADDR(x)                                                                ((x) + 0x6bc)
#define HWIO_CPR_GCNT63_PHYS(x)                                                                ((x) + 0x6bc)
#define HWIO_CPR_GCNT63_OFFS                                                                   (0x6bc)
...
#define HWIO_CPR_GCNT63_GCNT63_SHFT                                                                     0

#define HWIO_CPR_64RO_CTRL_ADDR(x)                                                             ((x) + 0x6c0)
#define HWIO_CPR_64RO_CTRL_PHYS(x)                                                             ((x) + 0x6c0)
#define HWIO_CPR_64RO_CTRL_OFFS                                                                (0x6c0)
...
#define HWIO_CPR_64RO_CTRL_CPR_64RO_EN_SHFT                                                             0

#define HWIO_CPR_MISC_REGISTER_ADDR(x)                                                         ((x) + 0x700)
#define HWIO_CPR_MISC_REGISTER_PHYS(x)                                                         ((x) + 0x700)
#define HWIO_CPR_MISC_REGISTER_OFFS                                                            (0x700)
...
#define HWIO_CPR_MISC_REGISTER_TEMP_COLD_CTRL_BMSK                                             0xf0000000
#define HWIO_CPR_MISC_REGISTER_TEMP_COLD_CTRL_SHFT                                                     28
#define HWIO_CPR_MISC_REGISTER_TEMP_HOT_CTRL_BMSK                                               0xf000000
#define HWIO_CPR_MISC_REGISTER_TEMP_HOT_CTRL_SHFT                                                      24
#define HWIO_CPR_MISC_REGISTER_MARGIN_TABLE_ROW_SELECT_BMSK                                      0xf00000
#define HWIO_CPR_MISC_REGISTER_MARGIN_TABLE_ROW_SELECT_SHFT                                            20
#define HWIO_CPR_MISC_REGISTER_DISABLE_CPR_STALL_FIX_BMSK                                         0x80000
#define HWIO_CPR_MISC_REGISTER_DISABLE_CPR_STALL_FIX_SHFT                                              19
#define HWIO_CPR_MISC_REGISTER_UNUSED_BMSK                                                        0x7f000
#define HWIO_CPR_MISC_REGISTER_UNUSED_SHFT                                                             12
#define HWIO_CPR_MISC_REGISTER_CPRF_SETTLE_TIMER_UP_EN_BMSK                                         0x800
#define HWIO_CPR_MISC_REGISTER_CPRF_SETTLE_TIMER_UP_EN_SHFT                                            11
#define HWIO_CPR_MISC_REGISTER_CPR_GCNT_PER_MODE_EN_BMSK                                            0x400
#define HWIO_CPR_MISC_REGISTER_CPR_GCNT_PER_MODE_EN_SHFT                                               10
#define HWIO_CPR_MISC_REGISTER_CPRF_MID_COMMAND_EN_BMSK                                             0x200
#define HWIO_CPR_MISC_REGISTER_CPRF_MID_COMMAND_EN_SHFT                                                 9
#define HWIO_CPR_MISC_REGISTER_CPR_TSENSE_CTL_READING_EN_BMSK                                       0x100
#define HWIO_CPR_MISC_REGISTER_CPR_TSENSE_CTL_READING_EN_SHFT                                           8
#define HWIO_CPR_MISC_REGISTER_CPR_AGGRESIVE_CGC_DISABLE_BMSK                                        0x80
#define HWIO_CPR_MISC_REGISTER_CPR_AGGRESIVE_CGC_DISABLE_SHFT                                           7
#define HWIO_CPR_MISC_REGISTER_CPRF_SETTLE_TIMER_DOWN_EN_BMSK                                        0x40
#define HWIO_CPR_MISC_REGISTER_CPRF_SETTLE_TIMER_DOWN_EN_SHFT                                           6
#define HWIO_CPR_MISC_REGISTER_CPRF_INTERFACE_ENABLE_BMSK                                            0x20
#define HWIO_CPR_MISC_REGISTER_CPRF_INTERFACE_ENABLE_SHFT                                               5
#define HWIO_CPR_MISC_REGISTER_STEP_QUOT_INIT_PER_RO_BMSK                                            0x10
#define HWIO_CPR_MISC_REGISTER_STEP_QUOT_INIT_PER_RO_SHFT                                               4
#define HWIO_CPR_MISC_REGISTER_THREAD_HAS_ALWAYS_VOTE_BMSK                                            0x8
#define HWIO_CPR_MISC_REGISTER_THREAD_HAS_ALWAYS_VOTE_SHFT                                              3
#define HWIO_CPR_MISC_REGISTER_RESET_STEP_QUOT_LOOP_EN_BMSK                                           0x4
#define HWIO_CPR_MISC_REGISTER_RESET_STEP_QUOT_LOOP_EN_SHFT                                             2
#define HWIO_CPR_MISC_REGISTER_ADD_SUB_MARGIN_BMSK                                                    0x2
#define HWIO_CPR_MISC_REGISTER_ADD_SUB_MARGIN_SHFT                                                      1
#define HWIO_CPR_MISC_REGISTER_TEMP_MARGIN_POLARITY_BMSK                                              0x1
#define HWIO_CPR_MISC_REGISTER_TEMP_MARGIN_POLARITY_SHFT                                                0

#define HWIO_CPR_DISABLE_RO_ALL_THREADS_ADDR(x)                                                ((x) + 0x704)
#define HWIO_CPR_DISABLE_RO_ALL_THREADS_PHYS(x)                                                ((x) + 0x704)
#define HWIO_CPR_DISABLE_RO_ALL_THREADS_OFFS                                                   (0x704)
...
#define HWIO_CPR_DISABLE_RO_ALL_THREADS_UNUSED_SHFT                                                    16
#define HWIO_CPR_DISABLE_RO_ALL_THREADS_RO_DISABLE_BMSK                                            0xffff
#define HWIO_CPR_DISABLE_RO_ALL_THREADS_RO_DISABLE_SHFT                                                 0

#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_ADDR(x)                                                ((x) + 0x708)
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_PHYS(x)                                                ((x) + 0x708)
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_OFFS                                                   (0x708)
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_RMSK                                                          0x3
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_IN(x)            \
                in_dword(HWIO_CPR_UP_DN_FLAG_NACK_STATUS_ADDR(x))
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_INM(x, m)            \
                in_dword_masked(HWIO_CPR_UP_DN_FLAG_NACK_STATUS_ADDR(x), m)
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_UP_FLAG_IS_NACK_BMSK                                          0x2
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_UP_FLAG_IS_NACK_SHFT                                            1
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_DOWN_FLAG_IS_NACK_BMSK                                        0x1
#define HWIO_CPR_UP_DN_FLAG_NACK_STATUS_DOWN_FLAG_IS_NACK_SHFT                                          0

#define HWIO_CPR_ACD_CPRC_SW_CTRL_ADDR(x)                                                      ((x) + 0x718)
#define HWIO_CPR_ACD_CPRC_SW_CTRL_PHYS(x)                                                      ((x) + 0x718)
#define HWIO_CPR_ACD_CPRC_SW_CTRL_OFFS                                                         (0x718)
#define HWIO_CPR_ACD_CPRC_SW_CTRL_RMSK                                                                0xf
#define HWIO_CPR_ACD_CPRC_SW_CTRL_IN(x)            \
                in_dword(HWIO_CPR_ACD_CPRC_SW_CTRL_ADDR(x))
#define HWIO_CPR_ACD_CPRC_SW_CTRL_INM(x, m)            \
                in_dword_masked(HWIO_CPR_ACD_CPRC_SW_CTRL_ADDR(x), m)
#define HWIO_CPR_ACD_CPRC_SW_CTRL_OUT(x, v)            \
                out_dword(HWIO_CPR_ACD_CPRC_SW_CTRL_ADDR(x),v)
#define HWIO_CPR_ACD_CPRC_SW_CTRL_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_ACD_CPRC_SW_CTRL_ADDR(x),m,v,HWIO_CPR_ACD_CPRC_SW_CTRL_IN(x))
#define HWIO_CPR_ACD_CPRC_SW_CTRL_MID_FLAG_SW_BMSK                                                    0x8
#define HWIO_CPR_ACD_CPRC_SW_CTRL_MID_FLAG_SW_SHFT                                                      3
#define HWIO_CPR_ACD_CPRC_SW_CTRL_ACD_CPRC_CALIB_ACK_SW_BMSK                                          0x4
#define HWIO_CPR_ACD_CPRC_SW_CTRL_ACD_CPRC_CALIB_ACK_SW_SHFT                                            2
#define HWIO_CPR_ACD_CPRC_SW_CTRL_ACD_CALIB_SW_OVERRIDE_MODE_BMSK                                     0x2
#define HWIO_CPR_ACD_CPRC_SW_CTRL_ACD_CALIB_SW_OVERRIDE_MODE_SHFT                                       1
#define HWIO_CPR_ACD_CPRC_SW_CTRL_ACD_CALIB_FEATURE_EN_BMSK                                           0x1
#define HWIO_CPR_ACD_CPRC_SW_CTRL_ACD_CALIB_FEATURE_EN_SHFT                                             0

#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_ADDR(x)                                              ((x) + 0x71c)
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_PHYS(x)                                              ((x) + 0x71c)
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_OFFS                                                 (0x71c)
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_RMSK                                                 0xffffffff
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_IN(x)            \
                in_dword(HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_ADDR(x))
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_INM(x, m)            \
                in_dword_masked(HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_ADDR(x), m)
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_OUT(x, v)            \
                out_dword(HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_ADDR(x),v)
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_ADDR(x),m,v,HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_IN(x))
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_CALIB_ACK_WAIT_TIMER_BMSK                            0xffffffff
#define HWIO_CPR_ACD_CALIB_ACK_WAIT_TIMER_CALIB_ACK_WAIT_TIMER_SHFT                                     0

#define HWIO_CPR_ACD_CPRC_SW_STATUS_ADDR(x)                                                    ((x) + 0x720)
#define HWIO_CPR_ACD_CPRC_SW_STATUS_PHYS(x)                                                    ((x) + 0x720)
#define HWIO_CPR_ACD_CPRC_SW_STATUS_OFFS                                                       (0x720)
#define HWIO_CPR_ACD_CPRC_SW_STATUS_RMSK                                                              0x7
#define HWIO_CPR_ACD_CPRC_SW_STATUS_IN(x)            \
                in_dword(HWIO_CPR_ACD_CPRC_SW_STATUS_ADDR(x))
#define HWIO_CPR_ACD_CPRC_SW_STATUS_INM(x, m)            \
                in_dword_masked(HWIO_CPR_ACD_CPRC_SW_STATUS_ADDR(x), m)
#define HWIO_CPR_ACD_CPRC_SW_STATUS_TIMEOUT_BMSK                                                      0x4
#define HWIO_CPR_ACD_CPRC_SW_STATUS_TIMEOUT_SHFT                                                        2
#define HWIO_CPR_ACD_CPRC_SW_STATUS_ACD_FORCE_ACK_BMSK                                                0x2
#define HWIO_CPR_ACD_CPRC_SW_STATUS_ACD_FORCE_ACK_SHFT                                                  1
#define HWIO_CPR_ACD_CPRC_SW_STATUS_ACD_CALIB_REQ_BMSK                                                0x1
#define HWIO_CPR_ACD_CPRC_SW_STATUS_ACD_CALIB_REQ_SHFT                                                  0

#define HWIO_CPR_PER_SENSOR_QUOT_0_ADDR(x)                                                     ((x) + 0x780)
#define HWIO_CPR_PER_SENSOR_QUOT_0_PHYS(x)                                                     ((x) + 0x780)
#define HWIO_CPR_PER_SENSOR_QUOT_0_OFFS                                                        (0x780)
...
#define HWIO_CPR_PER_SENSOR_QUOT_0_PER_SENSOR_QUOT_QUOT_0_SHFT                                          8
#define HWIO_CPR_PER_SENSOR_QUOT_0_PER_SENSOR_QUOT_ID_0_BMSK                                         0xff
#define HWIO_CPR_PER_SENSOR_QUOT_0_PER_SENSOR_QUOT_ID_0_SHFT                                            0

#define HWIO_CPR_PER_SENSOR_QUOT_1_ADDR(x)                                                     ((x) + 0x784)
#define HWIO_CPR_PER_SENSOR_QUOT_1_PHYS(x)                                                     ((x) + 0x784)
#define HWIO_CPR_PER_SENSOR_QUOT_1_OFFS                                                        (0x784)
...
#define HWIO_CPR_PER_SENSOR_QUOT_1_PER_SENSOR_QUOT_QUOT_1_SHFT                                          8
#define HWIO_CPR_PER_SENSOR_QUOT_1_PER_SENSOR_QUOT_ID_1_BMSK                                         0xff
#define HWIO_CPR_PER_SENSOR_QUOT_1_PER_SENSOR_QUOT_ID_1_SHFT                                            0

#define HWIO_CPR_PER_SENSOR_QUOT_2_ADDR(x)                                                     ((x) + 0x788)
#define HWIO_CPR_PER_SENSOR_QUOT_2_PHYS(x)                                                     ((x) + 0x788)
#define HWIO_CPR_PER_SENSOR_QUOT_2_OFFS                                                        (0x788)
...
#define HWIO_CPR_PER_SENSOR_QUOT_2_PER_SENSOR_QUOT_QUOT_2_SHFT                                          8
#define HWIO_CPR_PER_SENSOR_QUOT_2_PER_SENSOR_QUOT_ID_2_BMSK                                         0xff
#define HWIO_CPR_PER_SENSOR_QUOT_2_PER_SENSOR_QUOT_ID_2_SHFT                                            0

#define HWIO_CPR_PER_SENSOR_QUOT_3_ADDR(x)                                                     ((x) + 0x78c)
#define HWIO_CPR_PER_SENSOR_QUOT_3_PHYS(x)                                                     ((x) + 0x78c)
#define HWIO_CPR_PER_SENSOR_QUOT_3_OFFS                                                        (0x78c)
...
#define HWIO_CPR_PER_SENSOR_QUOT_3_PER_SENSOR_QUOT_QUOT_3_SHFT                                          8
#define HWIO_CPR_PER_SENSOR_QUOT_3_PER_SENSOR_QUOT_ID_3_BMSK                                         0xff
#define HWIO_CPR_PER_SENSOR_QUOT_3_PER_SENSOR_QUOT_ID_3_SHFT                                            0

#define HWIO_CPR_PER_SENSOR_QUOT_4_ADDR(x)                                                     ((x) + 0x790)
#define HWIO_CPR_PER_SENSOR_QUOT_4_PHYS(x)                                                     ((x) + 0x790)
#define HWIO_CPR_PER_SENSOR_QUOT_4_OFFS                                                        (0x790)
...
#define HWIO_CPR_PER_SENSOR_QUOT_4_PER_SENSOR_QUOT_QUOT_4_SHFT                                          8
#define HWIO_CPR_PER_SENSOR_QUOT_4_PER_SENSOR_QUOT_ID_4_BMSK                                         0xff
#define HWIO_CPR_PER_SENSOR_QUOT_4_PER_SENSOR_QUOT_ID_4_SHFT                                            0

#define HWIO_CPR_DEBUG_BUS_ADDR(x)                                                             ((x) + 0x794)
#define HWIO_CPR_DEBUG_BUS_PHYS(x)                                                             ((x) + 0x794)
#define HWIO_CPR_DEBUG_BUS_OFFS                                                                (0x794)
...
#define HWIO_CPR_DEBUG_BUS_CPR_DEBUG_BUS_SHFT                                                           0

#define HWIO_CPR_CORE_ADJ_MODE_REG_ADDR(x)                                                     ((x) + 0x798)
#define HWIO_CPR_CORE_ADJ_MODE_REG_PHYS(x)                                                     ((x) + 0x798)
#define HWIO_CPR_CORE_ADJ_MODE_REG_OFFS                                                        (0x798)
...
#define HWIO_CPR_CORE_ADJ_MODE_REG_MODE_CHANGE_READY_SHFT                                              31
#define HWIO_CPR_CORE_ADJ_MODE_REG_CODE_ADJ_NUM_CORES_BMSK                                     0x78000000
#define HWIO_CPR_CORE_ADJ_MODE_REG_CODE_ADJ_NUM_CORES_SHFT                                             27
#define HWIO_CPR_CORE_ADJ_MODE_REG_UNUSED_BMSK                                                  0x7fffffe
#define HWIO_CPR_CORE_ADJ_MODE_REG_UNUSED_SHFT                                                          1
#define HWIO_CPR_CORE_ADJ_MODE_REG_MODE_CHANGE_BMSK                                                   0x1
#define HWIO_CPR_CORE_ADJ_MODE_REG_MODE_CHANGE_SHFT                                                     0

#define HWIO_CPR_CPR_SRAM_SENSORS_ADDR(x)                                                      ((x) + 0x79c)
#define HWIO_CPR_CPR_SRAM_SENSORS_PHYS(x)                                                      ((x) + 0x79c)
#define HWIO_CPR_CPR_SRAM_SENSORS_OFFS                                                         (0x79c)
...
#define HWIO_CPR_CPR_SRAM_SENSORS_SRAM0_RESET_SHFT                                                     31
#define HWIO_CPR_CPR_SRAM_SENSORS_SRAM1_RESET_BMSK                                             0x40000000
#define HWIO_CPR_CPR_SRAM_SENSORS_SRAM1_RESET_SHFT                                                     30
#define HWIO_CPR_CPR_SRAM_SENSORS_SRAM1_DATA_BMSK                                               0x3ffe000
#define HWIO_CPR_CPR_SRAM_SENSORS_SRAM1_DATA_SHFT                                                      13
#define HWIO_CPR_CPR_SRAM_SENSORS_SRAM0_DATA_BMSK                                                  0x1fff
#define HWIO_CPR_CPR_SRAM_SENSORS_SRAM0_DATA_SHFT                                                       0

#define HWIO_CPR_CPRF_DN_TIMER_ADDR(x)                                                         ((x) + 0x7a0)
#define HWIO_CPR_CPRF_DN_TIMER_PHYS(x)                                                         ((x) + 0x7a0)
#define HWIO_CPR_CPRF_DN_TIMER_OFFS                                                            (0x7a0)
...
#define HWIO_CPR_CPRF_DN_TIMER_DN_TIMER_INTERVAL_BMSK                                          0xffffffff
#define HWIO_CPR_CPRF_DN_TIMER_DN_TIMER_INTERVAL_SHFT                                                   0

#define HWIO_CPR_SAW_ERROR_STEP_LIMIT_ADDR(x)                                                  ((x) + 0x7a4)
#define HWIO_CPR_SAW_ERROR_STEP_LIMIT_PHYS(x)                                                  ((x) + 0x7a4)
#define HWIO_CPR_SAW_ERROR_STEP_LIMIT_OFFS                                                     (0x7a4)
...
#define HWIO_CPR_SAW_ERROR_STEP_LIMIT_DN_ERROR_STEP_LIMIT_SHFT                                          5
#define HWIO_CPR_SAW_ERROR_STEP_LIMIT_UP_ERROR_STEP_LIMIT_BMSK                                       0x1f
#define HWIO_CPR_SAW_ERROR_STEP_LIMIT_UP_ERROR_STEP_LIMIT_SHFT                                          0

#define HWIO_CPR_MARGIN_TEMP_CORE_TIMERS_ADDR(x)                                               ((x) + 0x7a8)
#define HWIO_CPR_MARGIN_TEMP_CORE_TIMERS_PHYS(x)                                               ((x) + 0x7a8)
#define HWIO_CPR_MARGIN_TEMP_CORE_TIMERS_OFFS                                                  (0x7a8)
...
#define HWIO_CPR_MARGIN_TEMP_CORE_TIMERS_UNUSED_SHFT                                                   29
#define HWIO_CPR_MARGIN_TEMP_CORE_TIMERS_TIMER_SETTLE_VOLTAGE_COUNT_BMSK                       0x1ffc0000
#define HWIO_CPR_MARGIN_TEMP_CORE_TIMERS_TIMER_SETTLE_VOLTAGE_COUNT_SHFT                               18
#define HWIO_CPR_MARGIN_TEMP_CORE_TIMERS_TIMER_LOWER_VOLTAGE_COUNT_BMSK                           0x3ffff
#define HWIO_CPR_MARGIN_TEMP_CORE_TIMERS_TIMER_LOWER_VOLTAGE_COUNT_SHFT                                 0

#define HWIO_CPR_MARGIN_TEMP_0_ADDR(x)                                                         ((x) + 0x7ac)
#define HWIO_CPR_MARGIN_TEMP_0_PHYS(x)                                                         ((x) + 0x7ac)
#define HWIO_CPR_MARGIN_TEMP_0_OFFS                                                            (0x7ac)
...
#define HWIO_CPR_MARGIN_TEMP_0_MARGIN_TEMPBAND3_SHFT                                                   24
#define HWIO_CPR_MARGIN_TEMP_0_MARGIN_TEMPBAND2_BMSK                                             0xff0000
#define HWIO_CPR_MARGIN_TEMP_0_MARGIN_TEMPBAND2_SHFT                                                   16
#define HWIO_CPR_MARGIN_TEMP_0_MARGIN_TEMPBAND1_BMSK                                               0xff00
#define HWIO_CPR_MARGIN_TEMP_0_MARGIN_TEMPBAND1_SHFT                                                    8
#define HWIO_CPR_MARGIN_TEMP_0_MARGIN_TEMPBAND0_BMSK                                                 0xff
#define HWIO_CPR_MARGIN_TEMP_0_MARGIN_TEMPBAND0_SHFT                                                    0

#define HWIO_CPR_MARGIN_TEMP_1_ADDR(x)                                                         ((x) + 0x7b0)
#define HWIO_CPR_MARGIN_TEMP_1_PHYS(x)                                                         ((x) + 0x7b0)
#define HWIO_CPR_MARGIN_TEMP_1_OFFS                                                            (0x7b0)
...
#define HWIO_CPR_MARGIN_TEMP_1_MARGIN_TEMPBAND3_SHFT                                                   24
#define HWIO_CPR_MARGIN_TEMP_1_MARGIN_TEMPBAND2_BMSK                                             0xff0000
#define HWIO_CPR_MARGIN_TEMP_1_MARGIN_TEMPBAND2_SHFT                                                   16
#define HWIO_CPR_MARGIN_TEMP_1_MARGIN_TEMPBAND1_BMSK                                               0xff00
#define HWIO_CPR_MARGIN_TEMP_1_MARGIN_TEMPBAND1_SHFT                                                    8
#define HWIO_CPR_MARGIN_TEMP_1_MARGIN_TEMPBAND0_BMSK                                                 0xff
#define HWIO_CPR_MARGIN_TEMP_1_MARGIN_TEMPBAND0_SHFT                                                    0

#define HWIO_CPR_MARGIN_TEMP_2_ADDR(x)                                                         ((x) + 0x7b4)
#define HWIO_CPR_MARGIN_TEMP_2_PHYS(x)                                                         ((x) + 0x7b4)
#define HWIO_CPR_MARGIN_TEMP_2_OFFS                                                            (0x7b4)
...
#define HWIO_CPR_MARGIN_TEMP_2_MARGIN_TEMPBAND3_SHFT                                                   24
#define HWIO_CPR_MARGIN_TEMP_2_MARGIN_TEMPBAND2_BMSK                                             0xff0000
#define HWIO_CPR_MARGIN_TEMP_2_MARGIN_TEMPBAND2_SHFT                                                   16
#define HWIO_CPR_MARGIN_TEMP_2_MARGIN_TEMPBAND1_BMSK                                               0xff00
#define HWIO_CPR_MARGIN_TEMP_2_MARGIN_TEMPBAND1_SHFT                                                    8
#define HWIO_CPR_MARGIN_TEMP_2_MARGIN_TEMPBAND0_BMSK                                                 0xff
#define HWIO_CPR_MARGIN_TEMP_2_MARGIN_TEMPBAND0_SHFT                                                    0

#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_ADDR(x)                                                ((x) + 0x7b8)
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_PHYS(x)                                                ((x) + 0x7b8)
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_OFFS                                                   (0x7b8)
...
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_UNUSED_SHFT                                                    15
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_DCVS_POINT2_BMSK                                           0x7c00
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_DCVS_POINT2_SHFT                                               10
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_DCVS_POINT1_BMSK                                            0x3e0
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_DCVS_POINT1_SHFT                                                5
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_DCVS_POINT0_BMSK                                             0x1f
#define HWIO_CPR_MARGIN_TEMP_DCVS_POINT_DCVS_POINT0_SHFT                                                0

#define HWIO_CPR_TEMP_SENSOR_DATA_ADDR(x)                                                      ((x) + 0x7ec)
#define HWIO_CPR_TEMP_SENSOR_DATA_PHYS(x)                                                      ((x) + 0x7ec)
#define HWIO_CPR_TEMP_SENSOR_DATA_OFFS                                                         (0x7ec)
...
#define HWIO_CPR_TEMP_SENSOR_DATA_COLD_SENSOR_SHFT                                                     28
#define HWIO_CPR_TEMP_SENSOR_DATA_COLD_TEMP_BMSK                                                0xfff0000
#define HWIO_CPR_TEMP_SENSOR_DATA_COLD_TEMP_SHFT                                                       16
#define HWIO_CPR_TEMP_SENSOR_DATA_HOT_SENSOR_BMSK                                                  0xf000
#define HWIO_CPR_TEMP_SENSOR_DATA_HOT_SENSOR_SHFT                                                      12
#define HWIO_CPR_TEMP_SENSOR_DATA_HOT_TEMP_BMSK                                                     0xfff
#define HWIO_CPR_TEMP_SENSOR_DATA_HOT_TEMP_SHFT                                                         0

#define HWIO_CPR_MARGIN_TEMP_POINT0N1_ADDR(x)                                                  ((x) + 0x7f0)
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_PHYS(x)                                                  ((x) + 0x7f0)
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_OFFS                                                     (0x7f0)
...
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_BELOWPOINT0_HOTCOLD_SHFT                                         31
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_BELOWPOINT1_HOTCOLD_BMSK                                 0x40000000
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_BELOWPOINT1_HOTCOLD_SHFT                                         30
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_POINT1_BMSK                                                0xfff000
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_POINT1_SHFT                                                      12
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_POINT0_BMSK                                                   0xfff
#define HWIO_CPR_MARGIN_TEMP_POINT0N1_POINT0_SHFT                                                       0

#define HWIO_CPR_MARGIN_TEMP_POINT2_ADDR(x)                                                    ((x) + 0x7f4)
#define HWIO_CPR_MARGIN_TEMP_POINT2_PHYS(x)                                                    ((x) + 0x7f4)
#define HWIO_CPR_MARGIN_TEMP_POINT2_OFFS                                                       (0x7f4)
...
#define HWIO_CPR_MARGIN_TEMP_POINT2_BELOWPOINT2_HOTCOLD_SHFT                                           31
#define HWIO_CPR_MARGIN_TEMP_POINT2_ABOVEPOINT2_HOTCOLD_BMSK                                   0x40000000
#define HWIO_CPR_MARGIN_TEMP_POINT2_ABOVEPOINT2_HOTCOLD_SHFT                                           30
#define HWIO_CPR_MARGIN_TEMP_POINT2_POINT2_BMSK                                                     0xfff
#define HWIO_CPR_MARGIN_TEMP_POINT2_POINT2_SHFT                                                         0

#define HWIO_CPR_MARGIN_ADJ_CTL_ADDR(x)                                                        ((x) + 0x7f8)
#define HWIO_CPR_MARGIN_ADJ_CTL_PHYS(x)                                                        ((x) + 0x7f8)
#define HWIO_CPR_MARGIN_ADJ_CTL_OFFS                                                           (0x7f8)
...
#define HWIO_CPR_MARGIN_ADJ_CTL_KV_MARGIN_ADJ_SINGLE_STEP_QUOT_SHFT                                    26
#define HWIO_CPR_MARGIN_ADJ_CTL_MAX_NUM_CORES_BMSK                                              0x3c00000
#define HWIO_CPR_MARGIN_ADJ_CTL_MAX_NUM_CORES_SHFT                                                     22
#define HWIO_CPR_MARGIN_ADJ_CTL_INITIAL_TEMP_BAND_BMSK                                           0x380000
#define HWIO_CPR_MARGIN_ADJ_CTL_INITIAL_TEMP_BAND_SHFT                                                 19
#define HWIO_CPR_MARGIN_ADJ_CTL_LOWER_VOLTAGE_WAIT_SELECT_BMSK                                    0x60000
#define HWIO_CPR_MARGIN_ADJ_CTL_LOWER_VOLTAGE_WAIT_SELECT_SHFT                                         17
#define HWIO_CPR_MARGIN_ADJ_CTL_PMIC_STEP_SIZE_BMSK                                               0x1f000
#define HWIO_CPR_MARGIN_ADJ_CTL_PMIC_STEP_SIZE_SHFT                                                    12
#define HWIO_CPR_MARGIN_ADJ_CTL_WAIT_MID_DN_BF_BMSK                                                 0x800
#define HWIO_CPR_MARGIN_ADJ_CTL_WAIT_MID_DN_BF_SHFT                                                    11
#define HWIO_CPR_MARGIN_ADJ_CTL_SAW_ERROR_REPEAT_EN_BMSK                                            0x400
#define HWIO_CPR_MARGIN_ADJ_CTL_SAW_ERROR_REPEAT_EN_SHFT                                               10
#define HWIO_CPR_MARGIN_ADJ_CTL_ADJ_SW_RESET_BMSK                                                   0x200
#define HWIO_CPR_MARGIN_ADJ_CTL_ADJ_SW_RESET_SHFT                                                       9
#define HWIO_CPR_MARGIN_ADJ_CTL_KV_MARGIN_ADJ_EN_BMSK                                               0x100
#define HWIO_CPR_MARGIN_ADJ_CTL_KV_MARGIN_ADJ_EN_SHFT                                                   8
#define HWIO_CPR_MARGIN_ADJ_CTL_PER_RO_KV_MARGIN_EN_BMSK                                             0x80
#define HWIO_CPR_MARGIN_ADJ_CTL_PER_RO_KV_MARGIN_EN_SHFT                                                7
#define HWIO_CPR_MARGIN_ADJ_CTL_WAIT_MID_DN_TEMP_EN_BMSK                                             0x40
#define HWIO_CPR_MARGIN_ADJ_CTL_WAIT_MID_DN_TEMP_EN_SHFT                                                6
#define HWIO_CPR_MARGIN_ADJ_CTL_WAIT_MID_DN_EN_BMSK                                                  0x20
#define HWIO_CPR_MARGIN_ADJ_CTL_WAIT_MID_DN_EN_SHFT                                                     5
#define HWIO_CPR_MARGIN_ADJ_CTL_CLOSED_LOOP_EN_BMSK                                                  0x10
#define HWIO_CPR_MARGIN_ADJ_CTL_CLOSED_LOOP_EN_SHFT                                                     4
#define HWIO_CPR_MARGIN_ADJ_CTL_TIMER_SETTLE_VOLTAGE_EN_BMSK                                          0x8
#define HWIO_CPR_MARGIN_ADJ_CTL_TIMER_SETTLE_VOLTAGE_EN_SHFT                                            3
#define HWIO_CPR_MARGIN_ADJ_CTL_TEMP_ADJ_EN_BMSK                                                      0x4
#define HWIO_CPR_MARGIN_ADJ_CTL_TEMP_ADJ_EN_SHFT                                                        2
#define HWIO_CPR_MARGIN_ADJ_CTL_CORE_ADJ_EN_BMSK                                                      0x2
#define HWIO_CPR_MARGIN_ADJ_CTL_CORE_ADJ_EN_SHFT                                                        1
#define HWIO_CPR_MARGIN_ADJ_CTL_BOOST_EN_BMSK                                                         0x1
#define HWIO_CPR_MARGIN_ADJ_CTL_BOOST_EN_SHFT                                                           0

#define HWIO_CPR_HW_STARVATION_THRESHOLD_ADDR(x)                                               ((x) + 0x7fc)
#define HWIO_CPR_HW_STARVATION_THRESHOLD_PHYS(x)                                               ((x) + 0x7fc)
#define HWIO_CPR_HW_STARVATION_THRESHOLD_OFFS                                                  (0x7fc)
...
#define HWIO_CPR_HW_STARVATION_THRESHOLD_THRESHOLD_SHFT                                                 0

#define HWIO_CPR_CONT_CMD_t_ADDR(base,t)                                                       ((base) + 0X800 + (0x440*(t)))
#define HWIO_CPR_CONT_CMD_t_PHYS(base,t)                                                       ((base) + 0X800 + (0x440*(t)))
#define HWIO_CPR_CONT_CMD_t_OFFS(t)                                                            (0X800 + (0x440*(t)))
...
#define HWIO_CPR_CONT_CMD_t_VDD_CHANGED_ONE_STEP_SHFT                                                   0

#define HWIO_CPR_THRESHOLD_t_ADDR(base,t)                                                      ((base) + 0X808 + (0x440*(t)))
#define HWIO_CPR_THRESHOLD_t_PHYS(base,t)                                                      ((base) + 0X808 + (0x440*(t)))
#define HWIO_CPR_THRESHOLD_t_OFFS(t)                                                           (0X808 + (0x440*(t)))
...
#define HWIO_CPR_THRESHOLD_t_UP_THRESHOLD_SHFT                                                         13
#define HWIO_CPR_THRESHOLD_t_DN_THRESHOLD_BMSK                                                     0x1f00
#define HWIO_CPR_THRESHOLD_t_DN_THRESHOLD_SHFT                                                          8
#define HWIO_CPR_THRESHOLD_t_CONSECUTIVE_UP_BMSK                                                     0xf0
#define HWIO_CPR_THRESHOLD_t_CONSECUTIVE_UP_SHFT                                                        4
#define HWIO_CPR_THRESHOLD_t_CONSECUTIVE_DN_BMSK                                                      0xf
#define HWIO_CPR_THRESHOLD_t_CONSECUTIVE_DN_SHFT                                                        0

#define HWIO_CPR_MASK_THREAD_t_ADDR(base,t)                                                    ((base) + 0X80C + (0x440*(t)))
#define HWIO_CPR_MASK_THREAD_t_PHYS(base,t)                                                    ((base) + 0X80C + (0x440*(t)))
#define HWIO_CPR_MASK_THREAD_t_OFFS(t)                                                         (0X80C + (0x440*(t)))
...
#define HWIO_CPR_MASK_THREAD_t_DISABLE_THREAD_SHFT                                                     31
#define HWIO_CPR_MASK_THREAD_t_RO_MASK4THREAD_BMSK                                                 0xffff
#define HWIO_CPR_MASK_THREAD_t_RO_MASK4THREAD_SHFT                                                      0

#define HWIO_CPR_RESULT0_t_ADDR(base,t)                                                        ((base) + 0X810 + (0x440*(t)))
#define HWIO_CPR_RESULT0_t_PHYS(base,t)                                                        ((base) + 0X810 + (0x440*(t)))
#define HWIO_CPR_RESULT0_t_OFFS(t)                                                             (0X810 + (0x440*(t)))
...
#define HWIO_CPR_RESULT0_t_ERROR_LT_0_SHFT                                                             20
#define HWIO_CPR_RESULT0_t_ERROR_BMSK                                                             0xfff00
#define HWIO_CPR_RESULT0_t_ERROR_SHFT                                                                   8
#define HWIO_CPR_RESULT0_t_ERROR_STEPS_BMSK                                                          0xf8
#define HWIO_CPR_RESULT0_t_ERROR_STEPS_SHFT                                                             3
#define HWIO_CPR_RESULT0_t_STEP_UP_BMSK                                                               0x4
#define HWIO_CPR_RESULT0_t_STEP_UP_SHFT                                                                 2
#define HWIO_CPR_RESULT0_t_STEP_DN_BMSK                                                               0x2
#define HWIO_CPR_RESULT0_t_STEP_DN_SHFT                                                                 1
#define HWIO_CPR_RESULT0_t_BUSY_BMSK                                                                  0x1
#define HWIO_CPR_RESULT0_t_BUSY_SHFT                                                                    0

#define HWIO_CPR_RESULT1_t_ADDR(base,t)                                                        ((base) + 0X814 + (0x440*(t)))
#define HWIO_CPR_RESULT1_t_PHYS(base,t)                                                        ((base) + 0X814 + (0x440*(t)))
#define HWIO_CPR_RESULT1_t_OFFS(t)                                                             (0X814 + (0x440*(t)))
...
#define HWIO_CPR_RESULT1_t_SEL_MAX_SHFT                                                                28
#define HWIO_CPR_RESULT1_t_SEL_MIN_BMSK                                                         0xf000000
#define HWIO_CPR_RESULT1_t_SEL_MIN_SHFT                                                                24
#define HWIO_CPR_RESULT1_t_QUOT_MAX_BMSK                                                         0xfff000
#define HWIO_CPR_RESULT1_t_QUOT_MAX_SHFT                                                               12
#define HWIO_CPR_RESULT1_t_QUOT_MIN_BMSK                                                            0xfff
#define HWIO_CPR_RESULT1_t_QUOT_MIN_SHFT                                                                0

#define HWIO_CPR_RESULT2_t_ADDR(base,t)                                                        ((base) + 0X818 + (0x440*(t)))
#define HWIO_CPR_RESULT2_t_PHYS(base,t)                                                        ((base) + 0X818 + (0x440*(t)))
#define HWIO_CPR_RESULT2_t_OFFS(t)                                                             (0X818 + (0x440*(t)))
...
#define HWIO_CPR_RESULT2_t_SENSOR_MAX_SHFT                                                             24
#define HWIO_CPR_RESULT2_t_SENSOR_MIN_BMSK                                                       0xff0000
#define HWIO_CPR_RESULT2_t_SENSOR_MIN_SHFT                                                             16
#define HWIO_CPR_RESULT2_t_STEP_QUOT_MAX_BMSK                                                       0xfc0
#define HWIO_CPR_RESULT2_t_STEP_QUOT_MAX_SHFT                                                           6
#define HWIO_CPR_RESULT2_t_STEP_QUOT_MIN_BMSK                                                        0x3f
#define HWIO_CPR_RESULT2_t_STEP_QUOT_MIN_SHFT                                                           0

#define HWIO_CPR_IRQ_EN_t_ADDR(base,t)                                                         ((base) + 0X81C + (0x440*(t)))
#define HWIO_CPR_IRQ_EN_t_PHYS(base,t)                                                         ((base) + 0X81C + (0x440*(t)))
#define HWIO_CPR_IRQ_EN_t_OFFS(t)                                                              (0X81C + (0x440*(t)))
...
#define HWIO_CPR_IRQ_EN_t_CLAMP_CHANGE_WHILE_BUSY_EN_SHFT                                              31
#define HWIO_CPR_IRQ_EN_t_STARVATION_ERROR_EN_BMSK                                             0x40000000
#define HWIO_CPR_IRQ_EN_t_STARVATION_ERROR_EN_SHFT                                                     30
#define HWIO_CPR_IRQ_EN_t_UP_FLAG_EN_BMSK                                                             0x8
#define HWIO_CPR_IRQ_EN_t_UP_FLAG_EN_SHFT                                                               3
#define HWIO_CPR_IRQ_EN_t_MID_FLAG_EN_BMSK                                                            0x4
#define HWIO_CPR_IRQ_EN_t_MID_FLAG_EN_SHFT                                                              2
#define HWIO_CPR_IRQ_EN_t_DOWN_FLAG_EN_BMSK                                                           0x2
#define HWIO_CPR_IRQ_EN_t_DOWN_FLAG_EN_SHFT                                                             1
#define HWIO_CPR_IRQ_EN_t_CPR_DONE_EN_BMSK                                                            0x1
#define HWIO_CPR_IRQ_EN_t_CPR_DONE_EN_SHFT                                                              0

#define HWIO_CPR_IRQ_CLEAR_t_ADDR(base,t)                                                      ((base) + 0X820 + (0x440*(t)))
#define HWIO_CPR_IRQ_CLEAR_t_PHYS(base,t)                                                      ((base) + 0X820 + (0x440*(t)))
#define HWIO_CPR_IRQ_CLEAR_t_OFFS(t)                                                           (0X820 + (0x440*(t)))
...
#define HWIO_CPR_IRQ_CLEAR_t_CLAMP_CHANGE_WHILE_BUSY_CLEAR_SHFT                                        31
#define HWIO_CPR_IRQ_CLEAR_t_STARVATION_ERROR_CLEAR_BMSK                                       0x40000000
#define HWIO_CPR_IRQ_CLEAR_t_STARVATION_ERROR_CLEAR_SHFT                                               30
#define HWIO_CPR_IRQ_CLEAR_t_UP_FLAG_CLEAR_BMSK                                                       0x8
#define HWIO_CPR_IRQ_CLEAR_t_UP_FLAG_CLEAR_SHFT                                                         3
#define HWIO_CPR_IRQ_CLEAR_t_MID_FLAG_CLEAR_BMSK                                                      0x4
#define HWIO_CPR_IRQ_CLEAR_t_MID_FLAG_CLEAR_SHFT                                                        2
#define HWIO_CPR_IRQ_CLEAR_t_DOWN_FLAG_CLEAR_BMSK                                                     0x2
#define HWIO_CPR_IRQ_CLEAR_t_DOWN_FLAG_CLEAR_SHFT                                                       1
#define HWIO_CPR_IRQ_CLEAR_t_CPR_DONE_CLEAR_BMSK                                                      0x1
#define HWIO_CPR_IRQ_CLEAR_t_CPR_DONE_CLEAR_SHFT                                                        0

#define HWIO_CPR_IRQ_STATUS_t_ADDR(base,t)                                                     ((base) + 0X824 + (0x440*(t)))
#define HWIO_CPR_IRQ_STATUS_t_PHYS(base,t)                                                     ((base) + 0X824 + (0x440*(t)))
#define HWIO_CPR_IRQ_STATUS_t_OFFS(t)                                                          (0X824 + (0x440*(t)))
...
#define HWIO_CPR_IRQ_STATUS_t_CLAMP_CHANGE_WHILE_BUSY_SHFT                                             31
#define HWIO_CPR_IRQ_STATUS_t_STARVATION_ERROR_BMSK                                            0x40000000
#define HWIO_CPR_IRQ_STATUS_t_STARVATION_ERROR_SHFT                                                    30
#define HWIO_CPR_IRQ_STATUS_t_UP_FLAG_BMSK                                                            0x8
#define HWIO_CPR_IRQ_STATUS_t_UP_FLAG_SHFT                                                              3
#define HWIO_CPR_IRQ_STATUS_t_MID_FLAG_BMSK                                                           0x4
#define HWIO_CPR_IRQ_STATUS_t_MID_FLAG_SHFT                                                             2
#define HWIO_CPR_IRQ_STATUS_t_DOWN_FLAG_BMSK                                                          0x2
#define HWIO_CPR_IRQ_STATUS_t_DOWN_FLAG_SHFT                                                            1
#define HWIO_CPR_IRQ_STATUS_t_CPR_DONE_BMSK                                                           0x1
#define HWIO_CPR_IRQ_STATUS_t_CPR_DONE_SHFT                                                             0

#define HWIO_CPR_TARGET_MODE_SELECT_t_ADDR(base,t)                                             ((base) + 0X828 + (0x440*(t)))
#define HWIO_CPR_TARGET_MODE_SELECT_t_PHYS(base,t)                                             ((base) + 0X828 + (0x440*(t)))
#define HWIO_CPR_TARGET_MODE_SELECT_t_OFFS(t)                                                  (0X828 + (0x440*(t)))
...
#define HWIO_CPR_TARGET_MODE_SELECT_t_TARGET_MODE_SELECT_SHFT                                           0

#define HWIO_CPR_PTE_RESULT_REGISTER_t_ADDR(base,t)                                            ((base) + 0X82C + (0x440*(t)))
#define HWIO_CPR_PTE_RESULT_REGISTER_t_PHYS(base,t)                                            ((base) + 0X82C + (0x440*(t)))
#define HWIO_CPR_PTE_RESULT_REGISTER_t_OFFS(t)                                                 (0X82C + (0x440*(t)))
...
#define HWIO_CPR_PTE_RESULT_REGISTER_t_SCLK_CNT_FAIL_SHFT                                              31
#define HWIO_CPR_PTE_RESULT_REGISTER_t_SCLK_CNT0_DIV2_BMSK                                     0x7f800000
#define HWIO_CPR_PTE_RESULT_REGISTER_t_SCLK_CNT0_DIV2_SHFT                                             23
#define HWIO_CPR_PTE_RESULT_REGISTER_t_SENSOR_MIN_BMSK                                           0x7e0000
#define HWIO_CPR_PTE_RESULT_REGISTER_t_SENSOR_MIN_SHFT                                                 17
#define HWIO_CPR_PTE_RESULT_REGISTER_t_SEL_MIN_BMSK                                               0x1e000
#define HWIO_CPR_PTE_RESULT_REGISTER_t_SEL_MIN_SHFT                                                    13
#define HWIO_CPR_PTE_RESULT_REGISTER_t_QUOT_MIN_BMSK                                               0x1ffe
#define HWIO_CPR_PTE_RESULT_REGISTER_t_QUOT_MIN_SHFT                                                    1
#define HWIO_CPR_PTE_RESULT_REGISTER_t_BUSY_BMSK                                                      0x1
#define HWIO_CPR_PTE_RESULT_REGISTER_t_BUSY_SHFT                                                        0

#define HWIO_CPR_TARGET0_0_m_ADDR(base,m)                                                      ((base) + 0X840 + (0x40*(m)))
#define HWIO_CPR_TARGET0_0_m_PHYS(base,m)                                                      ((base) + 0X840 + (0x40*(m)))
#define HWIO_CPR_TARGET0_0_m_OFFS(m)                                                           (0X840 + (0x40*(m)))
...
#define HWIO_CPR_TARGET0_0_m_MODE_GCNT0_SHFT                                                           12
#define HWIO_CPR_TARGET0_0_m_TARGET0_BMSK                                                           0xfff
#define HWIO_CPR_TARGET0_0_m_TARGET0_SHFT                                                               0

#define HWIO_CPR_TARGET1_0_m_ADDR(base,m)                                                      ((base) + 0X844 + (0x40*(m)))
#define HWIO_CPR_TARGET1_0_m_PHYS(base,m)                                                      ((base) + 0X844 + (0x40*(m)))
#define HWIO_CPR_TARGET1_0_m_OFFS(m)                                                           (0X844 + (0x40*(m)))
...
#define HWIO_CPR_TARGET1_0_m_MODE_GCNT1_SHFT                                                           12
#define HWIO_CPR_TARGET1_0_m_TARGET1_BMSK                                                           0xfff
#define HWIO_CPR_TARGET1_0_m_TARGET1_SHFT                                                               0

#define HWIO_CPR_TARGET2_0_m_ADDR(base,m)                                                      ((base) + 0X848 + (0x40*(m)))
#define HWIO_CPR_TARGET2_0_m_PHYS(base,m)                                                      ((base) + 0X848 + (0x40*(m)))
#define HWIO_CPR_TARGET2_0_m_OFFS(m)                                                           (0X848 + (0x40*(m)))
...
#define HWIO_CPR_TARGET2_0_m_MODE_GCNT2_SHFT                                                           12
#define HWIO_CPR_TARGET2_0_m_TARGET2_BMSK                                                           0xfff
#define HWIO_CPR_TARGET2_0_m_TARGET2_SHFT                                                               0

#define HWIO_CPR_TARGET3_0_m_ADDR(base,m)                                                      ((base) + 0X84C + (0x40*(m)))
#define HWIO_CPR_TARGET3_0_m_PHYS(base,m)                                                      ((base) + 0X84C + (0x40*(m)))
#define HWIO_CPR_TARGET3_0_m_OFFS(m)                                                           (0X84C + (0x40*(m)))
...
#define HWIO_CPR_TARGET3_0_m_MODE_GCNT3_SHFT                                                           12
#define HWIO_CPR_TARGET3_0_m_TARGET3_BMSK                                                           0xfff
#define HWIO_CPR_TARGET3_0_m_TARGET3_SHFT                                                               0

#define HWIO_CPR_TARGET4_0_m_ADDR(base,m)                                                      ((base) + 0X850 + (0x40*(m)))
#define HWIO_CPR_TARGET4_0_m_PHYS(base,m)                                                      ((base) + 0X850 + (0x40*(m)))
#define HWIO_CPR_TARGET4_0_m_OFFS(m)                                                           (0X850 + (0x40*(m)))
...
#define HWIO_CPR_TARGET4_0_m_MODE_GCNT4_SHFT                                                           12
#define HWIO_CPR_TARGET4_0_m_TARGET4_BMSK                                                           0xfff
#define HWIO_CPR_TARGET4_0_m_TARGET4_SHFT                                                               0

#define HWIO_CPR_TARGET5_0_m_ADDR(base,m)                                                      ((base) + 0X854 + (0x40*(m)))
#define HWIO_CPR_TARGET5_0_m_PHYS(base,m)                                                      ((base) + 0X854 + (0x40*(m)))
#define HWIO_CPR_TARGET5_0_m_OFFS(m)                                                           (0X854 + (0x40*(m)))
...
#define HWIO_CPR_TARGET5_0_m_MODE_GCNT5_SHFT                                                           12
#define HWIO_CPR_TARGET5_0_m_TARGET5_BMSK                                                           0xfff
#define HWIO_CPR_TARGET5_0_m_TARGET5_SHFT                                                               0

#define HWIO_CPR_TARGET6_0_m_ADDR(base,m)                                                      ((base) + 0X858 + (0x40*(m)))
#define HWIO_CPR_TARGET6_0_m_PHYS(base,m)                                                      ((base) + 0X858 + (0x40*(m)))
#define HWIO_CPR_TARGET6_0_m_OFFS(m)                                                           (0X858 + (0x40*(m)))
...
#define HWIO_CPR_TARGET6_0_m_MODE_GCNT6_SHFT                                                           12
#define HWIO_CPR_TARGET6_0_m_TARGET6_BMSK                                                           0xfff
#define HWIO_CPR_TARGET6_0_m_TARGET6_SHFT                                                               0

#define HWIO_CPR_TARGET7_0_m_ADDR(base,m)                                                      ((base) + 0X85C + (0x40*(m)))
#define HWIO_CPR_TARGET7_0_m_PHYS(base,m)                                                      ((base) + 0X85C + (0x40*(m)))
#define HWIO_CPR_TARGET7_0_m_OFFS(m)                                                           (0X85C + (0x40*(m)))
...
#define HWIO_CPR_TARGET7_0_m_MODE_GCNT7_SHFT                                                           12
#define HWIO_CPR_TARGET7_0_m_TARGET7_BMSK                                                           0xfff
#define HWIO_CPR_TARGET7_0_m_TARGET7_SHFT                                                               0

#define HWIO_CPR_TARGET8_0_m_ADDR(base,m)                                                      ((base) + 0X860 + (0x40*(m)))
#define HWIO_CPR_TARGET8_0_m_PHYS(base,m)                                                      ((base) + 0X860 + (0x40*(m)))
#define HWIO_CPR_TARGET8_0_m_OFFS(m)                                                           (0X860 + (0x40*(m)))
...
#define HWIO_CPR_TARGET8_0_m_MODE_GCNT8_SHFT                                                           12
#define HWIO_CPR_TARGET8_0_m_TARGET8_BMSK                                                           0xfff
#define HWIO_CPR_TARGET8_0_m_TARGET8_SHFT                                                               0

#define HWIO_CPR_TARGET9_0_m_ADDR(base,m)                                                      ((base) + 0X864 + (0x40*(m)))
#define HWIO_CPR_TARGET9_0_m_PHYS(base,m)                                                      ((base) + 0X864 + (0x40*(m)))
#define HWIO_CPR_TARGET9_0_m_OFFS(m)                                                           (0X864 + (0x40*(m)))
...
#define HWIO_CPR_TARGET9_0_m_MODE_GCNT9_SHFT                                                           12
#define HWIO_CPR_TARGET9_0_m_TARGET9_BMSK                                                           0xfff
#define HWIO_CPR_TARGET9_0_m_TARGET9_SHFT                                                               0

#define HWIO_CPR_TARGET10_0_m_ADDR(base,m)                                                     ((base) + 0X868 + (0x40*(m)))
#define HWIO_CPR_TARGET10_0_m_PHYS(base,m)                                                     ((base) + 0X868 + (0x40*(m)))
#define HWIO_CPR_TARGET10_0_m_OFFS(m)                                                          (0X868 + (0x40*(m)))
...
#define HWIO_CPR_TARGET10_0_m_MODE_GCNT10_SHFT                                                         12
#define HWIO_CPR_TARGET10_0_m_TARGET10_BMSK                                                         0xfff
#define HWIO_CPR_TARGET10_0_m_TARGET10_SHFT                                                             0

#define HWIO_CPR_TARGET11_0_m_ADDR(base,m)                                                     ((base) + 0X86C + (0x40*(m)))
#define HWIO_CPR_TARGET11_0_m_PHYS(base,m)                                                     ((base) + 0X86C + (0x40*(m)))
#define HWIO_CPR_TARGET11_0_m_OFFS(m)                                                          (0X86C + (0x40*(m)))
...
#define HWIO_CPR_TARGET11_0_m_MODE_GCNT11_SHFT                                                         12
#define HWIO_CPR_TARGET11_0_m_TARGET11_BMSK                                                         0xfff
#define HWIO_CPR_TARGET11_0_m_TARGET11_SHFT                                                             0

#define HWIO_CPR_TARGET12_0_m_ADDR(base,m)                                                     ((base) + 0X870 + (0x40*(m)))
#define HWIO_CPR_TARGET12_0_m_PHYS(base,m)                                                     ((base) + 0X870 + (0x40*(m)))
#define HWIO_CPR_TARGET12_0_m_OFFS(m)                                                          (0X870 + (0x40*(m)))
...
#define HWIO_CPR_TARGET12_0_m_MODE_GCNT12_SHFT                                                         12
#define HWIO_CPR_TARGET12_0_m_TARGET12_BMSK                                                         0xfff
#define HWIO_CPR_TARGET12_0_m_TARGET12_SHFT                                                             0

#define HWIO_CPR_TARGET13_0_m_ADDR(base,m)                                                     ((base) + 0X874 + (0x40*(m)))
#define HWIO_CPR_TARGET13_0_m_PHYS(base,m)                                                     ((base) + 0X874 + (0x40*(m)))
#define HWIO_CPR_TARGET13_0_m_OFFS(m)                                                          (0X874 + (0x40*(m)))
...
#define HWIO_CPR_TARGET13_0_m_MODE_GCNT13_SHFT                                                         12
#define HWIO_CPR_TARGET13_0_m_TARGET13_BMSK                                                         0xfff
#define HWIO_CPR_TARGET13_0_m_TARGET13_SHFT                                                             0

#define HWIO_CPR_TARGET14_0_m_ADDR(base,m)                                                     ((base) + 0X878 + (0x40*(m)))
#define HWIO_CPR_TARGET14_0_m_PHYS(base,m)                                                     ((base) + 0X878 + (0x40*(m)))
#define HWIO_CPR_TARGET14_0_m_OFFS(m)                                                          (0X878 + (0x40*(m)))
...
#define HWIO_CPR_TARGET14_0_m_MODE_GCNT14_SHFT                                                         12
#define HWIO_CPR_TARGET14_0_m_TARGET14_BMSK                                                         0xfff
#define HWIO_CPR_TARGET14_0_m_TARGET14_SHFT                                                             0

#define HWIO_CPR_TARGET15_0_m_ADDR(base,m)                                                     ((base) + 0X87C + (0x40*(m)))
#define HWIO_CPR_TARGET15_0_m_PHYS(base,m)                                                     ((base) + 0X87C + (0x40*(m)))
#define HWIO_CPR_TARGET15_0_m_OFFS(m)                                                          (0X87C + (0x40*(m)))
...
#define HWIO_CPR_TARGET15_0_m_MODE_GCNT15_SHFT                                                         12
#define HWIO_CPR_TARGET15_0_m_TARGET15_BMSK                                                         0xfff
#define HWIO_CPR_TARGET15_0_m_TARGET15_SHFT                                                             0

#define HWIO_CPR_QSENSE_CTRL_0_ADDR(x)                                                         ((x) + 0x3100)
#define HWIO_CPR_QSENSE_CTRL_0_PHYS(x)                                                         ((x) + 0x3100)
#define HWIO_CPR_QSENSE_CTRL_0_OFFS                                                            (0x3100)
#define HWIO_CPR_QSENSE_CTRL_0_RMSK                                                              0x3fffff
#define HWIO_CPR_QSENSE_CTRL_0_IN(x)            \
                in_dword(HWIO_CPR_QSENSE_CTRL_0_ADDR(x))
#define HWIO_CPR_QSENSE_CTRL_0_INM(x, m)            \
                in_dword_masked(HWIO_CPR_QSENSE_CTRL_0_ADDR(x), m)
#define HWIO_CPR_QSENSE_CTRL_0_OUT(x, v)            \
                out_dword(HWIO_CPR_QSENSE_CTRL_0_ADDR(x),v)
#define HWIO_CPR_QSENSE_CTRL_0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_QSENSE_CTRL_0_ADDR(x),m,v,HWIO_CPR_QSENSE_CTRL_0_IN(x))
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_RST_BMSK                                                   0x200000
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_RST_SHFT                                                         21
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_EN_BMSK                                                    0x100000
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_EN_SHFT                                                          20
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_ISO_EN_BMSK                                                 0x80000
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_ISO_EN_SHFT                                                      19
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_PWR_EN_BMSK                                                 0x40000
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_PWR_EN_SHFT                                                      18
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_OVERRIDE_BMSK                                               0x20000
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_OVERRIDE_SHFT                                                    17
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_GCNT_BMSK                                                   0x1fffe
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_GCNT_SHFT                                                         1
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_START_BMSK                                                      0x1
#define HWIO_CPR_QSENSE_CTRL_0_QSENSE_START_SHFT                                                        0

#define HWIO_CPR_QSENSE_CONFIG_ADDR(x)                                                         ((x) + 0x3104)
#define HWIO_CPR_QSENSE_CONFIG_PHYS(x)                                                         ((x) + 0x3104)
#define HWIO_CPR_QSENSE_CONFIG_OFFS                                                            (0x3104)
#define HWIO_CPR_QSENSE_CONFIG_RMSK                                                            0xffffffff
#define HWIO_CPR_QSENSE_CONFIG_IN(x)            \
                in_dword(HWIO_CPR_QSENSE_CONFIG_ADDR(x))
#define HWIO_CPR_QSENSE_CONFIG_INM(x, m)            \
                in_dword_masked(HWIO_CPR_QSENSE_CONFIG_ADDR(x), m)
#define HWIO_CPR_QSENSE_CONFIG_OUT(x, v)            \
                out_dword(HWIO_CPR_QSENSE_CONFIG_ADDR(x),v)
#define HWIO_CPR_QSENSE_CONFIG_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_QSENSE_CONFIG_ADDR(x),m,v,HWIO_CPR_QSENSE_CONFIG_IN(x))
#define HWIO_CPR_QSENSE_CONFIG_QSENSE_CONFIG_SEL_BMSK                                          0x80000000
#define HWIO_CPR_QSENSE_CONFIG_QSENSE_CONFIG_SEL_SHFT                                                  31
#define HWIO_CPR_QSENSE_CONFIG_FS_ENABLERING_BMSK                                              0x40000000
#define HWIO_CPR_QSENSE_CONFIG_FS_ENABLERING_SHFT                                                      30
#define HWIO_CPR_QSENSE_CONFIG_FS_DEBUGREAD_BMSK                                               0x20000000
#define HWIO_CPR_QSENSE_CONFIG_FS_DEBUGREAD_SHFT                                                       29
#define HWIO_CPR_QSENSE_CONFIG_FS_BANKSEL_BMSK                                                 0x1c000000
#define HWIO_CPR_QSENSE_CONFIG_FS_BANKSEL_SHFT                                                         26
#define HWIO_CPR_QSENSE_CONFIG_FS_WRITEDATA_BMSK                                                0x2000000
#define HWIO_CPR_QSENSE_CONFIG_FS_WRITEDATA_SHFT                                                       25
#define HWIO_CPR_QSENSE_CONFIG_FS_SUBTILEADDR_BMSK                                              0x1c00000
#define HWIO_CPR_QSENSE_CONFIG_FS_SUBTILEADDR_SHFT                                                     22
#define HWIO_CPR_QSENSE_CONFIG_FS_TILEADDR_BMSK                                                  0x3c0000
#define HWIO_CPR_QSENSE_CONFIG_FS_TILEADDR_SHFT                                                        18
#define HWIO_CPR_QSENSE_CONFIG_FS_DATASLEW_BMSK                                                   0x30000
#define HWIO_CPR_QSENSE_CONFIG_FS_DATASLEW_SHFT                                                        16
#define HWIO_CPR_QSENSE_CONFIG_QSENSE_MISC_CFG_BMSK                                                0xffff
#define HWIO_CPR_QSENSE_CONFIG_QSENSE_MISC_CFG_SHFT                                                     0

#define HWIO_CPR_QSENSE_STATUS_0_ADDR(x)                                                       ((x) + 0x3110)
#define HWIO_CPR_QSENSE_STATUS_0_PHYS(x)                                                       ((x) + 0x3110)
#define HWIO_CPR_QSENSE_STATUS_0_OFFS                                                          (0x3110)
#define HWIO_CPR_QSENSE_STATUS_0_RMSK                                                          0xf3ff1fff
#define HWIO_CPR_QSENSE_STATUS_0_IN(x)            \
                in_dword(HWIO_CPR_QSENSE_STATUS_0_ADDR(x))
#define HWIO_CPR_QSENSE_STATUS_0_INM(x, m)            \
                in_dword_masked(HWIO_CPR_QSENSE_STATUS_0_ADDR(x), m)
#define HWIO_CPR_QSENSE_STATUS_0_FS_ZERORESULT_BMSK                                            0xf0000000
#define HWIO_CPR_QSENSE_STATUS_0_FS_ZERORESULT_SHFT                                                    28
#define HWIO_CPR_QSENSE_STATUS_0_FS_RESULT_BMSK                                                 0x3ff0000
#define HWIO_CPR_QSENSE_STATUS_0_FS_RESULT_SHFT                                                        16
#define HWIO_CPR_QSENSE_STATUS_0_FSCAL_QSENSE_RO_CNT_BMSK                                          0x1fff
#define HWIO_CPR_QSENSE_STATUS_0_FSCAL_QSENSE_RO_CNT_SHFT                                               0

#define HWIO_CPR_QUOT_MAXMIN_ROr_ADDR(base,r)                                                  ((base) + 0X3200 + (0x8*(r)))
#define HWIO_CPR_QUOT_MAXMIN_ROr_PHYS(base,r)                                                  ((base) + 0X3200 + (0x8*(r)))
#define HWIO_CPR_QUOT_MAXMIN_ROr_OFFS(r)                                                       (0X3200 + (0x8*(r)))
...
#define HWIO_CPR_QUOT_MAXMIN_ROr_QUOT_MAX_SHFT                                                         16
#define HWIO_CPR_QUOT_MAXMIN_ROr_QUOT_MIN_BMSK                                                      0xfff
#define HWIO_CPR_QUOT_MAXMIN_ROr_QUOT_MIN_SHFT                                                          0

#define HWIO_CPR_QUOT_SUM_ROr_ADDR(base,r)                                                     ((base) + 0X3204 + (0x8*(r)))
#define HWIO_CPR_QUOT_SUM_ROr_PHYS(base,r)                                                     ((base) + 0X3204 + (0x8*(r)))
#define HWIO_CPR_QUOT_SUM_ROr_OFFS(r)                                                          (0X3204 + (0x8*(r)))
...
#define HWIO_CPR_QUOT_SUM_ROr_QUOT_SUM_SHFT                                                             0

#define HWIO_CPR_TOTAL_UNMASKED_SENSORS_ADDR(x)                                                ((x) + 0x3280)
#define HWIO_CPR_TOTAL_UNMASKED_SENSORS_PHYS(x)                                                ((x) + 0x3280)
#define HWIO_CPR_TOTAL_UNMASKED_SENSORS_OFFS                                                   (0x3280)
...
#define HWIO_CPR_TOTAL_UNMASKED_SENSORS_TOTAL_UNMASKED_SENSORS_SHFT                                     0

#define HWIO_CPR_BIST_QUOT_CHECK_NEW_ADDR(x)                                                   ((x) + 0x3284)
#define HWIO_CPR_BIST_QUOT_CHECK_NEW_PHYS(x)                                                   ((x) + 0x3284)
#define HWIO_CPR_BIST_QUOT_CHECK_NEW_OFFS                                                      (0x3284)
...
#define HWIO_CPR_BIST_QUOT_CHECK_NEW_FAIL_SEL_MAX_SHFT                                                  6
#define HWIO_CPR_BIST_QUOT_CHECK_NEW_FAIL_SEL_MIN_BMSK                                               0x3f
#define HWIO_CPR_BIST_QUOT_CHECK_NEW_FAIL_SEL_MIN_SHFT                                                  0

#define HWIO_CPR_RESULT_t_ADDR(base,t)                                                         ((base) + 0X3288 + (0x4*(t)))
#define HWIO_CPR_RESULT_t_PHYS(base,t)                                                         ((base) + 0X3288 + (0x4*(t)))
#define HWIO_CPR_RESULT_t_OFFS(t)                                                              (0X3288 + (0x4*(t)))
...
#define HWIO_CPR_RESULT_t_SEL_MAX_SHFT                                                                  6
#define HWIO_CPR_RESULT_t_SEL_MIN_BMSK                                                               0x3f
#define HWIO_CPR_RESULT_t_SEL_MIN_SHFT                                                                  0

#define HWIO_CPR_CPRF_UP_TIMER_ADDR(x)                                                         ((x) + 0x32b0)
#define HWIO_CPR_CPRF_UP_TIMER_PHYS(x)                                                         ((x) + 0x32b0)
#define HWIO_CPR_CPRF_UP_TIMER_OFFS                                                            (0x32b0)
#define HWIO_CPR_CPRF_UP_TIMER_RMSK                                                            0xffffffff
#define HWIO_CPR_CPRF_UP_TIMER_IN(x)            \
                in_dword(HWIO_CPR_CPRF_UP_TIMER_ADDR(x))
#define HWIO_CPR_CPRF_UP_TIMER_INM(x, m)            \
                in_dword_masked(HWIO_CPR_CPRF_UP_TIMER_ADDR(x), m)
#define HWIO_CPR_CPRF_UP_TIMER_OUT(x, v)            \
                out_dword(HWIO_CPR_CPRF_UP_TIMER_ADDR(x),v)
#define HWIO_CPR_CPRF_UP_TIMER_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_CPRF_UP_TIMER_ADDR(x),m,v,HWIO_CPR_CPRF_UP_TIMER_IN(x))
#define HWIO_CPR_CPRF_UP_TIMER_UP_TIMER_INTERVAL_BMSK                                          0xffffffff
#define HWIO_CPR_CPRF_UP_TIMER_UP_TIMER_INTERVAL_SHFT                                                   0

#define HWIO_CPR_MULTI_DIE_CL_CONFIG_ADDR(x)                                                   ((x) + 0x32b4)
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_PHYS(x)                                                   ((x) + 0x32b4)
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_OFFS                                                      (0x32b4)
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_RMSK                                                         0x3ff07
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_IN(x)            \
                in_dword(HWIO_CPR_MULTI_DIE_CL_CONFIG_ADDR(x))
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_INM(x, m)            \
                in_dword_masked(HWIO_CPR_MULTI_DIE_CL_CONFIG_ADDR(x), m)
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_OUT(x, v)            \
                out_dword(HWIO_CPR_MULTI_DIE_CL_CONFIG_ADDR(x),v)
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_MULTI_DIE_CL_CONFIG_ADDR(x),m,v,HWIO_CPR_MULTI_DIE_CL_CONFIG_IN(x))
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_VOTE_TABLE_STATUS_BMSK                                       0x30000
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_VOTE_TABLE_STATUS_SHFT                                            16
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_CONSECUTIVE_DN_NEW_BMSK                                       0xff00
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_CONSECUTIVE_DN_NEW_SHFT                                            8
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_VOTE_TABLE_EN_BMSK                                               0x4
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_VOTE_TABLE_EN_SHFT                                                 2
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_PAUSE_MEASUREMENT_BMSK                                           0x2
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_PAUSE_MEASUREMENT_SHFT                                             1
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_MULTI_DIE_CL_EN_BMSK                                             0x1
#define HWIO_CPR_MULTI_DIE_CL_CONFIG_MULTI_DIE_CL_EN_SHFT                                               0

#define HWIO_CPR_ACD_CONFIG_ADDR(x)                                                            ((x) + 0x32b8)
#define HWIO_CPR_ACD_CONFIG_PHYS(x)                                                            ((x) + 0x32b8)
#define HWIO_CPR_ACD_CONFIG_OFFS                                                               (0x32b8)
#define HWIO_CPR_ACD_CONFIG_RMSK                                                                 0x3fffff
#define HWIO_CPR_ACD_CONFIG_IN(x)            \
                in_dword(HWIO_CPR_ACD_CONFIG_ADDR(x))
#define HWIO_CPR_ACD_CONFIG_INM(x, m)            \
                in_dword_masked(HWIO_CPR_ACD_CONFIG_ADDR(x), m)
#define HWIO_CPR_ACD_CONFIG_OUT(x, v)            \
                out_dword(HWIO_CPR_ACD_CONFIG_ADDR(x),v)
#define HWIO_CPR_ACD_CONFIG_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_ACD_CONFIG_ADDR(x),m,v,HWIO_CPR_ACD_CONFIG_IN(x))
#define HWIO_CPR_ACD_CONFIG_ACD_UP_NOTWAIT_4_DOWN_BMSK                                           0x200000
#define HWIO_CPR_ACD_CONFIG_ACD_UP_NOTWAIT_4_DOWN_SHFT                                                 21
#define HWIO_CPR_ACD_CONFIG_NACK_AVG_DN_NO_MARGIN_BMSK                                           0x100000
#define HWIO_CPR_ACD_CONFIG_NACK_AVG_DN_NO_MARGIN_SHFT                                                 20
#define HWIO_CPR_ACD_CONFIG_AVG_ABORT_AUTOCONTTIMER_BMSK                                          0x80000
#define HWIO_CPR_ACD_CONFIG_AVG_ABORT_AUTOCONTTIMER_SHFT                                               19
#define HWIO_CPR_ACD_CONFIG_ACD_ADJ_STEP_DOWN_LIMIT_BMSK                                          0x7c000
#define HWIO_CPR_ACD_CONFIG_ACD_ADJ_STEP_DOWN_LIMIT_SHFT                                               14
#define HWIO_CPR_ACD_CONFIG_ACD_ADJ_STEP_UP_LIMIT_BMSK                                             0x3800
#define HWIO_CPR_ACD_CONFIG_ACD_ADJ_STEP_UP_LIMIT_SHFT                                                 11
#define HWIO_CPR_ACD_CONFIG_ACD_ADJ_STEP_SIZE_DOWN_BMSK                                             0x600
#define HWIO_CPR_ACD_CONFIG_ACD_ADJ_STEP_SIZE_DOWN_SHFT                                                 9
#define HWIO_CPR_ACD_CONFIG_ACD_ADJ_STEP_SIZE_UP_BMSK                                               0x180
#define HWIO_CPR_ACD_CONFIG_ACD_ADJ_STEP_SIZE_UP_SHFT                                                   7
#define HWIO_CPR_ACD_CONFIG_ACD_GEN_DISABLE_REQ_ALWAYS_BMSK                                          0x40
#define HWIO_CPR_ACD_CONFIG_ACD_GEN_DISABLE_REQ_ALWAYS_SHFT                                             6
#define HWIO_CPR_ACD_CONFIG_ACD_ALWAYS_ACK_DN_BMSK                                                   0x20
#define HWIO_CPR_ACD_CONFIG_ACD_ALWAYS_ACK_DN_SHFT                                                      5
#define HWIO_CPR_ACD_CONFIG_ACD_ALWAYS_ACK_UP_BMSK                                                   0x10
#define HWIO_CPR_ACD_CONFIG_ACD_ALWAYS_ACK_UP_SHFT                                                      4
#define HWIO_CPR_ACD_CONFIG_ACD_NOTWAIT_4_CL_SETTLE_BMSK                                              0x8
#define HWIO_CPR_ACD_CONFIG_ACD_NOTWAIT_4_CL_SETTLE_SHFT                                                3
#define HWIO_CPR_ACD_CONFIG_ACD_WAIT4TIMER_BMSK                                                       0x4
#define HWIO_CPR_ACD_CONFIG_ACD_WAIT4TIMER_SHFT                                                         2
#define HWIO_CPR_ACD_CONFIG_ACD_AVG_FAST_MEAS_EN_BMSK                                                 0x2
#define HWIO_CPR_ACD_CONFIG_ACD_AVG_FAST_MEAS_EN_SHFT                                                   1
#define HWIO_CPR_ACD_CONFIG_ACD_AVG_EN_BMSK                                                           0x1
#define HWIO_CPR_ACD_CONFIG_ACD_AVG_EN_SHFT                                                             0

#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ADDR(x)                                               ((x) + 0x32bc)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_PHYS(x)                                               ((x) + 0x32bc)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_OFFS                                                  (0x32bc)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_RMSK                                                  0xffffffff
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_IN(x)            \
                in_dword(HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ADDR(x))
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_INM(x, m)            \
                in_dword_masked(HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ADDR(x), m)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_OUT(x, v)            \
                out_dword(HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ADDR(x),v)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ADDR(x),m,v,HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_IN(x))
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_NO_ACK_STATUS_BMSK                                0x80000000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_NO_ACK_STATUS_SHFT                                        31
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_CPR_ACD_DISABLE_WAIT_TIMER_BMSK                       0x7f800000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_CPR_ACD_DISABLE_WAIT_TIMER_SHFT                               23
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_ACTIVE_REQ_EN_BMSK                                  0x400000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_ACTIVE_REQ_EN_SHFT                                        22
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_ACK_WAIT_TIMER_EN_BMSK                              0x200000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_ACK_WAIT_TIMER_EN_SHFT                                    21
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_SW_CPR_ACD_DISABLE_REQ_BMSK                             0x100000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_SW_CPR_ACD_DISABLE_REQ_SHFT                                   20
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_SW_ALL_ACK_DEASSERTED_BMSK                               0x80000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_SW_ALL_ACK_DEASSERTED_SHFT                                    19
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_SW_ALL_ACK_ASSERTED_BMSK                                 0x40000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_SW_ALL_ACK_ASSERTED_SHFT                                      18
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_SW_OVERRIDE_EN_BMSK                                      0x20000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_SW_OVERRIDE_EN_SHFT                                           17
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_DCVS_DISABLE_HS_EN_BMSK                              0x10000
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_DCVS_DISABLE_HS_EN_SHFT                                   16
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_ACK_RCVD_DIS_BMSK                                     0xffff
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG_ACD_ACK_RCVD_DIS_SHFT                                          0

#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ADDR(x)                                              ((x) + 0x32c0)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_PHYS(x)                                              ((x) + 0x32c0)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_OFFS                                                 (0x32c0)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_RMSK                                                        0xf
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_IN(x)            \
                in_dword(HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ADDR(x))
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_INM(x, m)            \
                in_dword_masked(HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ADDR(x), m)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_OUT(x, v)            \
                out_dword(HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ADDR(x),v)
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ADDR(x),m,v,HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_IN(x))
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_SW_CPR_SETTLE_BMSK                                          0x8
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_SW_CPR_SETTLE_SHFT                                            3
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_CPR_SETTLE_ON_AGGREGATED_MID_BMSK                           0x4
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_CPR_SETTLE_ON_AGGREGATED_MID_SHFT                             2
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ACD_DISABLE_REQ_IGNORE_INACTIVE_ACD_BMSK                    0x2
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ACD_DISABLE_REQ_IGNORE_INACTIVE_ACD_SHFT                      1
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ACD_DISABLE_REQ_NEW_FEATURE_EN_BMSK                         0x1
#define HWIO_CPR_ACD_DCVS_DISABLE_CONFIG1_ACD_DISABLE_REQ_NEW_FEATURE_EN_SHFT                           0

#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_ADDR(x)                                            ((x) + 0x32c4)
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_PHYS(x)                                            ((x) + 0x32c4)
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_OFFS                                               (0x32c4)
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_RMSK                                               0xffffffff
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_IN(x)            \
                in_dword(HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_ADDR(x))
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_INM(x, m)            \
                in_dword_masked(HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_ADDR(x), m)
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_OUT(x, v)            \
                out_dword(HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_ADDR(x),v)
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_ADDR(x),m,v,HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_IN(x))
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_NEW_ACD_DISABLE_WAIT_TIMER_BMSK                    0xffffffff
#define HWIO_CPR_ACD_DCVS_DISABLE_TIMER_VAL_NEW_ACD_DISABLE_WAIT_TIMER_SHFT                             0

#define HWIO_CPR_ACD_MASK_CONFIG_ADDR(x)                                                       ((x) + 0x32c8)
#define HWIO_CPR_ACD_MASK_CONFIG_PHYS(x)                                                       ((x) + 0x32c8)
#define HWIO_CPR_ACD_MASK_CONFIG_OFFS                                                          (0x32c8)
#define HWIO_CPR_ACD_MASK_CONFIG_RMSK                                                          0xffffffff
#define HWIO_CPR_ACD_MASK_CONFIG_IN(x)            \
                in_dword(HWIO_CPR_ACD_MASK_CONFIG_ADDR(x))
#define HWIO_CPR_ACD_MASK_CONFIG_INM(x, m)            \
                in_dword_masked(HWIO_CPR_ACD_MASK_CONFIG_ADDR(x), m)
#define HWIO_CPR_ACD_MASK_CONFIG_OUT(x, v)            \
                out_dword(HWIO_CPR_ACD_MASK_CONFIG_ADDR(x),v)
#define HWIO_CPR_ACD_MASK_CONFIG_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_ACD_MASK_CONFIG_ADDR(x),m,v,HWIO_CPR_ACD_MASK_CONFIG_IN(x))
#define HWIO_CPR_ACD_MASK_CONFIG_AVG_ACK_RCVD_DIS_ACD_BMSK                                     0xffff0000
#define HWIO_CPR_ACD_MASK_CONFIG_AVG_ACK_RCVD_DIS_ACD_SHFT                                             16
#define HWIO_CPR_ACD_MASK_CONFIG_AVG_MASK_ACD_BMSK                                                 0xffff
#define HWIO_CPR_ACD_MASK_CONFIG_AVG_MASK_ACD_SHFT                                                      0

#define HWIO_CPR_AVG_BYPASS_SETTINGS_ADDR(x)                                                   ((x) + 0x32cc)
#define HWIO_CPR_AVG_BYPASS_SETTINGS_PHYS(x)                                                   ((x) + 0x32cc)
#define HWIO_CPR_AVG_BYPASS_SETTINGS_OFFS                                                      (0x32cc)
#define HWIO_CPR_AVG_BYPASS_SETTINGS_RMSK                                                           0x7ff
#define HWIO_CPR_AVG_BYPASS_SETTINGS_IN(x)            \
                in_dword(HWIO_CPR_AVG_BYPASS_SETTINGS_ADDR(x))
#define HWIO_CPR_AVG_BYPASS_SETTINGS_INM(x, m)            \
                in_dword_masked(HWIO_CPR_AVG_BYPASS_SETTINGS_ADDR(x), m)
#define HWIO_CPR_AVG_BYPASS_SETTINGS_OUT(x, v)            \
                out_dword(HWIO_CPR_AVG_BYPASS_SETTINGS_ADDR(x),v)
#define HWIO_CPR_AVG_BYPASS_SETTINGS_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_AVG_BYPASS_SETTINGS_ADDR(x),m,v,HWIO_CPR_AVG_BYPASS_SETTINGS_IN(x))
#define HWIO_CPR_AVG_BYPASS_SETTINGS_DN_ERROR_STEPS_BMSK                                            0x7c0
#define HWIO_CPR_AVG_BYPASS_SETTINGS_DN_ERROR_STEPS_SHFT                                                6
#define HWIO_CPR_AVG_BYPASS_SETTINGS_UP_ERROR_STEPS_BMSK                                             0x3e
#define HWIO_CPR_AVG_BYPASS_SETTINGS_UP_ERROR_STEPS_SHFT                                                1
#define HWIO_CPR_AVG_BYPASS_SETTINGS_AVG_BYPASS_EN_BMSK                                               0x1
#define HWIO_CPR_AVG_BYPASS_SETTINGS_AVG_BYPASS_EN_SHFT                                                 0

#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_ADDR(x)                                              ((x) + 0x32d0)
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_PHYS(x)                                              ((x) + 0x32d0)
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_OFFS                                                 (0x32d0)
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_RMSK                                                        0x3
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_IN(x)            \
                in_dword(HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_ADDR(x))
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_INM(x, m)            \
                in_dword_masked(HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_ADDR(x), m)
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_OUT(x, v)            \
                out_dword(HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_ADDR(x),v)
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_ADDR(x),m,v,HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_IN(x))
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_MULTI_STEP_UADJ_EN_BMSK                                     0x2
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_MULTI_STEP_UADJ_EN_SHFT                                       1
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_ENABLE_CPR_UADJ_PRE_CHECK_BMSK                              0x1
#define HWIO_CPR_MULTI_STEP_UADJ_SETTINGS_ENABLE_CPR_UADJ_PRE_CHECK_SHFT                                0

#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_ADDR(base,m)                                          ((base) + 0X32D4 + (0x4*(m)))
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_PHYS(base,m)                                          ((base) + 0X32D4 + (0x4*(m)))
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_OFFS(m)                                               (0X32D4 + (0x4*(m)))
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_RMSK                                                        0x7f
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_MAXm                                                          15
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_INI(base,m)                \
                in_dword_masked(HWIO_CPR_STEP_COUNTER_SETTINGS_m_ADDR(base,m), HWIO_CPR_STEP_COUNTER_SETTINGS_m_RMSK)
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_INMI(base,m,mask)        \
                in_dword_masked(HWIO_CPR_STEP_COUNTER_SETTINGS_m_ADDR(base,m), mask)
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_OUTI(base,m,val)        \
                out_dword(HWIO_CPR_STEP_COUNTER_SETTINGS_m_ADDR(base,m),val)
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_OUTMI(base,m,mask,val) \
                out_dword_masked_ns(HWIO_CPR_STEP_COUNTER_SETTINGS_m_ADDR(base,m),mask,val,HWIO_CPR_STEP_COUNTER_SETTINGS_m_INI(base,m))
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_MAX_STEPS_BMSK                                              0x7f
#define HWIO_CPR_STEP_COUNTER_SETTINGS_m_MAX_STEPS_SHFT                                                 0

#define HWIO_CPR_TEMP_RX_EN_ADDR(x)                                                            ((x) + 0x3320)
#define HWIO_CPR_TEMP_RX_EN_PHYS(x)                                                            ((x) + 0x3320)
#define HWIO_CPR_TEMP_RX_EN_OFFS                                                               (0x3320)
#define HWIO_CPR_TEMP_RX_EN_RMSK                                                                   0xffff
#define HWIO_CPR_TEMP_RX_EN_IN(x)            \
                in_dword(HWIO_CPR_TEMP_RX_EN_ADDR(x))
#define HWIO_CPR_TEMP_RX_EN_INM(x, m)            \
                in_dword_masked(HWIO_CPR_TEMP_RX_EN_ADDR(x), m)
#define HWIO_CPR_TEMP_RX_EN_OUT(x, v)            \
                out_dword(HWIO_CPR_TEMP_RX_EN_ADDR(x),v)
#define HWIO_CPR_TEMP_RX_EN_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_TEMP_RX_EN_ADDR(x),m,v,HWIO_CPR_TEMP_RX_EN_IN(x))
#define HWIO_CPR_TEMP_RX_EN_TEMP_INPUT_BMSK                                                        0xffff
#define HWIO_CPR_TEMP_RX_EN_TEMP_INPUT_SHFT                                                             0

#define HWIO_CPR_TEMP_MISC_CTL_ADDR(x)                                                         ((x) + 0x3324)
#define HWIO_CPR_TEMP_MISC_CTL_PHYS(x)                                                         ((x) + 0x3324)
#define HWIO_CPR_TEMP_MISC_CTL_OFFS                                                            (0x3324)
#define HWIO_CPR_TEMP_MISC_CTL_RMSK                                                            0xffff007f
#define HWIO_CPR_TEMP_MISC_CTL_IN(x)            \
                in_dword(HWIO_CPR_TEMP_MISC_CTL_ADDR(x))
#define HWIO_CPR_TEMP_MISC_CTL_INM(x, m)            \
                in_dword_masked(HWIO_CPR_TEMP_MISC_CTL_ADDR(x), m)
#define HWIO_CPR_TEMP_MISC_CTL_OUT(x, v)            \
                out_dword(HWIO_CPR_TEMP_MISC_CTL_ADDR(x),v)
#define HWIO_CPR_TEMP_MISC_CTL_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_TEMP_MISC_CTL_ADDR(x),m,v,HWIO_CPR_TEMP_MISC_CTL_IN(x))
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_WDTIMER_EXPIRED_COUNTER_BMSK                               0xffff0000
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_WDTIMER_EXPIRED_COUNTER_SHFT                                       16
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_WDTIMER_EXPIRED_COUNTER_RST_BMSK                                 0x40
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_WDTIMER_EXPIRED_COUNTER_RST_SHFT                                    6
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_WDTIMER_EXPIRED_BMSK                                             0x20
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_WDTIMER_EXPIRED_SHFT                                                5
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_WDTIMER_SW_EN_BMSK                                               0x10
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_WDTIMER_SW_EN_SHFT                                                  4
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_INTF_LOOP_EN_BMSK                                                 0x8
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_INTF_LOOP_EN_SHFT                                                   3
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_NON_CONTIGUOUS_ID_EN_BMSK                                         0x4
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_NON_CONTIGUOUS_ID_EN_SHFT                                           2
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_RX_FLUSH_EN_BMSK                                                  0x2
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_RX_FLUSH_EN_SHFT                                                    1
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_RX_SSC_EN_BMSK                                                    0x1
#define HWIO_CPR_TEMP_MISC_CTL_TEMP_RX_SSC_EN_SHFT                                                      0

#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_ADDR(base,n)                                            ((base) + 0X3328 + (0x4*(n)))
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_PHYS(base,n)                                            ((base) + 0X3328 + (0x4*(n)))
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_OFFS(n)                                                 (0X3328 + (0x4*(n)))
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_RMSK                                                          0xff
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_MAXn                                                            15
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_INI(base,n)                \
                in_dword_masked(HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_ADDR(base,n), HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_RMSK)
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_INMI(base,n,mask)        \
                in_dword_masked(HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_ADDR(base,n), mask)
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_OUTI(base,n,val)        \
                out_dword(HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_ADDR(base,n),val)
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_OUTMI(base,n,mask,val) \
                out_dword_masked_ns(HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_ADDR(base,n),mask,val,HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_INI(base,n))
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_TEMP_CTRL_ID_BMSK                                             0xf0
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_TEMP_CTRL_ID_SHFT                                                4
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_TEMP_SENSOR_ID_BMSK                                            0xf
#define HWIO_CPR_TEMP_CTRL_SENSOR_ID_n_TEMP_SENSOR_ID_SHFT                                              0

#define HWIO_CPR_TEMP_WDTIMER_ADDR(x)                                                          ((x) + 0x3368)
#define HWIO_CPR_TEMP_WDTIMER_PHYS(x)                                                          ((x) + 0x3368)
#define HWIO_CPR_TEMP_WDTIMER_OFFS                                                             (0x3368)
#define HWIO_CPR_TEMP_WDTIMER_RMSK                                                             0xffffffff
#define HWIO_CPR_TEMP_WDTIMER_IN(x)            \
                in_dword(HWIO_CPR_TEMP_WDTIMER_ADDR(x))
#define HWIO_CPR_TEMP_WDTIMER_INM(x, m)            \
                in_dword_masked(HWIO_CPR_TEMP_WDTIMER_ADDR(x), m)
#define HWIO_CPR_TEMP_WDTIMER_OUT(x, v)            \
                out_dword(HWIO_CPR_TEMP_WDTIMER_ADDR(x),v)
#define HWIO_CPR_TEMP_WDTIMER_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_TEMP_WDTIMER_ADDR(x),m,v,HWIO_CPR_TEMP_WDTIMER_IN(x))
#define HWIO_CPR_TEMP_WDTIMER_TEMP_WDTIMER_BMSK                                                0xffffffff
#define HWIO_CPR_TEMP_WDTIMER_TEMP_WDTIMER_SHFT                                                         0
