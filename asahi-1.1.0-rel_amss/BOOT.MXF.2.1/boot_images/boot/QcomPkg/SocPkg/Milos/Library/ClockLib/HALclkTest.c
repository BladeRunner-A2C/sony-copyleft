...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlAPSSCC_milos =
{
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlCAMCC_milos =
{
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlDISPCC_milos =
{
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlGCC_milos =
{
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlGPUCC_milos =
{
...
/*=========================================================================
      GX_CLKCTL Debug Mux Control Functions
==========================================================================*/

static void HAL_clk_ConfigDebugMuxGXCLKCTL
(
  HAL_clk_DebugMuxDescType  *pmDebugMux,
  uint32_t                   nMuxSel
)
{
  HWIO_OUTF(GPU_GX_CLKCTL_DEBUG_MUX_MUXR, MUX_SEL, nMuxSel);
  HWIO_OUTF(GPU_GX_CLKCTL_DEBUG_CBCR, CLK_ENABLE, 1);
}

HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlGXCLKCTL_milos =
{
  .ConfigMux  = HAL_clk_ConfigDebugMuxGXCLKCTL,
};
...
HAL_clk_DebugMuxControlType HAL_clk_DebugMuxControlVIDEOCC_milos =
{
