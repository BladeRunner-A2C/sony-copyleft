...
----------   ---     ----------------------------------------------------------  
2024-03-13   sb      Update for Milos with V16.0 phy version
2023-01-31   gk      Update for Camano version 12.0 
2023-01-31   gk      Update for Camano version 11.0 
...
static struct ufs_mphy_init_item ufs_bsp_mphy_init_table[] = {
   ...
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_BG_TIMER_OFFS,						0x0E},   
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_DEC_START_MODE0_OFFS,               0x82}, 
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_CP_CTRL_MODE0_OFFS,                 0x14}, 
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_PLL_RCTRL_MODE0_OFFS,               0x18}, 
   { 0x00, HWIO_UFS_MEM_QSERDES_COM_PLL_CCTRL_MODE0_OFFS,               0x18}, 
   ...
   { CONDITIONAL_FLAG(0, HS_G4),
		   HWIO_UFS_MEM_QSERDES_COM_DEC_START_MODE1_OFFS,               0x98}, 
   { CONDITIONAL_FLAG(0, HS_G4),
		   HWIO_UFS_MEM_QSERDES_COM_CP_CTRL_MODE1_OFFS,                 0x14}, 
   { CONDITIONAL_FLAG(0, HS_G4),
		   HWIO_UFS_MEM_QSERDES_COM_PLL_RCTRL_MODE1_OFFS,               0x18}, 
   { CONDITIONAL_FLAG(0, HS_G4),
		   HWIO_UFS_MEM_QSERDES_COM_PLL_CCTRL_MODE1_OFFS,               0x18}, 
   { CONDITIONAL_FLAG(0, HS_G4),
		   HWIO_UFS_MEM_QSERDES_COM_LOCK_CMP1_MODE1_OFFS,               0x32}, 
   { CONDITIONAL_FLAG(0, HS_G4),
		   HWIO_UFS_MEM_QSERDES_COM_LOCK_CMP2_MODE1_OFFS,               0x0F},    
   ...
   { CONDITIONAL_FLAG(0, HS_G4), 
           HWIO_UFS_MEM_QSERDES_TX0_TX_FR_DCC_CTRL_OFFS,                0xCC}, 
...
static struct ufs_mphy_init_item ufs_bsp_mphy_init_end_table[] = {
   ...
   { CONDITIONAL_FLAG(0, HS_G4), 
           HWIO_UFS_MEM_UFS_PHY_PLL_CNTL_OFFS,                     0x0B},		   
   ...
   { 0x00, HWIO_UFS_PHY_PHY_START_OFFS,                            0x01},    
   { STOP_CONDITION, 0,0}};
...
static struct ufs_mphy_init_item ufs_bsp_mphy_2_lane_init_table[] = {
     ...
     { CONDITIONAL_FLAG(0, HS_G4),   
           HWIO_UFS_MEM_QSERDES_TX1_TX_FR_DCC_CTRL_OFFS,                  0xCC},     
