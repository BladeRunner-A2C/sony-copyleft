...
// .id : refr the clock domain index number from the "Milos BCM Configurations" HSR

// .vote_addr : refer the SWI

// for .nMax_hlvl : Note the Corner string from milos DFS Configurations and refer the value against it from "VLVL to HLVL" in file 
// /AOP.HO.5.0/aop_proc/core/power/cmd_db/target/milos/arc_export.rinit
...
dfs_domains dfs_table[] = {
  ...
  [3]={
    ...
    .nMax_hlvl = 7, // kept 7 by refering before files
      },
  [4]={
    .name = "ipa",
    .id  = VCD_IPA_ID,
