...
/* MDPPlatform context include platform/power/panel info
*/
typedef struct
{
  MDPPlatformInfo               sPlatformInfo;
  Panel_PowerCtrlParams         sPanelPowerCtrl;
  MDPPlatformPanelInfo          sPlatformPanel[MDP_DISPLAY_MAX];
  PanelConfigType               asPanelConfig[MDP_DISPLAY_MAX];
  MDPPlatformPanelFunctionTable asMDPSupportPanelFunctions[MDP_DISPLAY_MAX];
}MDPPlatformContext;
...
/* Get panel functions from MDPPlatform context
*/
