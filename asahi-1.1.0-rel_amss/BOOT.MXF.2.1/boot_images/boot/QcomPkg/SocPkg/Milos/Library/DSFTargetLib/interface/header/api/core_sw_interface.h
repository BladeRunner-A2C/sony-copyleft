...
extern size_t (*fptr_HAL_EXT_CORE_SW_strlcpy)(char *dest, const char *src, size_t n);
...
/*===========================================================================
**  Function : HAL_EXT_CORE_SW_strlcpy
** ==========================================================================
*/
/*!
*   @brief
*   This function compares two strings
*  
*   @param dest     - [IN] pointer to destination to which the string needs to be copied
*   @param src     - [IN] pointer to const string which is copied
*   @param n      - [IN] length to fill
*   
*   @par Dependencies
*   None
*   
...
size_t HAL_EXT_CORE_SW_strlcpy(char *dest, const char *src, size_t n);
