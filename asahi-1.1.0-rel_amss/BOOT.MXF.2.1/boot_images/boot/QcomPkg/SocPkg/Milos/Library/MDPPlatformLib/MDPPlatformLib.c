...
static uint32 CheckNumDisplayCores()
{
  ...
  else if (EFI_SUCCESS != hChipInfoProtocol->GetDefectivePart(hChipInfoProtocol, EFICHIPINFO_PART_DISPLAY, &uDisplayCoreMask))
  {
    DEBUG((EFI_D_INFO, "CheckNumDisplayCores(): gEfiChipInfoProtocolGuid->GetDefectivePart() failed. \n"));
  }
  else if (uDisplayCoreMask)
  {
