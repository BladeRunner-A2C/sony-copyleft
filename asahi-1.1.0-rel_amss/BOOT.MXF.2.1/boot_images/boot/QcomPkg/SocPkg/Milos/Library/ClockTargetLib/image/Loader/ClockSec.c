...
)
{
  ...
  HWIO_OUTF(GCC_MMSS_QM_AHB_CBCR, CLK_ENABLE, 1);
...
)
{
  ...
  HWIO_OUTF(GCC_SDCC1_ICE_CORE_CBCR, CLK_ENABLE, 0);
  HWIO_OUTF(GCC_PIMEM_AXI_CBCR, CLK_ENABLE, 0);
  HWIO_OUTF(GCC_MMSS_QM_AHB_CBCR, CLK_ENABLE, 0);
  /*
