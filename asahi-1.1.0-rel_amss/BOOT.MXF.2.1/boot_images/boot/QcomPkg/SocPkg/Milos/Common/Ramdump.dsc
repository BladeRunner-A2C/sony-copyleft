...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Milos$(VAR)/RamDump
...
#
  QcomPkg/XBLRamDump/XBLRamDump.inf {
    <LibraryClasses>
      ...
      ClockTargetLib|QcomPkg/SocPkg/Milos/Library/ClockTargetLib/ClockRamDumpLib.inf
      ...
      MDPPlatformLibBoot|QcomPkg/SocPkg/Milos/Library/MDPPlatformLibBoot/MDPPlatformLibBoot.inf
      ...
      #PmicLoaderLib|QcomPkg/SocPkg/Milos/Library/PmicLib/loader/PmicRamDump.inf
      ...
      QusbTargetLib|QcomPkg/SocPkg/Milos/Library/QusbTargetLib/QusbTargetLib.inf
      #QusbTargetLib|QcomPkg/Library/NullLibs/QusbTargetLibNull/QusbTargetLibNull.inf
      QusbDciCommonLib|QcomPkg/SocPkg/Milos/Library/QusbDciCommonLib/QusbDciCommonLib.inf
      #QusbDciCommonLib|QcomPkg/Library/NullLibs/QusbDciCommonLibNull/QusbDciCommonLibNull.inf

	  UsbSharedLib|QcomPkg/SocPkg/Milos/Library/UsbSharedLib/UsbSharedLibRamdump.inf
