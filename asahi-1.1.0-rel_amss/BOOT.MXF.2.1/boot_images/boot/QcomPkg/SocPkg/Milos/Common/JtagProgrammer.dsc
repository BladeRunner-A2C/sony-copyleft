...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Milos$(VAR)/JtagProgrammer
...
[Components.common]
  QcomPkg/Library/JtagProgrammerLib/JtagProgrammer.inf {
	  ...
	  SdccTargetLib|QcomPkg/SocPkg/Milos/Library/SdccTargetLib/SdccJtagTargetLib.inf
	  ...
	  UsbSharedLib|QcomPkg/SocPkg/Milos/Library/UsbSharedLib/UsbSharedLibCore.inf
