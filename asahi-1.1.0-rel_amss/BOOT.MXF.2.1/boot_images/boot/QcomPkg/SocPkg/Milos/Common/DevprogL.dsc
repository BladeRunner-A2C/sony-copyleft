...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Milos$(VAR)/DevprogL
...
[Components.common]
  QcomPkg/DevPrg/DevPrgL.inf {
     <LibraryClasses>
      ...
      #PmicLoaderLib|QcomPkg/SocPkg/Milos/Library/PmicLib/loader/PmicLoaderNoChgrLib.inf
