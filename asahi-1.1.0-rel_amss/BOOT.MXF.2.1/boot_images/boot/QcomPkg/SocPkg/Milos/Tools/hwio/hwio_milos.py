...
#
#  @file hwio_milos.py
#  @brief HWIO config file for the HWIO generation scripts for Milos.
#
#  This file can be invoked by calling:
#
#    HWIOGen.py --cfg=hwio_milos.py --flat=ARM_ADDRESS_FILE.FLAT
#
#  ===========================================================================
#
...
if __name__ == "__main__":
  ...
  flat_path = 'ARM_ADDRESS_FILE_SW.FLAT'
  if os.name == 'nt':
