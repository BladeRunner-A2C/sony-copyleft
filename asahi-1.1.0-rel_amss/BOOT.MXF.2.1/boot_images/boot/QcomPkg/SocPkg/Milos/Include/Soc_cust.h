...
--------   --------     ----------------------------------------------------------
02/06/24   gk           IPA memory dumps address, size update for Milos target.
11/30/23   nnaram       Added TME_LOG_REGION
11/10/23   ng           Added pIMEM support.
...
#define SCL_IPA_IU_SIZE    0x4F00
#define SCL_IPA_SRAM_BASE  0x03F50000
#define SCL_IPA_SRAM_SIZE  0x4400
#define SCL_IPA_MBOX_BASE  0x03FC2000
#define SCL_IPA_MBOX_SIZE  0x100
#define SCL_IPA_HRAM_BASE  0x03F60000
#define SCL_IPA_HRAM_SIZE  0x2017C
#define SCL_IPA_SEQ_BASE   0x3F81000
#define SCL_IPA_SEQ_SIZE   0x464
