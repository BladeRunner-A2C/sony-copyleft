...
#define HWIO_QUPV3_SE_IF_IRQ_MASKED_H_IN(x)            \
                in_dword_masked(HWIO_QUPV3_SE_IF_IRQ_MASKED_H_ADDR(x), HWIO_QUPV3_SE_IF_IRQ_MASKED_H_RMSK)
...
#define HWIO_QUPV3_SYNC_ID_SE_MAP0_IN(x)            \
                in_dword_masked(HWIO_QUPV3_SYNC_ID_SE_MAP0_ADDR(x), HWIO_QUPV3_SYNC_ID_SE_MAP0_RMSK)
...
#define HWIO_QUPV3_SYNC_ID_SE_MAP1_IN(x)            \
                in_dword_masked(HWIO_QUPV3_SYNC_ID_SE_MAP1_ADDR(x), HWIO_QUPV3_SYNC_ID_SE_MAP1_RMSK)
...
#define HWIO_QUPV3_SYNC_DATA_DEBUG_IN(x)            \
                in_dword_masked(HWIO_QUPV3_SYNC_DATA_DEBUG_ADDR(x), HWIO_QUPV3_SYNC_DATA_DEBUG_RMSK)
...
#define HWIO_QUPV3_WD_TIMER_CFG_IN(x)            \
                in_dword_masked(HWIO_QUPV3_WD_TIMER_CFG_ADDR(x), HWIO_QUPV3_WD_TIMER_CFG_RMSK)
...
#define HWIO_QUPV3_WD_TIMER_STS_IN(x)            \
                in_dword_masked(HWIO_QUPV3_WD_TIMER_STS_ADDR(x), HWIO_QUPV3_WD_TIMER_STS_RMSK)
...
#define HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_NS_IN(x)            \
                in_dword_masked(HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_NS_ADDR(x), HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_NS_RMSK)
...
#define HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_MSA_IN(x)            \
                in_dword_masked(HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_MSA_ADDR(x), HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_MSA_RMSK)
...
#define HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_SP_IN(x)            \
                in_dword_masked(HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_SP_ADDR(x), HWIO_QUPV3_FORCE_TLVOUT_LOOPBACK_SP_RMSK)
...
#define HWIO_QUPV3_COMMON_CGC_CTRL_IN(x)            \
                in_dword_masked(HWIO_QUPV3_COMMON_CGC_CTRL_ADDR(x), HWIO_QUPV3_COMMON_CGC_CTRL_RMSK)
...
#define HWIO_QUPV3_QTIMER_BIN_IN(x)            \
                in_dword_masked(HWIO_QUPV3_QTIMER_BIN_ADDR(x), HWIO_QUPV3_QTIMER_BIN_RMSK)
...
#define HWIO_QUPV3_QTIMER_BIN_MSB_IN(x)            \
                in_dword_masked(HWIO_QUPV3_QTIMER_BIN_MSB_ADDR(x), HWIO_QUPV3_QTIMER_BIN_MSB_RMSK)
