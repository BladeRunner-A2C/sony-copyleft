...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Palawan$(VAR)/RamDump
...
#
  QcomPkg/XBLRamDump/XBLRamDump.inf {
    <LibraryClasses>
      ...
      ClockTargetLib|QcomPkg/SocPkg/Palawan/Library/ClockTargetLib/ClockRamDumpLib.inf
	  #ClockTargetLib|QcomPkg/Library/NullLibs/ClockTargetLibNull/ClockTargetLibNull.inf
      ...
      HALMDSSLib|QcomPkg/Library/HALMDSSLib/HALMDSS1010.inf
      ...
      MDPPlatformLibBoot|QcomPkg/SocPkg/Palawan/Library/MDPPlatformLibBoot/MDPPlatformLibBoot.inf
      ...
      PmicLoaderLib|QcomPkg/SocPkg/Palawan/Library/PmicLib/loader/PmicRamDump.inf
      ...
      QusbTargetLib|QcomPkg/SocPkg/Palawan/Library/QusbTargetLib/QusbTargetLib.inf
      #QusbTargetLib|QcomPkg/Library/NullLibs/QusbTargetLibNull/QusbTargetLibNull.inf
      QusbDciCommonLib|QcomPkg/SocPkg/Palawan/Library/QusbDciCommonLib/QusbDciCommonLib.inf
      #QusbDciCommonLib|QcomPkg/Library/NullLibs/QusbDciCommonLibNull/QusbDciCommonLibNull.inf

	  UsbSharedLib|QcomPkg/SocPkg/Palawan/Library/UsbSharedLib/UsbSharedLibRamdump.inf
