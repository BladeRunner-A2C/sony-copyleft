...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Palawan$(VAR)/Loader
...
[BuildOptions]
   GCC:*_*_*_CC_FLAGS = -I$(WORKSPACE)/QcomPkg/Palawan/Include/xbl_sc_cust.h
################################################################################
#
...
[Components.common]
  QcomPkg/XBLLoader/XBLLoader.inf {
    <LibraryClasses>
     ...
     EUDTargetLib|QcomPkg/SocPkg/Palawan/Library/EUDTargetLib/EUDTargetLib.inf
     #EUDTargetLib|QcomPkg/SocPkg/Library/EUDTargetLib/EUDTargetLib.inf
     ButtonsBootLib|QcomPkg/SocPkg/Palawan/Library/ButtonsTargetLib/ButtonsBootLib.inf
     ...
     TLMMTargetLib|QcomPkg/SocPkg/Palawan/Library/TLMMTargetLib/TLMMTargetLib.inf
     ...
     PmicPsiLib|QcomPkg/SocPkg/Palawan/Library/PmicLib/loader/PmicPsiLib.inf
     PmicLib|QcomPkg/SocPkg/Palawan/Library/PmicLib/PmicLib.inf
     PmicLoaderLib|QcomPkg/SocPkg/Palawan/Library/PmicLib/loader/PmicLoaderLib.inf
     ...
     DDITargetLib|QcomPkg/SocPkg/Palawan/Library/DDITargetLib/DDITargetLib.inf
     #DDITargetLib|QcomPkg/Library/NullLibs/DDITargetLibNull/DDITargetLibNull.inf
     SecLib|SecPkg/Library/SecLib/SecLib.inf
     SecTargetLib|SecPkg/Library/SecTargetLib/chipsets/Palawan/SecTargetLib.inf
     DbgInfoLib|SecPkg/Library/dbginfolib/build/DbgInfoLib.inf
     ACLib|SecPkg/Library/ACLib/ACLib.inf
     ACConfigDataLib|SecPkg/Library/ACConfigDataLib/palawan/ACConfigDataLib.inf
     ...
     SmemImageLib|QcomPkg/SocPkg/Palawan/Library/SmemImageLib/SmemImageLib.inf
