...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Palawan$(VAR)/JtagProgrammer
...
[Components.common]
  QcomPkg/Library/JtagProgrammerLib/JtagProgrammer.inf {
	  ...
	  SdccTargetLib|QcomPkg/SocPkg/Palawan/Library/SdccTargetLib/SdccJtagTargetLib.inf
	  ...
	  UsbSharedLib|QcomPkg/SocPkg/Palawan/Library/UsbSharedLib/UsbSharedLibCore.inf
