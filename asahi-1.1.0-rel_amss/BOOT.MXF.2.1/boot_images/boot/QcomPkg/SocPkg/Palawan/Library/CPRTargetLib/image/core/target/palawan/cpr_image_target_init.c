 ...
 * $Header: //components/dev/core.boot/6.1/cvelempa.core.boot.6.1.Lanai_XBL_CPR_Changes_07_04_2022/QcomPkg/SocPkg/lanai/Library/CPRTargetLib/image/core/target/lanai/cpr_image_target_init.c#1 $
 * $Change: 38231469 $
 */
#include <string.h>
#include "cpr_logs.h"
...
static cpr_cfg_funcs* init_open_loop(cpr_rail* rail)
{
   ...
   //updating aging data in smem structures
    cpr_smem_update_misc_data(rail->id);
