#ifndef HALHWIOTSENS_H
#define HALHWIOTSENS_H
/*
===========================================================================
*/
/**
...
#define HWIO_TSENS_CTRL_RMSK                                                       0xffffffff
...
#define HWIO_TSENS_CTRL_PSHOLD_ARES_MODE_LEVEL_BMSK                                0x80000000
#define HWIO_TSENS_CTRL_PSHOLD_ARES_MODE_LEVEL_SHFT                                        31
#define HWIO_TSENS_CTRL_PSHOLD_ARES_MODE_LEVEL_LEVEL_FVAL                                 0x0
#define HWIO_TSENS_CTRL_PSHOLD_ARES_MODE_LEVEL_PULSE_FVAL                                 0x1
#define HWIO_TSENS_CTRL_INTER_SENSOR_DELAY_EN_BMSK                                 0x40000000
#define HWIO_TSENS_CTRL_INTER_SENSOR_DELAY_EN_SHFT                                         30
...
#define HWIO_TSENS_0C_CTRL_ADDR(x)                                                 ((x) + 0x18)
...
#define HWIO_TSENS_0C_CTRL_TSENS_0C_SENSOR_EN_SHFT                                          1
#define HWIO_TSENS_0C_CTRL_TSENS_0C_INTERRUPT_EN_BMSK                                     0x1
#define HWIO_TSENS_0C_CTRL_TSENS_0C_INTERRUPT_EN_SHFT                                       0

#define HWIO_TSENS_0C_THRESHOLDS_ADDR(x)                                           ((x) + 0x1c)
...
#define HWIO_TSENS_0C_THRESHOLDS_THRESHOLD_SET_SHFT                                        12
#define HWIO_TSENS_0C_THRESHOLDS_THRESHOLD_RESET_BMSK                                   0xfff
#define HWIO_TSENS_0C_THRESHOLDS_THRESHOLD_RESET_SHFT                                       0
...
#define HWIO_TSENS_WATCHDOG_CTRL_ADDR(x)                                           ((x) + 0x140)
...
#define HWIO_TSENS_SERVER_CFG_ADDR(x)                                              ((x) + 0x144)
...
#define HWIO_TSENS_SERVER_CFG_SLP_CLK_XO_DIV_COUNT_SHFT                                     0

#define HWIO_TSENS_RESERVED_REG_ADDR(x)                                            ((x) + 0x148)
...
#define HWIO_TSENS_RESERVED_REG_RSRVED_REG_1_SHFT                                          16
#define HWIO_TSENS_RESERVED_REG_RSRVED_REG_0_BMSK                                      0xffff
#define HWIO_TSENS_RESERVED_REG_RSRVED_REG_0_SHFT                                           0

/*----------------------------------------------------------------------------
 * MODULE: TSENS0_TM
 *--------------------------------------------------------------------------*/

#define TSENS0_TM_REG_BASE                                                           (AOSS_BASE      + 0x01228000)
...
#define HWIO_TSENS_0C_INT_STATUS_ADDR(x)                                             ((x) + 0xe0)
...
#define HWIO_TSENS_0C_INT_STATUS_INT_STATUS_SHFT                                              0
...
#define HWIO_TSENS_MAX_TEMP_ADDR(x)                                                  ((x) + 0xe8)
...
#define HWIO_TSENS_MAX_TEMP_MAX_TEMP_VALID_SHFT                                              16
...
#define HWIO_TSENS_MIN_TEMP_ADDR(x)                                                  ((x) + 0xec)
...
#define HWIO_TSENS_MIN_TEMP_MIN_TEMP_VALID_SHFT                                              16
#define HWIO_TSENS_MIN_TEMP_MIN_TEMP_SENSOR_ID_BMSK                                      0xf000
#define HWIO_TSENS_MIN_TEMP_MIN_TEMP_SENSOR_ID_SHFT                                          12
#define HWIO_TSENS_MIN_TEMP_MIN_TEMP_BMSK                                                 0xfff
#define HWIO_TSENS_MIN_TEMP_MIN_TEMP_SHFT                                                     0
...
#define HWIO_TSENS_DEBUG_CONTROL_TSENS_DEBUG_BUS_ID_SHFT                                      7
#define HWIO_TSENS_DEBUG_CONTROL_TSENS_HBRG_SLV_DEBUG_BUS_EN_BMSK                          0x40
#define HWIO_TSENS_DEBUG_CONTROL_TSENS_HBRG_SLV_DEBUG_BUS_EN_SHFT                             6
...
#define HWIO_TSENS_DEBUG_CONTROL_TSENS_HBRG_MSTR_DEBUG_BUS_EN_SHFT                            5
...
#define HWIO_TSENS_QDSS_CONTROL_ADDR(x)                                              ((x) + 0x138)
...
#define HWIO_TSENS_QDSS_CONTROL_QDSS_SENSOR_EN_SHFT                                           0

#define HWIO_TSENS_WATCHDOG_LOG_ADDR(x)                                              ((x) + 0x13c)
