...
//============================================================================
/**
  Copyright (c) 2015-2018,2023 Qualcomm Technologies, Inc. All rights reserved.
  ...
  UINTN              QscratchBase)
{
 ...
 /*
  ...
  if (CoreNum == USB_CORE_0) { //For Primary Core
   ...
   //1.    Software updates HS_PHY_CTRL.UTMI_OTG_VBUS_VALID. 
    HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_OUTM(HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_UTMI_OTG_VBUS_VALID_BMSK, (0x1 << HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_UTMI_OTG_VBUS_VALID_SHFT));
    
    //2.    Software updates HS_PHY_CTRL.SW_SESSVLD_SEL to 1 indicating that the value is driven by UTMI_OTG_VBUS_VALID.
    HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_OUTM(HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_SW_SESSVLD_SEL_BMSK, (0x1 << HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_SW_SESSVLD_SEL_SHFT));
    
    //3.    Software set lane0_power_present
    HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMSS_PHY_CTRL_OUTM(HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMSS_PHY_CTRL_LANE0_PWR_PRESENT_BMSK, (0x1 << HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMSS_PHY_CTRL_LANE0_PWR_PRESENT_SHFT)); 
  }
  #endif
}
  ...
  UINTN              QscratchBase)
{
  ...
  *Reference USB 3.0 HPG (Oct, 2014)
  ...
  if (CoreNum == USB_CORE_0) {//For Primary Core
   ...
   //1.    Software updates HS_PHY_CTRL.UTMI_OTG_VBUS_VALID. 
    HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_OUTM(HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_UTMI_OTG_VBUS_VALID_BMSK, (0x0 << HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_UTMI_OTG_VBUS_VALID_SHFT));
    
    //2.    Software updates HS_PHY_CTRL.SW_SESSVLD_SEL to 1 indicating that the value is driven by UTMI_OTG_VBUS_VALID.
    HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_OUTM(HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_SW_SESSVLD_SEL_BMSK, (0x0 << HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMHS_PHY_CTRL_SW_SESSVLD_SEL_SHFT));
    
    //3.    Software set lane0_power_present
    HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMSS_PHY_CTRL_OUTM(HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMSS_PHY_CTRL_LANE0_PWR_PRESENT_BMSK, (0x0 << HWIO_USB4_SS_USB3_DRD_SP_1USB31_PRIMSS_PHY_CTRL_LANE0_PWR_PRESENT_SHFT)); 
  }
  #endif
}
