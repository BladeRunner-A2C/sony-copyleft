...
Copyright (c) 2016-2017, 2023 QUALCOMM Technologies, Inc. (QTI). All Rights Reserved.
...
typedef enum
{
  ...
  TCS_UEFI_SW_SLEEP = 3,   //AMC_END, SLEEP_TCS_START
  TCS_UEFI_SW_WAKE  = 5,   //WAKE_TCS_START
  TCS_UEFI_SW_MAX   = 7    //WAKE_TCS_END
