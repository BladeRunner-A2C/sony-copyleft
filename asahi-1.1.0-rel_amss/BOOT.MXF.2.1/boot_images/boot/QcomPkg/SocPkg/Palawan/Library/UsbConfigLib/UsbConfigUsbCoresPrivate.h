/** @file \UsbConfigUsbCoresPrivate.h
  ...
  Copyright (c) 2016-2017,2023 Qualcomm Technologies, Inc. All rights reserved.
...
#define HWIO_HS2_ROM_STRING_START_OFFS           (0x00010008)
...
#define CORE_DEFAULT_PHY                          0
#define CORE_SEC_PHY                              1
