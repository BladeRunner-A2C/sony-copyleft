...
static MDPPlatformHardwareConfig sHwConfig[] =
{
  ...
  MDP_PLATFORM_CREATE_PANEL_HW_CONFIG_POWER(Panel_LCD_PowerUp, Panel_LCD_PowerDown),                             /* HW_CONFIG_DEFAULT_LCD_POWER */
};
...
static PhysicalPanelConfigType sPhysicalPanelConfigTable[] =
{
  ...
  {"vtdr6130_144hz_fhd_dsc_vid",        "Panel_vtdr6130_144hz_fhd_plus_dsc_vid.xml",              "qcom,mdss_dsi_vtdr6130_fhd_plus_vid:config0:timing0:",        &sModeConfig[MDP_MODE_SINGLEDSI0], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2]},
  ...
  {"vtdr6130_60hz_fhd_dsc_vid",         "Panel_vtdr6130_60hz_fhd_plus_dsc_vid.xml",               "qcom,mdss_dsi_vtdr6130_fhd_plus_vid:config3:timing3:",        &sModeConfig[MDP_MODE_SINGLEDSI0], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2]},
  {"sharp_qhd_plus_dsc_cmd",            "Panel_sharp_120hz_qhd_plus_dsc_cmd.xml",                 "qcom,mdss_dsi_sharp_qhd_plus_dsc_cmd:",                       &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_LCD_POWER]},
  {"sharp_qhd_plus_dsc_vid",            "Panel_sharp_120hz_qhd_plus_dsc_vid.xml",                 "qcom,mdss_dsi_sharp_qhd_plus_dsc_video:",                     &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_LCD_POWER]},
  ...
  {"vtdr6130_120hz_fhd_dsc_vid",        "Panel_vtdr6130_120hz_fhd_plus_dsc_vid.xml",              "qcom,mdss_dsi_vtdr6130_fhd_plus_120hz_vid:config0:timing0:",  &sModeConfig[MDP_MODE_SINGLEDSI0], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2]},
  ...
  {"sec_vtdr6130_60hz_dsc_vid",         "Panel_secondary_vtdr6130_60hz_fhd_plus_dsc_vid.xml",     "qcom,mdss_dsi_vtdr6130_fhd_plus_60hz_vid:config1:timing0:",   &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2_SEC_GPIO]},
  {"sec_vtdr6130_60hz_dsc_cmd",         "Panel_secondary_vtdr6130_60hz_fhd_plus_dsc_cmd.xml",     "qcom,mdss_dsi_vtdr6130_fhd_plus_60hz_cmd:config1:timing0:",   &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2_SEC_GPIO]},
  {"sec_vtdr6130_120hz_dsc_cmd",        "Panel_secondary_vtdr6130_120hz_fhd_plus_dsc_cmd.xml",    "qcom,mdss_dsi_vtdr6130_fhd_plus_120hz_cmd:config1:timing0:",  &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2_SEC_GPIO]},
  {"sec_vtdr6130_120hz_dsc_vid",        "Panel_secondary_vtdr6130_120hz_fhd_plus_dsc_vid.xml",    "qcom,mdss_dsi_vtdr6130_fhd_plus_120hz_vid:config1:timing0:",  &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT_BRIGHT_V2_SEC_GPIO]},
};
                                                    ...
                                                    MDPPlatformInfo      *pMDPPlatformInfo)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        if ((0x10000 == pPlatformInfo->sEFIPlatformType.version)  && 
            ((0x3     == pPlatformInfo->sEFIPlatformType.subtype) || 
             (0x4     == pPlatformInfo->sEFIPlatformType.subtype)))
        {
      ...
      {
        if ((0x10000 == pPlatformInfo->sEFIPlatformType.version)  && 
            ((0x0     == pPlatformInfo->sEFIPlatformType.subtype) || 
             (0x2     == pPlatformInfo->sEFIPlatformType.subtype)))
        {
          MDPPlatformSetPanelName(pPlatformPanel->szName, "vtdr6130_144hz_fhd_dsc_cmd");
          break;
        }
        else if ((0x10000 == pPlatformInfo->sEFIPlatformType.version)  && 
                 ((0x1     == pPlatformInfo->sEFIPlatformType.subtype) ||
                  (0x3     == pPlatformInfo->sEFIPlatformType.subtype)))
        {
