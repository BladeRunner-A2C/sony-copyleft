#ifndef RSC_HAL_HWIO_H
#define RSC_HAL_HWIO_H
/*
===========================================================================
*/
/**
    ...
    Reference chip release:
        Palawan [palawan_v1.0_p3q2r47_rtl_partition_F04]
...
#include "msmhwiobase.h"
/*----------------------------------------------------------------------------
 * Manually edited section KAILUA_TODO
 *--------------------------------------------------------------------------*/
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_READ_RESPONSE_DATA_ADDR(base,m,n)                                          ((base) + 0x00000d44 + 0x2A0 * (m) + 0x18 * (n))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_READ_RESPONSE_DATA_PHYS(base,m,n)                                          ((base) + 0x00000d44 + 0x2A0 * (m) + 0x18 * (n))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_READ_RESPONSE_DATA_OFFS(base,m,n)                                          (0x00000d44 + 0x2A0 * (m) + 0x18 * (n))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_READ_RESPONSE_DATA_ADDR(base,m,n)                                          ((base) + 0x00010d44 + 0x2A0 * (m) + 0x18 * (n))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_READ_RESPONSE_DATA_PHYS(base,m,n)                                          ((base) + 0x00010d44 + 0x2A0 * (m) + 0x18 * (n))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_READ_RESPONSE_DATA_OFFS(base,m,n)                                          (0x00010d44 + 0x2A0 * (m) + 0x18 * (n))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_READ_RESPONSE_DATA_ADDR(base,m,n)                                          ((base) + 0x00020d44 + 0x2A0 * (m) + 0x18 * (n))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_READ_RESPONSE_DATA_PHYS(base,m,n)                                          ((base) + 0x00020d44 + 0x2A0 * (m) + 0x18 * (n))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_READ_RESPONSE_DATA_OFFS(base,m,n)                                          (0x00020d44 + 0x2A0 * (m) + 0x18 * (n))
...
#define APSS_RSC_RSCC_RSCC_RSC_REG_BASE_PHYS                                                                         (APSS_HM_BASE_PHYS + 0x00a00000)
#define APSS_RSC_RSCC_RSCC_RSC_REG_BASE_OFFS                                                                         0x00a00000

#define HWIO_APSS_RSC_RSCC_RSC_ID_DRVd_ADDR(base,d)                                                                  ((base) + 0X0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ID_DRVd_PHYS(base,d)                                                                  ((base) + 0X0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ID_DRVd_OFFS(d)                                                                       (0X0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ID_DRVd_RMSK                                                                            0xffffff
#define HWIO_APSS_RSC_RSCC_RSC_ID_DRVd_MAXd                                                                                   3
#define HWIO_APSS_RSC_RSCC_RSC_ID_DRVd_POR                                                                           0x00030200
...
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_SOLVER_CONFIG_DRVd_ADDR(base,d)                                                 ((base) + 0X4 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_SOLVER_CONFIG_DRVd_PHYS(base,d)                                                 ((base) + 0X4 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_SOLVER_CONFIG_DRVd_OFFS(d)                                                      (0X4 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_SOLVER_CONFIG_DRVd_POR                                                          0x04010100
...
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_SOLVER_CONFIG_DRVd_SEQ_EXTENDED_SIMPLE_FVAL                                            0x0
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_SOLVER_CONFIG_DRVd_SEQ_EXTENDED_EXTENDED_FVAL                                          0x1
...
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_RSC_CONFIG_DRVd_ADDR(base,d)                                                    ((base) + 0X8 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_RSC_CONFIG_DRVd_PHYS(base,d)                                                    ((base) + 0X8 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_RSC_CONFIG_DRVd_OFFS(d)                                                         (0X8 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_RSC_CONFIG_DRVd_POR                                                             0x04800414
...
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_RSC_PARENTCHILD_CONFIG_DRVd_ADDR(base,d)                                        ((base) + 0XC + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_RSC_PARENTCHILD_CONFIG_DRVd_PHYS(base,d)                                        ((base) + 0XC + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_RSC_PARENTCHILD_CONFIG_DRVd_OFFS(d)                                             (0XC + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_PARAM_RSC_PARENTCHILD_CONFIG_DRVd_POR                                                 0x800c8104
...
#define HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_ADDR(base,d)                                                             ((base) + 0X10 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_PHYS(base,d)                                                             ((base) + 0X10 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_OFFS(d)                                                                  (0X10 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_ATTR                                                                                  0x3
...
#define HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_OUTI(base,d,val)        \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_ADDR(base,d),val)
#define HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_OUTMI(base,d,mask,val) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_ADDR(base,d),mask,val,HWIO_APSS_RSC_RSCC_RSC_STATUS0_DRVd_INI(base,d))
...
#define HWIO_APSS_RSC_RSCC_RSC_STATUS1_DRVd_ADDR(base,d)                                                             ((base) + 0X14 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_STATUS1_DRVd_PHYS(base,d)                                                             ((base) + 0X14 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_STATUS1_DRVd_OFFS(d)                                                                  (0X14 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_STATUS2_DRVd_ADDR(base,d)                                                             ((base) + 0X18 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_STATUS2_DRVd_PHYS(base,d)                                                             ((base) + 0X18 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_STATUS2_DRVd_OFFS(d)                                                                  (0X18 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CTRL_DRV0_ADDR(x)                                                              ((x) + 0x1c)
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CTRL_DRV0_PHYS(x)                                                              ((x) + 0x1c)
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CTRL_DRV0_OFFS                                                                 (0x1c)
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CTRL_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CTRL_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_PDC_SEQ_START_ADDR_REG_OFFSET_DRV0_ADDR(x)                                                ((x) + 0x20)
#define HWIO_APSS_RSC_RSCC_PDC_SEQ_START_ADDR_REG_OFFSET_DRV0_PHYS(x)                                                ((x) + 0x20)
#define HWIO_APSS_RSC_RSCC_PDC_SEQ_START_ADDR_REG_OFFSET_DRV0_OFFS                                                   (0x20)
...
#define HWIO_APSS_RSC_RSCC_PDC_SEQ_START_ADDR_REG_OFFSET_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_PDC_SEQ_START_ADDR_REG_OFFSET_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_LO_REG_OFFSET_DRV0_ADDR(x)                                                ((x) + 0x24)
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_LO_REG_OFFSET_DRV0_PHYS(x)                                                ((x) + 0x24)
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_LO_REG_OFFSET_DRV0_OFFS                                                   (0x24)
...
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_LO_REG_OFFSET_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_LO_REG_OFFSET_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_HI_REG_OFFSET_DRV0_ADDR(x)                                                ((x) + 0x28)
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_HI_REG_OFFSET_DRV0_PHYS(x)                                                ((x) + 0x28)
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_HI_REG_OFFSET_DRV0_OFFS                                                   (0x28)
...
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_HI_REG_OFFSET_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_HI_REG_OFFSET_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_PDC_SLAVE_ID_DRV0_ADDR(x)                                                                 ((x) + 0x2c)
#define HWIO_APSS_RSC_RSCC_PDC_SLAVE_ID_DRV0_PHYS(x)                                                                 ((x) + 0x2c)
#define HWIO_APSS_RSC_RSCC_PDC_SLAVE_ID_DRV0_OFFS                                                                    (0x2c)
...
#define HWIO_APSS_RSC_RSCC_PDC_SLAVE_ID_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_PDC_SLAVE_ID_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_STATUS_DRVd_ADDR(base,d)                                                       ((base) + 0X30 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_STATUS_DRVd_PHYS(base,d)                                                       ((base) + 0X30 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_STATUS_DRVd_OFFS(d)                                                            (0X30 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD0_ADDR_DRVd_ADDR(base,d)                                                    ((base) + 0X34 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD0_ADDR_DRVd_PHYS(base,d)                                                    ((base) + 0X34 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD0_ADDR_DRVd_OFFS(d)                                                         (0X34 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD0_ADDR_DRVd_POR                                                             0x82204514
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD0_DATA_DRVd_ADDR(base,d)                                                    ((base) + 0X38 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD0_DATA_DRVd_PHYS(base,d)                                                    ((base) + 0X38 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD0_DATA_DRVd_OFFS(d)                                                         (0X38 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD1_ADDR_DRVd_ADDR(base,d)                                                    ((base) + 0X3C + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD1_ADDR_DRVd_PHYS(base,d)                                                    ((base) + 0X3C + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD1_ADDR_DRVd_OFFS(d)                                                         (0X3C + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD1_ADDR_DRVd_POR                                                             0x82204510
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD1_DATA_DRVd_ADDR(base,d)                                                    ((base) + 0X40 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD1_DATA_DRVd_PHYS(base,d)                                                    ((base) + 0X40 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD1_DATA_DRVd_OFFS(d)                                                         (0X40 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_ADDR_DRVd_ADDR(base,d)                                                    ((base) + 0X44 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_ADDR_DRVd_PHYS(base,d)                                                    ((base) + 0X44 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_ADDR_DRVd_OFFS(d)                                                         (0X44 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_ADDR_DRVd_POR                                                             0x82204520
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_DATA_DRV0_ADDR(x)                                                         ((x) + 0x48)
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_DATA_DRV0_PHYS(x)                                                         ((x) + 0x48)
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_DATA_DRV0_OFFS                                                            (0x48)
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_DATA_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_DATA_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_HW_EVENT_OWNER_DRV0_ADDR(x)                                                               ((x) + 0x4c)
#define HWIO_APSS_RSC_RSCC_HW_EVENT_OWNER_DRV0_PHYS(x)                                                               ((x) + 0x4c)
#define HWIO_APSS_RSC_RSCC_HW_EVENT_OWNER_DRV0_OFFS                                                                  (0x4c)
...
#define HWIO_APSS_RSC_RSCC_HW_EVENT_OWNER_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_HW_EVENT_OWNER_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_HW_EVENT_MUXm_SELECT_DRVd_ADDR(base,d,m)                                                  ((base) + 0X50 + (0x10000*(d)) + (0x4*(m)))
#define HWIO_APSS_RSC_RSCC_HW_EVENT_MUXm_SELECT_DRVd_PHYS(base,d,m)                                                  ((base) + 0X50 + (0x10000*(d)) + (0x4*(m)))
#define HWIO_APSS_RSC_RSCC_HW_EVENT_MUXm_SELECT_DRVd_OFFS(d,m)                                                       (0X50 + (0x10000*(d)) + (0x4*(m)))
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_STATUS_DRV0_ADDR(x)                                                         ((x) + 0xd0)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_STATUS_DRV0_PHYS(x)                                                         ((x) + 0xd0)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_STATUS_DRV0_OFFS                                                            (0xd0)
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_STATUS_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_STATUS_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_CLEAR_DRV0_ADDR(x)                                                          ((x) + 0xd4)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_CLEAR_DRV0_PHYS(x)                                                          ((x) + 0xd4)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_CLEAR_DRV0_OFFS                                                             (0xd4)
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_CLEAR_DRV0_ATTR                                                                          0x2
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_ENABLE_DRV0_ADDR(x)                                                         ((x) + 0xd8)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_ENABLE_DRV0_PHYS(x)                                                         ((x) + 0xd8)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_ENABLE_DRV0_OFFS                                                            (0xd8)
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_ENABLE_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_ENABLE_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_ADDR(x)                                                          ((x) + 0x100)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_PHYS(x)                                                          ((x) + 0x100)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_OFFS                                                             (0x100)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_RMSK                                                                    0x1
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_POR                                                              0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_POR_RMSK                                                         0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_ATTR                                                                          0x3
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRV0_IN(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_ADDR(x)                                                          ((x) + 0x104)
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_PHYS(x)                                                          ((x) + 0x104)
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_OFFS                                                             (0x104)
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_RMSK                                                                    0x1
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_POR                                                              0x00000001
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_POR_RMSK                                                         0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_ATTR                                                                          0x3
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_RSC_SECURE_OVERRIDE_DRV0_IN(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_ADDR(x)                                                  ((x) + 0x108)
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_PHYS(x)                                                  ((x) + 0x108)
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_OFFS                                                     (0x108)
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_RMSK                                                            0x1
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_POR                                                      0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_POR_RMSK                                                 0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_ATTR                                                                  0x3
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRV0_IN(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_ADDR(x)                                                   ((x) + 0x10c)
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_PHYS(x)                                                   ((x) + 0x10c)
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_OFFS                                                      (0x10c)
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_RMSK                                                             0x1
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_POR                                                       0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_POR_RMSK                                                  0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_ATTR                                                                   0x2
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_PROFILING_REG_SW_RESET_DRV0_ADDR(x),v)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_ADDR(x)                                                           ((x) + 0x110)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_PHYS(x)                                                           ((x) + 0x110)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_OFFS                                                              (0x110)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_RMSK                                                                     0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_POR                                                               0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_POR_RMSK                                                          0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_ATTR                                                                           0x3
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_IN(x))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_EN_BMSK                                                                  0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_EN_DRV0_EN_SHFT                                                                    0

#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_ADDR(x)                                                       ((x) + 0x114)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_PHYS(x)                                                       ((x) + 0x114)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_OFFS                                                          (0x114)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_RMSK                                                                 0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_POR                                                           0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_POR_RMSK                                                      0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_ATTR                                                                       0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_STATUS_DRV0_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_ADDR(x)                                                          ((x) + 0x118)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_PHYS(x)                                                          ((x) + 0x118)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_OFFS                                                             (0x118)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_RMSK                                                                    0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_POR                                                              0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_POR_RMSK                                                         0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_ATTR                                                                          0x2
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_TIMEOUT_CLR_DRV0_ADDR(x),v)
...
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_ADDR(x)                                                      ((x) + 0x11c)
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_PHYS(x)                                                      ((x) + 0x11c)
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_OFFS                                                         (0x11c)
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_RMSK                                                         0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_POR                                                          0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_POR_RMSK                                                     0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_ATTR                                                                      0x3
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_RSC_PROFILING_THRESHOLD_DRV0_IN(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNIT_OWNER_DRV0_ADDR(x)                                                     ((x) + 0x200)
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNIT_OWNER_DRV0_PHYS(x)                                                     ((x) + 0x200)
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNIT_OWNER_DRV0_OFFS                                                        (0x200)
...
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNIT_OWNER_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNIT_OWNER_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_EN_DRVd_ADDR(base,d,m)                                                ((base) + 0X204 + (0x10000*(d)) + (0x20*(m)))
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_EN_DRVd_PHYS(base,d,m)                                                ((base) + 0X204 + (0x10000*(d)) + (0x20*(m)))
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_EN_DRVd_OFFS(d,m)                                                     (0X204 + (0x10000*(d)) + (0x20*(m)))
...
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_TIMESTAMP_L_DRVd_ADDR(base,d,m)                                       ((base) + 0X208 + (0x10000*(d)) + (0x20*(m)))
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_TIMESTAMP_L_DRVd_PHYS(base,d,m)                                       ((base) + 0X208 + (0x10000*(d)) + (0x20*(m)))
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_TIMESTAMP_L_DRVd_OFFS(d,m)                                            (0X208 + (0x10000*(d)) + (0x20*(m)))
...
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_TIMESTAMP_H_DRVd_ADDR(base,d,m)                                       ((base) + 0X20C + (0x10000*(d)) + (0x20*(m)))
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_TIMESTAMP_H_DRVd_PHYS(base,d,m)                                       ((base) + 0X20C + (0x10000*(d)) + (0x20*(m)))
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_TIMESTAMP_H_DRVd_OFFS(d,m)                                            (0X20C + (0x10000*(d)) + (0x20*(m)))
...
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_OUTPUT_DRVd_ADDR(base,d,m)                                            ((base) + 0X210 + (0x10000*(d)) + (0x20*(m)))
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_OUTPUT_DRVd_PHYS(base,d,m)                                            ((base) + 0X210 + (0x10000*(d)) + (0x20*(m)))
#define HWIO_APSS_RSC_RSCC_RSC_TIMESTAMP_UNITm_OUTPUT_DRVd_OFFS(d,m)                                                 (0X210 + (0x10000*(d)) + (0x20*(m)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_START_ADDR_DRV0_ADDR(x)                                                  ((x) + 0x400)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_START_ADDR_DRV0_PHYS(x)                                                  ((x) + 0x400)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_START_ADDR_DRV0_OFFS                                                     (0x400)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_START_ADDR_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_START_ADDR_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BUSY_DRV0_ADDR(x)                                                                 ((x) + 0x404)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BUSY_DRV0_PHYS(x)                                                                 ((x) + 0x404)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BUSY_DRV0_OFFS                                                                    (0x404)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BUSY_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_BUSY_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_DRV0_ADDR(x)                                                      ((x) + 0x408)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_DRV0_PHYS(x)                                                      ((x) + 0x408)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_DRV0_OFFS                                                         (0x408)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_ADDR(x)                                            ((x) + 0x40c)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_PHYS(x)                                            ((x) + 0x40c)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_OFFS                                               (0x40c)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_RMSK                                                    0x3ff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_POR                                                0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_POR_RMSK                                           0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_ATTR                                                            0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_PROFILING_DRV0_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_ADDR(x)                                                                 ((x) + 0x410)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_PHYS(x)                                                                 ((x) + 0x410)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_OFFS                                                                    (0x410)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_RMSK                                                                    0x80000001
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_POR                                                                     0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_POR_RMSK                                                                0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_ATTR                                                                                 0x3
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_RSC_SEQ_COMP_DRV0_IN(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_DELAY_VAL_i_DRV0_ADDR(base,i)                                                 ((base) + 0X450 + (0x4*(i)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_DELAY_VAL_i_DRV0_PHYS(base,i)                                                 ((base) + 0X450 + (0x4*(i)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_DELAY_VAL_i_DRV0_OFFS(i)                                                      (0X450 + (0x4*(i)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_DRV0_ADDR(x)                                                     ((x) + 0x460)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_DRV0_PHYS(x)                                                     ((x) + 0x460)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_DRV0_OFFS                                                        (0x460)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_START_ADDRESS_DRV0_ADDR(x)                                       ((x) + 0x464)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_START_ADDRESS_DRV0_PHYS(x)                                       ((x) + 0x464)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_START_ADDRESS_DRV0_OFFS                                          (0x464)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_START_ADDRESS_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_START_ADDRESS_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_BREAKPOINT_ADDR_DRV0_ADDR(x)                                                  ((x) + 0x490)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_BREAKPOINT_ADDR_DRV0_PHYS(x)                                                  ((x) + 0x490)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_BREAKPOINT_ADDR_DRV0_OFFS                                                     (0x490)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_BREAKPOINT_ADDR_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_BREAKPOINT_ADDR_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STEP_DRV0_ADDR(x)                                                             ((x) + 0x494)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STEP_DRV0_PHYS(x)                                                             ((x) + 0x494)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STEP_DRV0_OFFS                                                                (0x494)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STEP_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STEP_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_CONTINUE_DRV0_ADDR(x)                                                         ((x) + 0x498)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_CONTINUE_DRV0_PHYS(x)                                                         ((x) + 0x498)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_CONTINUE_DRV0_OFFS                                                            (0x498)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_CONTINUE_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_CONTINUE_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STAT_DRV0_ADDR(x)                                                             ((x) + 0x49c)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STAT_DRV0_PHYS(x)                                                             ((x) + 0x49c)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STAT_DRV0_OFFS                                                                (0x49c)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STAT_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_DBG_STAT_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_MASK_DRV0_ADDR(x)                                              ((x) + 0x4a0)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_MASK_DRV0_PHYS(x)                                              ((x) + 0x4a0)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_MASK_DRV0_OFFS                                                 (0x4a0)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_MASK_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_MASK_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_VAL_DRV0_ADDR(x)                                               ((x) + 0x4a4)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_VAL_DRV0_PHYS(x)                                               ((x) + 0x4a4)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_VAL_DRV0_OFFS                                                  (0x4a4)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_VAL_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_VAL_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_MASK_DRV0_ADDR(x)                                             ((x) + 0x4a8)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_MASK_DRV0_PHYS(x)                                             ((x) + 0x4a8)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_MASK_DRV0_OFFS                                                (0x4a8)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_MASK_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_MASK_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_VAL_DRV0_ADDR(x)                                              ((x) + 0x4ac)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_VAL_DRV0_PHYS(x)                                              ((x) + 0x4ac)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_VAL_DRV0_OFFS                                                 (0x4ac)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_VAL_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_VAL_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_ADDR(x)                                                      ((x) + 0x4b0)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_PHYS(x)                                                      ((x) + 0x4b0)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_OFFS                                                         (0x4b0)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_RMSK                                                         0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_POR                                                          0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_POR_RMSK                                                     0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_ATTR                                                                      0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRV0_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_ADDR(x)                                                     ((x) + 0x4b4)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_PHYS(x)                                                     ((x) + 0x4b4)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_OFFS                                                        (0x4b4)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_RMSK                                                        0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_POR                                                         0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_POR_RMSK                                                    0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_ATTR                                                                     0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRV0_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_ADDR(x)                                                      ((x) + 0x4b8)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_PHYS(x)                                                      ((x) + 0x4b8)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_OFFS                                                         (0x4b8)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_RMSK                                                         0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_POR                                                          0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_POR_RMSK                                                     0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_ATTR                                                                      0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRV0_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_BR_ADDR_i_DRV0_ADDR(base,i)                                                   ((base) + 0X4BC + (0x4*(i)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_BR_ADDR_i_DRV0_PHYS(base,i)                                                   ((base) + 0X4BC + (0x4*(i)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_BR_ADDR_i_DRV0_OFFS(i)                                                        (0X4BC + (0x4*(i)))
...
#define HWIO_APSS_RSC_RSCC_SEQ_MEM_m_DRV0_ADDR(base,m)                                                               ((base) + 0X550 + (0x4*(m)))
#define HWIO_APSS_RSC_RSCC_SEQ_MEM_m_DRV0_PHYS(base,m)                                                               ((base) + 0X550 + (0x4*(m)))
#define HWIO_APSS_RSC_RSCC_SEQ_MEM_m_DRV0_OFFS(m)                                                                    (0X550 + (0x4*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV0_ADDR(x)                                                      ((x) + 0xd00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV0_PHYS(x)                                                      ((x) + 0xd00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV0_OFFS                                                         (0xd00)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV0_ADDR(x)                                                      ((x) + 0xd04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV0_PHYS(x)                                                      ((x) + 0xd04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV0_OFFS                                                         (0xd04)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV0_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV0_ADDR(x)                                                       ((x) + 0xd08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV0_PHYS(x)                                                       ((x) + 0xd08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV0_OFFS                                                          (0xd08)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV0_ATTR                                                                       0x2
...
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_ADDR(x)                                                               ((x) + 0xd10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_PHYS(x)                                                               ((x) + 0xd10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_OFFS                                                                  (0xd10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_RMSK                                                                         0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_POR                                                                   0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_POR_RMSK                                                              0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_ATTR                                                                               0x3
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_IN(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_EN_BMSK                                                                      0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV0_EN_SHFT                                                                        0

#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_ADDR(x)                                                              ((x) + 0xd14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_PHYS(x)                                                              ((x) + 0xd14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_OFFS                                                                 (0xd14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_RMSK                                                                        0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_POR                                                                  0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_ATTR                                                                              0x2
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_CLR_BMSK                                                                    0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV0_CLR_SHFT                                                                      0

#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_ADDR(x)                                                           ((x) + 0xd18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_PHYS(x)                                                           ((x) + 0xd18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_OFFS                                                              (0xd18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_RMSK                                                                     0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_POR                                                               0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_POR_RMSK                                                          0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_ATTR                                                                           0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV0_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_ADDR(x)                                                              ((x) + 0xd1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_PHYS(x)                                                              ((x) + 0xd1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_OFFS                                                                 (0xd1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_RMSK                                                                     0xffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_POR                                                                  0x0000ffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_ATTR                                                                              0x3
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV0_IN(x))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CMD_WAIT_FOR_CMPL_ADDR(base,m)                                                  ((base) + 0XD20 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CMD_WAIT_FOR_CMPL_PHYS(base,m)                                                  ((base) + 0XD20 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CMD_WAIT_FOR_CMPL_OFFS(m)                                                       (0XD20 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CONTROL_ADDR(base,m)                                                            ((base) + 0XD24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CONTROL_PHYS(base,m)                                                            ((base) + 0XD24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CONTROL_OFFS(m)                                                                 (0XD24 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_STATUS_ADDR(base,m)                                                             ((base) + 0XD28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_STATUS_PHYS(base,m)                                                             ((base) + 0XD28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_STATUS_OFFS(m)                                                                  (0XD28 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CMD_ENABLE_ADDR(base,m)                                                         ((base) + 0XD2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CMD_ENABLE_PHYS(base,m)                                                         ((base) + 0XD2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_CMD_ENABLE_OFFS(m)                                                              (0XD2C + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_ADDR(base,m)                                                   ((base) + 0XD30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_PHYS(base,m)                                                   ((base) + 0XD30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_OFFS(m)                                                        (0XD30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_RMSK                                                                  0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_MAXm                                                                    3
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_POR                                                            0x00000001
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_POR_RMSK                                                       0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_ATTR                                                                        0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_INI(base,m)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_ADDR(base,m), HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_INMI(base,m,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_ADDR(base,m), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_CONTROLLER_IDLE_NOT_IDLE_FVAL                                         0x0
#define HWIO_APSS_RSC_RSCC_TCSm_DRV0_PROFILING_STATUS_CONTROLLER_IDLE_IS_IDLE_FVAL                                          0x1

#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_MSGID_ADDR(base,m,n)                                                       ((base) + 0XD34 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_MSGID_PHYS(base,m,n)                                                       ((base) + 0XD34 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_MSGID_OFFS(m,n)                                                            (0XD34 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_ADDR_ADDR(base,m,n)                                                        ((base) + 0XD38 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_ADDR_PHYS(base,m,n)                                                        ((base) + 0XD38 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_ADDR_OFFS(m,n)                                                             (0XD38 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_DATA_ADDR(base,m,n)                                                        ((base) + 0XD3C + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_DATA_PHYS(base,m,n)                                                        ((base) + 0XD3C + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_DATA_OFFS(m,n)                                                             (0XD3C + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_STATUS_ADDR(base,m,n)                                                      ((base) + 0XD40 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_STATUS_PHYS(base,m,n)                                                      ((base) + 0XD40 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_STATUS_OFFS(m,n)                                                           (0XD40 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_ADDR(base,n)                                            ((base) + 0XD44 + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_PHYS(base,n)                                            ((base) + 0XD44 + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_OFFS(n)                                                 (0XD44 + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_POR                                                     0x00000000
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_POR_RMSK                                                0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_ATTR                                                                 0x1
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_INI(base,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_ADDR(base,n), HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_RMSK)
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_INMI(base,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV0_READ_RESPONSE_DATA_ADDR(base,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_ADDR(base,m,n)                                            ((base) + 0XD48 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_PHYS(base,m,n)                                            ((base) + 0XD48 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_OFFS(m,n)                                                 (0XD48 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_POR                                                       0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_POR_RMSK                                                  0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_ATTR                                                                   0x1
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_INI2(base,m,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_ADDR(base,m,n), HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_INMI2(base,m,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_ADDR(base,m,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_COMPLETED_HAS_NOT_BEEN_COMPLETE_FVAL                             0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_COMPLETED_HAS_COMPLETED_FVAL                                     0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_ISSUED_HAS_NOT_BEEN_SENT_OVER_EPCB_FVAL                          0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_ISSUED_HAS_BEEN_SENT_OVER_EPCB_FVAL                              0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_TRIGGERED_HAS_NOT_BEEN_TRIGGERE_FVAL                             0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV0_PROFILING_STATUS_TRIGGERED_HAS_BEEN_TRIGGERED_FVAL                                0x1

#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CTRL_DRVd_ADDR(base,d)                                                         ((base) + 0X1C + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CTRL_DRVd_PHYS(base,d)                                                         ((base) + 0X1C + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CTRL_DRVd_OFFS(d)                                                              (0X1C + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_PDC_SEQ_START_ADDR_REG_OFFSET_DRVd_ADDR(base,d)                                           ((base) + 0X20 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_PDC_SEQ_START_ADDR_REG_OFFSET_DRVd_PHYS(base,d)                                           ((base) + 0X20 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_PDC_SEQ_START_ADDR_REG_OFFSET_DRVd_OFFS(d)                                                (0X20 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_LO_REG_OFFSET_DRVd_ADDR(base,d)                                           ((base) + 0X24 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_LO_REG_OFFSET_DRVd_PHYS(base,d)                                           ((base) + 0X24 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_LO_REG_OFFSET_DRVd_OFFS(d)                                                (0X24 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_HI_REG_OFFSET_DRVd_ADDR(base,d)                                           ((base) + 0X28 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_HI_REG_OFFSET_DRVd_PHYS(base,d)                                           ((base) + 0X28 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_PDC_MATCH_VALUE_HI_REG_OFFSET_DRVd_OFFS(d)                                                (0X28 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_PDC_SLAVE_ID_DRVd_ADDR(base,d)                                                            ((base) + 0X2C + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_PDC_SLAVE_ID_DRVd_PHYS(base,d)                                                            ((base) + 0X2C + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_PDC_SLAVE_ID_DRVd_OFFS(d)                                                                 (0X2C + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_DATA_DRVd_ADDR(base,d)                                                    ((base) + 0X48 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_DATA_DRVd_PHYS(base,d)                                                    ((base) + 0X48 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_HIDDEN_TCS_CMD2_DATA_DRVd_OFFS(d)                                                         (0X48 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_STATUS_DRVd_ADDR(base,d)                                                    ((base) + 0XD0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_STATUS_DRVd_PHYS(base,d)                                                    ((base) + 0XD0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_STATUS_DRVd_OFFS(d)                                                         (0XD0 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_ENABLE_DRVd_ADDR(base,d)                                                    ((base) + 0XD8 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_ENABLE_DRVd_PHYS(base,d)                                                    ((base) + 0XD8 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_IRQ_ENABLE_DRVd_OFFS(d)                                                         (0XD8 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_ADDR(base,d)                                                     ((base) + 0X100 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_PHYS(base,d)                                                     ((base) + 0X100 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_OFFS(d)                                                          (0X100 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_RMSK                                                                    0x1
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_MAXd                                                                      3
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_POR                                                              0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_POR_RMSK                                                         0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_ATTR                                                                          0x1
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_INI(base,d)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_ADDR(base,d), HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_RMSK)
#define HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_INMI(base,d,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_ERROR_RESP_CTRL_DRVd_ADDR(base,d), mask)
...
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_ADDR(base,d)                                             ((base) + 0X108 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_PHYS(base,d)                                             ((base) + 0X108 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_OFFS(d)                                                  (0X108 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_POR                                                      0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_POR_RMSK                                                 0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_ATTR                                                                  0x1
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_INI(base,d)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_ADDR(base,d), HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_RMSK)
#define HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_INMI(base,d,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_RIF_CLK_GATING_OVERRIDE_DRVd_ADDR(base,d), mask)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_START_ADDR_DRVd_ADDR(base,d)                                             ((base) + 0X400 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_START_ADDR_DRVd_PHYS(base,d)                                             ((base) + 0X400 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_START_ADDR_DRVd_OFFS(d)                                                  (0X400 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BUSY_DRVd_ADDR(base,d)                                                            ((base) + 0X404 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BUSY_DRVd_PHYS(base,d)                                                            ((base) + 0X404 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BUSY_DRVd_OFFS(d)                                                                 (0X404 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_DRVd_ADDR(base,d)                                                 ((base) + 0X408 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_DRVd_PHYS(base,d)                                                 ((base) + 0X408 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PROGRAM_COUNTER_DRVd_OFFS(d)                                                      (0X408 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_DELAY_VAL_i_DRVd_ADDR(base,d,i)                                               ((base) + 0X450 + (0x10000*(d)) + (0x4*(i)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_DELAY_VAL_i_DRVd_PHYS(base,d,i)                                               ((base) + 0X450 + (0x10000*(d)) + (0x4*(i)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_DELAY_VAL_i_DRVd_OFFS(d,i)                                                    (0X450 + (0x10000*(d)) + (0x4*(i)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_DRVd_ADDR(base,d)                                                ((base) + 0X460 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_DRVd_PHYS(base,d)                                                ((base) + 0X460 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_DRVd_OFFS(d)                                                     (0X460 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_START_ADDRESS_DRVd_ADDR(base,d)                                  ((base) + 0X464 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_START_ADDRESS_DRVd_PHYS(base,d)                                  ((base) + 0X464 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_TRIGGER_START_ADDRESS_DRVd_OFFS(d)                                       (0X464 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_MASK_DRVd_ADDR(base,d)                                         ((base) + 0X4A0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_MASK_DRVd_PHYS(base,d)                                         ((base) + 0X4A0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_MASK_DRVd_OFFS(d)                                              (0X4A0 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_VAL_DRVd_ADDR(base,d)                                          ((base) + 0X4A4 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_VAL_DRVd_PHYS(base,d)                                          ((base) + 0X4A4 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_PWR_CNTRL_VAL_DRVd_OFFS(d)                                               (0X4A4 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_MASK_DRVd_ADDR(base,d)                                        ((base) + 0X4A8 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_MASK_DRVd_PHYS(base,d)                                        ((base) + 0X4A8 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_MASK_DRVd_OFFS(d)                                             (0X4A8 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_VAL_DRVd_ADDR(base,d)                                         ((base) + 0X4AC + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_VAL_DRVd_PHYS(base,d)                                         ((base) + 0X4AC + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_OVERRIDE_WAIT_EVENT_VAL_DRVd_OFFS(d)                                              (0X4AC + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_ADDR(base,d)                                                 ((base) + 0X4B0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_PHYS(base,d)                                                 ((base) + 0X4B0 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_OFFS(d)                                                      (0X4B0 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_POR                                                          0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_POR_RMSK                                                     0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_ATTR                                                                      0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_INI(base,d)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_ADDR(base,d), HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_RMSK)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_INMI(base,d,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_CTRL_STATUS_DRVd_ADDR(base,d), mask)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_ADDR(base,d)                                                ((base) + 0X4B4 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_PHYS(base,d)                                                ((base) + 0X4B4 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_OFFS(d)                                                     (0X4B4 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_POR                                                         0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_POR_RMSK                                                    0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_ATTR                                                                     0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_INI(base,d)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_ADDR(base,d), HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_RMSK)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_INMI(base,d,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_PWR_EVENT_STATUS_DRVd_ADDR(base,d), mask)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_ADDR(base,d)                                                 ((base) + 0X4B8 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_PHYS(base,d)                                                 ((base) + 0X4B8 + (0x10000*(d)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_OFFS(d)                                                      (0X4B8 + (0x10000*(d)))
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_POR                                                          0x00000000
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_POR_RMSK                                                     0xffffffff
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_ATTR                                                                      0x1
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_INI(base,d)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_ADDR(base,d), HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_RMSK)
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_INMI(base,d,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_RSC_SEQ_BR_EVENT_STATUS_DRVd_ADDR(base,d), mask)
...
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_BR_ADDR_i_DRVd_ADDR(base,d,i)                                                 ((base) + 0X4BC + (0x10000*(d)) + (0x4*(i)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_BR_ADDR_i_DRVd_PHYS(base,d,i)                                                 ((base) + 0X4BC + (0x10000*(d)) + (0x4*(i)))
#define HWIO_APSS_RSC_RSCC_RSC_SEQ_CFG_BR_ADDR_i_DRVd_OFFS(d,i)                                                      (0X4BC + (0x10000*(d)) + (0x4*(i)))
...
#define HWIO_APSS_RSC_RSCC_SEQ_MEM_m_DRVd_ADDR(base,d,m)                                                             ((base) + 0X550 + (0x10000*(d)) + (0x4*(m)))
#define HWIO_APSS_RSC_RSCC_SEQ_MEM_m_DRVd_PHYS(base,d,m)                                                             ((base) + 0X550 + (0x10000*(d)) + (0x4*(m)))
#define HWIO_APSS_RSC_RSCC_SEQ_MEM_m_DRVd_OFFS(d,m)                                                                  (0X550 + (0x10000*(d)) + (0x4*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV1_ADDR(x)                                                      ((x) + 0x10d00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV1_PHYS(x)                                                      ((x) + 0x10d00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV1_OFFS                                                         (0x10d00)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV1_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV1_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV1_ADDR(x)                                                      ((x) + 0x10d04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV1_PHYS(x)                                                      ((x) + 0x10d04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV1_OFFS                                                         (0x10d04)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV1_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV1_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV1_ADDR(x)                                                       ((x) + 0x10d08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV1_PHYS(x)                                                       ((x) + 0x10d08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV1_OFFS                                                          (0x10d08)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV1_ATTR                                                                       0x2
...
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_ADDR(x)                                                               ((x) + 0x10d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_PHYS(x)                                                               ((x) + 0x10d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_OFFS                                                                  (0x10d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_RMSK                                                                         0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_POR                                                                   0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_POR_RMSK                                                              0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_ATTR                                                                               0x3
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_IN(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_EN_BMSK                                                                      0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV1_EN_SHFT                                                                        0

#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_ADDR(x)                                                              ((x) + 0x10d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_PHYS(x)                                                              ((x) + 0x10d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_OFFS                                                                 (0x10d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_RMSK                                                                        0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_POR                                                                  0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_ATTR                                                                              0x2
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_CLR_BMSK                                                                    0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV1_CLR_SHFT                                                                      0

#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_ADDR(x)                                                           ((x) + 0x10d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_PHYS(x)                                                           ((x) + 0x10d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_OFFS                                                              (0x10d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_RMSK                                                                     0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_POR                                                               0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_POR_RMSK                                                          0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_ATTR                                                                           0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV1_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_ADDR(x)                                                              ((x) + 0x10d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_PHYS(x)                                                              ((x) + 0x10d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_OFFS                                                                 (0x10d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_RMSK                                                                     0xffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_POR                                                                  0x0000ffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_ATTR                                                                              0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV1_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CMD_WAIT_FOR_CMPL_ADDR(base,m)                                                  ((base) + 0X10D20 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CMD_WAIT_FOR_CMPL_PHYS(base,m)                                                  ((base) + 0X10D20 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CMD_WAIT_FOR_CMPL_OFFS(m)                                                       (0X10D20 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CONTROL_ADDR(base,m)                                                            ((base) + 0X10D24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CONTROL_PHYS(base,m)                                                            ((base) + 0X10D24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CONTROL_OFFS(m)                                                                 (0X10D24 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_STATUS_ADDR(base,m)                                                             ((base) + 0X10D28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_STATUS_PHYS(base,m)                                                             ((base) + 0X10D28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_STATUS_OFFS(m)                                                                  (0X10D28 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CMD_ENABLE_ADDR(base,m)                                                         ((base) + 0X10D2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CMD_ENABLE_PHYS(base,m)                                                         ((base) + 0X10D2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_CMD_ENABLE_OFFS(m)                                                              (0X10D2C + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_ADDR(base,m)                                                   ((base) + 0X10D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_PHYS(base,m)                                                   ((base) + 0X10D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_OFFS(m)                                                        (0X10D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_RMSK                                                                  0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_MAXm                                                                    3
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_POR                                                            0x00000001
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_POR_RMSK                                                       0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_ATTR                                                                        0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_INI(base,m)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_ADDR(base,m), HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_INMI(base,m,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_ADDR(base,m), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_CONTROLLER_IDLE_NOT_IDLE_FVAL                                         0x0
#define HWIO_APSS_RSC_RSCC_TCSm_DRV1_PROFILING_STATUS_CONTROLLER_IDLE_IS_IDLE_FVAL                                          0x1

#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_MSGID_ADDR(base,m,n)                                                       ((base) + 0X10D34 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_MSGID_PHYS(base,m,n)                                                       ((base) + 0X10D34 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_MSGID_OFFS(m,n)                                                            (0X10D34 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_ADDR_ADDR(base,m,n)                                                        ((base) + 0X10D38 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_ADDR_PHYS(base,m,n)                                                        ((base) + 0X10D38 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_ADDR_OFFS(m,n)                                                             (0X10D38 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_DATA_ADDR(base,m,n)                                                        ((base) + 0X10D3C + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_DATA_PHYS(base,m,n)                                                        ((base) + 0X10D3C + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_DATA_OFFS(m,n)                                                             (0X10D3C + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_STATUS_ADDR(base,m,n)                                                      ((base) + 0X10D40 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_STATUS_PHYS(base,m,n)                                                      ((base) + 0X10D40 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_STATUS_OFFS(m,n)                                                           (0X10D40 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_ADDR(base,n)                                            ((base) + 0X10D44 + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_PHYS(base,n)                                            ((base) + 0X10D44 + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_OFFS(n)                                                 (0X10D44 + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_POR                                                     0x00000000
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_POR_RMSK                                                0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_ATTR                                                                 0x1
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_INI(base,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_ADDR(base,n), HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_RMSK)
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_INMI(base,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV1_READ_RESPONSE_DATA_ADDR(base,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_ADDR(base,m,n)                                            ((base) + 0X10D48 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_PHYS(base,m,n)                                            ((base) + 0X10D48 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_OFFS(m,n)                                                 (0X10D48 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_POR                                                       0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_POR_RMSK                                                  0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_ATTR                                                                   0x1
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_INI2(base,m,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_ADDR(base,m,n), HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_INMI2(base,m,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_ADDR(base,m,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_COMPLETED_HAS_NOT_BEEN_COMPLETE_FVAL                             0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_COMPLETED_HAS_COMPLETED_FVAL                                     0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_ISSUED_HAS_NOT_BEEN_SENT_OVER_EPCB_FVAL                          0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_ISSUED_HAS_BEEN_SENT_OVER_EPCB_FVAL                              0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_TRIGGERED_HAS_NOT_BEEN_TRIGGERE_FVAL                             0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV1_PROFILING_STATUS_TRIGGERED_HAS_BEEN_TRIGGERED_FVAL                                0x1

#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV2_ADDR(x)                                                      ((x) + 0x20d00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV2_PHYS(x)                                                      ((x) + 0x20d00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV2_OFFS                                                         (0x20d00)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV2_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV2_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV2_ADDR(x)                                                      ((x) + 0x20d04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV2_PHYS(x)                                                      ((x) + 0x20d04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV2_OFFS                                                         (0x20d04)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV2_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV2_ADDR(x))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV2_ADDR(x)                                                       ((x) + 0x20d08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV2_PHYS(x)                                                       ((x) + 0x20d08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV2_OFFS                                                          (0x20d08)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV2_ATTR                                                                       0x2
...
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_ADDR(x)                                                               ((x) + 0x20d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_PHYS(x)                                                               ((x) + 0x20d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_OFFS                                                                  (0x20d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_RMSK                                                                         0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_POR                                                                   0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_POR_RMSK                                                              0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_ATTR                                                                               0x3
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_IN(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_EN_BMSK                                                                      0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV2_EN_SHFT                                                                        0

#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_ADDR(x)                                                              ((x) + 0x20d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_PHYS(x)                                                              ((x) + 0x20d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_OFFS                                                                 (0x20d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_RMSK                                                                        0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_POR                                                                  0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_ATTR                                                                              0x2
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_CLR_BMSK                                                                    0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV2_CLR_SHFT                                                                      0

#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_ADDR(x)                                                           ((x) + 0x20d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_PHYS(x)                                                           ((x) + 0x20d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_OFFS                                                              (0x20d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_RMSK                                                                     0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_POR                                                               0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_POR_RMSK                                                          0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_ATTR                                                                           0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV2_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_ADDR(x)                                                              ((x) + 0x20d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_PHYS(x)                                                              ((x) + 0x20d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_OFFS                                                                 (0x20d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_RMSK                                                                     0xffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_POR                                                                  0x0000ffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_ATTR                                                                              0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV2_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CMD_WAIT_FOR_CMPL_ADDR(base,m)                                                  ((base) + 0X20D20 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CMD_WAIT_FOR_CMPL_PHYS(base,m)                                                  ((base) + 0X20D20 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CMD_WAIT_FOR_CMPL_OFFS(m)                                                       (0X20D20 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CONTROL_ADDR(base,m)                                                            ((base) + 0X20D24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CONTROL_PHYS(base,m)                                                            ((base) + 0X20D24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CONTROL_OFFS(m)                                                                 (0X20D24 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_STATUS_ADDR(base,m)                                                             ((base) + 0X20D28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_STATUS_PHYS(base,m)                                                             ((base) + 0X20D28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_STATUS_OFFS(m)                                                                  (0X20D28 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CMD_ENABLE_ADDR(base,m)                                                         ((base) + 0X20D2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CMD_ENABLE_PHYS(base,m)                                                         ((base) + 0X20D2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_CMD_ENABLE_OFFS(m)                                                              (0X20D2C + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_ADDR(base,m)                                                   ((base) + 0X20D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_PHYS(base,m)                                                   ((base) + 0X20D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_OFFS(m)                                                        (0X20D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_RMSK                                                                  0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_MAXm                                                                    7
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_POR                                                            0x00000001
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_POR_RMSK                                                       0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_ATTR                                                                        0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_INI(base,m)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_ADDR(base,m), HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_INMI(base,m,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_ADDR(base,m), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_CONTROLLER_IDLE_NOT_IDLE_FVAL                                         0x0
#define HWIO_APSS_RSC_RSCC_TCSm_DRV2_PROFILING_STATUS_CONTROLLER_IDLE_IS_IDLE_FVAL                                          0x1

#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_MSGID_ADDR(base,m,n)                                                       ((base) + 0X20D34 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_MSGID_PHYS(base,m,n)                                                       ((base) + 0X20D34 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_MSGID_OFFS(m,n)                                                            (0X20D34 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_ADDR_ADDR(base,m,n)                                                        ((base) + 0X20D38 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_ADDR_PHYS(base,m,n)                                                        ((base) + 0X20D38 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_ADDR_OFFS(m,n)                                                             (0X20D38 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_DATA_ADDR(base,m,n)                                                        ((base) + 0X20D3C + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_DATA_PHYS(base,m,n)                                                        ((base) + 0X20D3C + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_DATA_OFFS(m,n)                                                             (0X20D3C + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_STATUS_ADDR(base,m,n)                                                      ((base) + 0X20D40 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_STATUS_PHYS(base,m,n)                                                      ((base) + 0X20D40 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_STATUS_OFFS(m,n)                                                           (0X20D40 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_ADDR(base,n)                                            ((base) + 0X20D44 + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_PHYS(base,n)                                            ((base) + 0X20D44 + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_OFFS(n)                                                 (0X20D44 + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_POR                                                     0x00000000
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_POR_RMSK                                                0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_ATTR                                                                 0x1
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_INI(base,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_ADDR(base,n), HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_RMSK)
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_INMI(base,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV2_READ_RESPONSE_DATA_ADDR(base,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_ADDR(base,m,n)                                            ((base) + 0X20D48 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_PHYS(base,m,n)                                            ((base) + 0X20D48 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_OFFS(m,n)                                                 (0X20D48 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_POR                                                       0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_POR_RMSK                                                  0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_ATTR                                                                   0x1
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_INI2(base,m,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_ADDR(base,m,n), HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_INMI2(base,m,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_ADDR(base,m,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_COMPLETED_HAS_NOT_BEEN_COMPLETE_FVAL                             0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_COMPLETED_HAS_COMPLETED_FVAL                                     0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_ISSUED_HAS_NOT_BEEN_SENT_OVER_EPCB_FVAL                          0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_ISSUED_HAS_BEEN_SENT_OVER_EPCB_FVAL                              0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_TRIGGERED_HAS_NOT_BEEN_TRIGGERE_FVAL                             0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV2_PROFILING_STATUS_TRIGGERED_HAS_BEEN_TRIGGERED_FVAL                                0x1

#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_ADDR(x)                                                      ((x) + 0x30d00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_PHYS(x)                                                      ((x) + 0x30d00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_OFFS                                                         (0x30d00)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_RMSK                                                                0x7
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_POR                                                          0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_POR_RMSK                                                     0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_ATTR                                                                      0x3
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_ENABLE_DRV3_IN(x))
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_ADDR(x)                                                      ((x) + 0x30d04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_PHYS(x)                                                      ((x) + 0x30d04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_OFFS                                                         (0x30d04)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_RMSK                                                                0x7
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_POR                                                          0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_POR_RMSK                                                     0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_ATTR                                                                      0x1
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_STATUS_DRV3_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_ADDR(x)                                                       ((x) + 0x30d08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_PHYS(x)                                                       ((x) + 0x30d08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_OFFS                                                          (0x30d08)
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_RMSK                                                                 0x7
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_POR                                                           0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_POR_RMSK                                                      0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_ATTR                                                                       0x2
#define HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_AMC_MODE_IRQ_CLEAR_DRV3_ADDR(x),v)
...
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_ADDR(x)                                                               ((x) + 0x30d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_PHYS(x)                                                               ((x) + 0x30d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_OFFS                                                                  (0x30d10)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_RMSK                                                                         0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_POR                                                                   0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_POR_RMSK                                                              0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_ATTR                                                                               0x3
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_ADDR(x), m)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_ADDR(x),m,v,HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_IN(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_EN_BMSK                                                                      0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_EN_DRV3_EN_SHFT                                                                        0

#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_ADDR(x)                                                              ((x) + 0x30d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_PHYS(x)                                                              ((x) + 0x30d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_OFFS                                                                 (0x30d14)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_RMSK                                                                        0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_POR                                                                  0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_ATTR                                                                              0x2
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_OUT(x, v)            \
                out_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_ADDR(x),v)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_CLR_BMSK                                                                    0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_CLR_DRV3_CLR_SHFT                                                                      0

#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_ADDR(x)                                                           ((x) + 0x30d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_PHYS(x)                                                           ((x) + 0x30d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_OFFS                                                              (0x30d18)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_RMSK                                                                     0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_POR                                                               0x00000000
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_POR_RMSK                                                          0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_ATTR                                                                           0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_STATUS_DRV3_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_ADDR(x)                                                              ((x) + 0x30d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_PHYS(x)                                                              ((x) + 0x30d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_OFFS                                                                 (0x30d1c)
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_RMSK                                                                     0xffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_POR                                                                  0x0000ffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_ATTR                                                                              0x1
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_IN(x)            \
                in_dword(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_ADDR(x))
#define HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_INM(x, m)            \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS_TIMEOUT_VAL_DRV3_ADDR(x), m)
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_ADDR(base,m)                                                  ((base) + 0X30D20 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_PHYS(base,m)                                                  ((base) + 0X30D20 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_OFFS(m)                                                       (0X30D20 + (0x2A0*(m)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_POR                                                           0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_POR_RMSK                                                      0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_ATTR                                                                       0x3
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_INI(base,m)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_ADDR(base,m), HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_INMI(base,m,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_ADDR(base,m), mask)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_OUTI(base,m,val)        \
                out_dword(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_ADDR(base,m),val)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_OUTMI(base,m,mask,val) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_ADDR(base,m),mask,val,HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_WAIT_FOR_CMPL_INI(base,m))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_ADDR(base,m)                                                            ((base) + 0X30D24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_PHYS(base,m)                                                            ((base) + 0X30D24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_OFFS(m)                                                                 (0X30D24 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_RMSK                                                                     0x1010000
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_MAXm                                                                             2
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_POR                                                                     0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_POR_RMSK                                                                0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_ATTR                                                                                 0x3
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_INI(base,m)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_ADDR(base,m), HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_INMI(base,m,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_ADDR(base,m), mask)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_OUTI(base,m,val)        \
                out_dword(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_ADDR(base,m),val)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_OUTMI(base,m,mask,val) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_ADDR(base,m),mask,val,HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_INI(base,m))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_AMC_MODE_EN_AMC_MODE_DISABLE_FVAL                                              0x0
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CONTROL_AMC_MODE_EN_AMC_MODE_ENABLED_FVAL                                              0x1

#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_ADDR(base,m)                                                             ((base) + 0X30D28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_PHYS(base,m)                                                             ((base) + 0X30D28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_OFFS(m)                                                                  (0X30D28 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_RMSK                                                                            0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_MAXm                                                                              2
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_POR                                                                      0x00000001
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_POR_RMSK                                                                 0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_ATTR                                                                                  0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_INI(base,m)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_ADDR(base,m), HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_INMI(base,m,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_ADDR(base,m), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_CONTROLLER_IDLE_NOT_IDLE_FVAL                                                   0x0
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_STATUS_CONTROLLER_IDLE_IS_IDLE_FVAL                                                    0x1

#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_ADDR(base,m)                                                         ((base) + 0X30D2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_PHYS(base,m)                                                         ((base) + 0X30D2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_OFFS(m)                                                              (0X30D2C + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_RMSK                                                                     0xffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_MAXm                                                                          2
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_POR                                                                  0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_ATTR                                                                              0x3
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_INI(base,m)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_ADDR(base,m), HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_INMI(base,m,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_ADDR(base,m), mask)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_OUTI(base,m,val)        \
                out_dword(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_ADDR(base,m),val)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_OUTMI(base,m,mask,val) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_ADDR(base,m),mask,val,HWIO_APSS_RSC_RSCC_TCSm_DRV3_CMD_ENABLE_INI(base,m))
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_ADDR(base,m)                                                   ((base) + 0X30D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_PHYS(base,m)                                                   ((base) + 0X30D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_OFFS(m)                                                        (0X30D30 + (0x2A0*(m)))
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_RMSK                                                                  0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_MAXm                                                                    2
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_POR                                                            0x00000001
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_POR_RMSK                                                       0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_ATTR                                                                        0x1
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_INI(base,m)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_ADDR(base,m), HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_INMI(base,m,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_ADDR(base,m), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_CONTROLLER_IDLE_NOT_IDLE_FVAL                                         0x0
#define HWIO_APSS_RSC_RSCC_TCSm_DRV3_PROFILING_STATUS_CONTROLLER_IDLE_IS_IDLE_FVAL                                          0x1

#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_ADDR(base,m,n)                                                       ((base) + 0X30D34 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_PHYS(base,m,n)                                                       ((base) + 0X30D34 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_OFFS(m,n)                                                            (0X30D34 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_POR                                                                  0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_POR_RMSK                                                             0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_ATTR                                                                              0x3
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_INI2(base,m,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_ADDR(base,m,n), HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_INMI2(base,m,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_ADDR(base,m,n), mask)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_OUTI2(base,m,n,val)        \
                out_dword(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_ADDR(base,m,n),val)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_OUTMI2(base,m,n,mask,val) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_ADDR(base,m,n),mask,val,HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_INI2(base,m,n))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_READ_OR_WRITE_READ_FVAL                                                     0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_READ_OR_WRITE_WRITE_FVAL                                                    0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_RES_REQ_FIRE_AND_FORGET_FVAL                                                0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_MSGID_RES_REQ_RESPONSE_REQUIRED_FVAL                                              0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_ADDR(base,m,n)                                                        ((base) + 0X30D38 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_PHYS(base,m,n)                                                        ((base) + 0X30D38 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_OFFS(m,n)                                                             (0X30D38 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_POR                                                                   0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_POR_RMSK                                                              0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_ATTR                                                                               0x3
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_INI2(base,m,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_ADDR(base,m,n), HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_INMI2(base,m,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_ADDR(base,m,n), mask)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_OUTI2(base,m,n,val)        \
                out_dword(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_ADDR(base,m,n),val)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_OUTMI2(base,m,n,mask,val) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_ADDR(base,m,n),mask,val,HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_ADDR_INI2(base,m,n))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_ADDR(base,m,n)                                                        ((base) + 0X30D3C + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_PHYS(base,m,n)                                                        ((base) + 0X30D3C + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_OFFS(m,n)                                                             (0X30D3C + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_POR                                                                   0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_POR_RMSK                                                              0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_ATTR                                                                               0x3
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_INI2(base,m,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_ADDR(base,m,n), HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_INMI2(base,m,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_ADDR(base,m,n), mask)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_OUTI2(base,m,n,val)        \
                out_dword(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_ADDR(base,m,n),val)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_OUTMI2(base,m,n,mask,val) \
                out_dword_masked_ns(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_ADDR(base,m,n),mask,val,HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_DATA_INI2(base,m,n))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_ADDR(base,m,n)                                                      ((base) + 0X30D40 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_PHYS(base,m,n)                                                      ((base) + 0X30D40 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_OFFS(m,n)                                                           (0X30D40 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_POR                                                                 0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_POR_RMSK                                                            0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_ATTR                                                                             0x1
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_INI2(base,m,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_ADDR(base,m,n), HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_INMI2(base,m,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_ADDR(base,m,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_COMPLETED_HAS_NOT_BEEN_COMPLETE_FVAL                                       0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_COMPLETED_HAS_COMPLETED_FVAL                                               0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_ISSUED_HAS_NOT_BEEN_SENT_OVER_EPCB_FVAL                                    0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_ISSUED_HAS_BEEN_SENT_OVER_EPCB_FVAL                                        0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_TRIGGERED_HAS_NOT_BEEN_TRIGGERE_FVAL                                       0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_STATUS_TRIGGERED_HAS_BEEN_TRIGGERED_FVAL                                          0x1

#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_ADDR(base,n)                                            ((base) + 0X30D44 + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_PHYS(base,n)                                            ((base) + 0X30D44 + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_OFFS(n)                                                 (0X30D44 + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_POR                                                     0x00000000
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_POR_RMSK                                                0xffffffff
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_ATTR                                                                 0x1
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_INI(base,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_ADDR(base,n), HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_RMSK)
#define HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_INMI(base,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCS0_CMDn_DRV3_READ_RESPONSE_DATA_ADDR(base,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_ADDR(base,m,n)                                            ((base) + 0X30D48 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_PHYS(base,m,n)                                            ((base) + 0X30D48 + (0x2A0*(m)) + (0x18*(n)))
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_OFFS(m,n)                                                 (0X30D48 + (0x2A0*(m)) + (0x18*(n)))
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_POR                                                       0x00000000
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_POR_RMSK                                                  0xffffffff
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_ATTR                                                                   0x1
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_INI2(base,m,n)                \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_ADDR(base,m,n), HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_RMSK)
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_INMI2(base,m,n,mask)        \
                in_dword_masked(HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_ADDR(base,m,n), mask)
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_COMPLETED_HAS_NOT_BEEN_COMPLETE_FVAL                             0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_COMPLETED_HAS_COMPLETED_FVAL                                     0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_ISSUED_HAS_NOT_BEEN_SENT_OVER_EPCB_FVAL                          0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_ISSUED_HAS_BEEN_SENT_OVER_EPCB_FVAL                              0x1
...
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_TRIGGERED_HAS_NOT_BEEN_TRIGGERE_FVAL                             0x0
#define HWIO_APSS_RSC_RSCC_TCSm_CMDn_DRV3_PROFILING_STATUS_TRIGGERED_HAS_BEEN_TRIGGERED_FVAL                                0x1


#endif /* RSC_HAL_HWIO_H */
