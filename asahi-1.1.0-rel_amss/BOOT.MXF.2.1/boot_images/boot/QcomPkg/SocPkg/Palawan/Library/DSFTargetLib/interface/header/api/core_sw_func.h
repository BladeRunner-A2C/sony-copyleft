/*******************************************************************************
 ...
 Copyright (c) 2019,2022, 2023 Qualcomm Technologies Incorporated.
 All rights reserved.
 ******************************************************************************/
/*==============================================================================
$Header: //components/dev/core.boot/6.1/mmohamme.core.boot.6.1.Ln_initialDSF/QcomPkg/SocPkg/Kailua/Library/DSFTargetLib/interface/header/api/core_sw_func.h#1 $
...
uint32 EXT_CORE_SW_Get_Fuse_Value(uint32 address);
...
boolean  EXT_CORE_SW_Populate_LCP_DARE_Regions_Cfg(LCP_REGION_CONFIG_STRUCT *lcp_region_cfg, uint8 no_of_regions);
