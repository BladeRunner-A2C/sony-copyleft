...
void qusb_dci_eusb2phy_enable(boolean enable)
{
  if (enable)
  {
    // siddq '0' to power up analog blocks
    HWIO_USB2PHY_USB_PHY_HS_PHY_CTRL_COMMON0_OUTM (
      HWIO_USB2PHY_USB_PHY_HS_PHY_CTRL_COMMON0_SIDDQ_BMSK, 
      0x0 << HWIO_USB2PHY_USB_PHY_HS_PHY_CTRL_COMMON0_SIDDQ_SHFT);
  }
  else
  {
    // siddq '1' to power down analog blocks
    HWIO_USB2PHY_USB_PHY_HS_PHY_CTRL_COMMON0_OUTM (
      HWIO_USB2PHY_USB_PHY_HS_PHY_CTRL_COMMON0_SIDDQ_BMSK, 
      0x1 << HWIO_USB2PHY_USB_PHY_HS_PHY_CTRL_COMMON0_SIDDQ_SHFT);
  }
}
