...
/*******************************************************************************
 ...
 Copyright (c) 2013-2018,2020-2022, 2023 Qualcomm Technologies, Inc. All rights reserved.
Confidential and Proprietary - Qualcomm Technologies, Inc.
 ******************************************************************************/
/*==============================================================================
$Header: //components/dev/core.boot/6.1/mmohamme.core.boot.6.1.Ln_initialDSF/QcomPkg/SocPkg/Kailua/Library/DDRTargetLib/ddr_external.h#1 $
...
#else
  static inline uint32 ddr_external_get_clk_speed(void)
  {
    return 0;
  }
#endif
...
/* ============================================================================
**  Function : ddr_get_fuse_value(void)
** ============================================================================
*/
/*!
*   @brief
*   This function is called by external library to get fuse value from QFPROM.
*   
*   @details
*   This function is called by external library to get fuse value from QFPROM.
*   
*   @param 
*   @param uint32            -  [IN] Addr offset in QFPROM
*                                                   
*   
*   @par Dependencies
*   
...
#else
 static inline uint32 ddr_get_fuse_value(uint32 addr)
  {
	return 0;
  }
#endif
...
#if defined FEATURE_BOOT_EXTERN_DDR_COMPLETED && defined FEATURE_BOOT_DDI_ENABLE
	uint16 ddr_external_get_ddi_binary_size();
#else 
	static uint16 ddr_external_get_ddi_binary_size()
	{ 
	  return 0; 
	} 
#endif
