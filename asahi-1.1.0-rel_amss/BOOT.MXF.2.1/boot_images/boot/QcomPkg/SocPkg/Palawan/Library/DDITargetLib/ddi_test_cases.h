...
/*!
*   @brief
*   This function is for setting DDI parameters after DDR_FW_Exit
*
*   @param None
*
*   @par Dependencies
*   Call after DDR_FW_Exit()
*
*   @par Side Effects
*   None
*
...
/* ============================================================================
**  Function : memory copy for DDI mem Test
** ============================================================================
*/
/*!
*   @brief
*   This function is dedicated DDI mem Test APIs
*
*   @param None
*
*   @par Dependencies
...
*   @sa None
*/
void ddi_memset512(uint64 *dest, uint64 src, uint64 leng);
void ddi_memcpy256(uint64 *dest, uint64 * src, uint64 leng);
void ddi_memcpy(uint64 *dest, uint64 * src, uint64 leng);
void ddi_memread256(uint64 *dest, uint64 * src, uint64 leng);
uint64 ddi_memcmp(uint64 *src, uint64 *pattern, uint64 leng);
uint64 ddi_memcmptoval(uint64 *src, uint64 pattern, uint64 leng);
