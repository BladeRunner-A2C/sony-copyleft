...
#define CDP_DISP_RESET_GPIO                177     // GPIO number for LCD0_RESET
#define CDP_DISP_TE_GPIO                   77      // GPIO number for TE
#define CDP_SEC_DISP_RESET_GPIO            54     // GPIO number for LCD0_RESET on secondary display
#define CDP_SEC_DISP_TE_GPIO               78      // GPIO number for TE on secondary display
...
const static int8 vtdr6130_144Hz_fhd_dsc_cmd_panel_xmldata[] = 
  ...
  case MDPPLATFORM_CONFIG_GETPANELCONFIG:
    {
      ...
      case MDP_DISPLAY_PRIMARY:
        ...
        default:
          pPlatformParams->sPlatformPanel.pPanelXMLConfig = (int8*)vtdr6130_144Hz_fhd_dsc_cmd_panel_xmldata;
          pPlatformParams->sPlatformPanel.uConfigSize     = sizeof(vtdr6130_144Hz_fhd_dsc_cmd_panel_xmldata);
          break;
        }
        break;
