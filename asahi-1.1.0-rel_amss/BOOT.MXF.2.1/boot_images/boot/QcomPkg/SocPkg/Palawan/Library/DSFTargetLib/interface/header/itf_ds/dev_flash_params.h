...
/*******************************************************************************
 ...
 Copyright (c) 2013-2018,2022, 2023 Qualcomm Technologies Incorporated.
 All rights reserved.
 ******************************************************************************/
/*==============================================================================
$Header: //components/dev/core.boot/6.1/mmohamme.core.boot.6.1.Ln_initialDSF/QcomPkg/SocPkg/Kailua/Library/DSFTargetLib/interface/header/itf_ds/dev_flash_params.h#1 $
