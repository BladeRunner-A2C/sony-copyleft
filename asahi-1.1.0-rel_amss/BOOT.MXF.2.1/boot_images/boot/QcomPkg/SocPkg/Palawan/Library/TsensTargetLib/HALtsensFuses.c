...
uint32 HAL_tsens_GetBase1(boolean bUseRedundant, uint32 uController)
{
   if (!bUseRedundant)
   {
      switch (uController)
      {
         ...
         case 2:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW38_LSB, TSENS2_BASE0);
         default:
            break;
      }
   }
...
uint32 HAL_tsens_GetBase2(boolean bUseRedundant, uint32 uController)
{
   if (!bUseRedundant)
   {
      switch (uController)
      {
         ...
         case 2:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW38_MSB, TSENS2_BASE1);
         default:
            break;
      }
   }
...
uint32 HAL_tsens_GetOffset(boolean bUseRedundant, uint32 uFuseIdx)
{
   if (!bUseRedundant)
   {
      switch (uFuseIdx)
      {
         ...
         case 28:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW26_MSB, TSENS28_OFFSET);
         case 29:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW26_MSB, TSENS29_OFFSET);
         case 30:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_MSB, TSENS30_OFFSET);
         case 31:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_LSB, TSENS31_OFFSET);
         case 32:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_LSB, TSENS32_OFFSET);
         case 33:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_LSB, TSENS33_OFFSET);
         case 34:
            return HWIO_INF(QFPROM_CORR_CALIBRATION_ROW27_LSB, TSENS34_OFFSET);
         default:
            break;
      }
   }
