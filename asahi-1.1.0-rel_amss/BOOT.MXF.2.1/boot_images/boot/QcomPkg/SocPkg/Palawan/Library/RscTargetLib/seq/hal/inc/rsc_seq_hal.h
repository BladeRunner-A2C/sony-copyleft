#ifndef _RSC_SEQ_HAL_H_
#define _RSC_SEQ_HAL_H_
 ...
 */
uint16 rsc_hal_copy_simple_cmd_seq
(
  rsc_handle handle, 
  uint16 start_adr,
  rsc_cmd_t* cmds,
 ...
 * @return Number of commands copied to actual RSC HW (In successful call
          it must be equal to size).
 */
uint16 rsc_hal_copy_extended_cmd_seq
(
  rsc_handle handle, 
  uint16 start_adr, 
  rsc_cmd_t* cmds, 
 ...
 * @return Number of commands copied to actual RSC HW (In successful call
          it must be equal to size).
 */
uint16 rsc_hal_copy_32_cmd_seq
(
  rsc_handle handle, 
  uint16 start_adr, 
  rsc_cmd_t* cmds, 
 ...
 */
//void rsc_hal_pcie_rsc_force_wake(uint8* rsc_base, boolean enable);
