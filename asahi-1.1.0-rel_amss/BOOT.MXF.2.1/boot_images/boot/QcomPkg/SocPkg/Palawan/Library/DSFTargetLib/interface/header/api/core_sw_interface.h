...
Copyright 2019,2022, 2023 by Qualcomm Technologies, Inc. All rights reserved.
...
extern uint32 (*fptr_HAL_EXT_CORE_SW_Get_Fuse_Value)(uint32 address);
...
extern boolean (*fptr_HAL_EXT_CORE_SW_Populate_LCP_DARE_Regions_Cfg)(LCP_REGION_CONFIG_STRUCT *lcp_region_cfg, uint8 no_of_regions);
extern boolean (*fptr_HAL_EXT_CORE_SW_Get_Chromebook_Sku_Info)(void);
extern boolean (*fptr_HAL_EXT_CORE_SW_Get_Warm_Mission_Mode_Info)(void);
...
/* ============================================================================
**  Function : HAL_EXT_CORE_SW_Get_Fuse_Value
** ============================================================================
*/
/*!
*   @brief
*   This function obtains the value of a fuse
*   
*   @param address      -  [IN] address offset of fuse
*   
*   @par Dependencies
*   
*   @par Side Effects
...
*   
*   @retval
*   Value stored in fuse
*   
*   @sa None
*/
uint32 HAL_EXT_CORE_SW_Get_Fuse_Value(uint32 address);
/* ============================================================================
...
/*===========================================================================
**  Function : HAL_EXT_CORE_SW_Populate_LCP_DARE_Regions_Cfg
** ==========================================================================
*/
/*!
*   @brief
*   This function allows seclib to validate DARE regions address ranges for each region
*   seclib has to update other parameters of lcp_region_cfg struct  
*
*   @param *lcp_region_cfg    - [IN] pointer to structure defined on stack
*   @param no_of_regions      - [IN] size of structure array
*   
*   @par Dependencies
*   None
*   
...
*   
*   @retval
*   Returns TRUE if DARE regions in structure are configured correctly
*   
*   @sa None
*/
boolean HAL_EXT_CORE_SW_Populate_LCP_DARE_Regions_Cfg(LCP_REGION_CONFIG_STRUCT *lcp_region_cfg, uint8 no_of_regions);

/* ============================================================================
**  Function : HAL_EXT_CORE_SW_Get_Chromebook_Sku_Info
** ============================================================================
*/
/*!
*   @brief
*   This function obtains the chromebook sku fuse information
*   
*   @param
*   None
*   
...
*   
*   @retval
*   Chromebook sku fuse information 
*   
*   @sa None
*/
boolean HAL_EXT_CORE_SW_Get_Chromebook_Sku_Info(void);

/* ============================================================================
**  Function : HAL_EXT_CORE_SW_Get_Warm_Mission_Mode_Info
** ============================================================================
*/
/*!
*   @brief
*   This function obtains the warm mission mode enablement information
*   
*   @param
*   None
*   
...
*   
*   @retval
*   Warm mission mode enablement information 
*   
*   @sa None
*/
boolean HAL_EXT_CORE_SW_Get_Warm_Mission_Mode_Info(void);
