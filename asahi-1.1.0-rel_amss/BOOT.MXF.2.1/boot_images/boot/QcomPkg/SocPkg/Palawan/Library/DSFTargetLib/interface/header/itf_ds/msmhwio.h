 ...
 *
 * Copyright (c) 1998-2002, 2021, 2023 by Qualcomm Technologies, Inc. All Rights Reserved.
 *===========================================================================*/
 ...
 *
 * $Header: //components/dev/core.boot/6.1/mmohamme.core.boot.6.1.Ln_initialDSF/QcomPkg/SocPkg/Kailua/Library/DSFTargetLib/interface/header/itf_ds/msmhwio.h#1 $
 *
...
#define __msmhwio_outi3(hwiosym, index1, index2, index3, val)   HWIO_##hwiosym##_OUTI3(index1, index2, index3, val)
