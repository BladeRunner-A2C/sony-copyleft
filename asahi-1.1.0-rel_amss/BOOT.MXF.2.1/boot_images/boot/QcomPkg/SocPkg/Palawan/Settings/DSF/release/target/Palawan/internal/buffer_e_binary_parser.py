...
if __name__ == "__main__":
    ...
    if os.path.isdir(path):
      for root, dirs, files in os.walk(path, topdown=True):
        ...
        Run script:
        ./buffer_e_binary_parser.py  // by default it takes current working diretory as "path"
        ./buffer_e_binary_parser.py <path of directory>
        e.g.:   ./buffer_e_binary_parser.py  bin_directory
        Corresponding "<*>buffer_e<*>.csv" is generated in the bin directory
        ''')
        exit()
