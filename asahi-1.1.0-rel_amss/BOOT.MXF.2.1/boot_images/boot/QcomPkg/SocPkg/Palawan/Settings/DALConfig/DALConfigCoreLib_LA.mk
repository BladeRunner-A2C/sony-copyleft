...
#
#  Copyright (c) 2015-2022,2023 Qualcomm Technologies, Inc.
#  All rights reserved.
...
INC_DEPS = $(WORKSPACE)/QcomPkg/Include/api/dal/*.h \
           $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/DALConfig/*.h \
...
XML_DEPS = $(WORKSPACE)/QcomPkg/SocPkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           ...
           $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/HWIO/$(MACRO_NAME)/DalHWIO.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/ICB/core/icbcfg_arb.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/GPI/core/gpi_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/HSUART/core/hsuart_devcfg.xml \
          #$(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/PMIC/pm_config_target_core.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/ADC/internal/core/adc_props.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/ADC/internal/core/vadc_props.xml \
...
IMAGE_CFG_XML = $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/DALConfig/image_cfg.xml
CALLING_MAKE_FILE = $(WORKSPACE)/QcomPkg/SocPkg/Palawan/Settings/DALConfig/DALConfigCoreLib_LA.mk
# \
