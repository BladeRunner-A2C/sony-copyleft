...
INC_DEPS = $(WORKSPACE)/QcomPkg/Include/api/dal/*.h \
           $(WORKSPACE)/QcomPkg/SocPkg/Waipio/Settings/DALConfig/*.h \
...
INC = @$(MODULE_BUILD_DIR)/../DALGenLibTools/OUTPUT/inc.lst

DEVCFG_LIB = $(OUTPUT_DIR)/DALConfigToolsLib.lib
IMAGE_CFG_XML = $(WORKSPACE)/QcomPkg/SocPkg/Waipio/Settings/DALConfig/image_cfg.xml
CALLING_MAKE_FILE = $(WORKSPACE)/QcomPkg/SocPkg/Waipio/Settings/DALConfig/DALConfigToolsLib.mk
