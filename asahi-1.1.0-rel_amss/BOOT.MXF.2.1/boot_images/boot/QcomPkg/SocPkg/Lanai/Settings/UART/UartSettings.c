...
{
   // MAIN_PORT
   0x0089C000,  // uart_base
   0x008C0000,  // qup_common_base
   0x2001c1e1,  // gpio_tx_config
   0x2000c1f1,  // gpio_rx_config
   0,           // gpio_cts_config
   0,           // gpio_rfr_config
   0,           // clock_id_index
   (void*)0,        // bus_clock_id
   "gcc_qupv3_wrap2_s7_clk",		//core_clock_id
   (void*)"gcc_qupv3_wrap2_s7_clk",     // core_clock_id
   0,		//base_freq
...
UART_PROPERTIES rumi_devices =
{
   ...
   (void*)0,        // bus_clock_id
   "gcc_qupv3_wrap2_s7_clk",		//core_clock_id
   (void*)"gcc_qupv3_wrap2_s7_clk",// core_clock_str
   0,		//base_freq
   0,          // irq number not used 
   0,  //TCSR base
   0,  // TCSR offset
