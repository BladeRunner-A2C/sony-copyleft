...
INC_DEPS = $(WORKSPACE)/QcomPkg/Include/api/dal/*.h \
           $(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/DALConfig/*.h \
...
XML_DEPS = $(WORKSPACE)/QcomPkg/SocPkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           ...
           $(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/HWIO/$(MACRO_NAME)/DalHWIO.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/ICB/core/icbcfg_arb.xml \
           $(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/GPI/core/gpi_props.xml \
	   	 		 $(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/HSUART/core/hsuart_devcfg.xml \
          #$(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/PMIC/pm_config_target_core.xml \
           #$(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/ADC/internal/core/adc_props.xml \
           #$(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/ADC/internal/core/vadc_props.xml \
...
IMAGE_CFG_XML = $(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/DALConfig/image_cfg.xml
CALLING_MAKE_FILE = $(WORKSPACE)/QcomPkg/SocPkg/Lanai/Settings/DALConfig/DALConfigCoreLib_LA.mk
# \
