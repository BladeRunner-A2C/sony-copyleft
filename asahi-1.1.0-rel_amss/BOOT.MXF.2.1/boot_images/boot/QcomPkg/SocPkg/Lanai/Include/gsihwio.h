...
/*
    ...
    $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/SocPkg/Lanai/Include/gsihwio.h#1 $
...
#define QUPV3_0_COMMON_REG_BASE                  (0x00)
#define QUPV3_1_COMMON_REG_BASE                  (QUPV3_1_QUPV3_ID_1_BASE + 0x000c0000)
#define QUPV3_2_COMMON_REG_BASE                  (QUPV3_2_QUPV3_ID_2_BASE + 0x000c0000)
#define QUPV3_COMMON_REG_BASE                    (0x009C0000)
#define GSI_0_REG_BASE                           (0x00)
#define GSI_1_REG_BASE                           (QUPV3_1_QUPV3_ID_1_BASE + 0x00004000)
#define GSI_2_REG_BASE                           (QUPV3_2_QUPV3_ID_2_BASE + 0x00004000)


/* Size of GSI regions in QUPV3 */
#define GSI_0_REG_BASE_SIZE               (0x00)
#define GSI_1_REG_BASE_SIZE               (0x58000)
#define GSI_2_REG_BASE_SIZE               (0x58000)
#define GSI_SSC_REG_BASE_SIZE             (0x58000)
...
#define GSI_REG_BASE                                                                       (QUPV3_1_QUPV3_ID_1_BASE      + 0x00004000)
#define GSI_REG_BASE_SIZE                                                                  0x58000
#define GSI_REG_BASE_USED                                                                  0x51ffc
...
#define HWIO_GSI_TEST_BUS_SEL_ADDR(x)                                                      ((x) + 0x1000)
...
#define HWIO_GSI_TEST_BUS_SEL_GSI_HW_EVENTS_SEL_SHFT                                               16
#define HWIO_GSI_TEST_BUS_SEL_GSI_TESTBUS_SEL_BMSK                                               0xff
#define HWIO_GSI_TEST_BUS_SEL_GSI_TESTBUS_SEL_SHFT                                                  0
...
#define HWIO_GSI_TEST_BUS_REG_ADDR(x)                                                      ((x) + 0x1008)
...
#define HWIO_GSI_TEST_BUS_REG_GSI_TESTBUS_REG_SHFT                                                  0

#define HWIO_GSI_DEBUG_BUSY_REG_ADDR(x)                                                    ((x) + 0x1010)
...
#define HWIO_GSI_DEBUG_BUSY_REG_SDMA_BUSY_SHFT                                                     12
#define HWIO_GSI_DEBUG_BUSY_REG_IC_BUSY_BMSK                                                    0x800
#define HWIO_GSI_DEBUG_BUSY_REG_IC_BUSY_SHFT                                                       11
#define HWIO_GSI_DEBUG_BUSY_REG_UC_BUSY_BMSK                                                    0x400
#define HWIO_GSI_DEBUG_BUSY_REG_UC_BUSY_SHFT                                                       10
#define HWIO_GSI_DEBUG_BUSY_REG_DBG_CNT_BUSY_BMSK                                               0x200
#define HWIO_GSI_DEBUG_BUSY_REG_DBG_CNT_BUSY_SHFT                                                   9
#define HWIO_GSI_DEBUG_BUSY_REG_DB_ENG_BUSY_BMSK                                                0x100
#define HWIO_GSI_DEBUG_BUSY_REG_DB_ENG_BUSY_SHFT                                                    8
#define HWIO_GSI_DEBUG_BUSY_REG_REE_PWR_CLPS_BUSY_BMSK                                           0x80
#define HWIO_GSI_DEBUG_BUSY_REG_REE_PWR_CLPS_BUSY_SHFT                                              7
#define HWIO_GSI_DEBUG_BUSY_REG_INT_ENG_BUSY_BMSK                                                0x40
#define HWIO_GSI_DEBUG_BUSY_REG_INT_ENG_BUSY_SHFT                                                   6
#define HWIO_GSI_DEBUG_BUSY_REG_EV_ENG_BUSY_BMSK                                                 0x20
#define HWIO_GSI_DEBUG_BUSY_REG_EV_ENG_BUSY_SHFT                                                    5
#define HWIO_GSI_DEBUG_BUSY_REG_RD_WR_BUSY_BMSK                                                  0x10
#define HWIO_GSI_DEBUG_BUSY_REG_RD_WR_BUSY_SHFT                                                     4
#define HWIO_GSI_DEBUG_BUSY_REG_TIMER_BUSY_BMSK                                                   0x8
#define HWIO_GSI_DEBUG_BUSY_REG_TIMER_BUSY_SHFT                                                     3
#define HWIO_GSI_DEBUG_BUSY_REG_MCS_BUSY_BMSK                                                     0x4
#define HWIO_GSI_DEBUG_BUSY_REG_MCS_BUSY_SHFT                                                       2
#define HWIO_GSI_DEBUG_BUSY_REG_REE_BUSY_BMSK                                                     0x2
#define HWIO_GSI_DEBUG_BUSY_REG_REE_BUSY_SHFT                                                       1
#define HWIO_GSI_DEBUG_BUSY_REG_CSR_BUSY_BMSK                                                     0x1
#define HWIO_GSI_DEBUG_BUSY_REG_CSR_BUSY_SHFT                                                       0

#define HWIO_GSI_DEBUG_EVENT_PENDING_ADDR(x)                                               ((x) + 0x1014)
...
#define HWIO_GSI_DEBUG_EVENT_PENDING_CHID_BIT_MAP_SHFT                                              0

#define HWIO_GSI_DEBUG_TIMER_PENDING_ADDR(x)                                               ((x) + 0x1018)
...
#define HWIO_GSI_DEBUG_TIMER_PENDING_CHID_BIT_MAP_SHFT                                              0

#define HWIO_GSI_DEBUG_RD_WR_PENDING_ADDR(x)                                               ((x) + 0x101c)
...
#define HWIO_GSI_DEBUG_RD_WR_PENDING_CHID_BIT_MAP_SHFT                                              0

#define HWIO_GSI_SPARE_REG_1_ADDR(x)                                                       ((x) + 0x1030)
#define HWIO_GSI_SPARE_REG_1_RMSK                                                                 0x1
#define HWIO_GSI_SPARE_REG_1_IN(x)            \
                in_dword(HWIO_GSI_SPARE_REG_1_ADDR(x))
#define HWIO_GSI_SPARE_REG_1_INM(x, m)            \
                in_dword_masked(HWIO_GSI_SPARE_REG_1_ADDR(x), m)
#define HWIO_GSI_SPARE_REG_1_OUT(x, v)            \
                out_dword(HWIO_GSI_SPARE_REG_1_ADDR(x),v)
#define HWIO_GSI_SPARE_REG_1_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_GSI_SPARE_REG_1_ADDR(x),m,v,HWIO_GSI_SPARE_REG_1_IN(x))
#define HWIO_GSI_SPARE_REG_1_FIX_IEOB_WRONG_MSK_DISABLE_BMSK                                      0x1
#define HWIO_GSI_SPARE_REG_1_FIX_IEOB_WRONG_MSK_DISABLE_SHFT                                        0
...
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_ADDR(base,n,k)                                   ((base) + 0X1400 + (0x80*(n)) + (0x4*(k)))
...
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_VALID_SHFT                                                5
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_PHY_CH_BMSK                                            0x1f
#define HWIO_GSI_DEBUG_EE_n_CH_k_VP_TABLE_PHY_CH_SHFT                                               0

#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_ADDR(base,n,k)                                   ((base) + 0X1600 + (0x80*(n)) + (0x4*(k)))
...
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_VALID_SHFT                                                5
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_PHY_EV_CH_BMSK                                         0x1f
#define HWIO_GSI_DEBUG_EE_n_EV_k_VP_TABLE_PHY_EV_CH_SHFT                                            0
...
#define HWIO_EE_n_GSI_HW_PARAM_0_PERIPH_SEC_GRP_BMSK                                       0xfc000000
...
#define HWIO_EE_n_GSI_HW_PARAM_3_USE_AXI_M_BMSK                                            0x10000000
#define HWIO_EE_n_GSI_HW_PARAM_3_USE_AXI_M_SHFT                                                    28
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_STTS_RMSK                                                        0x1f
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_STTS_GSI_MASTER_TIMEOUT_BMSK                                     0x10
#define HWIO_EE_n_CNTXT_GSI_IRQ_STTS_GSI_MASTER_TIMEOUT_SHFT                                        4
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_EN_RMSK                                                          0x1f
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_EN_GSI_MASTER_TIMEOUT_BMSK                                       0x10
#define HWIO_EE_n_CNTXT_GSI_IRQ_EN_GSI_MASTER_TIMEOUT_SHFT                                          4
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_CLR_RMSK                                                         0x1f
...
#define HWIO_EE_n_CNTXT_GSI_IRQ_CLR_GSI_MASTER_TIMEOUT_BMSK                                      0x10
#define HWIO_EE_n_CNTXT_GSI_IRQ_CLR_GSI_MASTER_TIMEOUT_SHFT                                         4
...
#define HWIO_GSI_INST_RAM_n_MAXn                                                                 6143
