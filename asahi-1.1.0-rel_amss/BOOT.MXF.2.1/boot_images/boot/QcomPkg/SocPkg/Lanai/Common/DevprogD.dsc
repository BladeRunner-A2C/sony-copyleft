...
#
# Copyright (c) 2017-2024 Qualcomm Technologies, Inc. All rights reserved.
...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Lanai$(VAR)/DevprogD
...
[Components.common]
  QcomPkg/DevPrg/DevPrgD.inf {
     <LibraryClasses>
      ...
      PmicLoaderLib|QcomPkg/SocPkg/Lanai/Library/PmicLib/loader/PmicLoaderDevprogLib.inf
