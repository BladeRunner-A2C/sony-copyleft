...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Lanai$(VAR)/Loader
...
[BuildOptions]
   GCC:*_*_*_CC_FLAGS = -I$(WORKSPACE)/QcomPkg/Lanai/Include/xbl_sc_cust.h
################################################################################
#
...
[Components.common]
  QcomPkg/XBLLoader/XBLLoader.inf {
    <LibraryClasses>
     ...
     EUDTargetLib|QcomPkg/SocPkg/Lanai/Library/EUDTargetLib/EUDTargetLib.inf
     ...
     PmicLoaderLib|QcomPkg/SocPkg/Lanai/Library/PmicLib/loader/PmicLoaderLib.inf
     ...
     DDITargetLib|QcomPkg/SocPkg/Lanai/Library/DDITargetLib/DDITargetLib.inf
     #DDITargetLib|QcomPkg/Library/NullLibs/DDITargetLibNull/DDITargetLibNull.inf
     #SecLib|QcomPkg/Library/NullLibs/SecLibNull/SecLibNull.inf
     #SecTargetLib|QcomPkg/Library/NullLibs/SecTargetLibNull/SecTargetLibNull.inf
	 SecLib|SecPkg/Library/SecLib/SecLib.inf
     SecTargetLib|SecPkg/Library/SecTargetLib/chipsets/Lanai/SecTargetLib.inf
     DbgInfoLib|SecPkg/Library/dbginfolib/build/DbgInfoLib.inf
     ACLib|SecPkg/Library/ACLib/ACLib.inf
     ACConfigDataLib|SecPkg/Library/ACConfigDataLib/lanai/ACConfigDataLib.inf
     ...
     SmemImageLib|QcomPkg/SocPkg/Lanai/Library/SmemImageLib/SmemImageLib.inf
