...
uint32_t Clock_DCD_Cfg[] =
{
  ...
  HWIO_ADDR(GCC_CPUSS_UBWCP_DCD_CDIV_DCDR),
...
//  HWIO_ADDR(GCC_QUPV3_WRAP_2_S_AHB_CBCR), // CR 3439683
  HWIO_ADDR(GCC_QUPV3_WRAP_2_IBI_2_AHB_CBCR),
  HWIO_ADDR(GCC_QUPV3_WRAP_2_IBI_3_AHB_CBCR),
//  HWIO_ADDR(GCC_QUPV3_WRAP_3_S_AHB_CBCR), // CR 3439683
...
/*HWIO_ADDR(GCC_PCIE_0_SLV_AXI_CBCR), //WLAN Crash
...
//  HWIO_ADDR(GCC_PCIE_RSCC_CFG_AHB_CBCR), // PCIE CESTA hangs due to unable to read PCIE_0_GDSCR 
...
//HWIO_ADDR(GCC_LPASS_AGGRE_NOC_DDRSS_SHUB_CBCR),
  ...
  HWIO_ADDR(GCC_AGGRE_NOC_CENTER_HS_AXI_CBCR),
  HWIO_ADDR(GCC_AGGRE_NOC_SOUTH_AHB_CFG_CBCR),

  HWIO_ADDR(GCC_AGGRE_NOC_AHB_CBCR),
  HWIO_ADDR(GCC_AGGRE_NOC_CENTER_AXI_CBCR),
  HWIO_ADDR(GCC_AGGRE_NOC_PCIE_AXI_CBCR),

  HWIO_ADDR(GCC_SYS_NOC_AXI_CBCR),
  HWIO_ADDR(GCC_SYS_NOC_SF_AXI_CBCR),
  HWIO_ADDR(GCC_SYS_NOC_AHB_CFG_CBCR),

  HWIO_ADDR(GCC_CFG_NOC_PCIE_ANOC_AHB_CBCR),
  HWIO_ADDR(GCC_CNOC_SF_QX_CBCR),
  HWIO_ADDR(GCC_CNOC_PCIE_SF_AXI_CBCR),

  //Fails in ClockTZLanai with Below CBCRs
...
//HWIO_ADDR(GCC_DDRSS_SNOC_SF_AXI_CBCR), //usb issue
//HWIO_ADDR(GCC_DDRSS_CONFIG_NOC_SF_CBCR),//issue
  
  HWIO_ADDR(GCC_LPASS_QTB_AHB_CBCR),
  
  HWIO_ADDR(GCC_TURING_NSP_AHB_CBCR),
  HWIO_ADDR(GCC_CPUSS_GIC_CBCR),

  HWIO_ADDR(GCC_TCU_LPASS_AUDIO_QTB_CBCR),
  /*HWIO_ADDR(GCC_TCU_ANOC_QTB1_CBCR),
  HWIO_ADDR(GCC_TCU_ANOC_QTB2_CBCR),*/
  HWIO_ADDR(GCC_TCU_MMNOC_QTB_SF_CBCR),
  HWIO_ADDR(GCC_TCU_MMNOC_QTB_HF01_CBCR),
  HWIO_ADDR(GCC_TCU_MMNOC_QTB_HF23_CBCR),
//HWIO_ADDR(GCC_TCU_ANOC_PCIE_QTB_CBCR),
  HWIO_ADDR(GCC_TCU_TURING_Q6_QTB0_CBCR),
//HWIO_ADDR(GCC_DISP_HF_AXI_CBCR),//vysor connection error 
...
)
{
  ...
  HWIO_OUTF(GCC_DDRSS_PCIE_SF_QTB_CBCR, IGNORE_PMU_CLK_DIS, 1); /* QCTDD11024370 */
...
static void Clock_ApplyWorkarounds(void)
{
  ...
  /*
   * Turn off these clocks because they are default enabled on by hw
   * and are connected to nothing so they should not be turned on.
   */
  HWIO_OUTF(GCC_AGGRE_NOC_WEST_AXI_CBCR, CLK_ENABLE, 0x0);
  HWIO_OUTF(GCC_AGGRE_NOC_WEST_TUNNEL_CBCR, CLK_ENABLE, 0x0);
  ...
  HWIO_OUTF(GCC_QUPV3_WRAP3_S0_CDIVR, CLK_DIV, 0);
  HWIO_OUTF(GCC_QUPV3_WRAP1_S2_CDIVR, CLK_DIV, 0);
...
void Clock_ApplyGfMuxWA(void)
{
  ...
  HWIO_IN(GCC_APSS_QDSS_APB_CBCR);
  busywait(5);
