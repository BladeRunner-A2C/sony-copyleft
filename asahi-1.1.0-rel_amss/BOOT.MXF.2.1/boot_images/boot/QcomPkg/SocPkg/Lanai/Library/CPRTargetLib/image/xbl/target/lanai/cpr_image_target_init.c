 ...
 * $Header: //components/dev/core.boot/6.1/cvelempa.core.boot.6.1.Lanai_XBL_CPR_Changes_07_04_2022/QcomPkg/SocPkg/lanai/Library/CPRTargetLib/image/xbl/target/lanai/cpr_image_target_init.c#1 $
 * $Change: 38231469 $
 */
#include <string.h>
#include "cpr_logs.h"
