...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM8650v1 (lanai_1.0):
      PLL_HSR   : 9.0
      AOSS_CC     : lanai_aoss_cc_z_aoss_cc_7.0_p3q2r8.1_fp6 [lanai_aoss_cc.r1]
      APSS_CC     : lanai_apss_cc_lanai_apss_1.0_p3q3r465_fp15 [lanai_apss_cc.r4]
      GCC         : lanai_gcc_z_lanai_clk_ctl_p3q3r4.1_fp13 [lanai_gcc.r20]
      GPU_CC      : lanai_gpu_cc_z_gpu_cc_7.0_p3q3r5.03_fp9 [lanai_gpu_cc.r6]
      LPASS_AON_CC: lanai_lpass_aon_cc_lpass_12.0.0_lanai_p3q3r11_fp11 [lanai_lpass_aon_cc.r8]
      TCSR_CC     : None
...
{'db_override': {'GCC': {'cbc': {'gcc_aggre_ufs_phy_axi_clk': {'func_group': 'ufs_phy'},
                 ...
                 'TCSR_CC': {'cbc': {'tcsr_ufs_clkref_en': {'func_group': 'ufs_phy'},
 ...
 'generators': [{'options': {'clock_flags': {'gcc_gpll0': ['DO_NOT_DISABLE'],
                             ...
                             'flat_structs': True,
                             'hal_ctl_structs': {'aoss_cc_pll1': 'HAL_clk_PongooleLanaiPLLControl',
 ...
 */
extern HAL_clk_SourceControlType          HAL_clk_PongooleLanaiPLLControl;
...
ClockSourceNodeType ClockSource_AOSSCC_AOSSCCPLL1 =
{
  ...
  .pmControl      = &HAL_clk_PongooleLanaiPLLControl,
...
{
  { 1190400000, RAIL_VOLTAGE_LEVEL_NOM,        { 3,     2,     0,     0,     0xFF }, SRC_IDX_APSSCC_APSSCCL3PLL,                   0                   ,  },   /* Mux[3] = APSS_CC_L3_PLL_OUT_EVEN */
};
...
{
  { 1363200000, RAIL_VOLTAGE_LEVEL_NOM,        { 3,     2,     0,     0,     0xFF }, SRC_IDX_APSSCC_APSSCCSILVERPLL,               0                   ,  },   /* Mux[3] = APSS_CC_SILVER_PLL_OUT_EVEN */
};
...
{
  {  100000000, RAIL_VOLTAGE_LEVEL_NOM,        { 1,     12,    0,     0,     0x04 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN_PWRGRP5_CLKGEN_ACGC_CLK */
};
...
{
  {  806000000, RAIL_VOLTAGE_LEVEL_NOM,        { 5,     2,     0,     0,     0x04 }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
};
...
{
  {  806000000, RAIL_VOLTAGE_LEVEL_NOM,        { 5,     2,     0,     0,     0x04 }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
  {  933000000, RAIL_VOLTAGE_LEVEL_TUR,        { 3,     2,     0,     0,     0x05 }, SRC_IDX_GCC_GCCGPLL5,                         0                   ,  },   /* Mux[3] = GCC_GPLL5_OUT_MAIN */
  { 1066000000, RAIL_VOLTAGE_LEVEL_TUR_L1,     { 4,     2,     0,     0,     0x06 }, SRC_IDX_GCC_GCCGPLL1,                         0                   ,  },   /* Mux[4] = GCC_GPLL1_OUT_MAIN */
};
...
{
  {  300000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 1,     4,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN_PWRGRP5_CLKGEN_ACGC_CLK */
};
...
{
  {  240000000, RAIL_VOLTAGE_LEVEL_SVS,        { 1,     5,     0,     0,     0x01 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[1] = GCC_GPLL0_OUT_MAIN_PWRGRP7_CLKGEN_ACGC_CLK */
};
...
{
  {    7372800, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     2,     384,   15625, 0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP25_CLKGEN_ACGC_CLK */
  {   14745600, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     2,     768,   15625, 0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP25_CLKGEN_ACGC_CLK */
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0x00 }, SRC_IDX_NULL,                                 0                   ,  },   /* Mux[0] = BI_TCXO */
  {   48000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     2,     4,     25,    0x02 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP25_CLKGEN_ACGC_CLK */
};
...
{
  {   37500000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     16,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP26_CLKGEN_ACGC_CLK */
};
...
{
  {  200000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     3,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP21_CLKGEN_ACGC_CLK */
};
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCSDCC2APPS[] =
{
  ...
  {   25000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     24,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP23_CLKGEN_ACGC_CLK */
  {  100000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     6,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP23_CLKGEN_ACGC_CLK */
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCSDCC4APPS[] =
{
  {     400000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     24,    1,     4,     0xFF }, SRC_IDX_NULL,                                 0                   ,  },   /* Mux[0] = BI_TCXO */
  {   25000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     24,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP23_CLKGEN_ACGC_CLK */
  {   75000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     8,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP23_CLKGEN_ACGC_CLK */
};
...
ClockDomainNodeType ClockDomain_GCC_GCCQUPV3WRAP2IBICTRL0 =
{
  .aBSP      = ClockDomainBSP_GCC_GCCQUPV3WRAP2IBICTRL0,
  .nBSPLen   = SIZEOF_ARRAY(ClockDomainBSP_GCC_GCCQUPV3WRAP2IBICTRL0),
  .eMaster   = CLOCK_MASTER_DEFAULT,
  .nCGRAddr   = HWIO_ADDR(GCC_QUPV3_WRAP2_IBI_CTRL_0_CMD_RCGR),
};
...
static ClockGroupType aClockGroups[] =
{
  ...
  },
  {
    ...
    .aClocks = (ClockNodeType[]){
      ...
      {
        .nFlags      = 0x0,
        .nBranchAddr = HWIO_ADDR(TCSR_UFS_CLKREF_EN__UFS_ENABLE),
        .mHWVotable  = {0, 0},
      },
    },
    .nClocks = 10,
...
static uint32_t aBranchEnable[] =
{
  ...
  // HWIO_ADDR(GCC_AO_PGM_CBCR), /* Defaults on. */
  ...
  // HWIO_ADDR(GCC_CFG_NOC_MMNOC_AHB_CBCR), /* Defaults on. */
  ...
  // HWIO_ADDR(GCC_CORE_CBCR), /* Defaults on. */
...
static HAL_clk_RegisterMaskType aBranchVote[] =
{
   ...
   */
   { HWIO_ADDR(GCC_BOOT_CLK_BRANCH_ENA_VOTE_2), 0xF0200F },
};
