...
MDP_Status       MDPPlatformSetupPanelConfig(MDP_Display_IDType eDisplayId,MDPPlatformPanelInfo *pPlatformPanel, MDPPlatformInfo *pPlatformInfo, MDPPlatformInfo *pMDPPlatformInfo, PanelConfigType *pPanelConfig);
