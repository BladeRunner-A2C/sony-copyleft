...
DESCRIPTION:
  ...
  Auto-generated from the following IPCat controller releases:
    ...
    SM8650v1 (lanai_1.0):
      ...
      GCC       : lanai_gcc_z_lanai_clk_ctl_p3q3r4.1_fp13 [lanai_gcc.r16]
      TCSR_CC   : None
...
static ClockMuxConfigType ClockDomainBSP_DISPCC_DISPCCMDSSMDP[] =
{
  ...
  {  150000000, RAIL_VOLTAGE_LEVEL_LOW_SVS_D1, { 1,     6,     0,     0,     0xFF }, SRC_IDX_DISPCC_DISPCCPLL0,                    2 /* 450.0  */      ,  },   /* Mux[1] = DISP_CC_PLL0_OUT_MAIN */
  {  200000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 1,     6,     0,     0,     0xFF }, SRC_IDX_DISPCC_DISPCCPLL0,                    3 /* 600.0  */      ,  },   /* Mux[1] = DISP_CC_PLL0_OUT_MAIN */
  {  325000000, RAIL_VOLTAGE_LEVEL_SVS,        { 1,     6,     0,     0,     0xFF }, SRC_IDX_DISPCC_DISPCCPLL0,                    4 /* 975.0  */      ,  },   /* Mux[1] = DISP_CC_PLL0_OUT_MAIN */
...
{
  {   19200000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 0,     2,     0,     0,     0x00 }, SRC_IDX_NULL,                                 0                   ,  },   /* Mux[0] = BI_TCXO */
  {  200000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     3,     0,     0,     0x02 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP20_CLKGEN_ACGC_CLK */
  {  355333333, RAIL_VOLTAGE_LEVEL_SVS,        { 4,     6,     0,     0,     0x03 }, SRC_IDX_GCC_GCCGPLL1,                         0                   ,  },   /* Mux[4] = GCC_GPLL1_OUT_MAIN */
  {  403000000, RAIL_VOLTAGE_LEVEL_SVS_L1,     { 5,     4,     0,     0,     0x04 }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
  {  533000000, RAIL_VOLTAGE_LEVEL_NOM,        { 4,     4,     0,     0,     0x05 }, SRC_IDX_GCC_GCCGPLL1,                         0                   ,  },   /* Mux[4] = GCC_GPLL1_OUT_MAIN */
...
{
  {  150000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     4,     0,     0,     0x00 }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP25_CLKGEN_ACGC_CLK */
...
static ClockMuxConfigType ClockDomainBSP_GCC_GCCUFSPHYAXI[] =
{
  {   25000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     24,    0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP23_CLKGEN_ACGC_CLK */
  {  100000000, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     6,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP23_CLKGEN_ACGC_CLK */
  {  201500000, RAIL_VOLTAGE_LEVEL_SVS,        { 5,     8,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL4,                         0                   ,  },   /* Mux[5] = GCC_GPLL4_OUT_MAIN */
...
{
  {   66666667, RAIL_VOLTAGE_LEVEL_LOW_SVS,    { 6,     9,     0,     0,     0xFF }, SRC_IDX_GCC_GCCGPLL0,                         0                   ,  },   /* Mux[6] = GCC_GPLL0_OUT_EVEN_PWRGRP30_CLKGEN_ACGC_CLK */
...
static ClockNodeType aClocks[] =
{
  ...
  },
  {
    ...
    .pDomain   = &ClockDomain_GCC_GCCCONFIGNOC,
    .nFlags    = 0x0,
    .nBranchAddr = HWIO_ADDR(GCC_QUPV3_WRAP_2_IBI_2_AHB_CBCR),
  ...
  },
  {
    ...
    .pDomain   = &ClockDomain_GCC_GCCCONFIGNOC,
    .nFlags    = 0x0,
    .nBranchAddr = HWIO_ADDR(GCC_QUPV3_WRAP_2_IBI_3_AHB_CBCR),
  ...
  /*-----------------------------------------------------------------------*/
  {
    .szName    = "gcc_mmnoc_at_clk",
    .nFlags    = 0x0,
    .nBranchAddr = HWIO_ADDR(GCC_MMNOC_AT_CBCR),
    .mHWVotable  = {0, 0},
  },
  {
  ...
  /*-----------------------------------------------------------------------*/
  {
    ...
    .nFlags    = 0x0,
    .nBranchAddr = HWIO_ADDR(GCC_QUPV3_WRAP2_IBI_CTRL_2_CBCR),
  ...
  },
  {
    ...
    .pDomain   = &ClockDomain_GCC_GCCQUPV3WRAP2IBICTRL0,
    .nFlags    = 0x0,
    .nBranchAddr = HWIO_ADDR(GCC_QUPV3_WRAP2_IBI_CTRL_3_CBCR),
