...
static PhysicalPanelConfigType sPhysicalPanelConfigTable[] =
{
  ...
  {"sharp_quadpipe_plus_dsc_vid",       "Panel_sharp_120hz_qhdpipe_plus_dsc_vid.xml",              "qcom,mdss_dsi_sharp_qhd_plus_dsc_video:",                    &sModeConfig[MDP_MODE_SINGLEDSI1], &sHwConfig[HW_CONFIG_DEFAULT]},
#ifdef FEATURE_XBOOT
