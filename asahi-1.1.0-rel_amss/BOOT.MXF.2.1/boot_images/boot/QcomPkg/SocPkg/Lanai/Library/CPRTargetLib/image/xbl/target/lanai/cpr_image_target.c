 ...
 * $Header: //components/dev/core.boot/6.1/cvelempa.core.boot.6.1.Lanai_XBL_CPR_Changes_07_04_2022/QcomPkg/SocPkg/lanai/Library/CPRTargetLib/image/xbl/target/lanai/cpr_image_target.c#1 $
 * $Change: 38231469 $
 */
...
{
    extern const cpr_settings cpr_settings_lanai;
...
void cpr_externalize_state()
{
    ...
    cpr_smem_serialize_settings(cpr_utils_get_rail_state( CPR_RAIL_NAV_LDO),
            true );
    cpr_smem_serialize_settings( cpr_utils_get_rail_state( CPR_RAIL_NSP2),
            true );
    cpr_smem_serialize_settings( cpr_utils_get_rail_state( CPR_RAIL_WMSS_MX_1),
            true );
    cpr_smem_serialize_settings( cpr_utils_get_rail_state( CPR_RAIL_WMSS_MX_2),
            true );
