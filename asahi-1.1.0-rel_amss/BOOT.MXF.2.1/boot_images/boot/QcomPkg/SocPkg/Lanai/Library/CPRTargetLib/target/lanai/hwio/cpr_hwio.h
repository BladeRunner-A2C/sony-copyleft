...
/**
    ...
    Reference chip release:
        SM8650 (Lanai) [z_lanai_prj_v1.0_preF04_p3q2r11.4_rtl_partition]
...
#define CX_CPR3_REG_BASE_USED                                                                  0x3310
...
#define HWIO_CPR_SENSOR_THREAD_n_MAXn                                                                  50
...
#define HWIO_CPR_MISC_REGISTER_TEMP_SENSOR_ID_END_SHFT                                                 28
#define HWIO_CPR_MISC_REGISTER_TEMP_SENSOR_ID_START_BMSK                                        0xf000000
#define HWIO_CPR_MISC_REGISTER_TEMP_SENSOR_ID_START_SHFT                                               24
...
#define HWIO_CPR_TEMP_RX_EN_ADDR(x)                                                            ((x) + 0x70c)
#define HWIO_CPR_TEMP_RX_EN_PHYS(x)                                                            ((x) + 0x70c)
#define HWIO_CPR_TEMP_RX_EN_OFFS                                                               (0x70c)
...
#define HWIO_CPR_TEMP_RX_EN_TEMP_SID_BMSK                                                          0xffff
#define HWIO_CPR_TEMP_RX_EN_TEMP_SID_SHFT                                                               0

#define HWIO_CPR_TEMP_CTRL_ID_ADDR(x)                                                          ((x) + 0x710)
#define HWIO_CPR_TEMP_CTRL_ID_PHYS(x)                                                          ((x) + 0x710)
#define HWIO_CPR_TEMP_CTRL_ID_OFFS                                                             (0x710)
#define HWIO_CPR_TEMP_CTRL_ID_RMSK                                                                 0xffff
#define HWIO_CPR_TEMP_CTRL_ID_IN(x)            \
                in_dword(HWIO_CPR_TEMP_CTRL_ID_ADDR(x))
#define HWIO_CPR_TEMP_CTRL_ID_INM(x, m)            \
                in_dword_masked(HWIO_CPR_TEMP_CTRL_ID_ADDR(x), m)
#define HWIO_CPR_TEMP_CTRL_ID_OUT(x, v)            \
                out_dword(HWIO_CPR_TEMP_CTRL_ID_ADDR(x),v)
#define HWIO_CPR_TEMP_CTRL_ID_OUTM(x,m,v) \
                out_dword_masked_ns(HWIO_CPR_TEMP_CTRL_ID_ADDR(x),m,v,HWIO_CPR_TEMP_CTRL_ID_IN(x))
#define HWIO_CPR_TEMP_CTRL_ID_TEMP_CTRL_ID_BMSK                                                    0xffff
#define HWIO_CPR_TEMP_CTRL_ID_TEMP_CTRL_ID_SHFT                                                         0

#define HWIO_CPR_TEMP_MISC_CTL_ADDR(x)                                                         ((x) + 0x714)
#define HWIO_CPR_TEMP_MISC_CTL_PHYS(x)                                                         ((x) + 0x714)
#define HWIO_CPR_TEMP_MISC_CTL_OFFS                                                            (0x714)
#define HWIO_CPR_TEMP_MISC_CTL_RMSK                                                                   0x7
