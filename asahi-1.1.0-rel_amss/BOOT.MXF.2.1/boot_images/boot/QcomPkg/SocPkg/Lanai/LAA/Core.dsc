...
[Defines]
  ...
  FLASH_DEFINITION               = QcomPkg/SocPkg/Lanai/$(VAR)/Core.fdf

[Defines.ARM]
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Lanai$(VAR)/Core_32

[Defines.AARCH64]
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/Lanai$(VAR)/Core

[PcdsFeatureFlag.common]
  gQcomTokenSpaceGuid.PcdUefiEnhanced | 0

!include QcomPkg/SocPkg/Lanai/Common/Core.dsc.inc
...
[LibraryClasses]
  ...
  # XHwreset Library
  XHwresetLib|SomcPkg/Platform/SomcSm8650Pkg/Library/XHwresetLib/XHwresetLib.inf
  # XSDI Library
  ...
  # XHapticsLib
  XHapticsLib|SomcPkg/Platform/SomcSm8650Pkg/Library/XHapticsLib/XHapticsLib.inf
  # XBootPALLib Library
  ...
  XBootPanelLib|SomcPkg/Platform/SomcSm8650Pkg/Library/XBootPanelLib/XBootPanelLib.inf
  # XBootDisplayLib
