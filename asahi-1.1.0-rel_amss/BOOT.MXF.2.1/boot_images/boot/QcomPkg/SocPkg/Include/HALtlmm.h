...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/SocPkg/Include/HALtlmm.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
05/10/21   ara     Updated HAL structure to support DT.
...
typedef struct
{
  GPIODeviceIdType              eDeviceId;      /* Type of TLMM HW */
  ...
  uint32                        nSize;        /* size of TLMM base. */
