...
--------   --------     ---------------------------------------------------------- 
11/23/22   fi           Added entries for EUD and fuse controllers
...
#define EUD_USE_BOOT_CONFIG_CSR          
#ifdef  EUD_USE_BOOT_CONFIG_CSR
#define FUSE_CONTROLLER_SW_RANGES_BASE   0x221C9000
#define FUSE_CONTROLLER_SW_RANGES_SIZE   0x1000
#endif
