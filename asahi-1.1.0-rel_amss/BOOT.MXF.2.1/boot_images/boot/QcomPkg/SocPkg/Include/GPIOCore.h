...
/*==========================================================================
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/SocPkg/Include/GPIOCore.h#1 $
...
{
  uint32 nFunc     : 3;   /* Function Select Value */
  uint32 nStrongPull :1;  /* Strong Pull support */
