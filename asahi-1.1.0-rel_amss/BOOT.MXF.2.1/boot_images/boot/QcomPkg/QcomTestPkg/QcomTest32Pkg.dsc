...
# QcomTest package.
#
# Copyright (c) 2016-2024 Qualcomm Technologies, Inc. All rights reserved.
...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/QcomTest32
...
#  EblAddExternalCommandLib|EmbeddedPkg/Library/EblAddExternalCommandLib/EblAddExternalCommandLib.inf
  EblNetworkLib|QcomPkg/Library/EblNetworkLib/EblNetworkLib.inf
  EfiFileLib|QcomPkg/Library/EfiFileLib/EfiFileLib.inf
  ...
  PrePiLib|QcomPkg/Library/PrePiLib/PrePiLib.inf
  ...
  UncachedMemoryAllocationLib|QcomPkg/Library/UncachedMemoryAllocationLib/UncachedMemoryAllocationLib.inf
  ...
  KernelLib|QcomPkg/Library/KernelLib/KernelLib.inf
  LockLib|QcomPkg/Library/LockLib/LockLib.inf
  ...
  BootConfigLib|QcomPkg/Library/BootConfigLib/BootConfigLibVar.inf
  BusyWaitLib|QcomPkg/Library/BusyWaitLib/BusyWaitCoreLib.inf
  ...
  ImagePathUtilsLib|QcomPkg/Library/ImagePathUtilsLib/ImagePathUtilsLib.inf
  ...
  UCLib|SecPkg/Library/UCLib_core/UCLib_core.inf
  BMPLib|QcomPkg/Library/BMPLib/BMPLib.inf
  ClockApiLib|QcomPkg/Library/ClockApiLib/ClockApiLib.inf
  GPIOApiLib|QcomPkg/Library/GPIOApiLib/GPIOApiLib.inf
  FdtLib|EmbeddedPkg/Library/FdtLib/FdtLib.inf
  DTBExtnUEFILib|QcomPkg/Library/DTBExtnUEFILib/DTBExtnUEFILib.inf

  # TZ Diag Library
  TzDiagLib|QcomPkg/Library/TzDiagLib/TzDiag.inf
  ...
  #HSUart Library
  HSUartQupv3Lib|QcomPkg/Library/HSUartQupv3Lib/HSUartCoreLib.inf
  ...
  # ADC Libraries
  AdcDxeWrapperLib|QcomPkg/Library/PmicLib/adc/AdcDxeWrapperLib.inf
  ...
  # EnterpriseMgt Library
  EnterpriseMgtLib|QcomPkg/Library/EnterpriseMgtLib/EnterpriseMgtLib.inf

  TargetInitLib|QcomPkg/SocPkg/Library/TargetInitLib/TargetInitLib.inf

  PcieRpLib|QcomPkg/Library/PcieRpLib/PcieRpLib.inf
  PcieRpConfigLib|QcomPkg/QcomTestPkg/Pcie/Library/PcieRpConfigLib/PcieRpConfigLib.inf
  
  # PCIe DXE Lib
  PcieDxeLib|QcomPkg/QcomTestPkg/Pcie/Library/PcieDxeLib/PcieDxeLib.inf
  PcieTestUtilsLib|QcomPkg/QcomTestPkg/Pcie/Library/PcieTestUtilsLib/PcieTestUtilsLib.inf
  
  # MHI DXE Lib
  MhiDxeLib|QcomPkg/QcomTestPkg/Pcie/Library/MhiDxeLib/MhiDxeLib.inf
...
[BuildOptions.ARM]
  ...
  RVCT:*_*_ARM_ARCHCC_FLAGS  == --cpu Cortex-A7 --thumb --fpu vfpv3
  RVCT:*_*_ARM_ARCHASM_FLAGS == --cpu Cortex-A7
  GCC:*_*_*_ARCHCC_FLAGS  == -fno-common -mtune=cortex-a7 -include $(WORKSPACE)/QcomPkg/Include/Library/DebugLib.h -DQCOM_EDK2_PATCH -mno-thumb
...
#
gQcomTestTokenSpaceGuid.UseUncachedMemForPcieShadow|TRUE
...
[Components.common]
  ...
  QcomPkg/QcomTestPkg/CipherApp/CipherApp.inf
  QcomPkg/QcomTestPkg/HmacApp/HmacApp.inf
  ...
  QcomPkg/QcomTestPkg/FeatureEnablerApp/FeatureEnablerApp.inf
  ...
  QcomPkg/QcomTestPkg/HeapGuardTest/HeapGuardTest.inf
  QcomPkg/QcomTestPkg/I2CApp/I2Capp.inf
  QcomPkg/QcomTestPkg/HSUartApp/HSUartTest.inf
  QcomPkg/QcomTestPkg/ECFlashApp/ECFlashApp.inf
  ...
  QcomPkg/QcomTestPkg/MorApp/MorApp.inf
  QcomPkg/QcomTestPkg/PpiApp/PpiApp.inf
  ...
  QcomPkg/QcomTestPkg/QwesTest/QwesTest.inf
  ...
  QcomPkg/QcomTestPkg/GPIOApp/GPIOApp.inf
  ...
  QcomPkg/QcomTestPkg/TzeLoaderTest/TzeLoaderTest.inf
  QcomPkg/QcomTestPkg/SmcInvokeTest/SmcInvokeTest.inf
  ...
  QcomPkg/QcomTestPkg/DppToolApp/DppTool.inf
  QcomPkg/QcomTestPkg/ShmBridgeTest/ShmBridgeTest.inf
  QcomPkg/QcomTestPkg/WatchdogPetTest/WatchdogPetTest.inf
  QcomPkg/QcomTestPkg/BMPTest/BMPTest.inf
  QcomPkg/QcomTestPkg/VariablePolicyTest/VariablePolicyTest.inf
  QcomPkg/QcomTestPkg/VariablePolicySecureBootTest/VariablePolicySecureBootTest.inf
  QcomPkg/QcomTestPkg/PrivAuthVarTest/PrivAuthVarTest.inf  
  QcomPkg/QcomTestPkg/EnterpriseMgtApp/EnterpriseMgtApp.inf
  QcomPkg/QcomTestPkg/DTBTestApp/DTBTest.inf

  # To be enabled only in engg builds
  #QcomPkg/QcomTestPkg/WatchdogLibTest/WatchdogLibTest.inf {
  #<LibraryClasses>
  #  WatchDogLib|QcomPkg/SocPkg/Library/WatchDogLib/WatchDogLib.inf
  #}
  QcomPkg/QcomTestPkg/Pcie/PwrUp/Pwrup.inf
  QcomPkg/QcomTestPkg/Pcie/PcieTest/PcieTest.inf
   
[Components.AARCH64]
  QcomPkg/QcomTestPkg/HvxTestApp/HvxTest.inf
  QcomPkg/QcomTestPkg/cpt_LPMTest/cpt_LPMTest.inf
  QcomPkg/QcomTestPkg/cpt_MpTest/cpt_MpTest.inf
  QcomPkg/QcomTestPkg/cpt_MpTest2/cpt_MpTest2.inf
  QcomPkg/QcomTestPkg/Pcie/MhiTest/MhiTest.inf
  QcomPkg/QcomTestPkg/Pcie/MhiTestDxe/MhiTestDxe.inf
  
[Components.ARM]
  # Do NOT enable PCIe driver where a mission mode booting already has PCIe driver
  #QcomPkg/QcomTestPkg/Pcie/PcieTestDxe/PcieTestDxe.inf
