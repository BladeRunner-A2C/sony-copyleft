...
test_config *get_test_config (UINTN argc, CHAR8 **argv);
EFI_STATUS clear_counter(VOID);
EFI_STATUS set_counter(UINTN increment);
UINTN get_counter(VOID);
   ...
   while (index < argc)
   {
      ...
      switch (CmdOp)
      {
         ...
         case TEST_SUITE:
            ...
            {
               //tc_config.suite = "cpt";
               AsciiStrnCpyS(tc_config.suite, TEST_CONFIG_STR_LEN, "cpt", TEST_CONFIG_STR_LEN - 1);
            }
            else {
               //tc_config.suite = "dev";
               AsciiStrnCpyS(tc_config.suite, TEST_CONFIG_STR_LEN, "dev", TEST_CONFIG_STR_LEN - 1);
            }
            index++;
            break;
...
UINTN Get_Next_CPU(UINTN current_cpu) {
   ...
   UINTN active_cpu_set[TOTAL_CPU] = {0};
   UINTN active_cpu, max_cpu;
   //UINTN tmp1, tmp2;
   BOOLEAN found_next_cpu;
   last_active_cpu = 0;
   max_cpu = MpcoreGetMaxCpuCount();
   ...
   for (i=0;i<max_cpu;i++) {
      switch (i)
      {
         ...
         case 8:  active_cpu = active_mask & 256;
                  break;
				  
         case 9:  active_cpu = active_mask & 512;
                  break;
				  
         case 10:  active_cpu = active_mask & 1024;
                  break;
				  
         case 11:  active_cpu = active_mask & 2048;
                  break;
...
EFI_STATUS Event_unsignal_test(VOID) {
   ...
   AsciiStrnCpyS((CHAR8 *)(thr_config[0].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U0", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[1].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U1", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[2].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U2", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[3].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U3", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[4].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U4", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[5].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U5", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[6].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U6", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[7].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U7", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[8].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U8", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[9].thread_name), TEST_CONFIG_STR_LEN, "EVENT_U9", TEST_CONFIG_STR_LEN - 1);
...
EFI_STATUS Sem_wait_test(VOID) {
   ...
   AsciiStrnCpyS((CHAR8 *)(thr_config[0].thread_name), TEST_CONFIG_STR_LEN, "SEM_W0", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[1].thread_name), TEST_CONFIG_STR_LEN, "SEM_W1", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[2].thread_name), TEST_CONFIG_STR_LEN, "SEM_W2", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[3].thread_name), TEST_CONFIG_STR_LEN, "SEM_W3", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[4].thread_name), TEST_CONFIG_STR_LEN, "SEM_W4", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[5].thread_name), TEST_CONFIG_STR_LEN, "SEM_W5", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[6].thread_name), TEST_CONFIG_STR_LEN, "SEM_W6", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[7].thread_name), TEST_CONFIG_STR_LEN, "SEM_W7", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[8].thread_name), TEST_CONFIG_STR_LEN, "SEM_W8", TEST_CONFIG_STR_LEN - 1);
...
EFI_STATUS Cpu_any_test(VOID) {
   UINTN thr_index, num_of_threads, max_cpu;
   //UINTN cp, previous_cpu, next_cpu;
   Thread *t;
   KStatus thread_status;
   int thread_rc;
   ...
   num_of_threads = max_cpu;
   //num_of_threads = 4;

   AsciiStrnCpyS((CHAR8 *)(thr_config[0].thread_name), TEST_CONFIG_STR_LEN, "CPU_C0", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[1].thread_name), TEST_CONFIG_STR_LEN, "CPU_C1", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[2].thread_name), TEST_CONFIG_STR_LEN, "CPU_C2", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[3].thread_name), TEST_CONFIG_STR_LEN, "CPU_C3", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[4].thread_name), TEST_CONFIG_STR_LEN, "CPU_C4", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[5].thread_name), TEST_CONFIG_STR_LEN, "CPU_C5", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[6].thread_name), TEST_CONFIG_STR_LEN, "CPU_C6", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[7].thread_name), TEST_CONFIG_STR_LEN, "CPU_C7", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[8].thread_name), TEST_CONFIG_STR_LEN, "CPU_C8", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[9].thread_name), TEST_CONFIG_STR_LEN, "CPU_C9", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[10].thread_name), TEST_CONFIG_STR_LEN, "CPU_C10", TEST_CONFIG_STR_LEN - 1);
   AsciiStrnCpyS((CHAR8 *)(thr_config[11].thread_name), TEST_CONFIG_STR_LEN, "CPU_C11", TEST_CONFIG_STR_LEN - 1);
...
EFI_STATUS Cpu_pin_test(VOID) {
   UINTN thr_index, num_of_threads;
   UINTN cp, previous_cpu, next_cpu, max_cpu;
...
int t_thread_yield2( IN VOID  *Arg)
{
   int cp;
   Thread *t;
   UINTN iteration_index,yield_start;
   UINT32 priority_level;
   priority_level = DEFAULT_PRIORITY - 1;
...
UINT32 get_cpu_mask (UINTN cpu) {
   ...
   switch (cpu)
   {
	  ...
	  case 8:  cpu_mask = 256; break;
	  case 9:  cpu_mask = 512; break;
	  case 10: cpu_mask = 1024; break;
	  case 11: cpu_mask = 2048; break; 
...
EFI_STATUS Thread_mpcore_en_all_test(VOID) {
   ...
   UINTN thr_index;
   UINTN num_of_child_threads = TOTAL_CPU;   
   Thread *t;
   UINTN thr_create_time;
   KStatus thread_status;
   INT32 thread_rc;
