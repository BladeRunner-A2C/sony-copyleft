...
STATIC CONST pcie_reg_write_val_t port_0_phy_init_seq[] =
{
    ...
    */
   {HWIO_OFFS(QSERDES_TX0_RES_CODE_LANE_OFFSET_RX),                             0x09},
   /*
    * QSERDES_TX0_RES_CODE_LANE_OFFSET_TX
    * 0x15: value for Lanai;
    * 0x18: value for others
    */
   {HWIO_OFFS(QSERDES_TX0_RES_CODE_LANE_OFFSET_TX),                             0x15},
   /*  */
    ...
    * 0x06: value for others
    */
   {HWIO_OFFS(QSERDES_TX1_RES_CODE_LANE_OFFSET_RX),                             0x09},
   /*
    * QSERDES_TX1_RES_CODE_LANE_OFFSET_TX
    * 0x15: value for Lanai;
    * 0x18: value for others
    */
   {HWIO_OFFS(QSERDES_TX1_RES_CODE_LANE_OFFSET_TX),                             0x15},
   /*  */
...
CONST pcie_clk_mux_cfg_t pcie_0_clk_mux =
{
...
CONST clk_freq_cfg_t pcie_0_clk_settings[] =
{
 ...
 ******************************************************************************/
#define RC_0_GPIO_PCIE_RESET      94
#define RC_0_GPIO_CLK_REQ         95
#define RC_0_GPIO_PCIE_WAKE       96

STATIC CONST pcie_gpio_cfg_t gpio_config_rp0[] =
{
  {
   .cfg_type = MSM_GPIO,
   {
 ...
 ******************************************************************************/
pcie_pmic_config_t port_0_pmic_cfg =
{
...
{
   .port_clk_cfg           = &pcie_clk_rp0,
   .port_gpio_cfg          = gpio_config_rp0,
   .iommu_cfg              = "PCIE0",
   .pmic_cfg               = &port_0_pmic_cfg,
   .vcs_cfg                = NULL,
};
 ...
 ******************************************************************************/
const pcie_port_config_t lanai_port_0_cfg[] =
{
   {
      .hw_rp_index            = 0,
...
const uint8_t lanai_port_0_cfg_len = ARRAY_LENGTH(lanai_port_0_cfg);
