...
Copyright 2010, 2015 - 2019, 2023 by Qualcomm Technologies Inc.  All Rights Reserved.
=============================================================================*/
...
static bl_error_boot_type boot_get_time2(uint32 ref_time, uint32 *crt_time)
{
  ...
  do
  {
    ...
    uint32 curr_time = ltimer_hw_if->get_aoss_sleep_cntr_us();
...
static bl_error_boot_type boot_get_time_count2(uint32 *crt_time)
{
  ...
  do
  {
    ...
    *crt_time = ltimer_hw_if->get_aoss_sleep_cntr_us();
