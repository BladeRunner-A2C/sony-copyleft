...
**  Function :  boot_flash_led_module_control

** ==========================================================================
*/
/*!
 * @brief This function controls the pmic function to enable/disable Flash LED
 */
bl_error_boot_type boot_flash_led_module_control(uint32 pmic_device_index, uint8 enable)
{
  boot_boolean ret_val = TRUE;
  ...
  ret_val = pmic_if->pm_flash_led_module_control(pmic_device_index, enable);
