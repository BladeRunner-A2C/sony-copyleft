...
//============================================================================
/**
  Copyright (c) 2016-2019, 2020-23 Qualcomm Technologies, Inc. All rights reserved.
...
ProcessCommand (UINTN Argc, CHAR8** Argv)
{
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ToggleDGPU") == 0)
    ToggleDGPU((CHAR8*) ArgStr);
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ToggleEnableMemMap") == 0)
    ToggleEnableMemMap((CHAR8*) ArgStr);
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ChargerPDLogLevel") == 0)
    SetChargerPDLogLevel ((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ChargerPDLogTimer") == 0)
    SetChargerPDLogTimer ((CHAR8*) ArgStr);    
  
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SocBasedBoot") == 0)
    SetBootThresholdCfgOption ((CHAR8*) ArgStr);  

  else if (AsciiStriCmp((CHAR8*)CmdStr, "EnableChargingLimit") == 0)
    ToggleChargingLimit();

  else if (AsciiStriCmp((CHAR8*)CmdStr, "EnableBatteryAuthentication") == 0)
    ToggleBatteryAuthentication(); 

  else if (AsciiStriCmp((CHAR8*)CmdStr, "UnauthenticatedBatteryChargingEnable") == 0)
    ToggleUnauthenticatedBatteryCharging();   
  
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "MDMCrashRecovery") == 0)
    ToggleMDMCrashRecovery();
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsbConfigTertiaryPort") == 0)
     SetUsbConfigTertiaryPort ((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsbConfigMultiPort") == 0)
     SetUsbConfigMultiPort ((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsbDevicePort") == 0)
     SetUsbDevicePort ((CHAR8*) ArgStr);
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "EnableHighSpeedOnlyForPrimary") == 0)
    EnableHighSpeedOnlyForPrimary((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "EnableHighSpeedOnlyForSecondary") == 0)
    EnableHighSpeedOnlyForSecondary((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "EnableHighSpeedOnlyForTertiary") == 0)
    EnableHighSpeedOnlyForTertiary((CHAR8*) ArgStr);
  
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "EnableHighSpeedOnlyForMP") == 0)
    EnableHighSpeedOnlyForMP((CHAR8*) ArgStr);
  
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsbMultiPortDisableBitfield") == 0)
    SetUsbMultiPortDisableBitfield((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ToggleEnableUsb4Uefi") == 0)
    ToggleEnableUsb4Uefi((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ToggleWakeOnLAN") == 0)
    ToggleWakeOnLAN();

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ToggleForceUsbWakeOnLanInUefi") == 0)
    ToggleForceUsbWakeOnLanInUefi();

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ToggleForceUsb4RetimerDP4LANE") == 0)
    ToggleForceUsb4RetimerDP4LANE();
    
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsb3HLOSConfigPrimaryPort") == 0)
    SetUsb3HLOSConfigPrimaryPort((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsb3HLOSConfigSecondaryPort") == 0)
    SetUsb3HLOSConfigSecondaryPort((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsb3HLOSConfigTertiaryPort") == 0)
    SetUsb3HLOSConfigTertiaryPort((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsb4HLOSConfigPrimaryPort") == 0)
    SetUsb4HLOSConfigPrimaryPort((CHAR8*) ArgStr);
  
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsb4HLOSConfigSecondaryPort") == 0)
    SetUsb4HLOSConfigSecondaryPort((CHAR8*) ArgStr);
  
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetUsb4HLOSConfigTertiaryPort") == 0)
    SetUsb4HLOSConfigTertiaryPort((CHAR8*) ArgStr);    
	
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ResetUsbUefiVariable") == 0)
    ResetUsbUefiVariable((CHAR8*) ArgStr);
    
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ForcePowerTesting") == 0)
    ToggleForcePowerTesting();
    

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "SetDPModeConfigTertiaryPort") == 0)
    SetDPModeConfigTertiaryPort();

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ChargerAppOffmodeCharging") == 0)
    ToggleChargerAppOffmodeCharging();
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "OffmodeChargingSleepTime") == 0)
    SetOffmodeChargingSleepTime ((CHAR8*) ArgStr);
