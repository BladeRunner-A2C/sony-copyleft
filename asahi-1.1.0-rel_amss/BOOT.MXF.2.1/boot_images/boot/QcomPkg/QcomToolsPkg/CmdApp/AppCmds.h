...
/*
 * Handler for SetUsbConfigMultiPort Command
 */
EFI_STATUS
...
/*
 * Toggle force power testing in uefi on/off
 */
EFI_STATUS
...
/*
 * Toggle chargerApp offmode charging
 */
EFI_STATUS
ToggleChargerAppOffmodeCharging(VOID);

/*
 * Handler to set charging loop sleep time
 */
EFI_STATUS
