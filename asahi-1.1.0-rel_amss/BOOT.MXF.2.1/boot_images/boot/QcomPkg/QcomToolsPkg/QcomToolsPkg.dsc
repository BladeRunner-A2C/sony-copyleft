...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/QcomTools
...
[Components.common]
  ...
  QcomPkg/QcomToolsPkg/UfsEyemonApp/UfsEyemonApp.inf
  ...
  QcomPkg/QcomToolsPkg/CapsuleApp/CapsuleApp.inf
  QcomPkg/Application/Ebl/Ebl.inf

  QcomPkg/QcomToolsPkg/MpTest/MpTest.inf
...
#
[Components.common]
  SomcPkg/SomcTestPkg/XUtilTestApp/XUtilTestApp.inf
  SomcPkg/SomcTestPkg/XHwresetTestApp/XHwresetTestApp.inf {
    <LibraryClasses>
      XHwresetApiLib|SomcPkg/Library/XHwresetApiLib/XHwresetApiLib.inf
      PmicLib|QcomPkg/SocPkg/Lanai/Library/PmicLib/PmicLib.inf
      PmicCoreLib|QcomPkg/SocPkg/Lanai/Library/PmicLib/core/PmicCoreLib.inf
      SPMIApiLib|QcomPkg/Library/SPMIApiLib/SPMIApiLib.inf
  }
  SomcPkg/SomcTestPkg/MazeTestApp/MazeTestApp.inf
  SomcPkg/SomcTestPkg/XResetReasonTestApp/XResetReasonTestApp.inf
  SomcPkg/SomcTestPkg/PALTestApp/PALTestApp.inf {
    <LibraryClasses>
...
[LibraryClasses.common]
  ...
  XHapticsLib|SomcPkg/Platform/SomcQcomCmnPkg/Library/XHapticsLib/XHapticsLibNull.inf
  XBootPALLib|SomcPkg/Platform/SomcSm8650Pkg/Library/XBootPALLib/XBootPALLib.inf
!endif # FEATURE_XBOOT
