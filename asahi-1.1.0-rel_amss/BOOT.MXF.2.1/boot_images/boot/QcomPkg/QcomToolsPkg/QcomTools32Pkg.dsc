...
# QcomTools package.
#
# Copyright (c) 2016-2020, 2021-2023 Qualcomm Technologies, Inc. All rights reserved.
...
[Defines]
  ...
  OUTPUT_DIRECTORY               = $(BUILDROOT)/Build/QcomTools32
...
# 2.0 Shell
 ...
 #    NULL|ShellPkg/Library/UefiShellNetwork1CommandsLib/UefiShellNetwork1CommandsLib.inf    #commenting as internally its using NetLib which is not present in MdeModulePkg
