...
*
*$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Drivers/PmicGlinkDxe/pmic_glink_msg.h#1 $
...
//opcode for HLOS SHDN request
#define BATT_MNGR_SET_SHDN_REQ                      0x0047
...
/** Resquest Message; this is for generic usage */
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
}batt_mngr_generic_req_msg;  /* Message */
/**
    @}
  */
