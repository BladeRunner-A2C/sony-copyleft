...
*
*$Header: //components/dev/core.qdsp6/8.1/chunmeis.core.qdsp6.8.1.hamoa_adsp_0111/battman/framework/pmicglink/inc/pmic_glink_msg.h#1 $
*$DateTime: 2023/01/11 10:50:46 $
*$Author: chunmeis $
=============================================================================
EDIT HISTORY
...
--------       ---     -----------------------------------------------------------
11/26/2018     ivy     Support generic test interface
10/22/2018     dch     Update pin assingment API implementation
06/18/2018     dch     Support pin assignment command/ack
03/07/2018     cs      added ucsi interface support.
=============================================================================*/

#include "pmic_glink_power_supply_msg.h"
...
#define	PMIC_GLINK_MSG_OWNER_USBC_PAN    32780
#define	PMIC_GLINK_MSG_OWNER_QBG_DEBUG   32781
#define PMIC_GLINK_MSG_OWNER_OEM         32782
#define PMIC_GLINK_MSG_OWNER_REG_DUMP    32783
...
//opcode for PMIC_GLINK_MSG_OWNER_CHARGER owner
...
#define BATT_MNGR_GET_AGGREGATOR_INFO_REQ           0x0015
#define BATT_MNGR_OVERWRITE_VOTEABLE_REQ            0x0016
#define BATT_MNGR_GET_VOTEABLE_REQ                  0x0017
#define BATT_MNGR_GET_ULOG_REQ                      0x0018
#define BATT_MNGR_SET_LOGGING_PROP_REQ              0x0019 
#define BATT_MNGR_GET_TEST_INFO_REQ                 0x0020      
#define BATT_MNGR_NOTIFY_SHUTDOWN                   0x0022
#define BATT_MNGR_GET_INIT_ULOG_REQ                 0x0023      
#define BATT_MNGR_POWER_SUPPLY_GET_REQ              0x0030
#define BATT_MNGR_POWER_SUPPLY_SET_REQ              0x0031
#define USB_POWER_SUPPLY_GET_REQ                    0x0032
#define USB_POWER_SUPPLY_SET_REQ                    0x0033
#define DC_POWER_SUPPLY_GET_REQ                     0x0034
#define DC_POWER_SUPPLY_SET_REQ                     0x0035
#define BATT_MNGR_SET_SHIP_MODE_REQ                 0x0036
#define WLS_IDT_FW_CHECK_REQ                        0x0040
#define WLS_IDT_FW_PUSH_BUFFER_REQ                  0x0041
#define WLS_IDT_FW_STATUS_REQ                       0x0042
#define WLS_IDT_FW_PUSH_BUFFER_MSG_REQ              0x0043
#define WLS_IDT_FW_GET_REVISION_REQ                 0x0044 //wls_idt_fw_get_revision_msg

#define BATT_MNGR_GET_DEBUG_PARAM_REQ               0x0045
#define BATT_MNGR_SET_DEBUG_PARAM_REQ               0x0046
#define BATT_MNGR_GET_CHARGER_POWER_REQ             0x0047

// opcode for enable/disable charging limit
#define BATT_MNGR_ENABLE_CHRG_LIMIT                 0x0048 

//opcode for PMIC_GLINK_MSG_OWNER_QBG_DEBUG owner
#define BATT_MNGR_GET_QBG_DUMP_REQ                  0x0036



//opcode for PMIC_GLINK_MSG_OWNER_REG_DUMP
#define BATT_MNGR_GET_PMIC_REG_REQ                  0x0037
#define BATT_MNGR_SET_PMIC_REG_REQ                  0x0038


/*opcode definition maps to UCSI and USBC calls*/
#define UCSI_USBC_NOTIFY_RECEIVER_UCSI         0x0
#define UCSI_USBC_NOTIFY_RECEIVER_USBC         0x1
//UCSI opcode
#define UCSI_READ_BUFFER_REQ                   0x0011
#define UCSI_WRITE_BUFFER_REQ                  0x0012
#define UCSI_NOTIFY_IND                        0x0013
//USBC opcode
#define USBC_CMD_READ_REQ                      0x0014
#define USBC_CMD_WRITE_REQ                     0x0015
#define USBC_NOTIFY_IND                        0x0016


//OEM specific opcodes
#define OEM_OPCODE_READ_BUFFER               0x0101
#define OEM_OPCODE_WRITE_BUFFER              0x0102
#define OEM_OPCODE_NOTIFY_IND                0x0103
#define OEM_OPCODE_SEND_RECEIVE_BUFFER       0x0104


#define BATT_MNGR_NUM_RSP_TYPE               0x0105
...
@}
*/
/** @addtogroup batt_mngr_charging_source_req_type_e
    @{
  */
typedef enum {
...
/** @addtogroup batt_mngr_chg_cmd_req_type_e
    @{
  */
typedef enum {
...
/**
 ...
 /**  for oem to add oem specific property ID*/
 /** @addtogroup oem_property_id_type_e
    @{
  */
typedef enum {
  /**< add oem specify properties here*/
...
/**
  ...
  */
typedef enum {
  BATTMAN_DEBUG_PARAM_SET_ICL = 0,
  BATTMAN_DEBUG_PARAM_SUSPEND_USB,
  BATTMAN_DEBUG_PARAM_SMB_SETTING,
  BATTMAN_DEBUG_PARAM_CHG_TEMP_OVR,
  BATTMAN_DEBUG_PARAM_SET_MAIN_TEMP,
  BATTMAN_DEBUG_PARAM_SET_SMB_TEMP,
  BATTMAN_DEBUG_PARAM_WLS_TX_SOURCE,
  BATTMAN_DEBUG_PARAM_EN_OPT_MTC_CHG,
  BATTMAN_DEBUG_PARAM_USB_OTG_SOURCE,
  BATTMAN_DEBUG_PARAM_WLS_TX_DIE_TEMP_TH,
  BATTMAN_DEBUG_PARAM_WLS_RX_DIE_TEMP_TH,
  BATTMAN_DEBUG_PARAM_ICM_PT_OVR,
  BATTMAN_DEBUG_PARAM_UFCS_SUPPORT,
  BATTMAN_DEBUG_PARAM_MAX
}battman_debug_param_type_e;

/**
    @}
  */

/** @addtogroup batt_mngr_get_batt_id_resp_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_charger_status_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_charger_status_resp_msg
    @{
  */
...
/** @addtogroup batt_mngr_control_charging_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_set_status_notification_criteria_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_set_charge_rate_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_notify_ind_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_sbs_resp_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_battery_information_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_battery_information_resp_msg
    @{
  */
...
/** @addtogroup batt_mngr_set_averaging_interval_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_set_sampling_time_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_discharge_time_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_discharge_time_resp_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_charge_time_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_charge_time_resp_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_bmd_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_bmd_resp_msg
    @{
  */
...
/** @addtogroup batt_mngr_set_bmc_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_generic_info_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_generic_info_resp_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_test_info_req_msg
    @{
  */
...
/** @addtogroup batt_mngr_get_test_info_resp_msg
    @{
  */
...
//ucsi usbc write buffer resp message
typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    uint32 return_code;
}ucsi_usbc_write_buffer_resp_msg;
...
//usbc read buffer request  message
typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    uint32 reserved;
}usbc_read_buffer_req_msg;

//usbc read buffer response message
typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    uint8 read_buffer[USBC_READ_BUFFER_SIZE];
    uint32 return_code;
}usbc_read_buffer_resp_msg;

//usbc write buffer request  message
typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    uint8 write_buffer[USBC_WRITE_BUFFER_SIZE];
    uint32 reserved;
}usbc_write_buffer_req_msg;
...
typedef struct {
  ...
  /* Mandatory */
  uint8 payload[USBC_NOTIFY_PAYLOAD_SIZE];
  uint32 reserved;
  /* Reserved for padding */
}usbc_notify_ind_msg;  /* Message */

//pwoer supply properties request  message
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  uint32 battery_id;
  uint32 property_id;
  uint32 value;   /* not used for get msg, used for set msg*/
}power_supply_property_req_msg;

//pwoer supply properties response  message
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  uint32 property_id;
  uint32 value;
  uint32 return_code;
}power_supply_property_resp_msg;

/** request Message; set battman logging properties */
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  uint64 categories;
  uint32 level;
}battman_set_log_properties_req_msg;  /* Message */
extern battman_set_log_properties_req_msg set_log_prop;  

/** request Message; to get ulogs from chargerPD */
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  uint32 max_logsize;
}battman_get_log_req_msg;  /* Message */

/** Response Message; to get ulogs from chargerPD */
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  char read_buffer[MAX_ULOG_READ_BUFFER_SIZE];    
}battman_get_log_resp_msg;  /* Message */

/** Response Message; to get battery model power supply property */
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 property_id;
  char battery_model[BATT_MNGR_MAX_STRING_LEN];  
}battman_get_battery_model_resp_msg;  /* Message */


/** Resquest Message; to get QBG device context dump*/
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 battery_cell_id;
}battman_get_qbg_dump_req_msg;  /* Message */


/** Response Message; to get QBG device context dump */
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 dump_size;
  uint32 data_buffer[MAX_QBG_DUMP_SIZE];    //MAX_QBG_DUMP_SIZE is not the same as QBG_DEVICE_CONTEXT_SIZE
  
}battman_get_qbg_dump_resp_msg;  /* Message */

/** Resquest Message; for OEM read buffer*/
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 oem_property_id;
  uint32 data_size;
}battman_oem_read_buffer_req_msg;  /* Message */


/** Response Message; for OEM read buffer*/
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 oem_property_id;
  uint32 data_buffer[MAX_OEM_PROPERTY_DATA_SIZE];
  uint32 data_size; //size = 0 if failed, otherwise should be data_size.
}battman_oem_read_buffer_resp_msg;  /* Message */

/** Resquest Message; for OEM write buffer*/
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 oem_property_id;
  uint32 data_buffer[MAX_OEM_PROPERTY_DATA_SIZE];
  uint32 data_size;
}battman_oem_write_buffer_req_msg;  /* Message */
/** Response Message; for OEM write buffer use batt_mngr_generic_resp_msg*/

/** Request response Message; for OEM_OPCODE_SEND_RECEIVE_BUFFER */
typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    /**< pmic glink header */
    /* Mandatory */
    uint32 data_size;
    uint32 oem_buffer[MAX_OEM_PROPERTY_DATA_SIZE];
    /**<   command type */
}battman_oem_send_receive_req_resp_msg;  /* Message */                   

typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 debug_param_property_id;
}battman_get_debug_param_req_msg;  /* Message */

/** Response Message; for get debug param */
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 debug_param_property_id;
  uint32 data;
  uint32 status;
} battman_get_debug_param_resp_msg;  /* Message */
...
typedef struct { 
  ...
  uint32 debug_param_property_id;
  uint32 data;
}battman_set_debug_param_req_msg;  /* Message */
/** Response Message; for SET DEBUG PARAM use batt_mngr_generic_resp_msg*/

////////////////////////////Read Write Pmic Registers//////////////////////////////
/** Resquest Message; to read PMIC Register Dump*/
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 spmi_bus_id;       /*Prmary SPMI bus=0, QUP SPMI bus=1*/
  uint32 pmic_slave_id;     /*PMIC global slave ID for the specified SPMI bus*/
  uint32 address;           /*16 bit SPMI address within the specified Slave ID*/
  uint32 byte_count;        /*number of bytes to read (1-256)*/ 
}battman_get_reg_dump_req_msg;  /* Message */


/** Response Message; to read PMIC Register Dump*/
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 spmi_bus_id;       /*Prmary SPMI bus=0, QUP SPMI bus=1*/
  uint32 pmic_slave_id;     /*PMIC global slave ID for the specified SPMI bus*/
  uint32 address;           /*16 bit SPMI address within the specified Slave ID*/
  uint32 byte_count;        /*number of bytes to read (1-256)*/ 
  uint8 data[MAX_REG_DUMP_SIZE];          /*byte data of size byte_count read*/
}battman_get_reg_dump_resp_msg;  /* Message */


/** Resquest Message; to write PMIC Register*/
typedef struct { 
  PMIC_GLINK_HEADER_TYPE header;
  uint32 spmi_bus_id;       /*Prmary SPMI bus=0, QUP SPMI bus=1*/
  uint32 pmic_slave_id;     /*PMIC global slave ID for the specified SPMI bus*/
  uint32 address;           /*16 bit SPMI address within the specified Slave ID*/
  uint32 data;              /*byte data to write*/
}battman_set_reg_req_msg;  /* Message */


////////////////////////////Get Votable //////////////////////////////
/** Request Message; to get voteable information */
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  uint32 voteable_id;
}battman_get_voteable_req_msg;  /* Message */

/** Response Message; for get voteable information*/
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  uint32 voteable_id; //voteable property ID, 0: iusb, 1: FCC, 2: FV
  uint32 effective_value;
  uint8  voters[32];
  uint32 voted_values[32];
  uint32 voter_enable_status;
  uint32 effective_voter_id;
  uint32 overwrite_voter_id;
}battman_get_voteable_resp_msg;  /* Message */


/** @addtogroup batt_mngr_get_aggregator_info_req_msg
    @{
  */
/** Request Message; Get the aggregator manager info */
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
}batt_mngr_get_aggregator_info_req_msg;  /* Message */

/** Response Message; for get aggregator manager info*/
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  uint32 num_of_aggregators;
  uint32 num_of_clients;
  char aggregator_names[BATTMNGRTECH_MAX_NUM_AGGREGATOR][BATTMNGRTECH_AGGREGATOR_NAME_MAX_LENGTH];
  char clients_names[32][BATTMNGRTECH_AGGREGATOR_NAME_MAX_LENGTH]; //names of all the clients.
}battman_get_aggregator_info_resp_msg;  /* Message */


////////////////////////////overwrite Votable value //////////////////////////////
/** Request Message; to overwrite voteable with value*/
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  uint32 voteable_id;
  uint32 overwrite_value;
}battman_overwrite_voteable_req_msg;  /* Message */

/** Response Message; for overwrite voteable response msg, use batt_mngr_generic_resp_msg*/

////////////////////////////WLS IDT FW value //////////////////////////////
/** Request Message; to get wls idt FW bin revision*/
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  /**< pmic glink header */
  /* Mandatory */
  uint32 fw_bin_revision;
  uint32 fw_bin_size;
  uint32 fw_bin_crc;
}wls_idt_fw_check_req_msg;  /* Message: APPS to ADSP */

typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  /**< pmic glink header */
  /* Mandatory */
  uint32 fw_should_update;
}wls_idt_fw_check_resp_msg;  /* Message  ADSP to APPS*/

typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  /**< pmic glink header */
  /* Mandatory */
}wls_idt_fw_get_revision_req_msg;  /* Message : APPS to ADSP*/
...
typedef struct {
  ...
  /* Mandatory */
  uint32 fw_revision;
}wls_idt_fw_get_revision_resp_msg;  /* Message : ADSP to APPS*/

typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    uint32 fw_status; //set 1 if this 128 bytes are successfully flashed into IDT memory
}wls_idt_fw_push_buffer_msg;

#define MTP_PROGRAM_BLOCK_SIZE                0x80  //128
typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    uint8 read_buffer[MTP_PROGRAM_BLOCK_SIZE]; //0x80, 128 bytes
    uint32 chunk_num;  //start from 1. plus 1 every time Linux battery driver send 128 bytes chunk 
}wls_idt_fw_push_buffer;
...
typedef struct {
  ...
  /* Mandatory */
  uint32 fw_update_ok;
}wls_idt_fw_status_req_msg;  /* Message */

typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    uint32 ship_mode_type;
}battman_set_ship_mode_req_msg;

/* Request Message */
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
}battman_get_charger_power_req_msg;  /* Message */

/* Response Message; Get the charger status and input power */
typedef struct {
  PMIC_GLINK_HEADER_TYPE header;
  batt_mngr_charging_source_req_type_e charging_source;
  uint32 voltage_mv;
  uint32 current_ma;
  uint32 return_code;
}battman_get_charger_power_resp_msg;  /* Message */

/** @addtogroup BATT_MNGR_ENABLE_CHRG_LIMIT
    @{
  */
  /** Request Message; enable charging limit - 1, disable - 0 */
typedef struct {
    PMIC_GLINK_HEADER_TYPE header;
    /**< pmic glink header */
    ...
    uint32 delta_soc;
    /**<   command type */
}battman_enable_charging_limit_req_msg;  /* Message */
