...
*
* Copyright (c) 2011-2019, 2022 Qualcomm Technologies, Inc.  All Rights Reserved. 
...
--------   ---     ---------------------------------------------------------- 
06/15/22   xj      Adding API for selecting current source pulls type
...
)
{
  ...
  errFlag = pm_gpio_set_pull_sel(PmicDeviceIndex,  
                                (pm_gpio_perph_index) Gpio,
                                (pm_gpio_pull_sel_type) GpioPullType);
