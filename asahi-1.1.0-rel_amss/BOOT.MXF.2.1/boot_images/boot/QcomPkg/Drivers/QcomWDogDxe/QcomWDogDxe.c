...
VOID
QcomWdogResetSystem (IN EFI_RESET_TYPE  ResetType,
  IN EFI_STATUS      ResetStatus,
  IN UINTN           DataSize,
  IN VOID            *ResetData OPTIONAL
  )
{
  DisableWdogAndPetEBSCb(NULL, NULL);
}
...
ResetNotificationProtocolCb ()
{
  ...
  Status = ResetNotifyProtocol->RegisterResetNotify(ResetNotifyProtocol, QcomWdogResetSystem);
