 ...
 *
 * Copyright (c) 2014, 2017, 2023 by QUALCOMM Technologies, Inc. All Rights Reserved.
 */ 
/*==============================================================================
 EDIT HISTORY
...
ON_EXIT:
  ...
  if (EFI_ERROR(Status)) {
    gBS->CopyMem(UsbDevSm->SerialNumber, (VOID *)((CHAR8 *)StrSerialDescriptor + 2), sizeof(StrSerialDescriptor) - 2);
    UsbDevSm->SerialNumberLen = sizeof(StrSerialDescriptor) - 2;
  }  
  return Status;
}
