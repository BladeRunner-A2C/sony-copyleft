 ...
 *
 * Copyright (C) 2014-2022 by Qualcomm Technologies, Inc.  All Rights Reserved. 
 */
/*==============================================================================
 EDIT HISTORY
...
extern EFI_GUID gInitUsbDisableUsbControllerGuid;
extern EFI_GUID gInitUsbEnableUsbControllerGuid;
...
/**
 * @brief Polls SS USB PHY for handling special training sequence
 *
 * The function implements QCOM_USB_CONFIG_PROTOCOL_POLL_SS_PHY_TRAINING
 *
 * @see EFIUsbConfig.h
 */
EFI_STATUS
...
/**
 * @brief Advances SS compliance pattern
 *
 * The function implements QCOM_USB_CONFIG_ADVANCE_CMPL_PATTERN
 *
 * @see EFIUsbConfig.h
 */
...
/**
 * @brief Get Wake on LAN state
 *
 * The function implements QCOM_USB_CONFIG_PROTOCOL_GET_WOL_STATE
 *
 * @see EFIUsbConfig.h
 */
...
/**
 * @brief Set Wake on LAN state
 *
 * The function implements QCOM_USB_CONFIG_PROTOCOL_SET_WOL_STATE
 *
 * @see EFIUsbConfig.h
 */
