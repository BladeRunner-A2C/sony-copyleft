...
Portions copyright (c) 2010 - 2022 Qualcomm Technologies, Inc. All rights reserved.
...
#define USB_CDC_CONTROL_CLASS  0x02
...
typedef struct _USB_CONTEXT
{
    ...
    EFI_EVENT                                UsbBusChangeWoLEvt;
    BOOLEAN                                  WoLSuspendArmed;
    USB_DEVICE                               *WoLDevice;
#endif
