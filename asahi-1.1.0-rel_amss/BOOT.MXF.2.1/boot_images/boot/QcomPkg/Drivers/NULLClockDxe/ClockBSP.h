...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Drivers/NULLClockDxe/ClockBSP.h#1 $
 ...
 *    reconfigured.
 *  IGNORE_OFF_STATUS - Indicates this clock or power domain must
 *    not wait for the ON Status Bit to change to the OFF state.
 *  IGNORE_ON_STATUS - Indicates this clock or power domain must
 *    not wait for the ON Status Bit to change to the ON state.
...
#define CLOCK_FLAG_DONT_FORCE_DYNAMIC_SWITCH  PUBLIC_CLOCK_FLAG_RESERVED_0x00000040
#define CLOCK_FLAG_INITIALIZED                PUBLIC_CLOCK_FLAG_RESERVED_0x00000080
...
#define CLOCK_FLAG_IGNORE_OFF_STATUS          PUBLIC_CLOCK_FLAG_RESERVED_0x00001000
...
#define CLOCK_FLAG_IGNORE_ON_STATUS           PUBLIC_CLOCK_FLAG_RESERVED_0x00800000
...
{
  uint32 nRequired;     /**< Number of active required requests */
  uint32 nSuppressible; /**< Number of active suppressible requests */
} ClockRefCountType;
