...
/*
  ...
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Drivers/NULLClockDxe/ClockDriver.h#1 $
...
/**
  ...
  @param *pRail [in] -- Pointer to rail being requested.
...
ClockResult Clock_QueryClock(ClockHandle hClient, ClockIdType ClockId, ClockQueryType eQuery, uint32_t nPerfLevel, ClockQueryResultType *pResult);
