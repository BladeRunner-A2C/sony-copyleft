...
int Usb4PlatformAhbAccess_configure_usbap_usb4_mode(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx)
{
    ...
    HWIO_OUTXF((UINT64)base, GE_DUT_USB4_CTRL_REG, USB31_CTRL_MODE, 1); // Configure CIO mode for usb4 controller
#else
    base = usb4_platform_ahb_access_ctx->m_coreBaseAddress + USBAP_CONFIG_PROP_REG_BASE_OFFS;
    HWIO_OUTXF((UINT64)base, USB4_USBAP_CFG_USB4_MODE, USB4_MODE, 1); // Configure CIO mode of USBAP
...
int Usb4PlatformAhbAccess_PrepareUSB3Sleep(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx)
{
    ...
    usb4_platform_ahb_access_ctx->m_USBAP_CFG_RXTERM_BACKDOOR_STS = HWIO_INXF((UINT64)base, USB4_USBAP_CFG_RXTERM_BACKDOOR_STS, RX_TERM_STS);

    HWIO_OUTXF((UINT64)base, USB4_USBAP_CFG_TXDETECTRX_STS, TXDETECTRX, 0x1);      /* Clear RX.Detect status */
    while(1!= HWIO_INXF((UINT64)base, USB4_USBAP_CFG_TXDETECTRX_STS, TXDETECTRX))
...
int Usb4PlatformAhbAccess_PrepareUSB3Wakeup(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx)
{
    ...
    HWIO_OUTXF((UINT64)base, USB4_USBAP_CFG_RXTERM_BACKDOOR_CTRL, RX_TERM_VALUE, usb4_platform_ahb_access_ctx->m_USBAP_CFG_RXTERM_BACKDOOR_STS);
    HWIO_OUTXF((UINT64)base, USB4_USBAP_CFG_PHYSTATUS_EN, PHYSTATUS_EN, 0x1);  /* USB4_USBAP_CFG_PHYSTATUS_EN.PHYSTATUS_EN=1 */   
...
int Usb4PlatformAhbAccess_AssertDeassertUSBReset(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx)
{
    ...
    HWIO_OUTXF((UINT64)base + USBAP_CONFIG_PROP_REG_BASE_OFFS, USB4_USBAP_CFG_SYNC_RST, SYS_CLK_SYNC_RST_USB3, 0x1);      /* Assert USB4_USBAP_CFG_SYNC_RST */
    HWIO_OUTXF((UINT64)base + GE_DUT_USER_REGS_REG_BASE_OFFS, GE_DUT_RESET_REG, USB4_USB_PIPE_ARES, 0x1);                /*  GE_DUT_RESET_REG.USB4_USB_PIPE_ARES */ 
    HWIO_OUTXF((UINT64)base + GE_DUT_USER_REGS_REG_BASE_OFFS, GE_DUT_RESET_REG, USB4_CTRL_PIPE_ARES, 0x1);               /*  GE_DUT_RESET_REG.USB4_USB_PIPE_ARES */
...
#else /* !RUMI */
    HWIO_OUTXF((UINT64)base + USBAP_CONFIG_PROP_REG_BASE_OFFS, USB4_USBAP_CFG_PHYSTATUS_EN, PHYSTATUS_EN, 0x1);           /* USB4_USBAP_CFG_PHYSTATUS_EN.PHYSTATUS_EN */
#endif /* !RUMI */
    ...
    HWIO_OUTXF((UINT64)base + GE_DUT_USER_REGS_REG_BASE_OFFS, GE_DUT_RESET_REG, USB4_CTRL_PIPE_ARES, 0x0);              /*  GE_DUT_RESET_REG.USB4_USB_PIPE_ARES */
    HWIO_OUTXF((UINT64)base + GE_DUT_USER_REGS_REG_BASE_OFFS, GE_DUT_RESET_REG, USB4_USB_PIPE_ARES, 0x0);               /*  GE_DUT_RESET_REG.USB4_USB_PIPE_ARES */
    HWIO_OUTXF((UINT64)base + USBAP_CONFIG_PROP_REG_BASE_OFFS, USB4_USBAP_CFG_SYNC_RST, SYS_CLK_SYNC_RST_USB3, 0x0);      /* Assert USB4_USBAP_CFG_SYNC_RST */
    usb4_timer_Sleep_ms(&timer, 10);
...
int Usb4PlatformAhbAccess_configure_usbap_device_mode(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, boolean bDevice)
{
    ...
    HWIO_OUTXF((UINT64)base, USB4_USBAP_CFG_USB3_CTRL_MODE, USB3_CTRL_DEVICE_MODE, val); /* use it to enable USB AP CONFIG PROP configuration */
    ...
    else
    {
        ...
        HWIO_OUTX((UINT64)base, USBAP_STNDRD_BASIC_CFG_DW2_FIX_VALUES_PROP, 0x200101); 
    }
                                                                ...
                                                                boolean bEnable)
{
    ...
    // TODO should use #port->WriteSegment() instead
    HWIO_OUTX((UINT64)base, USB4_USB_AP_PATH_CS_1_STANDARD, cs1);
    ...
    if( 1 == pPath->PATH_CS_0.Valid)
    {
        ...
        timer.m_source = USB4_TIMER_SOURCE_QTIMER;
        pPath->PATH_CS_0.Valid = 0;
        HWIO_OUTX((UINT64)base, USB4_USB_AP_PATH_CS_0_STANDARD, cs0);
        usb4_timer_Sleep_ms(&timer, 1);
        pPath->PATH_CS_0.Valid = 1;
        HWIO_OUTX((UINT64)base, USB4_USB_AP_PATH_CS_0_STANDARD, cs0);
    }
    ...
    HWIO_OUTXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_0_STANDARD, VALID, 0x1);

    HWIO_OUTXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_0_STANDARD, PATH_ENABLE, bEnable);
...
int Usb4PlatformAhbAccess_USB3_VBUS_on_off(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, UINT32 CoreId, boolean State)
{
    ...
    HWIO_OUTXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_0_STANDARD, VALID, State);
    HWIO_OUTXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_0_STANDARD, PATH_ENABLE, State);
...
int Usb4PlatformAhbAccess_USB4_USBAP_mask_credits(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, boolean Credit)
{
    ...
    HWIO_OUTX((UINT64)base, USB4_PGRX_MASK_BUFFER, credit_mask);
...
int Usb4PlatformAhbAccessAssertUSBAPReset(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, boolean assert)
{
    ...
    base = usb4_platform_ahb_access_ctx->m_coreBaseAddress + USBAP_CONFIG_PROP_REG_BASE_OFFS;
    HWIO_OUTXF((UINT64)base, USB4_USBAP_CFG_SYNC_RST, SYS_CLK_SYNC_RST_USB3, assert);
...
int Usb4PlatformAhbAccessUSBAPPHYStatusEnable(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, boolean bEnable)
{
    ...
    base = usb4_platform_ahb_access_ctx->m_coreBaseAddress + USBAP_CONFIG_PROP_REG_BASE_OFFS;
    HWIO_OUTXF((UINT64)base, USB4_USBAP_CFG_PHYSTATUS_EN, PHYSTATUS_EN, bEnable); /* USB4_USBAP_CFG_PHYSTATUS_EN.PHYSTATUS_EN */
...
int Usb4PlatformAhbAccess_USB4_USBAP_BUF_access(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, boolean R_W)
{
    ...
    HWIO_OUTXF((UINT64)base, USBAP_TXBUF_WR_DATA_31_0_PROP, TXBUFF_WR_DATA_31_0, TX_WR_DATA_31_0);
    HWIO_OUTXF((UINT64)base, USBAP_TXBUF_WR_DATA_63_32_PROP, TXBUFF_WR_DATA_63_32, TX_WR_DATA_63_32);
    HWIO_OUTXF((UINT64)base, USBAP_TXBUF_WR_DATA_95_64_PROP, TXBUFF_WR_DATA_95_64, TX_WR_DATA_95_64);
    HWIO_OUTXF((UINT64)base, USBAP_TXBUF_WR_DATA_127_96_PROP, TXBUFF_WR_DATA_127_96, TX_WR_DATA_127_96);

    HWIO_OUTXF((UINT64)base, USBAP_TXBUF_CTRL_PROP, TXBUFF_WR_RDN, R_W);// Write the vlues to TX BUFF
    while(1!= HWIO_INXF((UINT64)base, USBAP_TXBUF_STS_PROP, TXBUFF_ACCESS_COMPL));

    HWIO_OUTXF((UINT64)base, USBAP_TXBUF_CTRL_PROP, TXBUFF_WR_RDN, ~R_W);// Read the values form TX BUFF

    RX_RD_DATA_31_0   = HWIO_INXF((UINT64)base, USBAP_TXBUF_RD_DATA_31_0_PROP, TXBUFF_RD_DATA_31_0);
    RX_RD_DATA_63_32  = HWIO_INXF((UINT64)base, USBAP_TXBUF_RD_DATA_63_32_PROP, TXBUFF_RD_DATA_63_32);
    RX_RD_DATA_95_64  = HWIO_INXF((UINT64)base, USBAP_TXBUF_RD_DATA_95_64_PROP, TXBUFF_RD_DATA_95_64);
    RX_RD_DATA_127_96 = HWIO_INXF((UINT64)base, USBAP_TXBUF_RD_DATA_127_96_PROP, TXBUFF_RD_DATA_127_96);
...
int Usb4PlatformAhbAccess_enable_usbap_XHCI_BW_negotiation(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, boolean CMR, UINT32 scale, UINT32 BW)
{
    ...
    val = CMR ? 1:0;
    HWIO_OUTXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_3_STANDARD, SCALE, scale); 
    HWIO_OUTXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_2_STANDARD, CMR, val);
    
    if(1 == HWIO_INXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_1_STANDARD, XCA))
    {    
      
      Consumed_UP_BW = HWIO_INXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_1_STANDARD, CONSUMED_UPSTREAM_BANDWIDTH);
      Consumed_DN_BW = HWIO_INXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_1_STANDARD, CONSUMED_DOWNSTREAM_BANDWIDTH);
      ...
      HWIO_OUTX((UINT64)base, USB4_USB_AP_ADP_USB_CS_2_STANDARD, 0x00080080);
      while(0 != HWIO_INXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_1_STANDARD, XCA));
...
int Usb4PlatformAhbAccess_set_usbap_local_rxterm_Req(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, UINT8 RxTerm)
{
    ...
    base = usb4_platform_ahb_access_ctx->m_coreBaseAddress + USB_ADAPTER_PORT_PROP_REG_BASE_OFFS;
    HWIO_OUTXF((UINT64)base, USBAP_NUM_RXTERM_REQ_PROP, NUM_RXTERM_REQ, RxTerm);
 
    val = HWIO_INXF((UINT64)base, USBAP_NUM_RXTERM_REQ_PROP, NUM_RXTERM_REQ);
...
UINT32 Usb4PlatformAhbAccess_get_usbap_num_DP_packets(usb4_platform_ahb_access_ctx_t* usb4_platform_ahb_access_ctx, boolean Pkt_byte)
{
    ...
    base = usb4_platform_ahb_access_ctx->m_coreBaseAddress + USB_ADAPTER_PORT_REG_BASE_OFFS;
    while(1 != HWIO_INXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_4_STANDARD, ULV));
    
    link_rate = HWIO_INXF((UINT64)base, USB4_USB_AP_ADP_USB_CS_4_STANDARD, ACTUAL_LINK_RATE); // Get USBAP link rate 
