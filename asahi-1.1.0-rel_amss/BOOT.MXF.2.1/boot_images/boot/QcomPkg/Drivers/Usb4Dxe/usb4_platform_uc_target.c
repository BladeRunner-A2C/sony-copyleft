...
int Usb4PlatformUcMsgRingPrintMsgs(usb4_platform_uC_target_MsgRing_ctx_t* usb4_platform_uC_target_MsgRing_ctx, UINT32 coreIndex)
{
    ...
    {
        Usb4Log2(USB4_LOG_CFG, Usb4PlatformUcMsgRingPrintMsgs__Params__uC_Msg, 0, (UINT64)usb4_platform_uC_target_MsgRing_ctx->m_pBuff + usb4_platform_uC_target_MsgRing_ctx->m_printIdx, coreIndex);
