...
----------   ---     ----------------------------------------------------------- 
2018/03/08   jt      Initial version, specifically for SD card boot
...
/**
  Function: SdEraseBlocks

  This function returns success as there is no support for erase
  in the SD card. 
  ...
  @return EFI_SUCCESS            The function returned successfully. 
**/
EFI_STATUS EFIAPI SdEraseBlocks (
   IN EFI_BLOCK_IO_PROTOCOL *This,
   IN UINT32 MediaId,
   IN EFI_LBA LBA,
   IN OUT EFI_ERASE_BLOCK_TOKEN *Token,
