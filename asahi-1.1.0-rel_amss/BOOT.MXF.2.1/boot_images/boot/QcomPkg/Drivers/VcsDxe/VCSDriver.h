...
/*  
  ...
  ==================================================================== 
  $Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/QcomPkg/Drivers/VcsDxe/VCSDriver.h#1 $
...
#define VCS_CLIENT_TO_RAIL(c) \
  (VCSRailNodeType *)(((npa_client_handle)c)->resource->node->data)

#define VCS_RESOURCE_TO_RAIL(r) \
  (VCSRailNodeType *)(((struct npa_resource *)r)->definition->data)
...
#define VCS_HW_VERSION(r) \
  (&((r)->HWVersion))

#define VCS_DEPENDENCY_EMPTY UCHAR_MAX
