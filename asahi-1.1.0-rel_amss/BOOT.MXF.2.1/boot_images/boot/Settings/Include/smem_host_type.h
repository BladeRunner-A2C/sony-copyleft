...
$Header: //service/BOOT/BOOT.MXF.2.1-01839-LANAI-2.65818/boot_images/boot/Settings/Include/smem_host_type.h#1 $
...
#define SMEM_NUM_HOSTS      20                    /**< Max number of host in target */
