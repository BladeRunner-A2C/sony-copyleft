...
&vadc {
   ...
   pm8350b: spmi-vadc@3 {
    ...
    adc-sid = <0x4>;
      ...
      gpio-map {
         aux_pin1 {
            vadc_ch = <0x5 0x25 0x45 0x65>;
            gpio-num = <1>;
         };
         aux_pin2 {
            vadc_ch = <0x6 0x26 0x46 0x66>;
            gpio-num = <2>;
         };
      };

      therm_table: therm_table { };
   };
};
