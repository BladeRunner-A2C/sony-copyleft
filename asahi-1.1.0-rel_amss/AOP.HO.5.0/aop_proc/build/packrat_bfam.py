...
def check_elf_exists(msm):
  ...
  elif msm in [ 'waipio','kuno','kailua', 'lanai', 'pakala', 'hamoa', 'pinnacle', 'sariska', 'camano']:
...
def match_whitelist(all_files, whitelist_files, msm):
  ...
  if msm == '670':
    ...
    execfile(packrat_path + '/whitelist_pinnacle.py', whitelist)
  elif msm == 'sariska':
    execfile(packrat_path + '/whitelist_sariska.py', whitelist)
  elif msm == 'kapiti':
    ...
    execfile(packrat_path + '/whitelist_hamoa.py', whitelist)
  elif msm == 'kuno':
    execfile(packrat_path + '/whitelist_kuno.py', whitelist)
  elif msm == 'camano':
    execfile(packrat_path + '/whitelist_camano.py', whitelist)
  else:
...
def main(argv):
  ...
  if msm == '670':
    ...
    supported_targets = ['lanai']
  elif msm == 'pakala':
    supported_targets = ['pakala']
  elif msm == 'pinnacle':
    supported_targets = ['pinnacle']
  elif msm == 'sariska':
    supported_targets = ['sariska']
  elif msm == 'kailua':
    ...
    supported_targets = ['hamoa']
  elif msm == 'kuno':
    supported_targets = ['kuno']
  elif msm == 'camano':
    supported_targets = ['camano']
  else:
