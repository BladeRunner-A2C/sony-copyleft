...
rem ==========================================================================
rem $Header: //components/dev/aop.ho/5.0/kparsha.aop.ho.5.0.aop50_pakala_base/aop_proc/build/build_pakala.bat#1 $

SET BUILD_ASIC=pakala
SET MSM_ID=pakala
SET HAL_PLATFORM=pakala
SET TARGET_FAMILY=pakala
SET CHIPSET=pakala
