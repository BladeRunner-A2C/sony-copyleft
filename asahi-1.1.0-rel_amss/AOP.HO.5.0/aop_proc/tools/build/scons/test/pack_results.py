...
# -------------------------------------------------------------------------
#
#  $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/tools/build/scons/test/pack_results.py#1 $
...
if __name__ == "__main__":
    ...
    arg_parser = ArgumentParser(description=__doc__,
                                version="$Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/tools/build/scons/test/pack_results.py#1 $")
