...
#-------------------------------------------------------------------------------
#
#  $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/tools/build/scons/scripts/sd_llvm.py#1 $
...
def generate(env):
   ...
   LLVMFlags = LLVMFlags + " -Wno-unused-parameter -Wno-sign-compare -Wno-gcc-compat -Wno-sizeof-pointer-div -fno-builtin-memset"
   ...
   env.Replace(ARFLAGS = "$ARMAR_LIB_REPLACE $ARMAR_LIB_QUITE $ARMAR_DETERMINISTIC")
