...
#----------------------------------------------------------------------------
#
#  $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/tools/build/scons/scripts/analytic_data_builder.py#1 $
...
def script_path_capture(env, publish_file, publish_name, publish_paths):
    ...
    if img_env is not None:
        ...
        if script_path_data_dict is not None:
            ...
            if publish_file in script_path_data_dict:
