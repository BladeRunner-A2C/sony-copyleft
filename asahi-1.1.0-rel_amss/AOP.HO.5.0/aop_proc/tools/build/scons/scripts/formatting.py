...
#-------------------------------------------------------------------------------
#
#  $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/tools/build/scons/scripts/formatting.py#1 $
...
def generate(env):
    ...
    if verbose == 3:
        ...
        if 0 and 'PLATFORM' in env and env['PLATFORM'] == 'cygwin':
            if progress:
