...
#-------------------------------------------------------------------------------
#
#  $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/tools/build/scons/scripts/elfparserutils.py#1 $
...
class Elf32_Ehdr(object):
    ...
    def readelf_print_values(self):
        ...
        print('   {0:<34} {1:#d} {2}'.format ("Start of program headers:", self.e_phoff, "(bytes into file)"))
        print('   {0:<34} {1:#d} {2}'.format ("Start of section headers:", self.e_shoff, "(bytes into file)"))
        print('   {0:<34} {1:#0x}'.format("Flags:", self.e_flags))
        print('   {0:<34} {1:#d} {2}'.format ("Size of this header:", self.e_ehsize, "(bytes)"))
        print('   {0:<34} {1:#d} {2}'.format ("Size of program headers:", self.e_phentsize, "(bytes)"))
        print('   {0:<34} {1:#0d}'.format ("Number of program headers:", self.e_phnum))
        print('   {0:<34} {1:#d} {2}'.format ("Size of section headers:", self.e_shentsize, "(bytes)"))
    ...
    def readelf_program_header_preamble(self):
        ...
        print('{0:8}'.format("Type"), end='')
        print('{0:10}'.format("Offset"), end='')
        print('{0:10}'.format("VirtAddr"), end='')
        print('{0:10}'.format("PhysAddr"), end='')
        print('{0:10}'.format("FileSiz"), end='')
        print('{0:10}'.format("MemSiz"), end='')
        print('{0:4}'.format("Flg"), end='')
    ...
    def readelf_section_header_preamble(self):
        ...
        print('{0:6}'.format("[Nr]"), end='')
        print('{0:26}'.format("Name"), end='')
        print('{0:8}'.format("Type"), end='')
        print('{0:10}'.format("Addr"), end='')
        print('{0:10}'.format("Off"), end='')
        print('{0:10}'.format("Size"), end='')
        print('{0:4}'.format("ES"), end='')
        print('{0:4}'.format("Flg"), end='')
        print('{0:4}'.format("Lk"), end='')
        print('{0:4}'.format("Inf"), end='')
        print('{0:4}'.format("Al")
)
...
class Elf32_Phdr(object):
    ...
    def readelf_print_values(self):
        '''
           readelf_print_values
        '''
        print('{0:8}'.format(self.get_type_str()), end='')        #Type
        print('{0:#010x}'.format(self.p_offset), end='')          #Addr
        print('{0:#010x}'.format(self.p_vaddr), end='')           #Vaddr
        print('{0:#010x}'.format(self.p_paddr), end='')           #Paddr
        print('{0:#010x}'.format(self.p_filesz), end='')          #FS
        print('{0:#010x}'.format(self.p_memsz), end='')           #MS
        print('{0:#04x}'.format(self.p_flags), end='')            #Flg
...
class Elf32_Shdr(object):
    ...
    def readelf_print_values(self):
        '''
           readelf_print_values
        '''
        print('[{0:4d}]'.format(self.index), end='')
        print('{0:18} ({1:#05x})'.format(self.str_name, self.sh_name), end='') #Name
        print('{0:8}'.format(self.get_type_str()), end='')         #Type
        print('{0:#010x}'.format(self.sh_addr), end='')            #Addr
        print('{0:#010x}'.format(self.sh_offset), end='')          #Off
        print('{0:#010x}'.format(self.sh_size), end='')            #Size
        print('{0:#04x}'.format(self.sh_entsize), end='')          #ES
        print('{0:#04x}'.format(self.sh_flags), end='')            #Flg
        print('{0:#04x}'.format(self.sh_link), end='')             #Lk
        print('{0:#4d}'.format(self.sh_info), end='')              #Inf
...
class ElfSymbols(object):
    ...
    def __init__(self, elf_fp, shdr_table):
        ...
        num_entries = int(self.symtab_sh.sh_size/16)
        symbol_list = []
...
def verify_elf_header(elf_header):
    ...
    if sys.version_info.major == 2:
       ...
       if (elf_header.e_ident[Elf32_Ehdr.ELFINFO_MAG0_INDEX] != \
           ord(Elf32_Ehdr.ELFINFO_MAG0)) or    \
          (elf_header.e_ident[Elf32_Ehdr.ELFINFO_MAG1_INDEX] != \
           ord(Elf32_Ehdr.ELFINFO_MAG1)) or   \
          (elf_header.e_ident[Elf32_Ehdr.ELFINFO_MAG2_INDEX] != \
           ord(Elf32_Ehdr.ELFINFO_MAG2)) or   \
          (elf_header.e_ident[Elf32_Ehdr.ELFINFO_MAG3_INDEX] != \
           ord(Elf32_Ehdr.ELFINFO_MAG3)) or   \
          (elf_header.e_ident[Elf32_Ehdr.ELFINFO_CLASS_INDEX] != \
           ord(Elf32_Ehdr.ELFINFO_CLASS_32)) or \
          (elf_header.e_ident[Elf32_Ehdr.ELFINFO_VERSION_INDEX] != \
           ord(Elf32_Ehdr.ELFINFO_VERSION_CURRENT)):
