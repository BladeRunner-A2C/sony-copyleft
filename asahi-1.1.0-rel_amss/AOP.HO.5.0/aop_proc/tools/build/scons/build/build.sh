...
#-------------------------------------------------------------------------------
#
# $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/tools/build/scons/build/build.sh#1 $
...
echo "#-------------------------------------------------------------------------------" >> build-log.txt
scriptdir=`dirname $0`
export PYTHONPATH=$scriptdir/../SCons/lib:$PYTHONPATH
echo "$scriptdir/../SCons/scripts/scons $*" >> build-log.txt
echo "$scriptdir/../SCons/scripts/scons $*"
chmod +x $scriptdir/../SCons/scripts/scons
$scriptdir/../SCons/scripts/scons $* 2>&1 | tee -a build-log.txt
