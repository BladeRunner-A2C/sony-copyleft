...
$Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/kernel/rex/inc/arch/aop_mpu.h#1 $
$Date: 2024/04/01 $
...
typedef enum
{
    ...
    AOP_MPU_RGN_AP_RW          = 1,
    AOP_MPU_RGN_AP_RW_RW       = 3,
    AOP_MPU_RGN_AP_RO          = 5,
} aop_mpu_rgn_ap_t;

/*
 *  * SCS.MPU.RegionAttrSize[21:19] TEX (Memory Type Extention)  
 */
typedef enum
{
    AOP_MPU_TEX_0 = 0,
