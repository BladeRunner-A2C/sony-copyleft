...
#include <stdint.h>
#include <stdbool.h>
#if defined(LANAI_TARGET_CONFIG) || defined(PAKALA_TARGET_CONFIG) || defined(PALAWAN_TARGET_CONFIG) || defined(MATRIX_TARGET_CONFIG) || defined(MILOS_TARGET_CONFIG)
...
{
#if !defined(PAKALA_TARGET_CONFIG) && !defined(LANAI_TARGET_CONFIG) && !defined(PALAWAN_TARGET_CONFIG) && !defined(MATRIX_TARGET_CONFIG) && !defined(MILOS_TARGET_CONFIG)
    return (__builtin_arm_rsr("IPSR") - 0x10);
#else
    return 0;  //TODO RISCV Implementation
#endif
}
