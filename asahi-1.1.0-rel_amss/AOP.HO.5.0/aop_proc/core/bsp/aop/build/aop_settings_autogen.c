...
#include "/local/mnt/workspace/CRMBuilds/e68a4a61-a213-45bf-0ec1-08dc4a24af2c/b/HY11_1/aop_proc/core/settings/pmic/interface/pm_config_interface.h"
...
property_type_t pmic_prop_arr[] = 
{
  ...
  {
    .prop_id =  4149945856, /*PM_PROP_MIN_SETTLING_TIME_THR*/
    .prop_val = (uint32_t)&min_settling_time_thr,
  },
};
...
{
  {
    .prop_id =  3176325200, /*global_pmu_en*/
    .prop_val = 1,
  },
};
...
property_type_t prochot_prop_arr[] = 
{
  {
    .prop_id =  3069903490, /*prochot_en*/
    .prop_val = 0,
  },
};
...
device_type_t devices[] __attribute__((used)) = {
  ...
  {
    .device_id = 4141237051, /*prochot*/
    .num_props_for_device = ARRAY_SIZE(prochot_prop_arr),
    .props = (property_type_t*)&prochot_prop_arr
  },
};
