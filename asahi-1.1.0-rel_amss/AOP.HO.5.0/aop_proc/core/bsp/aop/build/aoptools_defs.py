...
#-------------------------------------------------------------------------------
#
# $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/bsp/aop/build/aoptools_defs.py#1 $
#
#===============================================================================
import sys
import os
...
def generate(env):
   ...
   if env['MSM_ID'] in ['lanai', 'pakala', 'palawan','matrix', 'milos','kaanapali']:
     env.Tool('sd_riscv', toolpath = ['${BUILD_ROOT}/tools/build/scons/scripts'])
   else:
