...
dump_file_types = [
    ...
    {   # Certain system data is stored in OCIMEM
        'display_name'  : "OCIMEM",
        'name'          : {'OCIMEM.BIN','ocimem_0x14680000--0x146aafff.lst','ocimem_0x14680000--0x146bffff.lst','ocimem_0x14680000--0x146abfff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'OCIMEM', 'ocimem_0x14680000--0x146aafff','ocimem_0x14680000--0x146bffff','ocimem_0x14680000--0x146abfff'},
        'no_load'       : True,
        'path'          : "",
        'base'          : {
                              'hoya'  :{ '670': 0x14680000,
        ...
        'data'          : {
                              'dumptable' : {
                                  ...
                                  'netrani'   : 0x146AA000 + 0x10,
                                  'kailua'   : 0x146AA000 + 0x10,
                                  'lanai'   : 0x14680000 + 0x10,
                                  'palawan'   : 0x14680000 + 0x10,
                                  'hamoa'   : 0x146AA000 + 0x10,
                                  'kuno'   : 0x14693000 + 0x10,
                                  'pinnacle'   : 0x14680000 + 0x10,
                                  'camano'   : 0x146aa000 + 0x10,
                                  'pakala'   : 0x14680000 + 0x10,
                              },
                          },
    },
    ...
    {   # Heap is copied to DDR before overwritting
        ...
        'name'          : {'DDRCS1_0.BIN','dram_cs1_0x880000000--0x8ffffffff.lst','dram_cs1_0x140000000--0x1bfffffff.lst','dram_cs1_0x180000000--0x1ffffffff.lst', 'dram_cs1_0x200000000--0x27fffffff.lst','dram_cs1_0x800000000--0x87fffffff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'DDRCS1_0', 'dram_cs1_0x880000000--0x8ffffffff','dram_cs1_0x140000000--0x1bfffffff','dram_cs1_0x180000000--0x1ffffffff', 'dram_cs1_0x200000000--0x27fffffff','dram_cs1_0x800000000--0x87fffffff'},
        'no_load'       : True,
        'path'          : "",
        'update'        : True,
        'size'          : 0x0,
        'base'          : {
                              'hoya'  : {  #Size      : base address
                                            ...
                                            0x20000000 : 0x800000000,
                                            0x20000000 : 0x880000000,
                                         },
                              #'wildcat'  : {  #Size      : base address
                               #             0x80000000 : 0x100000000,
                                #         },
    ...
    {   # Heap is copied to DDR before overwritting
        ...
        'name'          : {'DDRCS1_1.BIN','dram_cs1_0x900000000--0x97fffffff.lst','dram_cs1_0x1c0000000--0x1ffffffff.lst','dram_cs1_0x280000000--0x2ffffffff.lst','dram_cs1_0x880000000--0x8ffffffff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'DDRCS1_1', 'dram_cs1_0x900000000--0x97fffffff','dram_cs1_0x1c0000000--0x1ffffffff','dram_cs1_0x280000000--0x2ffffffff','dram_cs1_0x880000000--0x8ffffffff'},
        'no_load'       : True,
        'path'          : "",
        'update'        : True,
        'size'          : 0x0,
    ...
    {   # Heap is copied to DDR before overwritting
        ...
        'name'          : {'DDRCS1_2.BIN','dram_cs1_0x980000000--0x9ffffffff.lst','dram_cs1_0x1c0000000--0x1ffffffff.lst','dram_cs1_0x280000000--0x2ffffffff.lst','dram_cs1_0x900000000--0x97fffffff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'DDRCS1_2', 'dram_cs1_0x980000000--0x9ffffffff','dram_cs1_0x1c0000000--0x1ffffffff','dram_cs1_0x280000000--0x2ffffffff','dram_cs1_0x900000000--0x97fffffff'},
        'no_load'       : True,
        'path'          : "",
        'update'        : True,
        'size'          : 0x0,
    ...
    {   # Heap is copied to DDR before overwritting
        ...
        'name'          : {'DDRCS2_0.BIN','dram_cs1_0xa00000000--0xa7fffffff.lst','dram_cs1_0x1c0000000--0x1ffffffff.lst','dram_cs1_0x280000000--0x2ffffffff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'DDRCS2_0', 'dram_cs1_0xa00000000--0xa7fffffff','dram_cs1_0x1c0000000--0x1ffffffff','dram_cs1_0x280000000--0x2ffffffff'},
        'no_load'       : True,
        'path'          : "",
        'update'        : True,
        'size'          : 0x0,
    ...
    {   # Heap is copied to DDR before overwritting
        ...
        'name'          : {'DDRCS2_1.BIN','dram_cs1_0xa80000000--0xa7fffffff.lst','dram_cs1_0x1c0000000--0x1ffffffff.lst','dram_cs1_0x280000000--0x2ffffffff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'DDRCS2_1', 'dram_cs1_0xa80000000--0xa7fffffff','dram_cs1_0x1c0000000--0x1ffffffff','dram_cs1_0x280000000--0x2ffffffff'},
        'no_load'       : True,
        'path'          : "",
        'update'        : True,
        'size'          : 0x0,
    ...
    {   # Heap is copied to DDR before overwritting
        ...
        'name'          : {'DDRCS2_2.BIN','dram_cs1_0xb00000000--0xb7fffffff.lst','dram_cs1_0x1c0000000--0x1ffffffff.lst','dram_cs1_0x280000000--0x2ffffffff.lst','dram_cs2_0xa00000000--0xa7fffffff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'DDRCS2_2', 'dram_cs1_0xb00000000--0xb7fffffff','dram_cs1_0x1c0000000--0x1ffffffff','dram_cs1_0x280000000--0x2ffffffff', 'dram_cs2_0xa00000000--0xa7fffffff'},
        'no_load'       : True,
        'path'          : "",
        'update'        : True,
        'size'          : 0x0,
    ...
    {   # Heap is copied to DDR before overwritting
        'display_name'  : "DDRCS2_3",
        'name'          : {'DDRCS2_3.BIN','dram_cs1_0xb80000000--0xbffffffff.lst','dram_cs1_0x1c0000000--0x1ffffffff.lst','dram_cs1_0x280000000--0x2ffffffff.lst','dram_cs2_0xa00000000--0xa7fffffff.lst'},
        'ext'           : {'.BIN', '.LST'},
        'basename'      : {'DDRCS2_3', 'dram_cs1_0xb80000000--0xbffffffff','dram_cs1_0x1c0000000--0x1ffffffff','dram_cs1_0x280000000--0x2ffffffff', 'dram_cs2_0xa00000000--0xa7fffffff'},
        'no_load'       : True,
        'path'          : "",
        'update'        : True,
        'size'          : 0x0,
