...
class DwarfObject(object):
    def __init__(self, system, debug_info):
        ...
        self._struct_fmts['unsigned'] = {k : v.upper() for k,v in self._struct_fmts['signed'].items()}
