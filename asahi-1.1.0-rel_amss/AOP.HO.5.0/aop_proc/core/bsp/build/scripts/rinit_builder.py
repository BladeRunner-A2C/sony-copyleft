...
#
# Copyright (c) 2016-2017,2023 by QUALCOMM Technologies, Incorporated.
# All Rights Reserved.
...
def flat_path_arg(env):
    ...
    target_flat_files = \
    {
        ...
        'sdm855' : [(base_path + '/v1/M3_ADDRESS_FILE_v1.FLAT', 1.0),
                    (base_path + '/v2/M3_ADDRESS_FILE_v2.FLAT', 2.0)],
