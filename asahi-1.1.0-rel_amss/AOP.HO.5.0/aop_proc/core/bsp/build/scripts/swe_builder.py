...
#
# Copyright (c) 2012-2019 by Qualcomm Technologies, Inc.
# All Rights Reserved.
# QUALCOMM Proprietary/GTDR
#
#-------------------------------------------------------------------------------
#
#  $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/bsp/build/scripts/swe_builder.py#1 $
...
def generate(env):
    ...
    if not os.path.exists(env['BUILD_ROOT']+'/core/api/debugtrace/') and platform.system() == 'Linux':
        os.makedirs(env['BUILD_ROOT']+'/core/api/debugtrace/')

    if not os.path.exists(env['BUILD_ROOT']+'\\core\\api\\debugtrace\\') and platform.system() == 'Windows':
        os.makedirs(env['BUILD_ROOT']+'\\core\\api\\debugtrace\\')
