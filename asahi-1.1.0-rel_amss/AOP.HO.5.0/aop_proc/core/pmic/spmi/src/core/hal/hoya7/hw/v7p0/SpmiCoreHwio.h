...
/*
    ...
    $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/pmic/spmi/src/core/hal/hoya7/hw/v7p0/SpmiCoreHwio.h#1 $
...
#define SPMI0_SPMI_CFG_REG_BASE_OFFS                                                        (PMIC_ARB_BASE_OFFS + 0x2D000)
...
#define SPMI0_SPMI_PIC_OWNER_REG_BASE_OFFS                                  (PMIC_ARB_BASE_OFFS + 0xc0000)
...
#define SPMI0_SPMI_SPMI_GENI_CFG_REG_BASE_OFFS                                   (PMIC_ARB_BASE_OFFS + 0x02c000)
...
#define SPMI1_SPMI_CFG_REG_BASE_OFFS                                                        (PMIC_ARB_BASE_OFFS + 0x32000)
...
#define SPMI1_SPMI_PIC_OWNER_REG_BASE_OFFS                                  (PMIC_ARB_BASE_OFFS + 0xd0000)
...
#define SPMI1_SPMI_SPMI_GENI_CFG_REG_BASE_OFFS                                   (PMIC_ARB_BASE_OFFS + 0x31000)
 ...
 * MODULE: SPMI_CFG
 *--------------------------------------------------------------------------*/
#define SPMI_CFG_REG_BASE_OFFS                                       (PMIC_ARB_BASE_OFFS + 0x2D000)
 ...
 *--------------------------------------------------------------------------*/
#define SPMI_GENI_CFG_REG_BASE_OFFS                                   (PMIC_ARB_BASE_OFFS + 0x02c000)
...
#define SPMI_PIC_OWNER_REG_BASE_OFFS                                  (PMIC_ARB_BASE_OFFS + 0xc0000)
