...
$Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/pmic/pm/prm/inc/pm_prm_device.h#1 $
...
typedef struct
{
    unpa_resource_state mode:6;
    unpa_resource_state voltage:25;
