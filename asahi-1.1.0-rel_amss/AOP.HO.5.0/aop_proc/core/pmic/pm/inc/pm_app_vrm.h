...
$Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/pmic/pm/inc/pm_app_vrm.h#1 $
...
* @param[out] pshold_status PS_HOLD status
* 
* @return
...
/**
* An app level API to get the VRM CLK resource settling logs.
*  
* @param[in] periph_info PMIC peripheral info (refer to pm_vrm_periph_info struct above)
* @param[in] estimated_time_us estimated settling time for the resource.
* 
