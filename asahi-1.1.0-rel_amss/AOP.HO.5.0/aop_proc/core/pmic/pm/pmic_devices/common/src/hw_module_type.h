...
$Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/pmic/pm/pmic_devices/common/src/hw_module_type.h#1 $
$Author: cirrusp4svc $
...
typedef enum
{
    ...
    PM_HW_MODULE_PON_GEN2_PBS_GEN3 = 8,
...
typedef enum
{
    ...
    PM_HW_MODULE_LDO_502_N1200_100     = 161,
    PM_HW_MODULE_LDO_502_MV_P600_500   = 165,
    PM_HW_MODULE_LDO_502_MV_HP_P300_500= 168,
    ...
    PM_HW_MODULE_LDO_515_MV_P1200_200  = 179,
...
typedef enum
{
    ...
    PM_HW_MODULE_BOB520_CONFIG =7,
    PM_HW_MODULE_BOB520_MONITORING = 8,
