...
$Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/pmic/pm/drivers/pon/src/pm_pon_key_reset.c#1 $
...
__attribute__((section("rinit_code_sec_pool1")))
pm_err_flag_type pm_pon_reset_source_cfg(uint32 pmic_device_index, pm_pon_reset_source_type reset_source,
...
__attribute__((section("rinit_code_sec_pool1")))
pm_err_flag_type pm_pon_stage3_reset_source_cfg(uint32 pmic_device_index, pm_pon_reset_source_type reset_source, uint32 s3_timer_ms)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 s3_timer_id = 0;
  uint32 slave_id = 0;
...
__attribute__((section("rinit_code_sec_pool1")))
pm_err_flag_type pm_pon_irq_enable(uint32 pmic_device_index, pm_pon_irq_type irq, boolean enable)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint8 mask = 1 << irq;
...
__attribute__((section("rinit_code_sec_pool1")))
pm_err_flag_type pm_pon_irq_clear(uint32  pmic_device_index, pm_pon_irq_type irq)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint32 slave_id = 0;
  uint8 mask = 1 << irq;
...
__attribute__((section("rinit_code_sec_pool1")))
pm_err_flag_type pm_pon_irq_set_trigger(uint32 pmic_device_index, pm_pon_irq_type irq, pm_irq_trigger_type trigger)
{
  pm_err_flag_type err_flag = PM_ERR_FLAG_SUCCESS;
  uint32 slave_id = 0;
  uint8 mask = 1 << irq;
...
__attribute__((section("rinit_code_sec_pool1")))
uint8 pm_pon_get_upper_idx(uint32 data_value, uint32 *data_list, uint8 list_count)
{
  uint8 idx = 0;
