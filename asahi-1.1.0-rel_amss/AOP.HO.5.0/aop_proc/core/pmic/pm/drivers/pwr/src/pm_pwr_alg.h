 ...
 *  \brief   
 *  \details  
 *  \n &copy; Copyright 2011-2018 QUALCOMM Technologies Incorporated, All Rights Reserved
 */
...
/* =======================================================================
  ...
  $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/pmic/pm/drivers/pwr/src/pm_pwr_alg.h#1 $
...
typedef struct 
{
    ...
    pm_register_address_type    OCP;                // OCP 0x88
    pm_register_address_type    PMIC4_OCP;          // PMIC_OCP 0x66
    ...
    pm_register_address_type    AHC_CTL;            // AHC_CTL(Different for smps and ldo)
    pm_register_address_type    PBS_VOTE_CTL;
    pm_register_address_type    PMOS_FORCE_SOFT_START; //for PMOS LDO only 0x3C
...
typedef struct
{
    ...
    boolean                       pmic4_flag;
    boolean                       is_ahc_enabled;
    uint32                        ahc_reserved_hr;
    boolean                       is_soft_start_present;
...
pm_err_flag_type pm_pwr_pmos_soft_start_en_alg(pm_pwr_data_type *pwr_data, 
                                               pm_comm_info_type *comm_ptr, 
                                               uint32 peripheral_index, 
