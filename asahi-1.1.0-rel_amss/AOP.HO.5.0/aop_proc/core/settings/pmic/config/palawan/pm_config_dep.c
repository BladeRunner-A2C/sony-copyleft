...
$Header: //components/dev/aop.ho/5.0/avadrav.aop.ho.5.0.palawan_buildinfra_new/aop_proc/core/settings/pmic/config/lanai/pm_config_dep.c#1 $
...
__attribute__((section("pm_ddr_reclaim_pool")))
pm_pwr_resource *smps3_b_child_dep[] =
{
  &ldo_b[1],
  &ldo_b[3],
  &ldo_b[9],
