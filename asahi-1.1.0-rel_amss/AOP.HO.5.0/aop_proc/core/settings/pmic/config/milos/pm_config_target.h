...
$Header: //components/dev/aop.ho/5.0/kuam.aop.ho.5.0.milos_bsp1/aop_proc/core/settings/pmic/config/lanai/pm_config_target.h#1 $
...
#define PM_DRV_WPSS   (0x1 << RSC_DRV_GLOBAL_WPSS)
