...
$Header: //components/dev/aop.ho/5.0/svaginep.aop.ho.5.0.matrix_build_support/aop_proc/core/settings/pmic/config/lanai/pm_config_dep.c#1 $
 Version : 1.0
===========================================================================*/
...
__attribute__((section("pm_ddr_reclaim_pool")))
static pm_pwr_resource *smps6_d_child_dep[] =
{
  &ldo_b[1],
  &ldo_b[8],
  &ldo_b[9],
...
pm_pwr_resource_dependency_info smps_dep_d[] =
{
   ...
   {
      NULL,// parent resource
      smps6_d_child_dep,// child resource dependencies
      9,  // num vreg children
      0,  // num xob children
   },
   // S7D
