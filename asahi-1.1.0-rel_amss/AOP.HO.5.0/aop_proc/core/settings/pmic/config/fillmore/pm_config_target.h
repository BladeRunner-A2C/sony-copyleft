...
$Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/settings/pmic/config/fillmore/pm_config_target.h#1 $
...
#define PM_DRV_WLANBB (0x1 << RSC_DRV_GLOBAL_WPSS)  //WPSS added for Fillmore
