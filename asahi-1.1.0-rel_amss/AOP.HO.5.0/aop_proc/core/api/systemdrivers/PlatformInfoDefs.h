...
/*
  ====================================================================
    ...
    Copyright (c) 2013-2019,2023-2024 Qualcomm Technologies, Inc. All rights reserved.
...
typedef enum
{
  ...
  DALPLATFORMINFO_TYPE_AEDK         = 0x23,  /**< Target is a AEDK device. */
  DALPLATFORMINFO_TYPE_WDP          = 0x24,  /**< Target is a WDP device. */
  DALPLATFORMINFO_TYPE_QAM          = 0x25,  /**< Target is a QAM device. */
  DALPLATFORMINFO_TYPE_QXR          = 0x26,  /**< Target is a QXR device. */
  DALPLATFORMINFO_TYPE_X100         = 0x27,  /**< Target is a X100 device. */
  DALPLATFORMINFO_TYPE_CRD          = 0x28,  /**< Target is a CRD device. */
  DALPLATFORMINFO_TYPE_QQVP      = 0x29,  /**< Qualcomm QEMU Virtual Platform */

  DALPLATFORMINFO_NUM_TYPES,               /**< Number of known targets
                                               (including unknown). */
  /** @cond */
...
typedef enum
{
  ...
  DALPLATFORMINFO_KEY_SLT           = 0x07,
  DALPLATFORMINFO_KEY_PMIC          = 0x08,

  DALPLATFORMINFO_NUM_KEYS          = 0x09,
 ...
 */
#define DALPLATFORMINFO_SMEM_FORMAT DALPLATFORMINFO_VERSION(0, 16)
...
typedef struct
{
  ...
  uint32                          nNumClusters;         /**< Number of clusters used 
                                                             by ChipInfo_GetDisabledCPUs API */
  uint32                          nClusterArrayOffset;  /**< Offset from base of structure to
                                                             uint32 array of disabled CPU clusters. */
