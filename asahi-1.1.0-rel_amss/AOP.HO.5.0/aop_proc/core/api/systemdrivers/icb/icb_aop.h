...
$Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/api/systemdrivers/icb/icb_aop.h#1 $

when         who     what, where, why
----------   ---     ------------------------------------------------------
2023/12/18   sds     Add ADCVS enable/disable hook
2020/08/07   sds     Move icb async callbacks to service thread
...
/**
@brief Interface for AOP services to notify ICB to service completions.
*/
void icb_handle_aop_service_comp_req( void );
...
** ----------------------------------------------------------------------- */
/**
@brief Runtime enable and disable of ADCVS, if necessary.

@param[in] en - The IRQ to handle
*/
void icb_enable_adcvs( bool en );
