...
typedef enum
{
  ...
  MSM_EPSS_REG_DUMP = 0x163,
  MSM_PCU_REG_DUMP = 0x164,
  MSM_CPRH_REG_DUMP = 0x165,
  CPU_L1_DCACHE_DIRTY = 0x170,
  CPU_L1_DCACHE_MTE = 0x180,
  CPU_L2_DCACHE_MTE = 0x190,
  CPU_L0_MOP_CACHE = 0x1A0,
  CPU_L1_BTB_DATA = 0x1B0,
  CPU_L1_GTB_DATA = 0x1C0,
  CPU_L1_BIM_DATA = 0x1D0,
  CPU_L2_VICTIM_LOCATION = 0x1E0,
  CPUSS_SPR_DUMP = 0x1F0,
  CPU_L2_TLB_TCSP_DUMP = 0x200,
  CPU_L2_TLB_TCMP_DUMP = 0x210,
  MSM_DATA_SCANDUMP_SMMU  = 0x220,
  MSM_DATA_SCANDUMP_GPU  = 0x221,
  MSM_DATA_SCANDUMP_UBWCP = 0x222,
  ALL_CPU_CACHES = 0x230,
  ALL_CLUSTER_CACHES = 0x240,
  MSM_CPU_CONTEXT_DUMP = 0x250,
  MSM_DATA_TZ_DIAG_DUMP = 0x260,
  MSM_MAX_DUMP = 0x300,
