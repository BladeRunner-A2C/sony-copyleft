...
typedef enum {
    ...
    RSC_DRV_GLOBAL_TME_HW        = 11,
    RSC_DRV_GLOBAL_TME_SW        = 12,
    RSC_DRV_GLOBAL_MODEM_SW      = 13,
    RSC_DRV_GLOBAL_MODEM_HW      = 14,
    RSC_DRV_GLOBAL_MODEM_CESTA   = 15,
    RSC_DRV_GLOBAL_WLAN_RF       = 16,
    RSC_DRV_GLOBAL_WLAN_BB       = 17,
    RSC_DRV_GLOBAL_CAM_IFE0      = 18,
    RSC_DRV_GLOBAL_CAM_IFE1      = 19,
    RSC_DRV_GLOBAL_CAM_IFE2      = 20,
    RSC_DRV_GLOBAL_PCIE0_CESTA   = 21,
    RSC_DRV_GLOBAL_PCIE1_CESTA   = 22,
	RSC_DRV_GLOBAL_WPSS          = 23,
    RSC_DRV_GLOBAL_DDR_AUX       = 24,
    RSC_DRV_GLOBAL_ARC_CPRF      = 25,
