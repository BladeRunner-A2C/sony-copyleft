...
tracer_event_item tracer_event_tbl[] = {
	...
	{AOP_RISCV_ERR_FATAL,"aop_riscv_err_fatal(ra: 0x%0.8x) (mcause: 0x%0.8x)"},
	{AOSS_CC_RESET,"AOSS CC RESET STATUS: (0x%x)"},
	{CLIC_MTVEC_FATAL,"clic_mtvec_fatal (mcause: 0x%x)) (mepc: 0x%x)) (mtval: 0x%x)) (exception: 0x%x))"},
	...
	{AOP_DDR_READ_OK=913," Successful DDR Reading.  Read value 0x(%X)"},
	{AOP_DDR_READ_NO_OK=914,"Failed DDR reading. Read value 0x(%X)"},
