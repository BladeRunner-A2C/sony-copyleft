#ifndef ARC_VT_HWIO_H
#define ARC_VT_HWIO_H
/*
===========================================================================
*/
/**
...
/*
    ...
    $Header: //service/AOP/AOP.HO.5.0-00688-LANAI_E-1.65547/aop_proc/core/power/utils/inc/lanai/arc_vt_hwio.h#1 $
...
#define HWIO_RPMH_ARC_DRVd_RMm_VOTE_ADDR(d,m)                                   (RPMH_ARC_ARC_VT_REG_BASE      + 0X0 + (0x10000*(d)) + (0x10*(m)))
#define HWIO_RPMH_ARC_DRVd_RMm_VOTE_OFFS(d,m)                                   (RPMH_ARC_ARC_VT_REG_BASE_OFFS + 0X0 + (0x10000*(d)) + (0x10*(m)))
#define HWIO_RPMH_ARC_DRVd_RMm_VOTE_RMSK                                        0x8000000f
#define HWIO_RPMH_ARC_DRVd_RMm_VOTE_MAXd                                                24
...
#define HWIO_RPMH_ARC_DRVd_RMm_VOTE_RR_SHFT                                             31
#define HWIO_RPMH_ARC_DRVd_RMm_VOTE_OL_BMSK                                            0xf
#define HWIO_RPMH_ARC_DRVd_RMm_VOTE_OL_SHFT                                              0

#define HWIO_RPMH_ARC_DRVd_RMm_TIMER_ADDR(d,m)                                  (RPMH_ARC_ARC_VT_REG_BASE      + 0X4 + (0x10000*(d)) + (0x10*(m)))
#define HWIO_RPMH_ARC_DRVd_RMm_TIMER_OFFS(d,m)                                  (RPMH_ARC_ARC_VT_REG_BASE_OFFS + 0X4 + (0x10000*(d)) + (0x10*(m)))
#define HWIO_RPMH_ARC_DRVd_RMm_TIMER_RMSK                                              0x1
#define HWIO_RPMH_ARC_DRVd_RMm_TIMER_MAXd                                               24
...
#define HWIO_RPMH_ARC_DRVd_RMm_TIMER_TIMER_CONSIDERED_SHFT                               0

#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_ADDR(d,m)                          (RPMH_ARC_ARC_VT_REG_BASE      + 0X8 + (0x10000*(d)) + (0x10*(m)))
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_OFFS(d,m)                          (RPMH_ARC_ARC_VT_REG_BASE_OFFS + 0X8 + (0x10000*(d)) + (0x10*(m)))
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_RMSK                               0xfffff001
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_MAXd                                       24
...
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_DESTINATION_OL_SHFT                        28
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_SEQUENCE_OL_BMSK                    0xf000000
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_SEQUENCE_OL_SHFT                           24
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_AGGREGATED_OL_BMSK                   0xf00000
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_AGGREGATED_OL_SHFT                         20
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_SOLVED_OL_BMSK                        0xf0000
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_SOLVED_OL_SHFT                             16
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_CURRENT_OL_BMSK                        0xf000
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_CURRENT_OL_SHFT                            12
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_RESPONSE_PENDING_BMSK                     0x1
#define HWIO_RPMH_ARC_DRVd_RMm_SHADOW_STATUS_RESPONSE_PENDING_SHFT                       0

#define HWIO_RPMH_ARC_BCM_DRVd_RMm_VOTE_ADDR(d,m)                               (RPMH_ARC_ARC_VT_REG_BASE      + 0X1D0000 + (0x1000*(d)) + (0x10*(m)))
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_VOTE_OFFS(d,m)                               (RPMH_ARC_ARC_VT_REG_BASE_OFFS + 0X1D0000 + (0x1000*(d)) + (0x10*(m)))
...
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_VOTE_RR_SHFT                                         31
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_VOTE_OL_BMSK                                        0xf
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_VOTE_OL_SHFT                                          0

#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_ADDR(d,m)                      (RPMH_ARC_ARC_VT_REG_BASE      + 0X1D0008 + (0x1000*(d)) + (0x10*(m)))
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_OFFS(d,m)                      (RPMH_ARC_ARC_VT_REG_BASE_OFFS + 0X1D0008 + (0x1000*(d)) + (0x10*(m)))
...
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_DESTINATION_OL_SHFT                    28
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_SEQUENCE_OL_BMSK                0xf000000
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_SEQUENCE_OL_SHFT                       24
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_AGGREGATED_OL_BMSK               0xf00000
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_AGGREGATED_OL_SHFT                     20
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_SOLVED_OL_BMSK                    0xf0000
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_SOLVED_OL_SHFT                         16
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_CURRENT_OL_BMSK                    0xf000
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_CURRENT_OL_SHFT                        12
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_RESPONSE_PENDING_BMSK                 0x1
#define HWIO_RPMH_ARC_BCM_DRVd_RMm_SHADOW_STATUS_RESPONSE_PENDING_SHFT                   0
