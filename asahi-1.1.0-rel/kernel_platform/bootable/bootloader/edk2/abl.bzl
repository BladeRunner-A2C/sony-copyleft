...
def _abl_impl(ctx):
    ...
    command += """
      ...
      # SONY_BEGIN
      export USES_FEATURE_XBOOT={uses_feature_xboot}
      export USES_FEATURE_RAMDUMP={uses_feature_ramdump}
      # SONY_END
    ...
    """.format(
        ...
        # SONY_BEGIN
        uses_feature_xboot = ctx.attr.uses_feature_xboot[BuildSettingInfo].value,
        uses_feature_ramdump = ctx.attr.uses_feature_ramdump[BuildSettingInfo].value,
        # SONY_END
    )
...
abl = rule(
    ...
    attrs = {
        ...
        # SONY_BEGIN
        "uses_feature_xboot": attr.label(default = ":uses_feature_xboot"),
        "uses_feature_ramdump": attr.label(default = ":uses_feature_ramdump"),
        # SONY_END
